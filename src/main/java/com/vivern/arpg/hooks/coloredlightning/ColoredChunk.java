...
public class ColoredChunk {
    ...
    public Vec3d getVec3dColorAt(int inChunkX, int inChunkY, int inChunkZ) {
        ...
        byte green = this.GREEN[bakedCoord];
        byte blue = this.BLUE[bakedCoord];
        return new Vec3d(ColoredLightning.getSaturation(red) / 15.0F * ColoredLightning.getPower(red) / 15.0F, ColoredLightning.getSaturation(green) / 15.0F * ColoredLightning.getPower(green) / 15.0F, ColoredLightning.getSaturation(blue) / 15.0F * ColoredLightning.getPower(blue) / 15.0F);
    }
