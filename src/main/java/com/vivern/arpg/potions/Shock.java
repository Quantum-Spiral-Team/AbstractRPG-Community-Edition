...
public class Shock extends Potion {
    ...
    public void performEffect(EntityLivingBase entityLivingBase, int amplifier) {
        ...
        world.playSound(null, entityLivingBase.posX, entityLivingBase.posY, entityLivingBase.posZ, Sounds.shock, SoundCategory.AMBIENT, 0.8F, 0.9F + this.rand.nextFloat() / 5.0F);
        ...
        if (!list.isEmpty()) {
            for (EntityLivingBase entitylivingb : list) {
                if (entitylivingb != entityLivingBase && (entitylivingb.isPotionActive(MobEffects.RESISTANCE) || entitylivingb.isPotionActive(PotionEffects.SLIME) || entitylivingb.isInWater())) {
