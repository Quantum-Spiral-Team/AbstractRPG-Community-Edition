...
public class WrapperAssemblyTable implements IRecipeWrapper {
    ...
    public void getIngredients(IIngredients ingredients) {
        ...
        ingredients.setOutputs(VanillaTypes.ITEM, NonNullList.from(ItemStack.EMPTY, new ItemStack[]{this.recipe.craftresult.createStack(), this.recipe.craftresult2.createStack()}));
    }
