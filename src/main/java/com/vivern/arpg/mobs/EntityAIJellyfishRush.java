...
public class EntityAIJellyfishRush extends EntityAIBase {
    ...
    public void updateTask() {
        if (this.move) {
            ...
            BlockPos poss = new BlockPos(this.entity.posX + this.entity.motionX, this.entity.posY + this.entity.motionY, this.entity.posZ + this.entity.motionZ);
    ...
    public void createNewVector() {
        if (this.entity.getAttackTarget() != null) {
            ...
            this.randomMotionVecY = (float) v.y + (this.entity.world.getBlockState(this.entity.getPosition().up(3)).getMaterial() == Material.AIR ? -0.8F : 0.0F);
