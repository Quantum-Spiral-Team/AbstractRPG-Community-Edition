...
public class EntityAIRayLogicFly extends EntityAIBase {
    ...
    public void updateTask() {
        if (this.logicRay == null) {
            this.logicRay = new LogicRay(this.entity.posX, this.entity.posY + this.entity.height / 2.0F, this.entity.posZ, this.entity.getAttackTarget(), null);
        } else {
            ...
            if (shouldTravel && this.entity.getDistance(this.entity.getAttackTarget()) > 3.0F && this.logicRay.exist(this.entity.world, this.raysuccess, this.rayignore, false)) {
                ...
                if (forwPos != null) {
                    ...
                    SuperKnockback.applyMove(this.entity, -flyspeed, forwPos.x, forwPos.y - this.entity.height / 2.0F, forwPos.z);
                }
            }
