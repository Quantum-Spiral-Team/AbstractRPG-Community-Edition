...
public class EntityAIArcAttack extends EntityAIBase {
    ...
    public static ResourceLocation[] textures = new ResourceLocation[]{new ResourceLocation("arpg:textures/lightning1.png"), new ResourceLocation("arpg:textures/lightning2.png"), new ResourceLocation("arpg:textures/lightning3.png")};
    ...
    public static void spawnParticle(World world, int entityid, float Yoffset, int targetid, float beamSize, int beamTex) {
        ...
        if (e1 != null && e2 != null) {
            RayTraceResult result = world.rayTraceBlocks(new Vec3d(e1.posX, e1.posY + Yoffset, e1.posZ), new Vec3d(e2.posX, e2.posY + e2.height / 2.0F, e2.posZ), false);
            ...
            BetweenParticle laser = new BetweenParticle(world, textures[beamTex], beamSize, 240, 1.0F, 1.0F, 1.0F, 0.1F, pos1.distanceTo(pos2), 9, 0.0F, 9999.0F, pos1, pos2);
    ...
    public void updateTask() {
        ...
        if (attackTarg != null && !this.entity.world.isRemote && this.attackTimer <= 0 && this.entity.ticksExisted % this.checkDelay == 0) {
            AxisAlignedBB axisalignedbb = this.entity.getEntityBoundingBox().expand(this.grow * 2.0F, this.grow * 2.0F, this.grow * 2.0F).offset(-this.grow, -this.grow, -this.grow);
            ...
            if (!list.isEmpty()) {
                ...
                if (target != null) {
                    RayTraceResult result = this.entity.world.rayTraceBlocks(new Vec3d(this.entity.posX, this.entity.posY + this.Yoffset, this.entity.posZ), new Vec3d(target.posX, target.posY + target.height / 2.0F, target.posZ), false);
                    ...
                    PacketHandler.sendToAllAround(packet, this.entity.world, this.entity.posX, this.entity.posY, this.entity.posZ, 48.0);
                }
            }
        }
    }
