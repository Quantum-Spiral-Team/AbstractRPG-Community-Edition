        ...
        if (attackTarg != null) {
            ...
            if (Math.sin(this.entity.ticksExisted / 20.0) < 0.85) {
                ...
                if (this.entity.getDistance(attackTarg) > 6.0F) {
                    ...
                    SuperKnockback.applyMove(this.entity, -0.3F, attackTarg.posX, attackTarg.posY + attackTarg.height / 2.0F, attackTarg.posZ);
                } else {
                    this.entity.motionX /= 2.0;
                    this.entity.motionY /= 2.0;
                    this.entity.motionZ /= 2.0;
                    SuperKnockback.applyMove(this.entity, 0.4F, attackTarg.posX, attackTarg.posY + attackTarg.height / 2.0F, attackTarg.posZ);
                }
