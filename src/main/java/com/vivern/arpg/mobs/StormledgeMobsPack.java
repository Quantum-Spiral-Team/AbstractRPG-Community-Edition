...
public class StormledgeMobsPack {
    ...
    public static void initRender() {
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsStormledgeMob.ThunderbirdModel(), new ResourceLocation("arpg:textures/thunderbird_model_tex.png"), 1.2F, Thunderbird.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsStormledgeMob.ZarpionModel(), new ResourceLocation("arpg:textures/zarpion_model_tex.png"), 0.4F, Zarpion.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsStormledgeMob.GustModel(), new ResourceLocation("arpg:textures/gust_model_tex.png"), 0.3F, Gust.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsStormledgeMob.WindbreakModel(), new ResourceLocation("arpg:textures/windbreak_model_tex.png"), 0.4F, Windbreak.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsStormledgeMob.SkyGuardModel(), new ResourceLocation("arpg:textures/sky_screen_guard_model_tex.png"), 0.3F, Skyguard.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsStormledgeMob.ScreenGuardModel(), new ResourceLocation("arpg:textures/sky_screen_guard_model_tex.png"), 0.3F, Screenguard.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsStormledgeMob.CloudbugModel(), new ResourceLocation("arpg:textures/cloudbug_model_tex.png"), 0.25F, Cloudbug.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsStormledgeMob.HomingbirdModel(), new ResourceLocation("arpg:textures/homingbird_model_tex.png"), 0.2F, Homingbird.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsStormledgeMob.CloudEaterModel(), new ResourceLocation("arpg:textures/cloud_eater_model_tex.png"), 0.7F, CloudEater.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsStormledgeMob.BossOphanimModel(), new ResourceLocation("arpg:textures/boss_ophanim_model_tex.png"), 2.0F, BossOphanim.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsStormledgeMob.OphanimGuardModel(), new ResourceLocation("arpg:textures/ophanim_guard_model_tex.png"), 0.4F, OphanimGuard.class));
    }
    ...
    public static class CloudEater extends AbstractMob {
        ...
        public CloudEater(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.STORMSTEEL_NUGGET, 1.0F, 0, 1, 3, 0), new MobDrop(ItemsRegister.THUNDER_STONE, 0.55F, 0, 1, 1, 0)});
                    ...
                    if (!this.isAIDisabled() && !this.isPotionActive(PotionEffects.STUN) && this.getHealth() > 0.0F) {
                        for (Entity entity : GetMOP.getEntitiesInAABBof(this.world, this, 8.0, this)) {
                            if (entity instanceof EntityThrowable) {
                                ...
                                if (Team.checkIsOpponent(proj.shootingEntity, this)) {
                                    ...
                                    for (int ix = 0; ix < this.ticksCalculate; ix++) {
                                        ...
                                        velocity = new Vec3d((velocity.x + proj.accelerationX) * mf, (velocity.y + proj.accelerationY) * mf, (velocity.z + proj.accelerationZ) * mf);
                                    }
                                }
                            }
                            ...
                            if (entity instanceof EntityShulkerBullet) {
                                ...
                                if ((obj == null || !(obj instanceof EntityLivingBase) || Team.checkIsOpponent((EntityLivingBase) obj, this)) && this.getDistanceSq(entity) < 6.0) {
                                    this.dashOutOf(entity);
                                    return;
                                }
                            }
        ...
        public void dashOutOf(Entity projectile) {
            ...
            Vec3d vectorFromto = new Vec3d(projectile.posX - this.posX, projectile.posY - this.posY, projectile.posZ - this.posZ).normalize();
            ...
            if (!this.world.collidesWithAnyBlock(this.getEntityBoundingBox().offset(vectorDash.scale(2.5)))) {
                this.setPosition(this.posX + vectorDash.x * 2.5, this.posY + vectorDash.y * 2.5, this.posZ + vectorDash.z * 2.5);
            }
        ...
        public boolean isPotionApplicable(PotionEffect potioneffectIn) {
            ...
            return potion != PotionEffects.BLOOD_THIRST && potion != PotionEffects.BERSERK && potion != MobEffects.WEAKNESS && potion != MobEffects.POISON && potion != MobEffects.REGENERATION && potion != MobEffects.INSTANT_HEALTH && super.isPotionApplicable(potioneffectIn);
        }
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 8) {
                ...
                for (int i = 0; i < countOfParticles; i++) {
                    ...
                    GUNParticle particle = new GUNParticle(sparkle, scale, 0.007F, 40, 240, this.world, poss.x, poss.y, poss.z, X, Y, Z, 0.9F, 1.0F, 1.0F, true, 0);
                    particle.alphaGlowing = true;
                    particle.scaleTickAdding = -scale / 40.0F;
                    this.world.spawnEntity(particle);
                }

                GUNParticle particle = new GUNParticle(texture, 0.1F, 0.0F, 10, 240, this.world, poss.x, poss.y, poss.z, 0.0F, 0.0F, 0.0F, 0.5F + this.rand.nextFloat() * 0.3F, 0.8F - this.rand.nextFloat() * 0.15F, 1.0F, true, 0);
                particle.alphaGlowing = true;
            ...
            if (id == 11) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.electric_impact, SoundCategory.HOSTILE, 1.5F, 1.3F + this.rand.nextFloat() / 5.0F, false);
            }
        }
    ...
    public static class Cloudbug extends AbstractMob {
        ...
        public Cloudbug(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.STORMSTEEL_NUGGET, 0.38F, 0, 1, 1, 0), new MobDrop(ItemsRegister.THUNDER_STONE, 0.07F, 0, 1, 1, 0)});
            this.var2 = 0.0F;
            if (world.isRemote) {
                int c = 1;
                int cl = 0;
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 8) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.electric_impact, SoundCategory.HOSTILE, 0.9F, 0.9F + this.rand.nextFloat() / 3.0F, false);
            }
        }
        ...
        protected void initEntityAI() {
            ...
            this.tasks.addTask(2, new EntityAIArcAttack(this, 50, 3, 4.0F, 1.5F, 1.2F, 2, (byte) 8).setPotionEffect(new PotionEffect(PotionEffects.SHOCK, 60), 0.4F).setMissToBlock(true, 4.0F, 4.0F));
    ...
    public static class Gust extends AbstractMob {
        ...
        public Gust(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.STORMBRASS_NUGGET, 0.75F, 0, 1, 4, 0), new MobDrop(ItemsRegister.SKY_CRYSTAL_PIECE, 0.75F, 0, 1, 2, 0), new MobDrop(ItemsRegister.WIND_NATURE, 0.37F, 0, 1, 1, 0)});
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 8) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.electric_arc, SoundCategory.HOSTILE, 0.7F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 11) {
                for (int i = 0; i < 5; i++) {
                    GUNParticle part = new GUNParticle(cloud, 1.1F - i / 10.0F, 0.0F, 20, 240, this.world, this.posX, this.posY + this.getEyeHeight(), this.posZ, 0.0F, 0.0F, 0.0F, 0.9F, 0.86F, 0.9F, true, this.rand.nextInt(360));
                ...
                for (int i = 0; i < 6; i++) {
                    GUNParticle part = new GUNParticle(cloud2, 0.4F + this.rand.nextFloat() / 3.0F, 0.0F, 20, 240, this.world, this.posX, this.posY + this.getEyeHeight(), this.posZ, 0.0F, 0.0F, 0.0F, 0.9F, 0.9F, 0.9F, true, this.rand.nextInt(360));
    ...
    public static class OphanimGuard extends AbstractMob {
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 7) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.ophanim_guard_attack, SoundCategory.HOSTILE, 2.3F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
        }
    ...
    public static class Screenguard extends AbstractMob {
        ...
        public Screenguard(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.STORMSTEEL_NUGGET, 0.45F, 0, 1, 4, 0), new MobDrop(ItemsRegister.THUNDER_STONE, 0.25F, 0, 1, 1, 0)});
            this.var2 = 0.0F;
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 8) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.stormledge_shoot_b, SoundCategory.HOSTILE, 1.7F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
            ...
            if (id == 11) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.forcefield, SoundCategory.HOSTILE, 0.6F, 0.95F + this.rand.nextFloat() / 7.0F, false);
            }

            if (id == 12) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.forcefield_impact, SoundCategory.HOSTILE, 0.9F, 0.8F + this.rand.nextFloat() / 4.0F, false);
                this.var1 = 0;
            }

            if (id == 13) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.forcefield_trigger, SoundCategory.HOSTILE, 0.8F, 0.9F + this.rand.nextFloat() / 5.0F, false);
                this.var1 = 1;
            }
    ...
    public static class Skyguard extends AbstractMob {
        ...
        public Skyguard(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.STORMSTEEL_NUGGET, 0.45F, 0, 1, 4, 0), new MobDrop(ItemsRegister.THUNDER_STONE, 0.2F, 0, 1, 1, 0)});
    ...
    public static class Thunderbird extends AbstractMob {
        ...
        public Thunderbird(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.STORMSTEEL_NUGGET, 1.0F, 0, 2, 8, 0), new MobDrop(ItemsRegister.THUNDER_STONE, 1.0F, 0, 1, 1, 0), new MobDrop(ItemsRegister.THUNDERBIRD_FEATHER, 1.0F, 0, 4, 7, 0)});
            this.var2 = 0.0F;
            this.var3 = 0.0F;
            this.var4 = 0.0F;
            this.var5 = 0.0F;
        ...
        public void onUpdate() {
            ...
            if (!this.world.isRemote) {
                ...
                if (speedSq > 0.25) {
                    AxisAlignedBB aabb = this.getEntityBoundingBox().offset(this.motionX, this.motionY < -0.7 ? this.motionY : 0.0, this.motionZ);
        ...
        public boolean isPotionApplicable(PotionEffect potioneffectIn) {
            Potion potion = potioneffectIn.getPotion();
            return potion != PotionEffects.SHOCK && potion != PotionEffects.BLOOD_THIRST && potion != PotionEffects.BERSERK && potion != MobEffects.WEAKNESS && potion != MobEffects.POISON && potion != MobEffects.REGENERATION && potion != MobEffects.INSTANT_HEALTH && super.isPotionApplicable(potioneffectIn);
        }
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 8) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.stormledge_shoot_a, SoundCategory.HOSTILE, 1.7F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 7) {
                this.world.playSound(this.posX, this.posY, this.posZ, SoundEvents.ENTITY_WITHER_BREAK_BLOCK, SoundCategory.HOSTILE, 1.3F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
            ...
            if (id >= 10 && id <= 14) {
                ...
                if (this.rand.nextFloat() < 0.25 && this.roarCooldown <= 0) {
                    ...
                    this.world.playSound(this.posX, this.posY, this.posZ, Sounds.thunderbird_roar, SoundCategory.HOSTILE, 2.5F, 0.8F + this.rand.nextFloat() * 0.4F, false);
                }
            }
        ...
        protected void initEntityAI() {
            ...
            this.tasks.addTask(2, new EntityAIAttackMelee(this, 1.0, false));
            this.tasks.addTask(3, new EntityAIStrikeLightning(this, 130, 40.0F, 2.0F, 18.0F, 20, true, false, 60).setPotionEffect(new PotionEffect(PotionEffects.SHOCK, 80, 1)).setSoundOnCharge(Sounds.thunderbird_charge));
            this.tasks.addTask(6, new EntityAIWatchClosest(this, EntityPlayer.class, 14.0F));
            this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, EntityPlayer.class, false));
            this.targetTasks.addTask(2, new EntityAIHurtByTarget(this, false, new Class[0]));
            this.targetTasks.addTask(3, new EntityAIAttackOtherTeam(this, EntityLiving.class, false));
    ...
    public static class Windbreak extends AbstractMob {
        ...
        public Windbreak(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.STORMBRASS_NUGGET, 0.75F, 0, 2, 5, 0), new MobDrop(ItemsRegister.SKY_CRYSTAL_PIECE, 0.75F, 0, 1, 3, 0), new MobDrop(ItemsRegister.WIND_NATURE, 0.8F, 0, 1, 1, 0)});
            this.var2 = 0.0F;
            this.var3 = 0.0F;
    ...
    public static class Zarpion extends AbstractMob implements ISynchronizedEntity {
        ...
        public Zarpion(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.STORMSTEEL_NUGGET, 0.5F, 0, 2, 4, 0), new MobDrop(ItemsRegister.THUNDER_STONE, 0.4F, 0, 1, 1, 0)});
            this.var2 = 0.0F;
            this.setRoleValues(EnumMobRole.STRONG_ENEMY, 6);
            this.soul = Soul.IONIZED;
        }
        ...
        public void onClient(double x, double y, double z, double a, double b, double c) {
            ...
            BetweenParticle laser = new BetweenParticle(this.world, texture, 0.1F + this.rand.nextFloat() / 5.0F, 240, 1.0F, 1.0F, 1.0F, 0.1F, pos1.distanceTo(pos2), 10, 0.2F, 9999.0F, pos1, pos2);
                ...
                if (this.getAttackTarget() != null) {
                    ...
                    if (this.arcCooldown <= 0 && this.ticksExisted % 5 == 0) {
                        if (d0 < 16.0 && cansee && this.arcTime < 120) {
                            ...
                            Weapons.dealDamage(new WeaponDamage(null, this, null, false, false, this, WeaponDamage.electric), (float) this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).getAttributeValue(), this, attarg, true);
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 8) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.laser, SoundCategory.HOSTILE, 1.0F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 9) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.stormledge_shoot_b, SoundCategory.HOSTILE, 1.0F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 10) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.swosh_a, SoundCategory.HOSTILE, 1.0F, 0.8F + this.rand.nextFloat() / 4.0F, false);
            }
