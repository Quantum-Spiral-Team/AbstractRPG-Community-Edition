...
public class EntityAIFlyingKeepDistToTarget extends EntityAIBase {
    ...
    public EntityAIFlyingKeepDistToTarget(EntityCreature entity, int frequency, float radius, float speed, float radiusVar, float nearPointRadius, float yOffset, float friction) {
        this.entity = entity;
    ...
    public void updateTask() {
        ...
        if (attackTarg != null) {
            if (this.entity.ticksExisted % this.frequency == 0) {
                ...
                this.followPoint = GetMOP.findRandPosNearPoint(attackTarg.posX, attackTarg.posY + this.yOffset, attackTarg.posZ, this.nearPointRadius);
            }
