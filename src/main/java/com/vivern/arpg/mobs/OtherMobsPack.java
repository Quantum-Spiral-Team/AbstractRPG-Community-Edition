...
public class OtherMobsPack {
    ...
    public static void initRender() {
        ...
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsOtherMob.LavaSprinklerModel(), new ResourceLocation("arpg:textures/lava_sprinkler_model_tex.png"), 0.6F, LavaSprinkler.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new CinderCrawlerModel(), new ResourceLocation("arpg:textures/cinder_crawler_model_tex.png"), 0.25F, CinderCrawler.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new VoidGuardModel(), 0.2F, VoidGuard.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new EnderSeerModel(), new ResourceLocation("arpg:textures/ender_seer_model_tex.png"), 1.0F, EnderSeer.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsOtherMob.HellhoundModel(), new ResourceLocation("arpg:textures/hellhound_model_tex.png"), 0.4F, Hellhound.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsOtherMob.MechanicalWatcherModel(), new ResourceLocation("arpg:textures/mechanical_watcher_model_tex.png"), 0.25F, MechanicalWatcher.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsOtherMob.HorribleEvokerModel(), new ResourceLocation("arpg:textures/horrible_evoker_model_tex.png"), 0.4F, HorribleEvoker.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsOtherMob.HorribleVindicatorModel(), new ResourceLocation("arpg:textures/horrible_vindicator_model_tex.png"), 0.3F, HorribleVindicator.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsOtherMob.EquestrianModel(), new ResourceLocation("arpg:textures/equestrian_model_tex.png"), 0.43F, Equestrian.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new BlubberModel(), new ResourceLocation("arpg:textures/blubber_model_tex.png"), 0.2F, Blubber.class));
    }
    ...
    public static class CinderCrawler extends AbstractGlyphid {
        ...
        public CinderCrawler(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.RAW_RIBS, 0.4F, 0, 1, 1, 1), new MobDrop(ItemsRegister.MOLTEN_NUGGET, 0.1F, 0, 1, 1, 1)});
        ...
        public void handleStatusUpdate(byte id) {
            if (id == 7) {
                for (int i = 0; i < 5; i++) {
                    ...
                    this.world.spawnParticle(EnumParticleTypes.FLAME, this.posX + this.rand.nextFloat() * this.width * 2.0F - this.width, this.posY + 0.5 + this.rand.nextFloat() * this.height, this.posZ + this.rand.nextFloat() * this.width * 2.0F - this.width, d0, d1, d2, new int[0]);
    ...
    public static class EnderSeer extends AbstractMob {
        ...
        public void onEntityUpdate() {
            if (this.world.isRemote) {
                GUNParticle fire2 = new GUNParticle(this.texture, 1.9F + (float) this.rand.nextGaussian() / 3.0F, -0.002F, 15 + this.rand.nextInt(5), 240, this.world, this.posX, this.posY, this.posZ, 0.0F, -0.3F, 0.0F, 0.8F + (float) this.rand.nextGaussian() / 5.0F, 0.5F + (float) this.rand.nextGaussian() / 5.0F, 1.0F, true, this.rand.nextInt(100) - 50);
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 9) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.ender_seer_shoot, SoundCategory.AMBIENT, 15.6F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
        }
    ...
    public static class Equestrian extends AbstractMob {
        ...
        public Equestrian(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(Items.EMERALD, 0.2F, 0, 1, 1, 1), new MobDrop(ItemsRegister.ARROW_BOUNCING, 0.85F, 0, 2, 4, 3), new MobDrop(ItemsRegister.BLACK_STRAP, 0.8F, 0, 1, 1, 0)});
        ...
        public void onUpdate() {
            ...
            if (!this.world.isRemote) {
                ...
                if (!this.isAIDisabled()) {
                    ...
                    if (target != null && this.getNavigator().noPath() && !this.getEntitySenses().canSee(target) && this.flyCooldown <= 0 && this.ticksFly <= 0) {
                        this.allowFlight();
                    }
                }
            }
        ...
        public boolean attackEntityFrom(DamageSource source, float amount) {
            if (this.flyCooldown <= 0 && !this.world.isRemote && this.ticksFly <= 0 && source.getTrueSource() != null && amount >= 2.0F && Team.checkIsOpponent(source.getTrueSource(), this) && this.getDistanceSq(source.getTrueSource()) < 16.0) {
                this.allowFlight();
            }
        ...
        public void handleStatusUpdate(byte id) {
            if (id == -1) {
                this.world.playSound(this.posX, this.posY, this.posZ, SoundEvents.ENTITY_ARROW_SHOOT, SoundCategory.HOSTILE, 1.0F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == -3) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.crossbow_load, SoundCategory.HOSTILE, 1.2F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
    ...
    public static class Hellhound extends AbstractMob {
        ...
        public Hellhound(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.HELLHOUND_COLLAR, 0.07F, 0, 1, 1, 0), new MobDrop(ItemsRegister.HELLHOUND_FUR, 0.85F, 0, 1, 1, 1)});
        ...
        public void onUpdate() {
            ...
            if (this.fireTime > 0) {
                ...
                if (this.fireTime <= fireTimeDamageTime) {
                    if (this.fireTime == fireTimeDamageTime) {
                        this.world.playSound(this.posX, this.posY, this.posZ, Sounds.fire_d, SoundCategory.HOSTILE, 1.5F, 0.9F + this.rand.nextFloat() / 5.0F, false);
                    }
                    ...
                    if (!this.world.isRemote) {
                        ...
                        GUNParticle part = new GUNParticle(flame, 0.1F, -0.004F, 20 + this.rand.nextInt(10), 240, this.world, this.posX, this.posY + this.getEyeHeight(), this.posZ, 0.0F, 0.0F, 0.0F, 0.15F + this.rand.nextFloat() * 0.2F, 0.0F, 1.0F, true, this.rand.nextInt(360), true, 1.1F);
                        ...
                        part = new GUNParticle(cloud, 0.05F, -0.006F, 15 + this.rand.nextInt(10), 200, this.world, this.posX, this.posY + this.getEyeHeight(), this.posZ, 0.0F, 0.0F, 0.0F, 1.0F - this.rand.nextFloat() * 0.3F, 0.15F + this.rand.nextFloat() * 0.2F, 1.0F, true, this.rand.nextInt(360), true, 1.1F);
    ...
    public static class HorribleEvoker extends AbstractMob {
        ...
        public HorribleEvoker(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(Items.EMERALD, 0.35F, 0, 1, 1, 1), new MobDrop(ItemsRegister.BLACK_STRAP, 0.75F, 0, 1, 1, 0)});
                    ...
                    if (this.spellCasting > 0) {
                        ...
                        if (this.spellCooldown <= 0 && target.getCreatureAttribute() != EnumCreatureAttribute.UNDEAD) {
                            ...
                            for (int i = 0; i < smax; i++) {
                                Vec3d randomvec = new Vec3d(this.rand.nextGaussian(), 0.0, this.rand.nextGaussian()).normalize().scale(3.0F + this.rand.nextFloat() * 3.0F);
                                GetMOP.BlockTraceResult result = GetMOP.blockTrace(this.world, new BlockPos(target.getPositionEyes(1.0F).add(randomvec)), EnumFacing.DOWN, 3, null);
                                if (result != null) {
        ...
        public void spawnPotionSpell(Vec3d pos, boolean phase2) {
            if (phase2) {
                EntityPotion entitypotion = new EntityPotion(this.world, this, PotionUtils.addPotionToItemStack(new ItemStack(Items.SPLASH_POTION), PotionTypes.HARMING));
        ...
        public void handleStatusUpdate(byte id) {
            if (id == 8) {
                this.world.playSound(this.posX, this.posY, this.posZ, SoundEvents.EVOCATION_ILLAGER_PREPARE_ATTACK, SoundCategory.HOSTILE, 1.2F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 7) {
                this.world.playSound(this.posX, this.posY, this.posZ, SoundEvents.EVOCATION_ILLAGER_CAST_SPELL, SoundCategory.HOSTILE, 2.0F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 11) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.item_misc_l, SoundCategory.HOSTILE, 1.2F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
    ...
    public static class HorribleVindicator extends AbstractMob {
        ...
        public HorribleVindicator(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(Items.EMERALD, 0.2F, 0, 1, 1, 1), new MobDrop(ItemsRegister.BLACK_STRAP, 0.85F, 0, 1, 1, 0)});
            this.leadershipBase = 7;
            this.setDropMoney(-3, 6, 1.0F);
            this.soul = Soul.GREEDY;
        }
            ...
            if (!this.world.isRemote) {
                ...
                if (this.dashBackTime > 0) {
                    ...
                    if (this.dashBackTime < 20) {
                        GetMOP.BlockTraceResult result = GetMOP.blockTrace(this.world, new BlockPos(this.posX + this.motionX, this.posY, this.posZ + this.motionZ), EnumFacing.DOWN, 4, null);
                        if (result == null) {
                            this.motionX *= 0.05;
                            this.motionZ *= 0.05;
                            this.dashBackTime = 0;
                        } else {
                            PathNodeType pathNodeType = this.getNavigator().getNodeProcessor().getPathNodeType(this.world, result.pos.getX(), result.pos.getY(), result.pos.getZ());
                            if (pathNodeType != null && (pathNodeType == PathNodeType.DAMAGE_CACTUS || pathNodeType == PathNodeType.DAMAGE_FIRE || pathNodeType == PathNodeType.DAMAGE_OTHER || pathNodeType == PathNodeType.DANGER_CACTUS || pathNodeType == PathNodeType.DANGER_FIRE || pathNodeType == PathNodeType.DANGER_OTHER || pathNodeType == PathNodeType.LAVA)) {
                                this.motionX *= 0.05;
                                this.motionZ *= 0.05;
                                this.dashBackTime = 0;
                            }
        ...
        public void handleStatusUpdate(byte id) {
            if (id == 8) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.horrible_vindicator_invisible, SoundCategory.HOSTILE, 1.0F, 0.9F + this.rand.nextFloat() / 5.0F, false);

                for (int i = 0; i < 20; i++) {
                    this.world.spawnParticle(EnumParticleTypes.SMOKE_LARGE, this.posX + (this.rand.nextFloat() - 0.5) * 2.0 * this.width, this.posY + this.rand.nextFloat() * this.height, this.posZ + (this.rand.nextFloat() - 0.5) * 2.0 * this.width, 0.0, 0.0, 0.0, new int[0]);
                }
            }

            if (id == -1) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.horrible_vindicator_attack, SoundCategory.HOSTILE, 0.7F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 11) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.dash_a, SoundCategory.HOSTILE, 1.0F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
    ...
    public static class LavaSprinkler extends AbstractMob {
        ...
        public LavaSprinkler(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.LIQUID_FIRE, 0.85F, 0, 1, 3, 2), new MobDrop(ItemsRegister.RAW_RIBS, 0.9F, 0, 1, 3, 2)});
            this.isImmuneToFire = true;
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 8) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.lava_shoot, SoundCategory.HOSTILE, 1.1F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
        }
    ...
    public static class MechanicalWatcher extends AbstractMob {
        ...
        public void onUpdate() {
            ...
            if (!this.world.isRemote) {
                ...
                if (this.owner != null && this.ticksExisted % 10 == 0) {
                    EntityLivingBase enemy = GetMOP.findNearestEnemy(this.world, this.owner, this.owner.posX, this.owner.posY, this.owner.posZ, 6.0, true);
                    if (enemy != null && enemy != this && enemy != this.owner && GetMOP.thereIsNoBlockCollidesBetween(this.world, this.getPositionEyes(1.0F), GetMOP.entityCenterPos(enemy), null, false)) {
        ...
        protected void onDeathUpdate() {
            ...
            if (this.deathTime == 19) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.explode5, SoundCategory.HOSTILE, 1.6F, 0.95F + this.rand.nextFloat() / 10.0F, false);
                if (!this.world.isRemote) {
                    ...
                    if (!list.isEmpty()) {
                        for (EntityLivingBase entitylivingbase : list) {
                            if (Team.checkIsOpponent(this, entitylivingbase)) {
                                Weapons.dealDamage(new WeaponDamage(null, this, null, true, false, this, WeaponDamage.explode), (float) this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).getAttributeValue() * 2.0F, this, entitylivingbase, true, -1.0F);
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 9) {
                ...
                for (int i = 0; i < 20; i++) {
                    this.world.spawnParticle(EnumParticleTypes.PORTAL, this.posX + (this.rand.nextDouble() - 0.5), this.posY + this.rand.nextDouble() - 0.25, this.posZ + (this.rand.nextDouble() - 0.5), (this.rand.nextDouble() - 0.5) * 2.0, -this.rand.nextDouble(), (this.rand.nextDouble() - 0.5) * 2.0, new int[0]);
                }

                float fsize = (float) (1.0 + this.rand.nextGaussian() / 6.0);
                int lt = 4 + this.rand.nextInt(3);
                GUNParticle part = new GUNParticle(void_explode, 0.4F, 0.0F, lt, 240, this.world, this.posX, this.posY, this.posZ, 0.0F, 0.0F, 0.0F, 0.5F, 0.8F, 1.0F, true, this.rand.nextInt(360));
                ...
                GUNParticle partx = new GUNParticle(void_explode, 4.5F, 0.0F, ltx, 240, this.world, this.posX, this.posY, this.posZ, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, true, this.rand.nextInt(360));
    ...
    public static class Varmint extends AbstractMob {
        ...
        public Varmint(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.RAW_RIBS, 0.4F, 0, 1, 1, 1), new MobDrop(ItemsRegister.DEMONITE_SHARD, 0.04F, 0, 1, 1, 0), new MobDrop(ItemsRegister.INFERNUM_NUGGET, 0.08F, 0, 1, 2, 1), new MobDrop(ItemsRegister.MAGIC_POWDER, 0.05F, 0, 1, 2, 1), new MobDrop(ItemsRegister.FIRE_EATER, 0.02F, 0, 1, 1, 0)});
    ...
    public static class VoidGuard extends AbstractMob {
        ...
        public VoidGuard(World world, boolean isSegment, int number, VoidGuard headEntity) {
            ...
            if (!this.isSubMob) {
                this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.VOID_CRYSTAL, 0.1F, 0, 1, 1, 0), new MobDrop(ItemsRegister.ENDER_GRAPLING_HOOK, 0.02F, 0, 1, 1, 0), new MobDrop(ItemsRegister.ENDER_LEECH, 0.03F, 0, 1, 1, 0)});
                ...
                if (!this.world.isRemote) {
                    if (this.headEntity != null) {
                        if (this.headEntity.poslist.size() > this.number + 1) {
                            ...
                            Vec3d vec = new Vec3d((vec1.x + vec2.x) / 2.0, (vec1.y + vec2.y) / 2.0, (vec1.z + vec2.z) / 2.0);
                            if (vec != null) {
                                this.motionX /= 2.0;
                                this.motionY /= 2.0;
                                this.motionZ /= 2.0;
