...
public class EntityAIFlyToSummoner extends EntityAIBase {
    ...
    public void updateTask() {
        ...
        if (this.summoned.allowedFollow && !this.summoned.getLeashed() && !this.summoned.isRiding() && (dist > this.summoned.followPlayerMaxRange || GetMOP.isCollideBlockOnPos(this.world, this.summoned.posX, this.summoned.posY, this.summoned.posZ) || GetMOP.isCollideBlockOnPos(this.world, this.summoned.posX, this.summoned.posY + 1.0, this.summoned.posZ))) {
        ...
        if (dist <= this.summoned.followPlayerMaxRange && !GetMOP.isCollideBlockOnPos(this.world, this.summoned.posX, this.summoned.posY, this.summoned.posZ) && !GetMOP.isCollideBlockOnPos(this.world, this.summoned.posX, this.summoned.posY + 1.0, this.summoned.posZ)) {
            this.summoned.noClip = false;
            this.summoned.setNoGravity(false);
        }
    }
