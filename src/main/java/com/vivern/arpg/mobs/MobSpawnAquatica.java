...
public class MobSpawnAquatica extends MobSpawn {
    ...
    public MobSpawnAquatica() {
        ...
        this.addReactor(new MobReactor(24, 7, AquaticaMobsPack.Dartfish.class, 1, 1, MobReactor.GroupSpawnMode.WATER, 32, 48, 20, false).setHeightLogic(0, 160, false));
        ...
        this.addReactor(new MobReactor(50, 1, AquaticaMobsPack.Mermaid.class, 1, 3, MobReactor.GroupSpawnMode.WATER, 32, 48, 20, true).setHeightLogic(0, 150, false));
    }
