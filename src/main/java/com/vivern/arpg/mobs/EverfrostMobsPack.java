...
public class EverfrostMobsPack {
    ...
    public static void initRender() {
        ...
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsEverfrostMob.HailWraithModel(), new ResourceLocation("arpg:textures/hail_wraith_model_tex.png"), 0.8F, HailWraith.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsEverfrostMob.IceApparitionModel(), new ResourceLocation("arpg:textures/ice_apparition_model_tex.png"), 1.0F, IceApparition.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsEverfrostMob.SlimeModel(), new ResourceLocation("arpg:textures/ice_cube_tex.png"), 0.2F, IceCube.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsEverfrostMob.AtorpidModel(), new ResourceLocation("arpg:textures/atorpid_model_tex.png"), 0.4F, Atorpid.class).setLayerHeldItem());
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsEverfrostMob.GargoyleModel(), new ResourceLocation("arpg:textures/gargoyle_model_tex.png"), 0.4F, Gargoyle.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsEverfrostMob.GelumModel(), new ResourceLocation("arpg:textures/gelum_model_tex.png"), 0.5F, Gelum.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsEverfrostMob.SnowroverModel(), new ResourceLocation("arpg:textures/snowrover_model_tex.png"), 0.4F, Snowrover.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsEverfrostMob.HarridanOfIceModel(), new ResourceLocation("arpg:textures/harridan_of_ice_model_tex.png"), 0.5F, HarridanOfIce.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new FrostModel(), new ResourceLocation("arpg:textures/frost_model_tex.png"), 0.7F, Frost.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsEverfrostMob.NiveousSliderModel(), new ResourceLocation("arpg:textures/niveous_slider_model_tex.png"), 0.435F, NiveousSlider.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsEverfrostMob.AurorasPhantasmModel(new ResourceLocation("arpg:textures/auroras_phantasm_model_tex_overlay.png")), new ResourceLocation("arpg:textures/auroras_phantasm_model_tex.png"), 0.5F, AurorasPhantasm.class));
    }
    ...
    public static class AurorasPhantasm extends AbstractMob implements ISynchronizedEntity {
        ...
        public void spawnBetwParticle(Vec3d from, Vec3d to) {
            ...
            if (from.lengthSquared() > 1.0E-6 && to.lengthSquared() > 1.0E-6) {
                BetweenParticle laser = new BetweenParticle(this.world, texturelaser, 0.35F, 240, 1.0F, 1.0F, 1.0F, 0.15F, from.distanceTo(to), 3, 0.08F, 5.0F, from, to);
                ...
                for (int ss = 0; ss < 3; ss++) {
                    GUNParticle bigsmoke = new GUNParticle(largesmoke, 0.4F + (float) this.rand.nextGaussian() / 20.0F, 0.0F, 12, 180, this.world, to.x, to.y, to.z, (float) this.rand.nextGaussian() / 23.0F, (float) this.rand.nextGaussian() / 27.0F, (float) this.rand.nextGaussian() / 23.0F, (float) rainbow.x, (float) rainbow.y, (float) rainbow.z, true, this.rand.nextInt(360));
                ...
                for (int ss = 0; ss < 3; ss++) {
                    GUNParticle sparkle = new GUNParticle(texture, 0.1F + (float) this.rand.nextGaussian() / 30.0F, 0.01F, 10, 240, this.world, to.x, to.y, to.z, (float) this.rand.nextGaussian() / 14.0F, (float) this.rand.nextGaussian() / 14.0F + 0.15F, (float) this.rand.nextGaussian() / 14.0F, (float) rainbow.x, (float) rainbow.y, (float) rainbow.z, true, 0);
        ...
        public void onLaser(Vec3d vec) {
            if (this.ticksExisted % 4 == 0 && !this.world.isRemote) {
                ...
                if (!list.isEmpty()) {
                    for (Entity entity : list) {
                        if (Team.checkIsOpponent(this, entity)) {
                            Weapons.dealDamage(new WeaponDamage(null, this, null, false, false, this, WeaponDamage.laser), (float) this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).getAttributeValue(), this, entity, true, 0.05F);
                ...
                Vec3d rainbow = getPhantasmColor(this);
                HostileProjectiles.Plasma plasma = new HostileProjectiles.Plasma(this.world, this, 0.9F, 0.0F, 100, vec.x, vec.y, vec.z, 4.0F, 0.4F, 1, false, (float) rainbow.x, (float) rainbow.y, (float) rainbow.z);
        ...
        public void onClient(double... args) {
            if (args.length == 3) {
                ...
                this.world.playSound(vec.x, vec.y, vec.z, Sounds.phantasm_shoot, SoundCategory.AMBIENT, 0.7F, 0.9F + this.rand.nextFloat() / 5.0F, false);
        ...
        public static Vec3d getPhantasmColor(Entity entity) {
            ...
            return entity.getEntityId() % 2 == 0 ? ColorConverters.getRainbow(0.55F + (float) GetMOP.arcsinusoid(time * 0.01) * 0.25F) : ColorConverters.getRainbow(0.47F + (float) GetMOP.arcsinusoid(time * 0.01) * 0.2F);
        }
        ...
        public void onUpdate() {
            ...
            if (this.world.isRemote) {
                ...
                GUNParticle snow = new GUNParticle(texture, scl, 0.01F, lt, 220, this.world, this.posX + (this.rand.nextDouble() - 0.5) * this.width, this.posY + this.rand.nextDouble() * this.height, this.posZ + (this.rand.nextDouble() - 0.5) * this.width, (this.rand.nextFloat() - 0.5F) * 0.02F, -this.rand.nextFloat() * 0.02F, (this.rand.nextFloat() - 0.5F) * 0.02F, (float) rainbow.x, (float) rainbow.y, (float) rainbow.z, true, this.rand.nextInt(100) - 50, true, 3.0F);
                ...
                if (this.laserAttackCooldown <= 0) {
                    ...
                    Vec3d laserPos = new Vec3d(GetMOP.partial(this.laserTarget2.x, this.laserTarget1.x, ft1), GetMOP.partial(this.laserTarget2.y, this.laserTarget1.y, ft1), GetMOP.partial(this.laserTarget2.z, this.laserTarget1.z, ft1));
        ...
        public boolean attackEntityFrom(DamageSource source, float amount) {
            ...
            if (this.getHealth() < this.getMaxHealth() / 2.0F) {
                if (this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).getModifier(lowhpbonus) == null) {
                    this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).applyModifier(new AttributeModifier(lowhpbonus, "lowhpbonus", 2.0 + this.getMobDifficulty() * 0.5, 0));
                }

                if (this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getModifier(lowhpbonus2) == null) {
                    this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).applyModifier(new AttributeModifier(lowhpbonus2, "lowhpbonus2", 0.1 + this.getMobDifficulty() * 0.05, 2));
                }
            }
    ...
    public static class Frost extends AbstractMob implements ILongLaserAttackMob {
        ...
        public void spawnBetwParticle(Vec3d from, Vec3d to) {
            if (from.lengthSquared() > 1.0E-6 && to.lengthSquared() > 1.0E-6) {
                BetweenParticle laser = new BetweenParticle(this.world, texturelaser, 0.23F, 240, 1.0F, 1.0F, 1.0F, 0.15F, from.distanceTo(to), 3, 0.5F, 4.0F, from, to);
                laser.ignoreFrustumCheck = true;
                laser.setPosition(from.x, from.y, from.z);
                laser.alphaGlowing = true;
                this.world.spawnEntity(laser);
                ...
                for (int ss = 0; ss < 3; ss++) {
                    GUNParticle bigsmoke = new GUNParticle(largesmoke, 0.4F + (float) this.rand.nextGaussian() / 20.0F, 0.0F, 12, 180, this.world, to.x, to.y, to.z, (float) this.rand.nextGaussian() / 23.0F, (float) this.rand.nextGaussian() / 27.0F, (float) this.rand.nextGaussian() / 23.0F, 0.8F, 1.0F, 1.0F, true, this.rand.nextInt(360));
                    bigsmoke.alphaGlowing = true;
                    bigsmoke.alphaTickAdding = -0.07F;
                    this.world.spawnEntity(bigsmoke);
                }
                ...
                for (int ss = 0; ss < 4; ss++) {
                    GUNParticle sparkle = new GUNParticle(texture, 0.1F + (float) this.rand.nextGaussian() / 30.0F, 0.01F, 10, 240, this.world, to.x, to.y, to.z, (float) this.rand.nextGaussian() / 14.0F, (float) this.rand.nextGaussian() / 14.0F + 0.15F, (float) this.rand.nextGaussian() / 14.0F, 0.8F + (float) this.rand.nextGaussian() / 5.0F, 1.0F, 1.0F, false, 0);
                    this.world.spawnEntity(sparkle);
                }
            }
        }
        ...
        public void onLaserTick(Vec3d vec, int attackDuration) {
            if (this.ticksExisted % 10 == 0 && !this.world.isRemote) {
                double radius = 0.3;
                AxisAlignedBB aabb = new AxisAlignedBB(vec.x - radius, vec.y - radius, vec.z - radius, vec.x + radius, vec.y + radius, vec.z + radius);
                ...
                if (!list.isEmpty()) {
                    for (EntityLivingBase entitylivingbase : list) {
                        if (entitylivingbase != this) {
                            ...
                            Weapons.dealDamage(new WeaponDamage(null, this, null, false, false, this, WeaponDamage.frost), damg, this, entitylivingbase, true, 1.0F, vec.x, vec.y, vec.z);
        ...
        public void onUpdate() {
            super.onUpdate();
            if (this.world.isRemote) {
                GUNParticle snow = new GUNParticle(texture, 0.07F + this.rand.nextFloat() / 10.0F, 0.01F, 25 + this.rand.nextInt(5), -1, this.world, this.posX + (this.rand.nextDouble() - 0.5) * this.width, this.posY + this.rand.nextDouble() * this.height, this.posZ + (this.rand.nextDouble() - 0.5) * this.width, (this.rand.nextFloat() - 0.5F) * 0.02F, -this.rand.nextFloat() * 0.02F, (this.rand.nextFloat() - 0.5F) * 0.02F, 0.9F + (float) this.rand.nextGaussian() / 10.0F, 1.0F, 1.0F, false, this.rand.nextInt(100) - 50, true, 3.0F);
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 9) {
                ...
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.frost_shoot, SoundCategory.AMBIENT, 0.7F, 0.9F + this.rand.nextFloat() / 5.0F, false);
                this.spawnBetwParticle(this.getPositionVector().add(0.0, this.height / 2.0F, 0.0), vec);
            }
        }
    ...
    public static class Gargoyle extends AbstractMob {
        ...
        protected void initEntityAI() {
            ...
            this.tasks.addTask(2, new EntityAIAttackSweep(this, 40, 0.5F, 0.5F, 4.3F, 10, true, 4.0F, 10.0F, Sounds.melee_block).setTriggerOnStart());
                ...
                if (!list.isEmpty()) {
                    for (EntityLivingBase entitylivingbase : list) {
                        if (entitylivingbase != this) {
                            ...
                            PotionEffect lastdebaff = Weapons.mixPotion(entitylivingbase, PotionEffects.FREEZING, (float) timeAmount, 1.0F, Weapons.EnumPotionMix.WITH_MAXIMUM, Weapons.EnumPotionMix.WITH_MAXIMUM, Weapons.EnumMathOperation.PLUS, Weapons.EnumMathOperation.PLUS, 250, 10);
    ...
    public static class HailWraith extends AbstractMob implements ISynchronizedEntity {
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 8) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.magic_n, SoundCategory.HOSTILE, 0.8F, 0.8F + this.rand.nextFloat() / 2.5F, false);
            }
        }
        ...
        public void onUpdate() {
            ...
            if (this.getAttackTarget() != null) {
                ...
                this.zapCooldown--;
                if (d0 <= 15.0 && this.zapCooldown <= 0 && GetMOP.thereIsNoBlockCollidesBetween(this.world, GetMOP.entityCenterPos(this), GetMOP.entityCenterPos(attarg), null, true)) {
                    this.zapCooldown = 60;
                    ISynchronizedEntity.sendSynchronize(this, 32.0, this.posX, this.posY + this.height / 2.0F, this.posZ, attarg.posX, attarg.posY + attarg.height / 2.0F, attarg.posZ);
        ...
        public void onClient(double x, double y, double z, double a, double b, double c) {
            ...
            BetweenParticle laser = new BetweenParticle(this.world, texture, 0.1F + this.rand.nextFloat() / 5.0F, 240, 0.6F, 1.0F, 0.8F, 0.1F, pos1.distanceTo(pos2), 10, 0.2F, 9999.0F, pos1, pos2);
            laser.alphaGlowing = true;
            laser.setPosition(pos1.x, pos1.y, pos1.z);
            this.world.spawnEntity(laser);
            this.world.playSound(this.posX, this.posY, this.posZ, Sounds.electric_arc, SoundCategory.HOSTILE, 0.7F, 0.8F + this.rand.nextFloat() / 2.5F, false);
        }
    ...
    public static class HarridanOfIce extends AbstractMob {
        ...
        public void onUpdate() {
            ...
            if (!this.world.isRemote) {
                            ...
                            if (Team.checkIsOpponent(this, entity)) {
                                if (entity instanceof EntityPlayer) {
                                    ...
                                    if (!Freezing.canImmobilizeEntity(player, player.getActivePotionEffect(PotionEffects.FREEZING))) {
                                        PotionEffect lastdebaff = Weapons.mixPotion(player, PotionEffects.FREEZING, 50.0F, 1.0F, Weapons.EnumPotionMix.WITH_MAXIMUM, Weapons.EnumPotionMix.WITH_MAXIMUM, Weapons.EnumMathOperation.PLUS, Weapons.EnumMathOperation.PLUS, 130, 8);
                                        Freezing.tryPlaySound(player, lastdebaff);
                                    }
                                } else {
                                    PotionEffect lastdebaff = Weapons.mixPotion(entity, PotionEffects.FREEZING, 50.0F, 1.0F, Weapons.EnumPotionMix.WITH_MAXIMUM, Weapons.EnumPotionMix.WITH_MAXIMUM, Weapons.EnumMathOperation.PLUS, Weapons.EnumMathOperation.PLUS, 130, 8);
                                    Freezing.tryPlaySound(entity, lastdebaff);
                                }

                                if (distSq < 25.0) {
                                    Weapons.dealDamage(new WeaponDamage(null, this, null, false, false, this, WeaponDamage.frost), (float) this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).getAttributeValue(), this, entity, true);
                ...
                ParticleTracker.TrackerFollowDynamicPoint tracker = new ParticleTracker.TrackerFollowDynamicPoint(this, false, 1.0F, 0.0F + Debugger.floats[0], 0.05F + Debugger.floats[1]);
                ...
                for (int i = 0; i < 4; i++) {
                    ...
                    GUNParticle part = new GUNParticle(snow1, scl, 0.0F, lt, 190, this.world, poss.x, poss.y, poss.z, (float) direction.x, (float) direction.y, (float) direction.z, 0.8F + this.rand.nextFloat() * 0.1F, 0.85F + this.rand.nextFloat() * 0.15F, 1.0F, false, this.rand.nextInt(360));
    ...
    public static class IceApparition extends AbstractMob {
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 8) {
                for (int i = 0; i < 5; i++) {
                    this.world.playSound(this.posX, this.posY, this.posZ, Sounds.crystal_fan, SoundCategory.HOSTILE, 1.1F, 1.3F + this.rand.nextFloat() / 4.0F, false);
                }
            }

            if (id == 11) {
                for (int i = 0; i < 5; i++) {
                    GUNParticle part = new GUNParticle(cloud, 0.7F - i / 10.0F, 0.0F, 20, 240, this.world, this.posX, this.posY + this.getEyeHeight(), this.posZ, 0.0F, 0.0F, 0.0F, 0.5F, 0.8F + this.rand.nextFloat() / 10.0F, 0.9F + this.rand.nextFloat() / 10.0F, true, this.rand.nextInt(360));
                ...
                for (int i = 0; i < 6; i++) {
                    GUNParticle part = new GUNParticle(cloud2, 0.3F + this.rand.nextFloat() / 3.0F, 0.0F, 20, 240, this.world, this.posX, this.posY + this.getEyeHeight(), this.posZ, 0.0F, 0.0F, 0.0F, 0.7F, 0.8F + this.rand.nextFloat() / 10.0F, 0.9F + this.rand.nextFloat() / 10.0F, true, this.rand.nextInt(360));
    ...
    public static class IceWarrior extends AbstractMob {
        ...
        @Override
        public boolean attackEntityAsMob(Entity entityIn) {
            if (this.rand.nextFloat() < 0.2F + this.getMobDifficulty() * 0.1F && entityIn instanceof EntityLivingBase && this.getHeldItemMainhand().getItem() == ItemsRegister.ICE_SWORD) {
                PotionEffect lastdebaff = Weapons.mixPotion(entityIn, PotionEffects.FREEZING, 70.0F, 2.0F, Weapons.EnumPotionMix.WITH_MAXIMUM, Weapons.EnumPotionMix.WITH_MAXIMUM, Weapons.EnumMathOperation.PLUS, Weapons.EnumMathOperation.PLUS, 100, 7);
        ...
        protected void initEntityAI() {
            this.tasks.addTask(0, new EntityAISwimming(this));
            this.tasks.addTask(2, new EntityAIAttackSweep(this, 40, 0.7F, 1.0F, 2.3F, 13, true, 5.0F, 11.0F, Sounds.melee_block).setTriggerOnStart().setknockbackOnReflect(1.8F));
    ...
    public static class NiveousSlider extends AbstractMob {
            ...
            if (!this.world.isRemote) {
                ...
                if (this.onGround) {
                    if (this.ticksExisted % 20 == 0) {
                        ...
                        if (block == BlocksRegister.SNOW_ICE || block == BlocksRegister.GLACIER || block == Blocks.PACKED_ICE || block == BlocksRegister.FROZEN_STONE || block == BlocksRegister.BLOCK_BLOCK_HARD || block == BlocksRegister.FROZEN_COBBLESTONE) {
                ...
                if (movspeed >= minspeed) {
                    ...
                    for (Entity entity : list) {
                        if (Weapons.dealDamage(new WeaponDamage(null, this.lastAttackEntity, this, false, false, this, WeaponDamage.heavymelee), GetMOP.getFromTo(movspeed, minspeed, maxspeed) * 60.0F, this.lastAttackEntity, entity, true, (float) (movspeed * 0.6), this.posX, this.posY, this.posZ) && spawnParticle) {
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 11) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.slider_summon, SoundCategory.NEUTRAL, 3.0F, 0.9F + this.rand.nextFloat() / 5.0F, false);
                ParticleFastSummon.round(this.world, this.getPositionVector(), 2.5F, 0.0F, 15, 240, 1.0F, 0.2F, 0.22F, 1, true);

                for (int ss = 0; ss < 5; ss++) {
                    ParticleFastSummon.coloredLightning(this.world, 0.1F, 7 + this.rand.nextInt(8), 200, 1.0F, 0.2F, 0.22F, 7, this.getPositionVector().add(0.0, this.height / 2.0F, 0.0), this.getPositionVector().add(this.rand.nextGaussian() * 0.7, 9.0, this.rand.nextGaussian() * 0.7), 0.7F, 0.0F, ParticleFastSummon.rand);
                }

                for (int ss = 0; ss < 15; ss++) {
                    GUNParticle bigsmoke = new GUNParticle(spellblue3, 0.15F + this.rand.nextFloat() * 0.08F, 0.04F, 30, 200, this.world, this.posX, this.posY + 0.1, this.posZ, (float) this.rand.nextGaussian() / 7.0F, (float) this.rand.nextGaussian() / 7.0F + 0.1F, (float) this.rand.nextGaussian() / 7.0F, 1.0F, 0.2F, 0.22F, false, this.rand.nextInt(360));
            ...
            if (id == 10) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.slider_hit, SoundCategory.NEUTRAL, 2.1F, 0.9F + this.rand.nextFloat() / 5.0F, false);
                GUNParticle part = new GUNParticle(hit, 0.01F, 0.0F, 6, 220, this.world, this.posX, this.posY, this.posZ, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, true, this.rand.nextInt(360));
            ...
            if (id == 9) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.goal, SoundCategory.NEUTRAL, 4.0F, 0.95F + this.rand.nextFloat() / 10.0F, false);
                GUNParticle part = new GUNParticle(hit, 0.01F, 0.0F, 7, 220, this.world, this.posX, this.posY, this.posZ, 0.0F, 0.0F, 0.0F, 1.0F, 0.2F, 0.22F, true, this.rand.nextInt(360));
                part.scaleTickAdding = 0.34F;
                part.alphaGlowing = true;
                this.world.spawnEntity(part);
                ParticleFastSummon.round(this.world, this.getPositionVector(), 0.1F, 2.75F + this.rand.nextFloat() * 1.25F, 13, 240, 0.7F, 0.88F, 1.0F, 1, true);
                ParticleFastSummon.round(this.world, this.getPositionVector(), 0.1F, 2.75F + this.rand.nextFloat() * 1.25F, 13, 240, 0.7F, 0.88F, 1.0F, 1, false);

                for (int ss = 0; ss < 25; ss++) {
                    GUNParticle bigsmoke = new GUNParticle(spellblue3, 0.16F + this.rand.nextFloat() * 0.08F, 0.04F, 30, 220, this.world, this.posX, this.posY + 0.1, this.posZ, (float) this.rand.nextGaussian() / 5.0F, (float) this.rand.nextGaussian() / 5.0F + 0.1F, (float) this.rand.nextGaussian() / 5.0F, 1.0F, 1.0F, 1.0F, false, this.rand.nextInt(360), true, 1.0F);
                    bigsmoke.scaleTickAdding = -0.004F;
                    this.world.spawnEntity(bigsmoke);
                }
            }
    ...
    public static class Snowrover extends AbstractMob {
        ...
        @Override
        public float getAIMoveSpeed() {
            return this.hasGun && this.getAttackTarget() != null && this.getAttackTarget().getDistanceSq(this) <= 50.0 ? super.getAIMoveSpeed() * 0.05F : super.getAIMoveSpeed();
        }
            ...
            if (this.hasGun && !this.world.isRemote) {
                ...
                if (this.gunTime <= 0) {
                    if (this.gunCooldown <= 0) {
                        if (this.getAttackTarget() != null && this.getEntitySenses().canSee(this.getAttackTarget()) && this.getAttackTarget().getDistanceSq(this) <= 100.0) {
                            this.gunTime = 35;
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 7) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.snowball_cannon_wooden, SoundCategory.HOSTILE, 1.0F, 0.9F + this.rand.nextFloat() * 0.2F, false);
            }

            if (id == 8) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.snowball_cannon, SoundCategory.HOSTILE, 1.6F, 0.8F + this.rand.nextFloat() * 0.2F, false);
            }
