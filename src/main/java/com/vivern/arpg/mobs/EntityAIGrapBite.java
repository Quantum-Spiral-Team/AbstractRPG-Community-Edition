...
public class EntityAIGrapBite extends AbstractMob.AbstractAI {
    ...
    public EntityAIGrapBite(AbstractMob entity, boolean doAttacks, int maxCooldown, float radiusHigher, float radiusLower, float power, int minGrapTime, float damageToFree, boolean onlyOthersCanFree, float grapVectorLength, boolean useKnockbackResistance, boolean invertedPitchYaw, boolean grabAllOpponents) {
        this.entity = entity;
    ...
    public Vec3d getGrapPosition() {
        ...
        return this.grapVectorLength == 1.0F ? lookVec.add(this.entity.posX, this.entity.posY, this.entity.posZ) : lookVec.scale(this.grapVectorLength).add(this.entity.posX, this.entity.posY, this.entity.posZ);
    }
        ...
        if (attackTarg != null) {
            if (this.grapped != null) {
                ...
                if (distSq < this.radiusHigherSq && distSq > this.radiusLowerSq) {
                    ...
                    for (EntityLivingBase livingBase : GetMOP.getHostilesInAABBto(this.entity.world, grabPosition, this.radiusHigher, this.radiusHigher, this.entity)) {
