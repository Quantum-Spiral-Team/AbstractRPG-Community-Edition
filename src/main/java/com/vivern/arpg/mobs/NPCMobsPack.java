...
public class NPCMobsPack {
    ...
    public static EntityAINPC.IBlockAiRequirement redstone = (world, blockstate, pos) -> {
        Block bl = blockstate.getBlock();
        return bl == Blocks.REDSTONE_WIRE || bl == Blocks.REDSTONE_TORCH || bl == Blocks.REDSTONE_LAMP || bl == Blocks.REDSTONE_BLOCK || bl == Blocks.REDSTONE_ORE || bl == Blocks.UNLIT_REDSTONE_TORCH || bl == Blocks.POWERED_COMPARATOR || bl == Blocks.UNPOWERED_COMPARATOR || bl == Blocks.POWERED_REPEATER || bl == Blocks.UNPOWERED_REPEATER || bl == Blocks.DISPENSER || bl == Blocks.DROPPER || bl == Blocks.OBSERVER || bl == Blocks.ACTIVATOR_RAIL || bl == Blocks.DETECTOR_RAIL || bl == Blocks.GOLDEN_RAIL || bl == Blocks.PISTON || bl == Blocks.STICKY_PISTON;
    };
    ...
    public static void initRender() {
        ...
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsOtherMob.MechanicModel(), new ResourceLocation("arpg:textures/mechanic_model_tex.png"), 0.3F, NpcMechanic.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsOtherMob.BristlingModel(), 0.3F, NpcBristling.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsStormledgeMob.ZarpionModel(), new ResourceLocation("arpg:textures/zarpion_trader_tex.png"), 0.4F, NpcZarpionTrader.class));
    }

    public static class NpcBristling extends NpcTrader {

        public static ResourceLocation[] textures = new ResourceLocation[]{new ResourceLocation("arpg:textures/bristling_tex0.png"), new ResourceLocation("arpg:textures/bristling_tex1.png"), new ResourceLocation("arpg:textures/bristling_tex2.png"), new ResourceLocation("arpg:textures/bristling_tex3.png")};
                ...
                if (rand.nextFloat() < 0.27) {
                    ...
                    if (profession == 0) {
                        ...
                        if (rand.nextFloat() < 0.3) {
                            this.trades.add(new Trade(new ItemStack(ItemsRegister.NORTHERN_INGOT, 2), new ItemStack(ItemsRegister.DEMONITE), 200 + rand.nextInt(50), 0, 0.0F));
                        }
        ...
        protected void initEntityAI() {
            this.tasks.addTask(1, new EntityAINPC(this, new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.furnaces, 200, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.craftables, 220, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.xmas, 100, 150, 4.0F, false, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.presentBox, 250, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.industrialBlock, 120, 200, 4.0F, false, true), new EntityAINPC.RequirementChairAndTable(4.0F, false, false), new EntityAINPC.RequirementChairAndTable(4.0F, true, false), new EntityAINPC.RequirementLight(6, 15, false)));
    ...
    public static class NpcMechanic extends NpcTrader implements IInventory {
        ...
        public void guiclick(EntityPlayer player, int mouseX, int mouseY, int mouseButton, int page) {
            if (!this.containedItemStack.isEmpty() && this.containedItemStack.isItemDamaged() && this.containedItemStack.getItem().isRepairable() && mouseX > 43 && mouseX < 68) {
        ...
        @Override
        protected void initEntityAI() {
            this.tasks.addTask(1, new EntityAINPC(this, new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.furnaces, 200, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.craftables, 160, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.anvils, 150, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.industrialBlock, 140, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.industrialMachinery, 140, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.redstone, 290, 100, 4.0F, true, false), new EntityAINPC.RequirementChairAndTable(4.0F, false, false), new EntityAINPC.RequirementChairAndTable(4.0F, true, false), new EntityAINPC.RequirementLight(8, 15, false)));
            this.tasks.addTask(7, new EntityAIWanderAvoidWater(this, 1.0));
            this.tasks.addTask(8, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0F));
            this.tasks.addTask(8, new EntityAILookIdle(this));
        }
    ...
    public static class NpcMerchant extends NpcTrader {
        ...
        @Override
        protected void initEntityAI() {
            this.tasks.addTask(1, new EntityAINPC(this, new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.furnaces, 200, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.craftables, 220, 200, 4.0F, true, false), new EntityAINPC.RequirementChairAndTable(4.0F, false, false), new EntityAINPC.RequirementChairAndTable(4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.water, 260, 200, 4.0F, true, false), new EntityAINPC.RequirementLight(6, 15, false)));
            this.tasks.addTask(7, new EntityAIWanderAvoidWater(this, 1.0));
            this.tasks.addTask(8, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0F));
            this.tasks.addTask(8, new EntityAILookIdle(this));
        }
    ...
    public abstract static class NpcTrader extends EntityCreature implements ISynchronizedEntity, IMultitexture {
        ...
        public void setattributes(double maxHealth, double followRange, double damage, double moveSpeed, double armor, double protection, double knockResist, double knockback, double vampirism, double jumpHeight) {
    ...
    public static class NpcWizard extends NpcTrader {
        ...
        public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
            if (!this.world.isRemote) {
                ...
                this.trades.add(new Trade(new ItemStack(ItemsRegister.MAGIC_POWDER, 2), new ItemStack(ItemsRegister.WEAPON_ENCHANTMENTS_BOX, 1), 10, 0, 0.0F));
        ...
        @Override
        protected void initEntityAI() {
            this.tasks.addTask(1, new EntityAINPC(this, new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.spellforge, 160, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.manaContainer, 160, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.books, 120, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.cauldrons, 180, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.potionBrewery, 160, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.enchantTable, 180, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.industrialBlock, 120, 200, 4.0F, false, true), new EntityAINPC.RequirementChairAndTable(4.0F, false, false), new EntityAINPC.RequirementChairAndTable(4.0F, false, false), new EntityAINPC.RequirementLight(8, 15, false)));
            this.tasks.addTask(7, new EntityAIWanderAvoidWater(this, 1.0));
            this.tasks.addTask(8, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0F));
            this.tasks.addTask(8, new EntityAILookIdle(this));
        }
    ...
    public static class NpcZarpionTrader extends NpcTrader {
        ...
        public EnumActionResult applyPlayerInteraction(EntityPlayer player, Vec3d vec, EnumHand hand) {
            if (!player.world.isRemote && this.isEnslaved && player.getHeldItemMainhand().getItem() == ItemsRegister.STORM_SPAWNER_PIECE && player.getHeldItemMainhand().getCount() >= 16) {
        ...
        public void onUpdate() {
            ...
            if (this.world.isRemote && this.isEnslaved && this.ticksExisted % 3 == 0) {
                ...
                for (int i = 0; i < 4; i++) {
                    ...
                    ParticleFastSummon.coloredLightning(this.world, 0.06F, 5, 240, 0.9F + this.rand.nextFloat() * 0.1F, 0.9F + this.rand.nextFloat() * 0.1F, 1.0F, 5, pos1, pos3, pos1.squareDistanceTo(pos3) > 2.0 ? 0.5F : 0.25F, 0.4F, ParticleFastSummon.rand);
                }
            }
        }
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 11) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.item_misc_l, SoundCategory.HOSTILE, 1.7F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
        }

        @Override
        protected void initEntityAI() {
            this.tasks.addTask(1, new EntityAINPC(this, new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.spellforge, 160, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.manaContainer, 160, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.cauldrons, 180, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.potionBrewery, 160, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.enchantTable, 180, 200, 4.0F, true, false), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.industrialBlock, 120, 200, 4.0F, false, true), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.industrialMachinery, 120, 200, 4.0F, false, true), new EntityAINPC.RequirementMoveToBlock(NPCMobsPack.redstone, 120, 200, 4.0F, false, true), new EntityAINPC.RequirementChairAndTable(4.0F, false, false), new EntityAINPC.RequirementChairAndTable(4.0F, false, false)));
            this.tasks.addTask(7, new EntityAIWanderAvoidWater(this, 1.0));
            this.tasks.addTask(8, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0F));
            this.tasks.addTask(8, new EntityAILookIdle(this));
        }
    ...
    public static class Trade {
        ...
        public boolean hasStack(InventoryPlayer inv, ItemStack stack, int[] removes, int sizeinv) {
            ...
            for (int i = 0; i < sizeinv; i++) {
                ...
                if (inslot.getItem() == stack.getItem() && (!this.useMeta || inslot.getMetadata() == stack.getMetadata()) && (!this.useNbt || this.nbtMathes(inslot, stack))) {
