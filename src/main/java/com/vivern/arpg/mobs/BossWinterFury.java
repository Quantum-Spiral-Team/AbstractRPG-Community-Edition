...
public class BossWinterFury extends AbstractBoss {
    ...
    public void onUpdate() {
        ...
        if (!this.world.isRemote) {
            ...
            if (this.ticksExisted % 10 == 0 && (this.isBurning() || this.isPotionActive(PotionEffects.DEMONIC_BURN) || this.isPotionActive(MobEffects.POISON))) {
                this.burnDamage--;
    ...
    public void attackWithCurse() {
        ...
        if (!list.isEmpty()) {
            for (EntityLivingBase entitylivingbase : list) {
                if (Team.checkIsOpponent(this, entitylivingbase) && GetMOP.entityMopRayTrace(BossWinterFury.class, 48.0, 1.0F, entitylivingbase, 1.0, entitylivingbase.rotationPitch, entitylivingbase.rotationYaw).contains(this)) {
    ...
    public void handleStatusUpdate(byte id) {
        ...
        if (id == 8) {
            this.world.playSound(this.posX, this.posY, this.posZ, Sounds.winter_beam, SoundCategory.HOSTILE, 1.4F, 0.9F + this.rand.nextFloat() / 5.0F, false);
        }
        ...
        if (id >= 10 && id <= 14) {
            ...
            if (this.rand.nextFloat() < 0.25 && this.roarCooldown <= 0) {
                ...
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.winter_fury_roar, SoundCategory.HOSTILE, 1.8F, 0.8F + this.rand.nextFloat() * 0.4F, false);
            }
        }
        ...
        if (id == 4) {
            this.world.playSound(this.posX, this.posY, this.posZ, Sounds.winter_curse_a, SoundCategory.HOSTILE, 2.5F, 0.9F + this.rand.nextFloat() / 5.0F, false);
        }

        if (id == 17) {
            this.world.playSound(this.posX, this.posY, this.posZ, Sounds.winter_fury_cast, SoundCategory.HOSTILE, 2.3F, 0.9F + this.rand.nextFloat() / 5.0F, false);
        }

        if (id == 17) {
            this.triggerAnimation(-2);
            this.roarCooldown = 60;
            this.world.playSound(this.posX, this.posY, this.posZ, Sounds.winter_fury_roar, SoundCategory.HOSTILE, 1.8F, 1.6F + this.rand.nextFloat() * 0.4F, false);
            this.world.playSound(this.posX, this.posY, this.posZ, Sounds.rrrrar, SoundCategory.HOSTILE, 1.8F, 0.9F + this.rand.nextFloat() * 0.4F, false);
        }
    }
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(3, new EntityAIProjectileStorm(this, 20.0, this.getMobDifficulty() >= 3 ? 150 : 170, 20, 6.0F, 7, 15, 10, 5, false, (byte) 1, (byte) 17));
