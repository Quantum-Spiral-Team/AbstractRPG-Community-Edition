...
public class EntityAILongLaserAttack extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        if (this.checkWalls) {
            ...
            return this.entity.getAttackTarget() != null && this.entity.getDistance(this.entity.getAttackTarget()) < this.entity.getEntityAttribute(SharedMonsterAttributes.FOLLOW_RANGE).getAttributeValue();
        }
    }
