...
public class ToxicomaniaMobsPack {
    ...
    public static void initRender() {
        ...
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsToxicomaniaMob.SpringerModel(), new ResourceLocation("arpg:textures/springer_model_tex.png"), 0.3F, Springer.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsToxicomaniaMob.MosquitoModel(), new ResourceLocation("arpg:textures/mosquito_model_tex.png"), 0.1F, Mosquito.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsToxicomaniaMob.BossAbominationModel(), new ResourceLocation("arpg:textures/boss_abomination_model_tex.png"), 1.0F, BossAbomination.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsToxicomaniaMob.AbominationCannonModel(), new ResourceLocation("arpg:textures/abomination_cannon_model_tex.png"), 0.4F, AbominationCannon.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsToxicomaniaMob.LumpModel(), new ResourceLocation("arpg:textures/lump_model_tex.png"), 0.8F, Lump.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsToxicomaniaMob.MutantBeastModel(), new ResourceLocation("arpg:textures/mutant_beast_model_tex.png"), 0.6F, MutantBeast.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsToxicomaniaMob.TestTubeSubstanceModel(), new ResourceLocation("arpg:textures/test_tube_substance_model_tex.png"), 0.7F, TestTubeSubstance.class).setLayerRandomItem(new LayerRandomItem(0.4F, true)));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsToxicomaniaMob.TestTubeCreatureModel(), new ResourceLocation("arpg:textures/test_tube_creature_model_tex.png"), 1.0F, TestTubeCreature.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsToxicomaniaMob.MutantZombieModel(), new ResourceLocation("arpg:textures/mutant_zombie_model_tex.png"), 0.3F, MutantZombie.class).setLayerHeldItem().setlayerArmor());
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsToxicomaniaMob.RocketBotModel(), new ResourceLocation("arpg:textures/rocket_bot_model_tex.png"), 0.5F, RocketBot.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsToxicomaniaMob.KillBotModel(), new ResourceLocation("arpg:textures/kill_bot_model_tex.png"), 0.3F, KillBot.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsToxicomaniaMob.DronModel(), new ResourceLocation("arpg:textures/dron_model_tex.png"), 0.15F, Dron.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsToxicomaniaMob.TurretModel(), new ResourceLocation("arpg:textures/turret_model_tex.png"), 0.25F, Turret.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsToxicomaniaMob.PoisonSpitterModel(), new ResourceLocation("arpg:textures/poison_spitter_model_tex.png"), 0.15F, PoisonSpitter.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsToxicomaniaMob.GlowingSkeletonModel(), new ResourceLocation("arpg:textures/glowing_skeleton_model_tex.png"), 0.3F, GlowingSkeleton.class).setLayerHeldItem().setlayerArmor());
    }
    ...
    public static class AbominationCannon extends AbstractMob {
        ...
        public AbominationCannon(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.SCRAP_METAL, 1.0F, 0, 1, 1, 1), new MobDrop(ItemsRegister.IMPULSE_THRUSTER, 0.5F, 0, 1, 1, 0)});
        ...
        protected void onDeathUpdate() {
            ...
            if (this.deathTime == 19) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.explode, SoundCategory.HOSTILE, 2.0F, 0.95F + this.rand.nextFloat() / 10.0F, false);
                if (!this.world.isRemote) {
                    int count = this.rand.nextInt(3) + 1;
                    this.world.setEntityState(this, (byte) 9);
                    double damageRadius = 2.0;
                    AxisAlignedBB axisalignedbb = this.getEntityBoundingBox().expand(damageRadius * 2.0, damageRadius * 1.2, damageRadius * 2.0).offset(-damageRadius, -damageRadius * 0.6, -damageRadius);
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 6) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.laser, SoundCategory.HOSTILE, 1.7F, 1.1F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 7) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.shoot, SoundCategory.HOSTILE, 1.7F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 8) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.firework, SoundCategory.HOSTILE, 1.7F, 0.9F + this.rand.nextFloat() / 5.0F, false);
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.mob_robot_attack, SoundCategory.HOSTILE, 1.7F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 9) {
                for (int ss = 0; ss < 6; ss++) {
                    GUNParticle fire = new GUNParticle(flame, 0.4F + (float) this.rand.nextGaussian() / 10.0F, -0.005F, 33 + this.rand.nextInt(20), 240, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 8.0F, (float) this.rand.nextGaussian() / 28.0F, (float) this.rand.nextGaussian() / 8.0F, 1.0F, 1.0F, 0.8F, true, this.rand.nextInt(100) - 50);
                ...
                for (int ss = 0; ss < 3; ss++) {
                    GUNParticle fire = new GUNParticle(flame, 0.8F + (float) this.rand.nextGaussian() / 10.0F, 0.02F, 53 + this.rand.nextInt(20), 240, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 29.0F, this.rand.nextFloat() / 3.0F, (float) this.rand.nextGaussian() / 29.0F, 1.0F, 1.0F, 0.8F, true, this.rand.nextInt(100) - 50);
                    fire.alphaTickAdding = -0.04F;
                    fire.alphaGlowing = true;
                    this.world.spawnEntity(fire);
                }
        ...
        public void onEntityUpdate() {
            ...
            if (this.world.isRemote && this.boss != null) {
                ...
                BetweenParticle laser = new BetweenParticle(this.world, slime, 0.28F, light, 1.0F, 1.0F, 1.0F, 0.0F, vec1.distanceTo(vec2), 1, 0.0F, 9999.0F, vec1, vec2);
    ...
    public static class Dron extends AbstractMob {
        ...
        public Dron(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.CIRCUIT, 0.2F, 0, 1, 1, 0), new MobDrop(ItemsRegister.SCRAP_METAL, 1.0F, 0, 1, 1, 1), new MobDrop(BlocksRegister.SCRAP_ELECTRONICS, 0.2F, 0, 1, 1, 0), new MobDrop(ItemsRegister.IMPULSE_THRUSTER, 0.33F, 0, 1, 1, 0)});
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 8) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.laser, SoundCategory.HOSTILE, 1.7F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
    ...
    public static class Experiment9 extends AbstractMob {
        ...
        public Experiment9(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.ANTIDOTE, 0.1F, 0, 1, 1, 0), new MobDrop(ItemsRegister.MUTAGEN, 0.1F, 0, 1, 1, 0)});
        ...
        public void handleStatusUpdate(byte id) {
            if (id == 7) {
                for (int i = 0; i < 7; i++) {
                    ...
                    this.world.spawnParticle(EnumParticleTypes.HEART, this.posX + this.rand.nextFloat() * this.width * 2.0F - this.width, this.posY + 0.5 + this.rand.nextFloat() * this.height, this.posZ + this.rand.nextFloat() * this.width * 2.0F - this.width, d0, d1, d2, new int[0]);
                }
            }
    ...
    public static class FlowerSpider extends AbstractMob {
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 8) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.larva_water_attack, SoundCategory.HOSTILE, 0.7F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
        }
    ...
    public static class GlowingSkeleton extends AbstractMob {
        ...
        public GlowingSkeleton(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(Items.BONE, 1.0F, 0, 0, 2, 3), new MobDrop(Items.ARROW, 0.33F, 0, 0, 8, 6), new MobDrop(ItemsRegister.ARROW_VICIOUS, 0.33F, 0, 0, 8, 6), new MobDrop(BlocksRegister.BOMB_RUSTED, 0.03F, 0, 1, 1, 0), new MobDrop(BlocksRegister.BOMB_SMALL, 0.03F, 0, 1, 1, 0), new MobDrop(BlocksRegister.BOMB_TOXIC, 0.03F, 0, 1, 1, 0)});
            this.setRoleValues(EnumMobRole.MIDDLE_ENEMY, 3);
            this.soul = Soul.PALE;
        }
        ...
        public void handleStatusUpdate(byte id) {
            if (id == 9) {
                for (int ss = 0; ss < 6; ss++) {
                    GUNParticle bigsmoke = new GUNParticle(largesmoke, 0.7F + (float) this.rand.nextGaussian() / 6.0F, -0.001F, 34, 60, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 13.0F, (float) this.rand.nextGaussian() / 16.0F, (float) this.rand.nextGaussian() / 13.0F, 1.0F, 1.0F, 1.0F, true, 0);
                    bigsmoke.alphaTickAdding = -0.028F;
                    this.world.spawnEntity(bigsmoke);
                }

                for (int ss = 0; ss < 10; ss++) {
                    GUNParticle fire = new GUNParticle(flame, 0.6F + (float) this.rand.nextGaussian() / 8.0F, -0.005F, 33 + this.rand.nextInt(20), 240, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 7.0F, (float) this.rand.nextGaussian() / 28.0F, (float) this.rand.nextGaussian() / 7.0F, 1.0F, 1.0F, 0.8F, true, this.rand.nextInt(100) - 50);
                    fire.alphaTickAdding = -0.04F;
                    fire.alphaGlowing = true;
                    this.world.spawnEntity(fire);
                }
                ...
                for (int ss = 0; ss < 10; ss++) {
                    GUNParticle fire = new GUNParticle(flame, 1.0F + (float) this.rand.nextGaussian() / 8.0F, 0.02F, 53 + this.rand.nextInt(20), 240, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 29.0F, this.rand.nextFloat() / 2.0F, (float) this.rand.nextGaussian() / 29.0F, 1.0F, 1.0F, 0.8F, true, this.rand.nextInt(100) - 50);
                    fire.alphaTickAdding = -0.04F;
                    fire.alphaGlowing = true;
                    this.world.spawnEntity(fire);
                }
            ...
            if (id == 8) {
                this.world.playSound(this.posX, this.posY, this.posZ, SoundEvents.ENTITY_ARROW_SHOOT, SoundCategory.HOSTILE, 0.9F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == -3) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.bow_aim_hostile, SoundCategory.HOSTILE, 1.5F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
    ...
    public static class KillBot extends AbstractMob {
        ...
        public KillBot(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.ADVANCED_CIRCUIT, 0.25F, 0, 1, 1, 0), new MobDrop(ItemsRegister.COPPER_WIRE, 0.5F, 0, 0, 2, 1), new MobDrop(ItemsRegister.SCRAP_METAL, 0.75F, 0, 0, 2, 1), new MobDrop(BlocksRegister.SCRAP_ELECTRONICS, 0.35F, 0, 1, 1, 0), new MobDrop(ItemsRegister.LEAD_BEARING, 0.25F, 0, 1, 1, 0), new MobDrop(ItemsRegister.BULLET_LEAD, 0.45F, 0, 10, 20, 25)});
    ...
    public static class MutantBeast extends AbstractMob {
        ...
        public MutantBeast(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(Items.ROTTEN_FLESH, 1.0F, 0, 0, 4, 4), new MobDrop(ItemsRegister.ANTIDOTE, 0.1F, 0, 1, 1, 0), new MobDrop(ItemsRegister.WASTE_BURGER, 0.1F, 0, 1, 1, 0), new MobDrop(ItemsRegister.TOXEDGE_BREAD, 0.1F, 0, 1, 1, 0), new MobDrop(ItemsRegister.TOXI_COLA, 0.1F, 0, 1, 1, 0), new MobDrop(BlocksRegister.TOXIC_TORCH, 0.1F, 0, 2, 4, 4)});
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 13) {
                RayTraceResult result = this.world.rayTraceBlocks(this.getPositionVector(), new Vec3d(this.posX, this.posY - 3.0, this.posZ));
                Vec3d posr = result != null ? result.hitVec : this.getPositionVector();
                GUNParticle particle = new GUNParticle(circle3, 0.1F, 0.0F, 7, 230, this.world, posr.x, posr.y + 0.1, posr.z, 0.0F, 0.0F, 0.0F, 0.8F, 0.8F, 0.8F, true, this.rand.nextInt(360));
                ...
                for (int ss = 0; ss < 20; ss++) {
                    ...
                    GUNParticle bigsmoke = new GUNParticle(largecloud, 0.8F + (float) this.rand.nextGaussian() / 8.0F, -0.003F, lt, 200, this.world, posr.x, posr.y + 0.1, posr.z, (float) this.rand.nextGaussian() / 8.0F, 0.0F, (float) this.rand.nextGaussian() / 8.0F, 0.8F, 0.8F, 0.8F, true, this.rand.nextInt(360));
            ...
            if (iBlockStateUp.getCollisionBoundingBox(this.world, posup) == null) {
                ...
                if (aabb != null) {
                    ...
                    for (int i = 0; i < imax; i++) {
                        ...
                        this.world.spawnParticle(EnumParticleTypes.BLOCK_CRACK, x, y, z, 0.0, 0.15 + this.rand.nextGaussian() / 20.0, 0.0, new int[]{Block.getStateId(iBlockState)});
        ...
        protected void initEntityAI() {
            ...
            this.tasks.addTask(2, new EntityAIJumpBeastAttack(this, 80, 16.0F, 4.0F, 1.0F, 0.25F, -1, 13.0F, false).setSounds(Sounds.mutant_beast_jump, SoundEvents.ENTITY_GENERIC_EXPLODE));
            this.tasks.addTask(5, new EntityAIMoveTowardsRestriction(this, 1.0));
            this.tasks.addTask(7, new EntityAIWanderAvoidWater(this, 1.0));
            this.tasks.addTask(8, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0F));
            this.tasks.addTask(8, new EntityAILookIdle(this));
    ...
    public static class MutantZombie extends AbstractMob {
        ...
        public MutantZombie(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(Items.ROTTEN_FLESH, 1.0F, 0, 0, 2, 3), new MobDrop(ItemsRegister.ANTIDOTE, 0.1F, 0, 1, 1, 0), new MobDrop(ItemsRegister.WASTE_BURGER, 0.1F, 0, 1, 1, 0), new MobDrop(ItemsRegister.TOXEDGE_BREAD, 0.1F, 0, 1, 1, 0), new MobDrop(ItemsRegister.TOXI_COLA, 0.1F, 0, 1, 1, 0), new MobDrop(BlocksRegister.TOXIC_TORCH, 0.1F, 0, 2, 4, 4)});
            this.leadershipBase = 5;
    ...
    public static class RocketBot extends AbstractMob {
        ...
        public RocketBot(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.CIRCUIT, 0.5F, 0, 1, 1, 0), new MobDrop(ItemsRegister.COPPER_WIRE, 0.5F, 0, 0, 2, 2), new MobDrop(ItemsRegister.SCRAP_METAL, 1.0F, 0, 0, 2, 2), new MobDrop(BlocksRegister.SCRAP_ELECTRONICS, 0.6F, 0, 1, 1, 0), new MobDrop(ItemsRegister.LEAD_BEARING, 0.4F, 0, 1, 1, 0), new MobDrop(ItemsRegister.COMMON_ROCKET, 1.0F, 0, 0, 6, 3)});
            this.stepHeight = 1.0F;
    ...
    public static class Springer extends AbstractMob {
        ...
        public EnumActionResult applyPlayerInteraction(EntityPlayer player, Vec3d vec, EnumHand hand) {
            ...
            if ((itemm == ItemsRegister.TOXIBERRY_WEEPING_SEEDS || itemm == ItemsRegister.TOXIBERRY_VIBRANT_SEEDS || itemm == ItemsRegister.SMALL_TOXIBERRY || itemm == ItemsRegister.DECEIDUS_SEEDS) && this.owner == null) {
                if (!player.capabilities.isCreativeMode) {
                    player.getHeldItemMainhand().shrink(1);
                }
    ...
    public static class TestTubeCreature extends AbstractMob {
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 9) {
                for (int ss = 0; ss < 10; ss++) {
                    GUNParticle bubble = new GUNParticle(this.texturbubble, 0.13F + this.rand.nextFloat() / 20.0F, 0.03F, 40 + this.rand.nextInt(20), 200, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 9.0F, (float) this.rand.nextGaussian() / 9.0F + 0.15F, (float) this.rand.nextGaussian() / 9.0F, 0.5F, 0.85F + (float) this.rand.nextGaussian() / 5.0F, 1.0F, false, this.rand.nextInt(180), true, 1.3F);
    ...
    public static class Turret extends AbstractMob implements ISynchronizedEntity, IWrenchUser {
        ...
        public Turret(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.CIRCUIT, 0.2F, 0, 1, 1, 0), new MobDrop(ItemsRegister.SCRAP_METAL, 1.0F, 0, 1, 1, 2), new MobDrop(BlocksRegister.SCRAP_ELECTRONICS, 0.2F, 0, 1, 1, 0), new MobDrop(ItemsRegister.LEAD_BEARING, 0.2F, 0, 1, 1, 0), new MobDrop(ItemsRegister.BULLET_LEAD, 0.4F, 0, 10, 15, 15)});
        ...
        public String getName() {
            return this.infinityAmmo ? super.getName() : super.getName() + " | " + (this.bullets == null ? "AMMO" : this.bullets.getNbtName()) + ": " + this.ammo;
        }
        ...
        public EnumActionResult applyPlayerInteraction(EntityPlayer player, Vec3d vec, EnumHand hand) {
            if (!this.world.isRemote && !Team.checkIsOpponent(player, this)) {
                ...
                if (!stack.isEmpty() && stack.getItem() instanceof ItemBullet && (this.bullets == null || this.bullets == stack.getItem() || this.ammo <= 0)) {
                    ...
                    if (count > 0) {
                        ...
                        ISynchronizedEntity.sendSynchronize(this, 32.0, this.deployStage, this.previousDeployStage, this.infinityAmmo ? 2000000.0 : this.ammo, this.bullets == null ? 0.0 : this.bullets.id, 0.0, 0.0);
                    }
                }
        ...
        public void shoot() {
            if ((this.infinityAmmo || this.ammo > 0) && !this.world.isRemote && this.deployStage >= 1.0F) {
                ...
                if (!this.infinityAmmo) {
                    this.ammo--;
                    ISynchronizedEntity.sendSynchronize(this, 32.0, this.deployStage, this.previousDeployStage, this.ammo, this.bullets == null ? 0.0 : this.bullets.id, 0.0, 0.0);
                }
            }
        }
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 9) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.sharkfire, SoundCategory.PLAYERS, 0.7F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
        }
    ...
    public static class VineChops extends AbstractMob {
        ...
        public VineChops(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.PLANT_FIBER, 1.0F, 0, 0, 4, 4), new MobDrop(ItemsRegister.JUNGLE_GRAPLING_HOOK, 0.04F, 0, 1, 1, 0)});
            this.setRoleValues(EnumMobRole.STRONG_SOLDIER, 3);
            this.soul = Soul.MUTATED;
        }
