...
public class EntityAICorrupterIdle extends EntityAIBase {
    ...
    public void updateTask() {
        ...
        if (entitylivingbase == null) {
            ...
            if (this.idleTime >= 0) {
                this.idleTime--;
                this.entity.getLookHelper().setLookPosition(this.entity.posX + this.lookX, this.entity.posY + this.entity.getEyeHeight(), this.entity.posZ + this.lookZ, this.entity.getHorizontalFaceSpeed(), this.entity.getVerticalFaceSpeed());
            }
