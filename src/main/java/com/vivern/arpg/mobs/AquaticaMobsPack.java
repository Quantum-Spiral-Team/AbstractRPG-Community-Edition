...
public class AquaticaMobsPack {
    ...
    public static void initRender() {
        ...
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.BlisterfishModel(), new ResourceLocation("arpg:textures/blisterfish_model_tex.png"), 0.4F, Blisterfish.class).setLightLayer(new ResourceLocation("arpg:textures/blisterfish_model_tex_overlay.png")));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.WizardfishModel(), new ResourceLocation("arpg:textures/wizardfish_model_tex.png"), 0.4F, Wizardfish.class).setLightLayer(new ResourceLocation("arpg:textures/wizardfish_model_tex_overlay.png")));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.DartfishModel(), new ResourceLocation("arpg:textures/dartfish_model_tex.png"), 0.5F, Dartfish.class).setLightLayer(new ResourceLocation("arpg:textures/dartfish_model_tex_overlay.png")));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.TrachymonaModel(), new ResourceLocation("arpg:textures/trachymona_model_tex.png"), 0.25F, Trachymona.class).setRenderAsRocket(true));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.HydromonaModel(), new ResourceLocation("arpg:textures/hydromona_model_tex.png"), 0.35F, Hydromona.class).setRenderAsRocket(true).setLightLayer(new ResourceLocation("arpg:textures/hydromona_model_tex_overlay.png")));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.BreedModel(), new ResourceLocation("arpg:textures/breed_model_tex.png"), 0.15F, Breed.class).setRenderAsRocket(false).setLightLayer(new ResourceLocation("arpg:textures/breed_model_tex_overlay.png")));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.PolipoidModel(), new ResourceLocation("arpg:textures/polipoid_model_tex.png"), 0.3F, Polipoid.class).setRenderAsRocket(false).setLightLayer(new ResourceLocation("arpg:textures/polipoid_model_tex_overlay.png")));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.SeaStrikerModel(), new ResourceLocation("arpg:textures/sea_striker_model_tex.png"), 0.35F, SeaStriker.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new OceanSpiritModel(), new ResourceLocation("arpg:textures/ocean_spirit_model_tex.png"), 0.4F, OceanSpirit.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.ArchelonModel(), new ResourceLocation("arpg:textures/archelon_model_tex.png"), 1.3F, Archelon.class).setLightLayer(new ResourceLocation("arpg:textures/archelon_model_tex_overlay.png")));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.ArchelonCreationModel(), new ResourceLocation("arpg:textures/archelon_creation_model_tex.png"), 0.5F, ArchelonCreation.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.MermaidModel(), new ResourceLocation("arpg:textures/mermaid_model_tex.png"), 0.35F, Mermaid.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.MermaidModel(), new ResourceLocation("arpg:textures/dark_mermaid_tex.png"), 0.35F, DarkMermaid.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.SirenModel(), new ResourceLocation("arpg:textures/siren_model_tex.png"), 0.4F, Siren.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.BossKrakenModel(), new ResourceLocation("arpg:textures/boss_kraken_model_tex.png"), 1.5F, BossKraken.class).setRenderAsRocket(true));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.KrakenTentacleModel(0), new ResourceLocation("arpg:textures/kraken_tentacle_model_tex.png"), 0.3F, KrakenTentacleBite.class).setUseIRender());
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.KrakenTentacleModel(1), new ResourceLocation("arpg:textures/kraken_tentacle_model_tex.png"), 0.3F, KrakenTentacleShock.class).setUseIRender());
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.KrakenTentacleModel(2), new ResourceLocation("arpg:textures/kraken_tentacle_model_tex.png"), 0.3F, KrakenTentacleCrash.class).setUseIRender());
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.KrakenTentacleModel(3), new ResourceLocation("arpg:textures/kraken_tentacle_model_tex.png"), 0.3F, KrakenTentacleMain.class).setUseIRender());
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsAquaticaMobs.KrakenTentacleModel(4), new ResourceLocation("arpg:textures/kraken_tentacle_model_tex.png"), 0.3F, KrakenTentacleGrab.class).setUseIRender());
    }
    ...
    public static class Archelon extends AbstractMob implements IMultipartMob, ISynchronizedEntity {
        ...
        public Archelon(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.ARCHELON_SHELL, 0.85F, 0, 1, 1, 0), new MobDrop(ItemsRegister.ARCHELON_SHELL, 0.15F, 0, 1, 1, 0)});
        ...
        public void onUpdate() {
            ...
            if (!this.world.isRemote) {
                ...
                Vec3d vec = this.getPositionVector().add(this.getVectorForRotation(this.rotationPitch * 0.8F, this.renderYawOffset + f2).scale(2.25 - 1.8F * headProtect)).add(0.0, 0.23, 0.0);
        ...
        public float onAttacked(float hurtdamage, DamageSource source, int shieldAngle, float damageBlocks) {
            ...
            if (attacker == null || GetMOP.getAngleBetweenVectors(vec1.x, vec1.y, vec1.z, attacker.posX - this.posX, attacker.posY - this.posY, attacker.posZ - this.posZ) < shieldAngle) {
                if (attacker == null) {
                    return hurtdamage;
                }
                ...
                if (hurtdamage < 1.5) {
                    this.world.playSound(null, this.posX, this.posY, this.posZ, Sounds.shield_hit_soft, SoundCategory.HOSTILE, 0.6F, 0.9F + this.rand.nextFloat() / 5.0F);
                } else {
                    this.world.playSound(null, this.posX, this.posY, this.posZ, Sounds.shield_break, SoundCategory.HOSTILE, 0.6F, 0.9F + this.rand.nextFloat() / 5.0F);
                }
            }
    ...
    public static class ArchelonCreation extends AbstractMob {
        ...
        public void onUpdate() {
            ...
            if (!this.world.isRemote) {
                ...
                } else if (this.var1 == 2 && this.spawns > 0 && this.isInWater() && this.getAttackTarget() != null && this.getDistanceSq(this.getAttackTarget()) < 144.0) {
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 11) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.slimeshoot_a, SoundCategory.HOSTILE, 1.5F, 1.1F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 7) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.sea_bomb, SoundCategory.HOSTILE, 1.6F, 1.1F + this.rand.nextFloat() / 5.0F, false);
            }
    ...
    public static class Blisterfish extends AbstractMob {
        ...
        public Blisterfish(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.FISH_STEAK_RAW, 1.0F, 0, 1, 1, 1), new MobDrop(ItemsRegister.PLACODERM_SCALES, 0.6F, 0, 1, 1, 0)});
            this.var3 = 0.0F;
            this.var4 = 0.0F;
            this.var5 = 0.0F;
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 7) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.slimeshoot, SoundCategory.HOSTILE, 0.9F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 15) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.blisterfish_prepare, SoundCategory.HOSTILE, 1.3F, 0.9F + this.rand.nextFloat() / 5.0F, false);
    ...
    public static class Breed extends AbstractMob {
        ...
        public void onUpdate() {
            ...
            if (this.world.isRemote) {
                this.var3 = this.var4;
                this.var4 = this.var4 + (float) this.getDistance(this.posX + this.motionX, this.posY + this.motionY, this.posZ + this.motionZ);
            }
    ...
    public static class DarkMermaid extends Mermaid {
        ...
        public DarkMermaid(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.FISH_STEAK_RAW, 0.5F, 0, 1, 1, 3), new MobDrop(ItemsRegister.AQUATIC_NUGGET, 0.5F, 0, 1, 3, 0), new MobDrop(ItemsRegister.BLACK_PEARL, 0.1F, 0, 1, 1, 0)});
        }
    ...
    public static class Dartfish extends AbstractMob {
        ...
        public Dartfish(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.FISH_STEAK_RAW, 1.0F, 0, 1, 2, 2), new MobDrop(ItemsRegister.PLACODERM_SCALES, 0.9F, 0, 1, 1, 0)});
            this.var3 = 0.0F;
            this.var4 = 0.0F;
            this.var5 = 0.0F;
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 7) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.dartfish_shoot, SoundCategory.HOSTILE, 1.4F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 15) {
                this.triggerAnimation(-1);
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.dartfish_prepare, SoundCategory.HOSTILE, 1.5F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
        }
    ...
    public static class Hydromona extends AbstractMob {
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 11) {
                for (int i = 2; i < 6; i++) {
                    GUNParticle part = new GUNParticle(cloud, 0.7F - i / 10.0F, 0.0F, 20, 140, this.world, this.posX, this.posY + this.getEyeHeight(), this.posZ, 0.0F, 0.0F, 0.0F, 0.25F, 0.6F + this.rand.nextFloat() / 10.0F, 0.9F + this.rand.nextFloat() / 10.0F, true, this.rand.nextInt(360), true, 1.0F);
                ...
                for (int i = 0; i < 2; i++) {
                    GUNParticle part = new GUNParticle(cloud, 0.5F + i / 10.0F, 0.0F, 20, 140, this.world, this.posX, this.posY + this.getEyeHeight(), this.posZ, 0.0F, 0.0F, 0.0F, 0.25F, 0.6F + this.rand.nextFloat() / 10.0F, 0.9F + this.rand.nextFloat() / 10.0F, true, this.rand.nextInt(360), true, 1.0F);
                ...
                for (int i = 0; i < 5; i++) {
                    GUNParticle part = new GUNParticle(cloud2, 0.2F + this.rand.nextFloat() / 4.0F, 0.0F, 20, 140, this.world, this.posX, this.posY + this.getEyeHeight(), this.posZ, 0.0F, 0.0F, 0.0F, 0.2F, 0.6F + this.rand.nextFloat() / 10.0F, 0.9F + this.rand.nextFloat() / 10.0F, true, this.rand.nextInt(360), true, 1.0F);
        ...
        protected void initEntityAI() {
            ...
            this.tasks.addTask(3, new EntityAIForceAttack(this, -1.0F, 60, 3.5F, 0.0F, 3.0F, 0.2F, 3.5F, 1.3F).setSoundOnAttack(Sounds.explode_water_b).setuseRocketRotations().setWaterhammer());
            this.tasks.addTask(5, new EntityAIMoveTowardsRestriction(this, 1.0));
        ...
        public void onUpdate() {
            ...
            if (this.kraken != null) {
                if (!this.world.isRemote && (this.ticksExisted % 40 == 0 || this.ticksExisted < 2)) {
                    ...
                    if (this.getAttackTarget() != null && this.kraken.getAttackTarget() != null && this.getAttackTarget().getDistanceSq(this.kraken.getAttackTarget()) > this.reagreeDistSq) {
                        this.setAttackTarget(this.kraken.getAttackTarget());
                    }
                }

                double followpower = 0.8;
                this.motionX = this.motionX + MathHelper.clamp((this.kraken.tentaclesAlignX - this.kraken.prevtentaclesAlignX) * followpower, -0.05F, 0.05F);
                this.motionY = this.motionY + MathHelper.clamp((this.kraken.tentaclesAlignY - this.kraken.prevtentaclesAlignY) * followpower, -0.05F, 0.05F);
                this.motionZ = this.motionZ + MathHelper.clamp((this.kraken.tentaclesAlignZ - this.kraken.prevtentaclesAlignZ) * followpower, -0.05F, 0.05F);
        ...
        public void renderPost(EntityLiving entity, double x, double y, double z, float entityYaw, float partialTicks) {
            ...
            if (entity instanceof KrakenTentacle) {
                ...
                if (tentacle.kraken != null) {
                    ...
                    Vec3d normalizedRotation1 = GetMOP.pitchYawToVec3D(-GetMOP.partial(tentacle.kraken.rotationPitch, tentacle.kraken.prevRotationPitch), -GetMOP.partial(tentacle.kraken.rotationYaw, tentacle.kraken.prevRotationYaw));
                    ...
                    int lightStart = Math.max(this.world.getLightFor(EnumSkyBlock.BLOCK, new BlockPos(pos1)), this.world.getLightFor(EnumSkyBlock.SKY, new BlockPos(pos1))) * 15;
                    int lightEnd = Math.max(this.world.getLightFor(EnumSkyBlock.BLOCK, new BlockPos(pos2)), this.world.getLightFor(EnumSkyBlock.SKY, new BlockPos(pos2))) * 15;
    ...
    public static class KrakenTentacleCrash extends KrakenTentacle implements IRender {
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 13) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.kraken_crash, SoundCategory.HOSTILE, 2.7F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
        }

        @Override
        protected void initEntityAI() {
            this.tasks.addTask(1, new EntityAITentacle(this, true, 7.0F, 6.0F, 0.25F, 140, 60, 2.4F).setBreakBlocks(BossKraken.hardnessBreaks, 0.12F, 2));
            this.targetTasks.addTask(1, new EntityAIHurtByTarget(this, false, new Class[0]));
            this.targetTasks.addTask(2, new EntityAIAgree(this, EntityPlayer.class, false));
            this.targetTasks.addTask(3, new EntityAIAttackOtherTeam(this, EntityLiving.class, false));
        }
    ...
    public static class KrakenTentacleGrab extends KrakenTentacle implements IRender {
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 15) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.grab_bite, SoundCategory.HOSTILE, 1.3F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
        }
        ...
        protected void initEntityAI() {
            ...
            if (this.isAngryBiteTentacle) {
                this.grab = new EntityAIGrapBite(this, true, 30, 3.5F, 0.0F, 3.0F, 160, 60 + this.getMobDifficulty() >= 3 ? 35.0F : 0.0F, false, 1.5F, false, false, true);
            } else {
                this.grab = new EntityAIGrapBite(this, true, 40, 2.5F, 0.0F, 3.0F, 160, 30 + this.getMobDifficulty() >= 3 ? 15.0F : 0.0F, false, 1.5F, true, false, true);
            }
    ...
    public static class KrakenTentacleMain extends KrakenTentacle implements IRender {
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 7) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.kraken_main_shoot, SoundCategory.HOSTILE, 3.5F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
        }
    ...
    public static class KrakenTentacleShock extends KrakenTentacle implements IRender {
        ...
        public boolean attackEntityFrom(DamageSource source, float amount) {
            ...
            if (succ && this.attacking && amount >= 3.0F) {
                ...
                if (source.getTrueSource() != null) {
                    SuperKnockback.applyKnockback(this, 2.0F, source.getTrueSource().posX, source.getTrueSource().posY, source.getTrueSource().posZ);
                }
            }
        ...
        public void onUpdate() {
            ...
            if (this.kraken != null) {
                ...
                if (!this.world.isRemote) {
                    if (this.getAttackTarget() != null) {
                        List<HostileProjectiles.KrakenShockbolt> listbolts = this.world.getEntitiesWithinAABB(HostileProjectiles.KrakenShockbolt.class, this.getAttackTarget().getEntityBoundingBox().grow(3.3));
                        ...
                        if (this.charge < maxCharge && !this.attacking) {
                            ...
                            if (this.attacking) {
                                for (EntityLivingBase entity : list) {
                                    ...
                                    Weapons.dealDamage(new WeaponDamage(null, this.kraken, this, false, false, this, WeaponDamage.electric), damage, this, entity, true, 0.3F);
            ...
            if (this.world.isRemote) {
                if (this.attacking) {
                    GUNParticle part = new GUNParticle(textureShock, 3.2F, 0.0F, 3, 240, this.world, this.posX, this.posY + this.height / 2.0F, this.posZ, 0.0F, 0.0F, 0.0F, 0.82F - this.rand.nextFloat() * 0.1F, 1.0F, 0.85F + this.rand.nextFloat() * 0.1F, true, this.rand.nextInt(360));
                    part.alphaGlowing = true;
                ...
                if (this.ticksExisted % 12 == 0) {
                    this.world.playSound(this.posX, this.posY, this.posZ, Sounds.kraken_shock_loop, SoundCategory.HOSTILE, 1.0F, 0.95F + this.rand.nextFloat() / 10.0F, false);
                }
            }
        }
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 11) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.kraken_shock_shoot, SoundCategory.HOSTILE, 2.0F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 10) {
                this.attacking = true;
                this.charge = maxCharge;
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.kraken_shock_attack, SoundCategory.HOSTILE, 1.5F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
        }
        ...
        public void renderPost(EntityLiving entity, double x, double y, double z, float entityYaw, float partialTicks) {
            ...
            if (entity instanceof KrakenTentacleShock) {
                ...
                if (tentacle.kraken != null) {
                    ...
                    int lightStart = Math.max(this.world.getLightFor(EnumSkyBlock.BLOCK, new BlockPos(pos1)), this.world.getLightFor(EnumSkyBlock.SKY, new BlockPos(pos1))) * 15;
                    int lightEnd = Math.max(this.world.getLightFor(EnumSkyBlock.BLOCK, new BlockPos(pos2)), this.world.getLightFor(EnumSkyBlock.SKY, new BlockPos(pos2))) * 15;
                    RenderTentacles.renderTentacleAnimGlow(segmentsPoses, partialTicks, 1.1F, 0.4F, lightStart, lightEnd, AnimationTimer.normaltick / 4 % segments, 0.3F, 1.0F, 1.0F, 210);
                }
    ...
    public static class Mermaid extends AbstractMob implements ISynchronizedEntity {
        ...
        public Mermaid(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.FISH_STEAK_RAW, 0.5F, 0, 1, 1, 3), new MobDrop(ItemsRegister.AQUATIC_NUGGET, 0.5F, 0, 1, 3, 0), new MobDrop(ItemsRegister.TIDE_ACTIVATOR_1, 0.1F, 0, 1, 1, 0), new MobDrop(ItemsRegister.PEARL, 0.3F, 0, 0, 3, 0)});
            this.var3 = 0.0F;
            this.var4 = 0.0F;
            this.var5 = 0.0F;
            this.setRoleValues(EnumMobRole.STRONG_ENEMY, 5);
        ...
        public void onClient(double... args) {
            if (args.length == 3) {
                ...
                this.world.playSound(this.spellhitPos.x, this.spellhitPos.y, this.spellhitPos.z, Sounds.magic_m, SoundCategory.HOSTILE, 1.8F, 0.9F + this.rand.nextFloat() / 5.0F, false);
                GUNParticle part = new GUNParticle(circle2, 3.2F, 0.0F, this.maxSpellhitReady, 220, this.world, this.spellhitPos.x, this.spellhitPos.y, this.spellhitPos.z, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 0.55F - this.rand.nextFloat() * 0.2F, true, 1);
                part.alphaGlowing = true;
        ...
        public void onUpdate() {
            ...
            if (this.world.isRemote) {
                ...
                if (this.spellhitActive && this.spellhitPos != null) {
                    GUNParticle spell = new GUNParticle(star2, 0.1F + this.rand.nextFloat() * 0.1F, 0.0F, 20, 200, this.world, this.spellhitPos.x + (this.rand.nextDouble() - 0.5) * 6.0, this.spellhitPos.y, this.spellhitPos.z + (this.rand.nextDouble() - 0.5) * 6.0, 0.0F, (float) this.rand.nextGaussian() / 4.0F, 0.0F, 1.0F, 1.0F, 0.4F - this.rand.nextFloat() * 0.2F, true, this.rand.nextInt(31) - 30);
                ...
                if (!this.isAIDisabled() && this.isEntityAlive()) {
                    if (this.WEAPON == 0) {
                        ...
                        if (this.ticksExisted % 9 == 0 && this.getAttackTarget() != null && this.spellhitCoolown <= 0) {
                            ...
                            if (!around.isEmpty()) {
                                for (int i = 0; i < 16; i++) {
                                    Vec3d pos = around.get(this.rand.nextInt(around.size())).getPositionVector().add((this.rand.nextDouble() - 0.5) * 6.0, (this.rand.nextDouble() - 0.5) * 3.0, (this.rand.nextDouble() - 0.5) * 6.0);
                            ...
                            if (maxpos != null) {
                                ...
                                ISynchronizedEntity.sendSynchronize(this, 64.0, this.spellhitPos.x, this.spellhitPos.y, this.spellhitPos.z);
                            }
                        }
                        ...
                        if (this.spellhitActive) {
                            if (this.spellhitReady < this.maxSpellhitReady) {
                                ...
                                for (EntityLivingBase entity : GetMOP.getHostilesInAABBto(this.world, this.spellhitPos, 3.2, 1.8, this)) {
                                    Weapons.dealDamage(new WeaponDamage(null, this, null, false, false, this.spellhitPos, WeaponDamage.acid), 25.0F, this, entity, true, 1.3F, this.spellhitPos.x, this.spellhitPos.y, this.spellhitPos.z);
                                    entity.hurtResistantTime = 0;
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 7) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.slimeshoot, SoundCategory.HOSTILE, 1.5F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
            ...
            if (id == 11 && this.spellhitActive && this.spellhitPos != null) {
                this.world.playSound(this.spellhitPos.x, this.spellhitPos.y, this.spellhitPos.z, Sounds.explode4, SoundCategory.HOSTILE, 1.8F, 0.9F + this.rand.nextFloat() / 5.0F, false);

                for (int ss = 0; ss < 20; ss++) {
                    GUNParticle spell = new GUNParticle(star2, 0.1F + this.rand.nextFloat() * 0.1F, 0.0F, 40, 240, this.world, this.spellhitPos.x + (this.rand.nextDouble() - 0.5) * 6.0, this.spellhitPos.y, this.spellhitPos.z + (this.rand.nextDouble() - 0.5) * 6.0, 0.0F, (float) this.rand.nextGaussian() / 8.0F, 0.0F, 1.0F, 1.0F, 0.4F - this.rand.nextFloat() * 0.2F, true, this.rand.nextInt(31) - 30);
                    spell.alphaGlowing = true;
                    spell.scaleTickAdding = -0.0016F;
                    this.world.spawnEntity(spell);
                }
                ...
                for (int ss = -3; ss <= 3; ss++) {
                    ...
                    GUNParticle part = new GUNParticle(circle, 0.2F, 0.0F, lt, 220, this.world, this.spellhitPos.x, this.spellhitPos.y, this.spellhitPos.z, 0.0F, ss * 0.1F, 0.0F, 1.0F, 1.0F, 0.4F - this.rand.nextFloat() * 0.2F, true, 1);
    ...
    public static class Needletooth extends AbstractMob implements ISynchronizedEntity {
        ...
        public Needletooth(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.FISH_STEAK_RAW, 0.5F, 0, 1, 1, 1), new MobDrop(ItemsRegister.PLACODERM_SCALES, 0.2F, 0, 1, 1, 0)});
            this.var3 = 0.0F;
            this.var4 = 0.0F;
            this.var5 = 0.0F;
            this.setRoleValues(EnumMobRole.SOLDIER, 5);
        ...
        public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
            if (!this.world.isRemote) {
                ...
                if (var8 == 5) {
                    this.getEntityAttribute(SharedMonsterAttributes.KNOCKBACK_RESISTANCE).setBaseValue(Math.min(this.knockResist + 0.4F * this.rand.nextFloat(), 1.0));
                }
            }
    ...
    public static class OceanSpirit extends AbstractMob implements ISynchronizedEntity {
        ...
        public void spawnBetwParticle(Vec3d from, Vec3d to) {
            if (from.lengthSquared() > 1.0E-6 && to.lengthSquared() > 1.0E-6) {
                BetweenParticle laser = new BetweenParticle(this.world, this.texturelaser, 0.2F, 220, 0.5F, 1.0F, 0.9F, 0.15F, from.distanceTo(to), 3, 0.5F, 4.0F, from, to);
                ...
                for (int ss = 0; ss < 3; ss++) {
                    ...
                    GUNParticle water = new GUNParticle(Seal.splashes[this.rand.nextInt(3)], scl, 0.023F, lt, 150, this.world, to.x, to.y, to.z, (float) this.rand.nextGaussian() / 25.0F, (float) this.rand.nextGaussian() / 25.0F, (float) this.rand.nextGaussian() / 25.0F, 0.65F - this.rand.nextFloat() * 0.2F, 1.0F - this.rand.nextFloat() * 0.22F, 1.0F - this.rand.nextFloat() * 0.2F, false, this.rand.nextInt(360), true, 1.15F);
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 8) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.magic_water, SoundCategory.HOSTILE, 1.2F, 0.9F + this.rand.nextFloat() / 5.0F, false);
                this.lazerTimer = 20;
            }

            if (id == 7) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.ocean_shoot, SoundCategory.HOSTILE, 1.0F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 9) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.explode_water_a, SoundCategory.HOSTILE, 1.6F, 0.7F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 10) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.sea_bomb, SoundCategory.HOSTILE, 1.6F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
    ...
    public static class Siren extends AbstractMob {
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 7) {
                this.triggerAnimation(-3);
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.fire, SoundCategory.HOSTILE, 1.7F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
        }
    ...
    public static class Trachymona extends AbstractMob {
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 7) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.item_misc_e, SoundCategory.HOSTILE, 0.8F, 1.2F + this.rand.nextFloat() / 5.0F, false);
            }
    ...
    public static class Wizardfish extends AbstractMob implements ISynchronizedEntity {
        ...
        public void onClient(double x, double y, double z, double a, double b, double c) {
            ...
            this.world.playSound(this.posX, this.posY, this.posZ, Sounds.magic_o, SoundCategory.HOSTILE, 0.9F, 0.8F + this.rand.nextFloat() * 0.4F, false);
        ...
        public void spawnParticles1(Entity target, Vec3d pos, float r, float g, float b, int count) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                GUNParticle spelll = new GUNParticle(tex1, scl, 0.01F - this.rand.nextFloat() * 0.02F, lt, 220, this.world, this.posX + (this.rand.nextFloat() - 0.5), this.posY + (this.rand.nextFloat() - 0.5), this.posZ + (this.rand.nextFloat() - 0.5), (float) this.rand.nextGaussian() / 15.0F, 0.15F, (float) this.rand.nextGaussian() / 15.0F, r, g, b, true, 0);
            ...
            if (this.world.isRemote) {
                ...
                if (this.particklesTime > 0) {
                    if (this.particklesEntity != null) {
                        this.spawnParticles1(this.particklesEntity, GetMOP.entityCenterPos(this.particklesEntity), (float) this.particklesColor.x, (float) this.particklesColor.y, (float) this.particklesColor.z, this.rand.nextInt(3) + 1);
                    }
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 7) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.restless_skull, SoundCategory.HOSTILE, 0.9F, 1.4F + this.rand.nextFloat() / 5.0F, false);
            }
