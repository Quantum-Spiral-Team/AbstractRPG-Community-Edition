...
public class EntityAIFlyingWorm extends EntityAIBase {
    ...
    public EntityAIFlyingWorm(EntityCreature entity, int frequency, float radius, float speed, float radiusVar, float yOffset, float resetDistance, float attackChance, float friction, boolean checkInBlock) {
        this.entity = entity;
