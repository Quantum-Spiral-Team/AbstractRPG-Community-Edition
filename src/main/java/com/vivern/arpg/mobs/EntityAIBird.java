...
public class EntityAIBird extends AbstractMob.AbstractAI {
    ...
    public EntityAIBird(AbstractMob mob, int attackCooldown, float maxShootDistance, int attackDelay, boolean shoot, float strafingDistance, float strafingAmplitude, boolean triggerAnim3) {
        this.entity = mob;
                ...
                if (this.entity.ticksExisted % 4 == 0) {
                    ...
                    if (this.stayTIME > 130 || this.HITS > 8) {
                        if (this.onGround(this.entity.world, this.entity.posX, this.entity.posY, this.entity.posZ)) {
                            ...
                            this.HITS = 0;
                            this.entity.world.setEntityState(this.entity, (byte) (1 + this.sendEntStateAdd));
                        } else if (cansee && this.onGround(this.entity.world, entitylivingbase.posX, entitylivingbase.posY, entitylivingbase.posZ)) {
                            this.stayTIME /= 2;
                            this.HITS /= 2;
