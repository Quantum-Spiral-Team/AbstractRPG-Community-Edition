...
public class Gargoyle extends EntityMob {
    ...
    public void handleStatusUpdate(byte id) {
        if (id == 10) {
            SweepParticle particle = new SweepParticle(sweeptex, 1.7F + this.getRNG().nextFloat() / 2.0F, 6, 1, 4, 2, (int) (this.getBrightness() * 150.0F), this.world, this.posX, this.posY + this.getEyeHeight(), this.posZ, this.rotationPitch, this.rotationYawHead, 0.2F, 0.2F, 0.3F, false, 80 + this.getRNG().nextInt(20));
