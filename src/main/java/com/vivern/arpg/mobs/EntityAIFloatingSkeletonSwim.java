...
public class EntityAIFloatingSkeletonSwim extends EntityAIFloatingSkeleton {
    ...
    public EntityAIFloatingSkeletonSwim(AbstractMob mob, int attackCooldown, float maxShootDistance, int attackDelay, boolean shoot, float strafingDistance, float strafingAmplitude, float levitateHeight, float levitatePower, boolean canFlyup, boolean triggerAnim3) {
        super(mob, attackCooldown, maxShootDistance, attackDelay, shoot, strafingDistance, strafingAmplitude, levitateHeight, levitatePower, canFlyup, triggerAnim3);
    }
    ...
    public static Vec3d RotatedPosRayTrace1(EntityLivingBase attacktarget, double blockReachDistance, float partialTicks, EntityLivingBase entity, double size, double step, float rotationPitch, float rotationYaw) {
