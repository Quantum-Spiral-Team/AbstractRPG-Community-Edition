...
public class EntityAIStrikeLightning extends EntityAIBase {
    ...
    public EntityAIStrikeLightning(AbstractMob entity, int maxCooldown, float radiusHigher, float radiusLower, float damage, int chargeMaxTime, boolean shouldSee, boolean vanillaLightning, int seeMemory) {
        this.entity = entity;
                        ...
                        if (this.lastSeeTime > 0) {
                            ...
                            if (this.chargeCurrentTime >= this.chargeMaxTime) {
                                ...
                                if (this.vanillaLightning) {
                                    EntityLightningBolt bolt = new EntityLightningBolt(this.entity.world, attackTarg.posX, attackTarg.posY, attackTarg.posZ, false);
