...
public class BossKraken extends AbstractBoss implements ISynchronizedEntity, IMultipartMob {
    ...
    public void spawnTentacle(int type) {
        if (type == 0) {
            ...
            mob.setPosition(this.tentaclesAlignX + this.rand.nextGaussian() * 3.0, this.tentaclesAlignY + this.rand.nextGaussian() * 3.0, this.tentaclesAlignZ + this.rand.nextGaussian() * 3.0);
    ...
    public Vec3d getTentaclesAlign(float partialTicks) {
        return new Vec3d(GetMOP.partial(this.tentaclesAlignX, this.prevtentaclesAlignX, partialTicks), GetMOP.partial(this.tentaclesAlignY, this.prevtentaclesAlignY, partialTicks), GetMOP.partial(this.tentaclesAlignZ, this.prevtentaclesAlignZ, partialTicks));
    }
    ...
    public void breakBlocks() {
        for (BlockPos pos : GetMOP.getBlockPosesCollidesAABB(this.world, this.getEntityBoundingBox().grow(0.2), false)) {
            ...
            if (Weapons.easyBreakBlockFor(this.world, hardnessBreaks, pos, blockState) && !blockState.getMaterial().isLiquid() && blockState.getMaterial() != Material.AIR) {
    ...
    public void handleStatusUpdate(byte id) {
        ...
        if (id == 7) {
            this.world.playSound(this.posX, this.posY, this.posZ, Sounds.kraken_roar, SoundCategory.HOSTILE, 5.0F, 0.9F + this.rand.nextFloat() / 5.0F, false);
        }
        ...
        if (id == 15) {
            ...
            this.world.playSound(this.posX, this.posY, this.posZ, Sounds.kraken_grab, SoundCategory.HOSTILE, 2.0F, 0.7F + this.rand.nextFloat() / 5.0F, false);
        }
    }

    @Override
    protected void initEntityAI() {
        this.tasks.addTask(4, new EntityAIGrapBite(this, true, 80, 4.5F + Debugger.floats[0], 0.0F, 3.0F, 200, 15.0F, false, 8.0F + Debugger.floats[1], true, true, true));
    ...
    public static class EntityAIKrakenSwim extends EntityAIBase {
        ...
        public EntityAIKrakenSwim(AbstractMob entity, float motionMaxSpeed, float speedIncrease, float directionChangeChance, boolean isIdle, double maxDistFromTarget, int maxtimeFollow) {
            this.entity = entity;
        ...
        public void updateTask() {
            ...
            if (this.move) {
                ...
                if (this.advancedCollisionCheck) {
                    ...
                    BlockPos possx = new BlockPos(this.entity.posX + this.entity.motionX, this.entity.posY + this.entity.motionY, this.entity.posZ + this.entity.motionZ);
        ...
        public void createNewVector() {
            if (this.timeFollow > 0 && this.entity.getAttackTarget() != null) {
                ...
                this.randomMotionVecY = (float) targ.y + (this.entity.world.getBlockState(this.entity.getPosition().up(3)).getMaterial() == Material.AIR ? -0.8F : 0.0F);
