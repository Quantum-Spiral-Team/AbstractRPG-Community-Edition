...
public class DungeonMobsPack {
    ...
    public static void initRender() {
        ...
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsDungeonMob.BeholderModel(), new ResourceLocation("arpg:textures/beholder_model_tex.png"), 0.4F, Beholder.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsDungeonMob.DevourerModel(), new ResourceLocation("arpg:textures/devourer_model_tex.png"), 1.0F, Devourer.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsDungeonMob.DegModel(), new ResourceLocation("arpg:textures/deg_model_tex.png"), 0.45F, Deg.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsDungeonMob.StoneEaterModel(false), new ResourceLocation("arpg:textures/stone_eater_model_tex.png"), 0.4375F, StoneEater.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsDungeonMob.StoneEaterModel(true), new ResourceLocation("arpg:textures/dolerite_eater_tex.png"), 0.4375F, DoleriteEater.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsDungeonMob.UnderworldDiggerModel(), new ResourceLocation("arpg:textures/underworld_digger_model_tex.png"), 0.55F, UnderworldDigger.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsDungeonMob.UnderworldSymbioteModel(), new ResourceLocation("arpg:textures/underworld_symbiote_model_tex.png"), 0.25F, UnderworldSymbiote.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsDungeonMob.LarvaModel(), new ResourceLocation("arpg:textures/larva_model_tex.png"), 0.2F, Larva.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsDungeonMob.LarvaFlyerModel(), new ResourceLocation("arpg:textures/larva_flyer_model_tex.png"), 0.5F, LarvaFlyer.class));
        AbstractMob.addToRender(new AbstractMob.RenderAbstractMobEntry(new ModelsDungeonMob.ShadowMageModel(), new ResourceLocation("arpg:textures/shadow_mage_model_tex.png"), 0.3F, ShadowMage.class));
    }
    ...
    public static class Beholder extends AbstractMob {
        ...
        public Beholder(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.EREBRIS_SHARD, 0.65F, 0, 1, 4, 0), new MobDrop(ItemsRegister.EYE_OF_BEHOLDER, 0.1F, 0, 1, 1, 0), new MobDrop(ItemsRegister.PALE_MEAT_RAW, 0.9F, 0, 0, 2, 3)});
            ...
            if (this.isEntityAlive()) {
                for (Entity entit : GetMOP.getEntitiesInAABBof(this.world, this, 3.0, this)) {
                    if (Team.checkIsOpponent(this, entit)) {
                        Weapons.dealDamage(new WeaponDamage(null, this, null, false, false, this, WeaponDamage.electric), (float) this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).getAttributeValue() + this.getMobDifficulty() * 0.5F, this, entit, true, 0.7F, this.posX, this.posY, this.posZ);
        ...
        public void onUpdate() {
            ...
            if (this.isEntityAlive() && this.lazerTimer > 0) {
                ...
                if (this.world.isRemote) {
                    this.spawnBetwParticle(this.getPositionEyes(1.0F).add(this.getVectorForRotation(0.0F, this.rotationYaw).scale(this.width / 2.2F)), vec);
                } else {
                    for (Entity entity : GetMOP.getEntitiesInAABBof(this.world, vec, 1.0, this)) {
                        if (Team.checkIsOpponent(this, entity)) {
                            Weapons.dealDamage(new WeaponDamage(null, this, null, false, false, this.getPositionEyes(1.0F), WeaponDamage.laser), 3.0F, this, entity, false);
        ...
        public void spawnBetwParticle(Vec3d from, Vec3d to) {
            if (from.lengthSquared() > 1.0E-6 && to.lengthSquared() > 1.0E-6) {
                BetweenParticle laser = new BetweenParticle(this.world, shard_trace, 0.13F, 240, 0.95F, 1.0F, 0.45F, 0.15F, from.distanceTo(to), 3, 0.5F, 4.0F, from, to);
                ...
                for (int ss = 0; ss < 2; ss++) {
                    ...
                    GUNParticle part = new GUNParticle(magic_effect_3, scl, -0.008F, lt, 240, this.world, to.x, to.y, to.z, (float) this.rand.nextGaussian() / 35.0F, (float) this.rand.nextGaussian() / 35.0F, (float) this.rand.nextGaussian() / 35.0F, 1.0F - this.rand.nextFloat() * 0.1F, 1.0F - this.rand.nextFloat() * 0.1F, 1.0F - this.rand.nextFloat() * 0.1F, true, this.rand.nextInt(15) - 14);
                ...
                GUNParticle part = new GUNParticle(magic_effect_2, 0.05F, 0.0F, lt, 240, this.world, to.x, to.y, to.z, 0.0F, 0.0F, 0.0F, 0.95F - this.rand.nextFloat() * 0.1F, 1.0F - this.rand.nextFloat() * 0.1F, 0.5F, true, this.rand.nextInt(360));
                part.alphaGlowing = true;
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 12) {
                this.lazerTimer = this.maxlazerTime;
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.beholder_shoot, SoundCategory.HOSTILE, 1.8F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 13) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.beholder_attack, SoundCategory.HOSTILE, 1.3F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id <= -10 && id >= -21) {
                for (int i = 0; i < 5; i++) {
                    Vec3d vecadd = new Vec3d(this.rand.nextGaussian(), this.rand.nextGaussian() / 6.0, this.rand.nextGaussian()).normalize().scale(0.8 + (-id - 10) / 5.0);
                    GUNParticle part = new GUNParticle(lightning1, 0.6F + this.rand.nextFloat() / 3.0F, 0.0F, 3, 240, this.world, this.posX + vecadd.x, this.posY + 0.3 + vecadd.y, this.posZ + vecadd.z, 0.0F, 0.0F, 0.0F, 0.6F + this.rand.nextFloat() / 10.0F, 1.0F, 1.0F, true, this.rand.nextInt(360));
                    part.alphaGlowing = true;
    ...
    public static class Deg extends AbstractMob {
        ...
        public Deg(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.EREBRIS_SHARD, 0.25F, 0, 1, 1, 0), new MobDrop(ItemsRegister.PALE_MEAT_RAW, 0.8F, 0, 0, 2, 3)});
    ...
    public static class Devourer extends AbstractMob implements ISynchronizedEntity {
        ...
        public Devourer(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.EREBRIS_SHARD, 0.65F, 0, 1, 4, 0), new MobDrop(ItemsRegister.DEVOURERS_TEETH, 0.05F, 0, 1, 1, 0), new MobDrop(ItemsRegister.PALE_MEAT_RAW, 1.0F, 0, 1, 3, 4)});
        ...
        public boolean attackEntityFrom(DamageSource source, float amount) {
            ...
            if (amount > 0.0F && this.resistanceDelay <= 0 && !this.world.isRemote) {
                Weapons.mixPotion(this, MobEffects.RESISTANCE, 130.0F, 1.0F, Weapons.EnumPotionMix.WITH_MAXIMUM, Weapons.EnumPotionMix.WITH_MAXIMUM, Weapons.EnumMathOperation.NONE, Weapons.EnumMathOperation.PLUS, 130, 5);
                Weapons.mixPotion(this, PotionEffects.TENACITY, 260.0F, 1.0F, Weapons.EnumPotionMix.WITH_MAXIMUM, Weapons.EnumPotionMix.WITH_MAXIMUM, Weapons.EnumMathOperation.NONE, Weapons.EnumMathOperation.PLUS, 260, 4);
                ...
                if (this.animations[0] == 77) {
                    ...
                    if (res != null && res.getBlockPos() != null && res.hitVec != null) {
                        ...
                        if (state.getMaterial() != Material.AIR) {
                            ISynchronizedEntity.sendSynchronize(this, 64.0, res.hitVec.x, res.hitVec.y, res.hitVec.z, Block.getStateId(state), 1.0, 0.0);
                        }
                    }
                }
                ...
                if (this.tailattackTimer > 0) {
                    ...
                    if (this.tailattackTimer == 0) {
                        ...
                        for (Entity entit : GetMOP.getEntitiesInAABBof(this.world, posTail, 2.8, this)) {
                            if (Team.checkIsOpponent(this, entit)) {
                                Weapons.dealDamage(new WeaponDamage(null, this, null, false, false, posTail, WeaponDamage.heavymelee), (float) this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).getAttributeValue(), this, entit, true, 1.8F, posTail.x, posTail.y - 1.0, posTail.z);
                            }
                        }

                        RayTraceResult res = this.world.rayTraceBlocks(posTail.add(0.0, this.height, 0.0), posTail.add(0.0, -3.0, 0.0));
                        if (res != null && res.getBlockPos() != null && res.hitVec != null) {
                            IBlockState state = this.world.getBlockState(res.getBlockPos());
                            if (state.getMaterial() != Material.AIR) {
                                ISynchronizedEntity.sendSynchronize(this, 64.0, res.hitVec.x, res.hitVec.y, res.hitVec.z, Block.getStateId(state), 0.0, 0.0);
                            }
                        }
                    }
        ...
        public void onClient(double x, double y, double z, double a, double b, double c) {
            ...
            for (int i = 0; i < 126; i++) {
                this.world.spawnParticle(EnumParticleTypes.BLOCK_DUST, x, y + 0.1, z, this.rand.nextGaussian() / 2.5, this.rand.nextGaussian() / 4.0, this.rand.nextGaussian() / 2.5, new int[]{(int) a});
            }

            for (int i = 0; i < 20; i++) {
                this.world.spawnParticle(EnumParticleTypes.CLOUD, x, y + 0.1, z, this.rand.nextGaussian() / 5.0, this.rand.nextGaussian() / 8.0, this.rand.nextGaussian() / 5.0, new int[0]);
            }
        }
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 9) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.item_misc_d, SoundCategory.HOSTILE, 0.8F, 0.6F + this.rand.nextFloat() / 5.0F, false);
                this.hurtTime = 0;
            }
        }
    ...
    public static class LarvaFlyer extends AbstractMob {
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 12) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.larva_flyer_breed, SoundCategory.HOSTILE, 1.8F, 0.95F + this.rand.nextFloat() / 10.0F, false);
            }

            if (id == 11) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.larva_flyer_attack, SoundCategory.HOSTILE, 1.8F, 0.95F + this.rand.nextFloat() / 10.0F, false);
            }
        }
    ...
    public static class ShadowMage extends AbstractMob implements ISynchronizedEntity {
        ...
        public static ParticleTracker.TrackerSmoothShowHideBetweenP ssh = new ParticleTracker.TrackerSmoothShowHideBetweenP(new Vec3d[]{new Vec3d(0.0, 4.0, 0.25), new Vec3d(6.0, 13.0, -0.14285715F)}, null);
            ...
            if (!this.world.isRemote && !this.isAIDisabled()) {
                ...
                if (target != null) {
                    if (this.canUseShield) {
                        boolean shouldStartCastShield = this.shieldHP <= 0.0F || this.getHealth() <= this.getMaxHealth() * 0.5F && this.shieldHP < shieldHPMax * 0.6F;
                    ...
                    if (this.spellCasting > 0) {
                        ...
                        if (canCastCrystals && this.spellCooldown <= 0) {
                            ...
                            for (int i = 0; i < smax; i++) {
                                Vec3d randomvec = new Vec3d(this.rand.nextGaussian(), 0.0, this.rand.nextGaussian()).normalize().scale(5.0F + this.rand.nextFloat() * 3.0F);
                                GetMOP.BlockTraceResult result = GetMOP.blockTrace(this.world, new BlockPos(speedAdded.add(randomvec)).up(3), EnumFacing.DOWN, 10, null);
                                if (result != null) {
                                    this.spellPoses.add(new Vec3d(result.prevPos.getX() + 0.5, result.prevPos.getY() + 0.2, result.prevPos.getZ() + 0.5));
                                } else {
        ...
        public void spawnCrystalSpell(Vec3d pos, boolean phase2) {
            if (phase2) {
                ...
                for (int i = 0; i < 7; i++) {
                    Vec3d posAdd = new Vec3d(this.rand.nextFloat() - 0.5, 0.0, this.rand.nextFloat() - 0.5).normalize().scale(spellRadius * this.rand.nextFloat());
                    Vec3d poss = new Vec3d(pos.x + posAdd.x, pos.y + posAdd.y + 0.1F, pos.z + posAdd.z);
                ...
                for (Entity entity : this.world.getEntitiesWithinAABBExcludingEntity(this, new AxisAlignedBB(pos.x - spellRadius, pos.y - 2.0, pos.z - spellRadius, pos.x + spellRadius, pos.y + yy, pos.z + spellRadius))) {
                    if (GetMOP.flatDistance(entity.getPositionVector(), pos) <= spellRadius + entity.width / 2.0F && Team.checkIsOpponent(this, entity)) {
                        Weapons.dealDamage(new WeaponDamage(null, this, null, false, false, null, WeaponDamage.magic), (float) this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).getAttributeValue(), this, entity, true);
        ...
        public void onClient(double... args) {
            if (args.length == 3) {
                ...
                for (int i = 0; i < 6; i++) {
                    Vec3d posAdd = new Vec3d(this.rand.nextFloat() - 0.5, 0.0, this.rand.nextFloat() - 0.5).normalize().scale(spellRadius);
            ...
            if (args.length == 4) {
                if (args[3] == -999.0) {
                    this.world.playSound(args[0], args[1], args[2], Sounds.shadow_mage_cast, SoundCategory.HOSTILE, 1.0F, 0.9F + this.rand.nextFloat() / 5.0F, false);
                } else {
                    Vec3d posCenter = new Vec3d(args[0], args[1], args[2]);

                    for (int i = 0; i < 7; i++) {
                        Vec3d posAdd1 = new Vec3d(this.rand.nextFloat() - 0.5, 0.0, this.rand.nextFloat() - 0.5).normalize().scale(spellRadius * this.rand.nextFloat());
                        Vec3d posAdd2 = new Vec3d(this.rand.nextFloat() - 0.5, 0.0, this.rand.nextFloat() - 0.5).normalize().scale(spellRadius * this.rand.nextFloat()).add(0.0, args[3], 0.0);
                        double dist = posAdd1.distanceTo(posAdd2);
                        Vec3d pos1 = posCenter.add(posAdd1);
                        BetweenParticle particle = new BetweenParticle(this.world, generic_beam6, 0.4F, 240, 0.8F, 0.28F, 0.55F, 0.0F, dist, 13, 0.0F, 9000.0F, pos1, posCenter.add(posAdd2));
        ...
        public void handleStatusUpdate(byte id) {
            super.handleStatusUpdate(id);
            if (id == 11) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.shadow_mage_prepare, SoundCategory.HOSTILE, 1.6F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }

            if (id == 12) {
                this.shieldHP = 10.0F;
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.shadow_mage_cast, SoundCategory.HOSTILE, 1.4F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            }
    ...
    public static class UnderworldDigger extends AbstractWorm {
        ...
        public UnderworldDigger(World world, boolean isSegment, int number, AbstractWorm headEntity) {
            ...
            if (!this.isSubMob) {
                this.registerLOOT(new MobDrop[]{new MobDrop(ItemsRegister.EREBRIS_SHARD, 1.0F, 0, 1, 5, 0), new MobDrop(ItemsRegister.EREBRIS_FRAGMENT, 0.75F, 0, 1, 2, 0)});
        ...
        @Override
        public boolean attackEntityFrom(DamageSource source, float amount) {
            if ((source != DamageSource.OUT_OF_WORLD || this.world.getBlockState(this.getPosition()).getCollisionBoundingBox(this.world, this.getPosition()) == null) && amount > 0.0F && !this.world.isRemote) {
                List<UnderworldSymbiote> list = this.world.getEntitiesWithinAABB(UnderworldSymbiote.class, GetMOP.newAABB(this, 64.0));
        ...
        public void handleStatusUpdate(byte id) {
            ...
            if (id == 7) {
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.slimeshoot_a, SoundCategory.HOSTILE, 1.2F, 0.9F + this.rand.nextFloat() / 5.0F, false);

                for (int ss = 0; ss < 6; ss++) {
                    GUNParticle bubble = new GUNParticle(slime, 0.6F + this.rand.nextFloat() / 3.0F, -0.001F, 10 + this.rand.nextInt(10), -1, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 19.0F, (float) this.rand.nextGaussian() / 22.0F + 0.05F, (float) this.rand.nextGaussian() / 19.0F, 0.77F + (float) this.rand.nextGaussian() / 10.0F, 0.68F + (float) this.rand.nextGaussian() / 10.0F, 0.53F + (float) this.rand.nextGaussian() / 10.0F, true, this.rand.nextInt(180));
    ...
    public static class Weaver extends AbstractGlyphid {
        ...
        public Weaver(World world) {
            ...
            this.registerLOOT(new MobDrop[]{new MobDrop(Items.STRING, 0.8F, 0, 1, 2, 2), new MobDrop(Items.SPIDER_EYE, 0.5F, 0, 1, 2, 2), new MobDrop(ItemsRegister.EREBRIS_SHARD, 0.45F, 0, 0, 2, 0), new MobDrop(ItemsRegister.WEB_GRAPLING_HOOK, 0.03F, 0, 1, 1, 0)});
            this.setRoleValues(EnumMobRole.SOLDIER, 4);
            this.soul = Soul.SHADOW;
        }
        ...
        public void handleStatusUpdate(byte id) {
            if (id == 7) {
                for (int i = 0; i < 5; i++) {
                    ...
                    this.world.spawnParticle(EnumParticleTypes.CLOUD, this.posX + this.rand.nextFloat() * this.width * 2.0F - this.width, this.posY + 0.5 + this.rand.nextFloat() * this.height, this.posZ + this.rand.nextFloat() * this.width * 2.0F - this.width, d0, d1, d2, new int[0]);
