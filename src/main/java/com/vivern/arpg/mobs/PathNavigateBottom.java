...
public class PathNavigateBottom extends PathNavigate {
    ...
    public Path getPathToPos(BlockPos pos) {
        if (this.world.getBlockState(pos).getMaterial() == Material.WATER) {
            ...
            while (blockpos.getY() < this.world.getHeight() && this.world.getBlockState(blockpos).getMaterial() == Material.WATER) {
    ...
    public class BottomNodeProcessor extends WalkNodeProcessor {
        ...
        public PathPoint getStart() {
            ...
            if (this.getCanSwim() && this.entity.isInWater()) {
                ...
                while (this.blockaccess.getBlockState(blockpos).getMaterial() == Material.WATER && this.blockaccess.getBlockState(blockpos).getBlock().isPassable(this.blockaccess, blockpos) && blockpos.getY() > 0) {
                    blockpos = blockpos.down();
                }
