...
public class PacketBaublesNbtToClients extends Packet {
    ...
    public static void send(EntityPlayer player, double distance, int nbtTypeId, char name, float value, Weapons.EnumMathOperation mathOperation, int baublesSlot) {
            ...
            if (entity instanceof EntityPlayer) {
                ...
                if (!itemStack.isEmpty()) {
                    ...
                    if (this.nbtTypeId == 6) {
                        ...
                        stackNbt.setDouble(this.name, this.mathOperation.apply(oldValue, this.value));
                    }
                }
            }
        }
