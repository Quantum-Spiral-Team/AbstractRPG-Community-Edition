...
public class MapGenRavineAquatica extends MapGenRavine {
    ...
    protected void digBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ, boolean foundTop) {
        ...
        if (biome != BiomesRegister.SEAWEED_BAY) {
            ...
            if (state.getBlock() == AquaticaChunkGenerator.STONE.getBlock() || state.getBlock() == AquaticaChunkGenerator.STONE2.getBlock() || state.getBlock() == top.getBlock() || state.getBlock() == filler.getBlock()) {
                if (y - 1 < 7) {
