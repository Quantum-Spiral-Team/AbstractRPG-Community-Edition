...
public class AquaticaChunkGenerator implements IChunkGenerator {
    ...
    public static WorldGenMinable cavegeneratorSeastone = new WorldGenMinable(BlocksRegister.SEA_STONE.getDefaultState(), 24, BlockMatcher.forBlock(BlocksRegister.SHELLROCK));
    public static WorldGenMinable cavegeneratorChalkrock = new WorldGenMinable(BlocksRegister.CHALKROCK.getDefaultState(), 24, BlockMatcher.forBlock(BlocksRegister.SHELLROCK));
    ...
    double[] depthRegion;
    public static Block[] corals = new Block[]{BlocksRegister.CORAL_YELLOW, BlocksRegister.CORAL_PINK, BlocksRegister.CORAL_WHITE, BlocksRegister.CORAL_ORANGE, BlocksRegister.CORAL_RED};
    public static Block[] coralsMini = new Block[]{BlocksRegister.HELIOPORACEA, BlocksRegister.GORGONARIA_BROWN, BlocksRegister.ACROPORA_PURPLE, BlocksRegister.GORGONARIA_RED, BlocksRegister.ACROPORA_WHITE, BlocksRegister.GORGONARIA_WHITE, BlocksRegister.GORGONARIA_WHITE};
    public static Block[] coralsFavia = new Block[]{BlocksRegister.FAVIA_BLUE, BlocksRegister.FAVIA_GREEN, BlocksRegister.FAVIA_RED, BlocksRegister.FAVIA_YELLOW, BlocksRegister.FAVIA_BRAIN};
    public static Block[] corallimorphas = new Block[]{BlocksRegister.CORALLIMORPHA_BLUE, BlocksRegister.CORALLIMORPHA_BROWN, BlocksRegister.CORALLIMORPHA_GREEN, BlocksRegister.CORALLIMORPHA_LILAC, BlocksRegister.CORALLIMORPHA_PINK, BlocksRegister.CORALLIMORPHA_RED, BlocksRegister.CORALLIMORPHA_YELLOW};
    public static Block[] coralsBig = new Block[]{BlocksRegister.GORGONARIA_BROWN_BIG, BlocksRegister.ACROPORA_PURPLE_BIG, BlocksRegister.GORGONARIA_RED_BIG, BlocksRegister.GORGONARIA_WHITE_BIG, BlocksRegister.ACROPORA_WHITE_BIG};
    public static Block[] coralsGlow = new Block[]{BlocksRegister.ACTINIFORA_RAMIFORM, BlocksRegister.ACTINIFORA_SEGREGATE, BlocksRegister.ACTINIFORA_ARENACEOUS, BlocksRegister.ACTINIFORA_GIANT, BlocksRegister.ACTINIFORA_BRIGHT};
    ...
    public static boolean[][] ccallrules = new boolean[][]{{true, false, true, true, true, false, false, true, false, false, false, true, false, true, false, true, true, true}, {true, false, true, false, true, false, false, true, false, false, false, true, false, true, false, true, true, true}, {true, true, true, false, true, false, false, true, false, false, false, true, false, true, false, true, true, false}, {true, true, true, false, true, false, true, true, false, false, false, true, false, true, false, true, true, false}, {true, true, true, false, true, false, true, true, false, false, false, true, false, true, false, true, true, true}, {true, false, true, false, true, false, true, true, false, false, false, true, false, true, false, true, true, false}, {true, false, true, false, true, false, false, true, false, false, false, true, false, true, false, true, true, false}, {false, false, false, false, true, false, false, true, false, false, false, true, false, true, false, true, false, false}, {false, false, false, false, true, false, true, true, false, false, false, true, false, true, false, true, false, false}, {false, false, false, false, true, false, true, true, false, false, false, true, false, true, false, true, true, false}};
    ...
    public void populate(int x, int z) {
        ...
        if (biome != BiomesRegister.ISLANDS && biome != BiomesRegister.AQUATICABEACH && biome != BiomesRegister.SHALLOW && this.settings.useWaterLakes && !flag && this.rand.nextInt(this.settings.waterLakeChance) == 0 && TerrainGen.populate(this, this.world, this.rand, x, z, flag, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.LAKE)) {
        ...
        if (!flag && this.rand.nextInt(this.settings.lavaLakeChance / 10) == 0 && this.settings.useLavaLakes && TerrainGen.populate(this, this.world, this.rand, x, z, flag, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.LAVA)) {
        ...
        if (this.settings.useDungeons && TerrainGen.populate(this, this.world, this.rand, x, z, flag, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.DUNGEON)) {
        ...
        if (hasJellyfishCaveAtChunk(x, z, this.world)) {
            GetMOP.BlockTraceResult result = GetMOP.blockTrace(this.world, new BlockPos(i, 0, j).add(this.rand.nextInt(16) + 8, sealvl, this.rand.nextInt(16) + 8), EnumFacing.DOWN, sealvl - 32, GetMOP.SOLID_BLOCKS);
            if (result != null) {
                ...
                generateJellyfishCave(this.world, result.pos, this.rand, 5, 9, 74, new Vec3d(this.rand.nextFloat() - 0.5F, -0.4F, this.rand.nextFloat() - 0.5F).normalize(), c, mc, cr.getDefaultState());
            }
        }

        if (hasSunkenTownAtChunk(x, z, this.world)) {
            GetMOP.BlockTraceResult result = GetMOP.blockTrace(this.world, new BlockPos(i, 0, j).add(this.rand.nextInt(16) + 8, sealvl - 16, this.rand.nextInt(16) + 8), EnumFacing.DOWN, sealvl - 32, GetMOP.SOLID_BLOCKS);
            if (result != null) {
        ...
        if (hasSirenSanctuaryAtChunk(x, z, this.world)) {
            GetMOP.BlockTraceResult result = GetMOP.blockTrace(this.world, new BlockPos(i, 0, j).add(this.rand.nextInt(16) + 8, 250, this.rand.nextInt(16) + 8), EnumFacing.DOWN, 250 - sealvl + 2, state -> state.getMaterial().isLiquid() || GetMOP.SOLID_BLOCKS.apply(state));
            if (result != null) {
        ...
        if (TerrainGen.populate(this, this.world, this.rand, x, z, flag, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.ICE)) {
            for (int k2 = 0; k2 < 16; k2++) {
                for (int j3 = 0; j3 < 16; j3++) {
                    ...
                    boolean isIslandBiome = biome == BiomesRegister.AQUATICABEACH || biome == BiomesRegister.ISLAND_RIVER || biome == BiomesRegister.ISLANDS || biome == BiomesRegister.ISLANDHILLS;
                    ...
                    for (int rr = 7; rr < bheight; rr++) {
                        ...
                        if (fstate.isOpaqueCube()) {
                            ...
                            if (prevBlocksSolid >= 2) {
                                ...
                                if ((!isIslandBiome || this.rand.nextFloat() < 0.04) && this.terrainControlNoise.getValue(xx / 7.1, zz / 7.1) > 0.5) {
                                    ...
                                    if (this.rand.nextFloat() < 0.35 && (biome == BiomesRegister.SEAWEED_BAY || this.caveNoise1.getValue(xx / 5.1, zz / 5.1) > 0.65) && var90 == 1) {
                                    ...
                                    if (this.caveNoise2.getValue(xx / 7.1, zz / 7.1) > 0.5) {
                                        ...
                                        this.world.setBlockState(finalpos, BlocksRegister.GIANT_SHELL.getDefaultState().withProperty(GiantShell.TYPE, this.rand.nextInt(8)).withProperty(GiantShell.WET, wetfinalpos == 1), 2);
                                    }
                        ...
                        if (isCoralsColumn && (this.noisegenerator3dbiomes.getValue(xx / 25.1, rr / 25.1, zz / 25.1) + 2.0) * noiseCoralsMult > (this.rand.nextFloat() + this.rand.nextFloat()) * 8.0F && fstate.getMaterial() == Material.WATER) {
                            EnumFacing fac = this.getRandomFacing(this.world, this.rand, finalpos);
                            if (fac != null) {
                                if (this.rand.nextFloat() < 0.75) {
                                    this.world.setBlockState(finalpos, coralsMini[this.rand.nextInt(7)].getDefaultState().withProperty(MiniCoral.FACING, fac).withProperty(MiniCoral.WET, true), 2);
                                } else if (this.rand.nextFloat() < 0.6) {
                                    this.world.setBlockState(finalpos, coralsBig[this.rand.nextInt(5)].getDefaultState().withProperty(MiniCoral.FACING, fac).withProperty(MiniCoral.WET, true), 2);
                                } else {
                                    this.world.setBlockState(finalpos, coralsGlow[this.rand.nextInt(5)].getDefaultState().withProperty(MiniCoral.FACING, fac).withProperty(MiniCoral.WET, true), 2);
                                }
                            }
                        }
    ...
    public static int[][] getStickPosition(World world, int x, int z, Random rand, int stickType) {
        if (stickType == 0) {
            ...
            int xr = rand.nextInt(3) - 1;
            int zr = rand.nextInt(3) - 1;
            return new int[][]{{x, z}, {x + xr, z}, {x, z + zr}, {x + xr, z + zr}, {x + rand.nextInt(3) - 1, z + rand.nextInt(3) - 1}, {x + rand.nextInt(3) - 1, z + rand.nextInt(3) - 1}};
        } else {
            return new int[][]{{x, z}};
        }
    }

    public static void genFlatCoral(World world, int x, int y, int z, Random rand, int range, int stickSize, int stickSizeVar, int displace, float noiseFilling, int smooth, int maxLength) {
    ...
    public static void genRecursiveCoral(World world, int x, int y, int z, Random rand, int[] maxCountStorage, int branchLength, IBlockState block, IBlockState blockTop, int yMax) {
    ...
    public static void genRecursiveCoral(World world, int x, int y, int z, Random rand, int maxCount, int branchLength, IBlockState block, IBlockState blockTop, int yMax) {
        int[] storage = new int[]{maxCount};
    ...
    public static boolean isCoral(IBlockState state) {
        ...
        return block == BlocksRegister.CORAL_ORANGE || block == BlocksRegister.CORAL_RED || block == BlocksRegister.CORAL_PINK || block == BlocksRegister.CORAL_WHITE || block == BlocksRegister.CORAL_YELLOW;
    }
    ...
    public static void generateJellyfishCave(World world, BlockPos pos, Random rand, int radiusMin, int radiusMax, int lenght, Vec3d caveDirection, WorldGenerator coralGenerator, WorldGenerator minicoralGenerator, IBlockState wallsCoral) {
        ...
        for (int i = 0; i < lenght; i++) {
            ...
            caveDirection = caveDirection.add(rand.nextInt(4) - rand.nextInt(4), rand.nextInt(3) - rand.nextInt(4), rand.nextInt(4) - rand.nextInt(4)).normalize().scale(scaleFactor);
            pos = pos.add(caveDirection.x, caveDirection.y, caveDirection.z);
            if (pos.getY() < 9 + radius) {
                pos = new BlockPos(pos.getX() + caveDirection.x * rand.nextFloat(), 8 + radius + rand.nextInt(3), pos.getZ() + caveDirection.z * rand.nextFloat());
            }
        ...
        for (int i = 0; i < listCenters.size(); i++) {
            ...
            if (i == listCenters.size() - 1) {
                GenerationHelper.setChestWithLoot(world, centerpos.down(4), EnumChest.CORAL, ListLootTable.CHESTS_JELLYFISH_CAVE_FINAL, EnumFacing.HORIZONTALS[rand.nextInt(4)]);
                ...
                GenerationHelper.setChestWithLoot(world, centerpos.down(5), EnumChest.SUNKEN, ListLootTable.CHESTS_JELLYFISH_CAVE, EnumFacing.HORIZONTALS[rand.nextInt(4)]);
    ...
    public static void generateSunkenChest(World world, BlockPos pos, Random rand, boolean inStromatoliteBiome) {
        ...
        if (rand.nextFloat() < (biome == BiomesRegister.SEA_BOTTOM ? 0.05 : 0.2) && biome != BiomesRegister.SHALLOW && biome != BiomesRegister.AQUATICABEACH && biome != BiomesRegister.ISLANDS && biome != BiomesRegister.ISLANDHILLS) {
            if (inStromatoliteBiome) {
                ...
                GetMOP.BlockTraceResult result = GetMOP.blockTrace(world, pos.add(rand.nextInt(16) + 8, sealvl, rand.nextInt(16) + 8), EnumFacing.DOWN, sealvl - 32, GetMOP.SOLID_BLOCKS);
                if (result != null) {
        ...
        if (chestSet != null) {
            if (rand.nextFloat() < 0.25F) {
                ...
                if (!poses.isEmpty()) {
                    GenerationHelper.setChestWithMap(world, chestSet, EnumChest.SUNKEN, poses.get(rand.nextInt(poses.size())), EnumFacing.HORIZONTALS[rand.nextInt(4)]);
                }
            } else {
    ...
    public static boolean hasJellyfishCaveAtChunk(int x, int z, World world) {
        ...
        if (biome != BiomesRegister.AQUATICABEACH && biome != BiomesRegister.ISLANDS && biome != BiomesRegister.ISLANDHILLS && biome != BiomesRegister.ISLAND_RIVER) {
    ...
    public static boolean hasSunkenTownAtChunk(int x, int z, World world) {
        ...
        BlockPos blockpos = new BlockPos(i, 0, j);
        Biome biome = world.getBiome(blockpos);
        if (biome != BiomesRegister.AQUATICABEACH && biome != BiomesRegister.ISLANDS && biome != BiomesRegister.ISLANDHILLS && biome != BiomesRegister.ISLAND_RIVER && biome != BiomesRegister.SHALLOW) {
