...
public class GenLayerBiomeStormledge extends GenLayer {
    ...
    private Biome[] allowedBiomes = new Biome[]{BiomesRegister.ELECTROFERN_WASTELANDS, BiomesRegister.ELECTROFERN_GROVE, BiomesRegister.ELECTROFERN_GROVE, BiomesRegister.SKY_ISLANDS, BiomesRegister.SKY_ISLANDS, BiomesRegister.SKY_ISLANDS, BiomesRegister.ARTHROHELIA_ISLANDS, BiomesRegister.ARTHROHELIA_ISLANDS, BiomesRegister.CRYSTALLIZED_SKY_ISLANDS, BiomesRegister.CRYSTALLIZED_SKY_ISLANDS};
