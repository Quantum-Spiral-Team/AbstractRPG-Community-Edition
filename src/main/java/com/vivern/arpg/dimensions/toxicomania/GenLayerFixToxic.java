...
public class GenLayerFixToxic {
    ...
    public static GenLayer[] initializeAllBiomeGenerators(long seed) {
        ...
        genlayer = new GenLayerBiomeCustomEdgeRand(1L, genlayer, Biomes.OCEAN, BiomesRegister.TOXIC_JUNGLE, BiomesRegister.TOXIC_JUNGLE, 50);
        genlayer = new GenLayerBiomeCustomEdgeRand(1L, genlayer, Biomes.OCEAN, BiomesRegister.TOXIC_JUNGLE, BiomesRegister.TOXIC_JUNGLE, 20);
        genlayer = new GenLayerBiomeCustomEdgeRand(1L, genlayer, Biomes.OCEAN, BiomesRegister.TOXIC_JUNGLE, BiomesRegister.TOXIC_FLOWER_ISLAND, 70);
        genlayer = new GenLayerFixAquatica.GenLayerRandomArrayPoint(1L, genlayer, Biomes.PLAINS, new Biome[]{BiomesRegister.TOXIC_MOUNTAINS, BiomesRegister.TOXIC_SLIME_LAND, BiomesRegister.TOXIC_SWAMP}, 2);
        genlayer = new GenLayerBiomeCustomEdgeRand(1L, genlayer, Biomes.PLAINS, BiomesRegister.TOXIC_SLIME_LAND, BiomesRegister.TOXIC_SLIME_LAND, 70);
        genlayer = new GenLayerBiomeCustomEdgeRand(1L, genlayer, Biomes.PLAINS, BiomesRegister.TOXIC_SWAMP, BiomesRegister.TOXIC_SWAMP, 80);
        genlayer = new GenLayerZoom(2001L, genlayer);
        genlayer = new GenLayerBiomeCustomEdgeRand(1L, genlayer, Biomes.PLAINS, BiomesRegister.TOXIC_MOUNTAINS, BiomesRegister.TOXIC_MOUNTAINS, 40);
        genlayer = new GenLayerFuzzyZoom(2000L, genlayer);
        ...
        public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight) {
            ...
            for (int i1 = 0; i1 < areaHeight; i1++) {
                for (int j1 = 0; j1 < areaWidth; j1++) {
                    ...
                    if (k2 == this.fromId && (k1 == this.neighborId || l1 == this.neighborId || i2 == this.neighborId || j2 == this.neighborId) && this.nextInt(100) < this.percentchance) {
