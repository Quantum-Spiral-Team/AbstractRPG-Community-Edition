...
public class GenLayerBiomeToxic extends GenLayer {
    ...
    private Biome[] allowedBiomes = new Biome[]{BiomesRegister.TOXIC_SLIME_LAND, BiomesRegister.TOXIC_JUNGLE, BiomesRegister.TOXIC_FLOWER_ISLAND, BiomesRegister.TOXIC_MOUNTAINS, BiomesRegister.TOXIC_SWAMP, BiomesRegister.TOXIC_PLAINS, Biomes.DEFAULT};
