...
public class ToxicomaniaCavesMapGen extends MapGenBase {
    ...
    protected boolean canReplaceBlock(IBlockState p_175793_1_, IBlockState p_175793_2_) {
        if (p_175793_1_.getBlock() == Blocks.STONE) {
            ...
            return p_175793_1_.getBlock() != BlocksRegister.FLUID_POISON && (p_175793_1_.getBlock() == Blocks.SAND || p_175793_1_.getBlock() == Blocks.GRAVEL) && p_175793_2_.getMaterial() != Material.WATER;
        }
    }
