...
public class BunkerGenerator {
    ...
    public static void generateGroup(World world, BunkerGenerator[][][] baseArray, int arraySizeXZ, int arraySizeY, int bunkerSize, Random rand, boolean needexit) {
                                ...
                                for (int i = 0; i < 4; i++) {
                                    if (gen.hasExitInSide(i)) {
                                        ...
                                        if (genLarge) {
                                            ...
                                            if (xx >= 1 && zz >= 1 && xx < arraySizeXZ - 1 && zz < arraySizeXZ - 1 && (y == arraySizeY - 1 || baseArray[xx][y + 1][zz] == null && baseArray[xx + 1][y + 1][zz] == null && baseArray[xx][y + 1][zz + 1] == null && baseArray[xx - 1][y + 1][zz] == null && baseArray[xx][y + 1][zz - 1] == null && baseArray[xx + 1][y + 1][zz + 1] == null && baseArray[xx - 1][y + 1][zz - 1] == null && baseArray[xx - 1][y + 1][zz + 1] == null && baseArray[xx + 1][y + 1][zz - 1] == null) && (baseArray[xx][y][zz] == null || baseArray[xx][y][zz].isNonStairs()) && (baseArray[xx + 1][y][zz] == null || baseArray[xx + 1][y][zz].isNonStairs()) && (baseArray[xx][y][zz + 1] == null || baseArray[xx][y][zz + 1].isNonStairs()) && (baseArray[xx - 1][y][zz] == null || baseArray[xx - 1][y][zz].isNonStairs()) && (baseArray[xx][y][zz - 1] == null || baseArray[xx][y][zz - 1].isNonStairs()) && baseArray[xx + 1][y][zz + 1] == null && baseArray[xx - 1][y][zz - 1] == null && baseArray[xx - 1][y][zz + 1] == null && baseArray[xx + 1][y][zz - 1] == null) {
                    ...
                    if (array[x][y][z] != null) {
                        ...
                        if (gen.structBaseConfiguration != 0 && !gen.empty) {
                            if (gen.structBaseConfiguration == 15) {
                                ...
                                placeStruct(world, basePos.add(x * 11, y * ymult, z * 11), rand, rand.nextFloat() < 0.5 ? ":bunker_small_4" : ":bunker_small_0", 5, 0, gen.rotation);
                                ...
                                placeStruct(world, basePos.add(x * 11 + 6, y * ymult, z * 11 + 6), rand, ":bunker_medium_" + (rand.nextInt(2) + 1), 11, 0, gen.rotation);
                                ...
                                placeStructLarge(world, basePos.add(x * 11, y * ymult, z * 11), rand, ":bunker_large_" + (rand.nextInt(2) + 1), 15, 0, gen.rotation);
            ...
            for (int y = 0; y < arraySizeY - 1; y++) {
                for (int z = 0; z < arraySizeXZ - 1; z++) {
                    if (array[x][y][z] == null && array[x + 1][y][z] == null && array[x][y][z + 1] == null && array[x + 1][y][z + 1] == null) {
                        ...
                        BunkerGenerator newgenerator = new BunkerGenerator();
                        boolean big = y == arraySizeY - 1 || array[x][y + 1][z] == null && array[x + 1][y + 1][z] == null && array[x][y + 1][z + 1] == null && array[x + 1][y + 1][z + 1] == null;
                        newgenerator.structBaseConfiguration = big ? configurationBig(rand) : configurationMedium(rand);
                        newgenerator.initSides();
                        boolean succ = false;
                        if ((!newgenerator.xminus || xminusm < exitsNeedOnSide) && (!newgenerator.xplus || xplusm < exitsNeedOnSide) && (!newgenerator.zminus || zminusm < exitsNeedOnSide) && (!newgenerator.zplus || zplusm < exitsNeedOnSide)) {
                            for (int r = 1; r < 4; r++) {
                                newgenerator.initSides();
                                newgenerator.rotateTo(r);
                                if (newgenerator.xminus && xminusm >= exitsNeedOnSide || newgenerator.xplus && xplusm >= exitsNeedOnSide || newgenerator.zminus && zminusm >= exitsNeedOnSide || newgenerator.zplus && zplusm >= exitsNeedOnSide) {
    ...
    public static void placeStructLarge(World worldIn, BlockPos pos, Random rand, String structure, int displace, int Yoffset, int rotation) {
        ...
        IBlockState column = rand.nextFloat() < 0.5F ? BlocksRegister.RUST_METAL.getDefaultState() : (rand.nextFloat() < 0.5F ? BlocksRegister.DARK_RUST_METALL.getDefaultState() : Blocks.STONE.getStateFromMeta(6));
