...
public class GenerationHelper {
    ...
    public static void placeStruct(World worldIn, BlockPos pos, Random rand, String structure, int displace, int Yoffset, int rotation, @Nullable ITemplateProcessor templateProcessor) {
    ...
    public static void placeStruct(WorldServer worldServer, WorldGenAdvanced worldIn, BlockPos pos, Random rand, String structure, int displace, int Yoffset, int rotation) {
    ...
    public static void generateSpeleothemsAtChunk(World world, BlockPos pos, Block blockstalact, Random rand, int startheight, float mainchance, float floorSmallThemsChance, float floorBigThemsChance) {
                ...
                if (rand.nextFloat() < mainchance) {
                    ...
                    for (int yy = startY; yy > 5; yy--) {
                        ...
                        if (state.getBlock() == Blocks.AIR) {
                            ...
                            if (state.isSideSolid(world, fpos, EnumFacing.UP) && stateup != null && (stateup.getBlock() == blockstalact || stateup.getBlock() == Blocks.AIR)) {
