...
public class WorldGenManaHealthFlowers implements IWorldGenerator {
    ...
    public static WorldGenGroundFoliage.WorldGenManaAndHealthFoliage healthFlowers = new WorldGenGroundFoliage.WorldGenManaAndHealthFoliage(BlocksRegister.HEALTH_FLOWER_LEAVES, 8, 2, 1);
    public static WorldGenGroundFoliage.WorldGenManaAndHealthFoliage manaFlowers = new WorldGenGroundFoliage.WorldGenManaAndHealthFoliage(BlocksRegister.MANA_FLOWER_LEAVES, 16, 3, 2);
