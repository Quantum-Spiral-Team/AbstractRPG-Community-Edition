...
public class CustomOreGenerator implements IWorldGenerator {
    ...
    public CustomOreGenerator(IBlockState oreState, int[] dimensions, Predicate<IBlockState> blocksToReplace, int blockAmountMin, int blockAmountMax, int chancesToSpawn, int minHeight, int maxHeight) {
    ...
    public CustomOreGenerator(IBlockState oreState, int dimension, Predicate<IBlockState> blocksToReplace, int blockAmountMin, int blockAmountMax, int chancesToSpawn, int minHeight, int maxHeight) {
        this.oreState = oreState;
