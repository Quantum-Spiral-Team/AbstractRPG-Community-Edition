...
public class ModuleScatter extends Module {
    ...
    public ModuleScatter(ModularStructureGenerator generator, int radiusX, int radiusZ, int height, int formType, int amountMin, int amountMax, boolean offsetFromSource) {
        super(generator);
