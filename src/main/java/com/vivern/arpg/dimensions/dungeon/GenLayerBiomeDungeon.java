...
public class GenLayerBiomeDungeon extends GenLayer {
    ...
    private Biome[] allowedBiomes = new Biome[]{BiomesRegister.CRYSTAL_CAVES, BiomesRegister.MAGIC_CRYSTAL_CAVES, BiomesRegister.CALCITE_CLEFTS, BiomesRegister.TUNNELS, BiomesRegister.ONYX_CAVES, BiomesRegister.GLOWING_TUNNELS};
