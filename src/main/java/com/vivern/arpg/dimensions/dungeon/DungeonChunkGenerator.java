...
public class DungeonChunkGenerator implements IChunkGenerator {
    ...
    public WorldGenAncientRuins wgAncientRuinsStone = new WorldGenAncientRuins(new IBlockState[]{Blocks.STONEBRICK.getDefaultState(), Blocks.STONEBRICK.getDefaultState(), Blocks.STONEBRICK.getStateFromMeta(1), Blocks.STONEBRICK.getStateFromMeta(2)}, null, Blocks.STONEBRICK.getStateFromMeta(3), Blocks.STONE_SLAB.getStateFromMeta(5), Blocks.COBBLESTONE.getDefaultState(), 15, 40, 1, 5, 2, 6, 3, 12);
    public WorldGenAncientRuins wgAncientRuinsCobble = new WorldGenAncientRuins(new IBlockState[]{Blocks.COBBLESTONE.getDefaultState(), Blocks.COBBLESTONE.getDefaultState(), Blocks.MOSSY_COBBLESTONE.getDefaultState(), Blocks.STONE.getStateFromMeta(5), Blocks.STONEBRICK.getStateFromMeta(2)}, null, Blocks.STONEBRICK.getStateFromMeta(3), Blocks.STONE_SLAB.getStateFromMeta(3), Blocks.STONE.getDefaultState(), 15, 30, 1, 4, 2, 5, 2, 6);
    public WorldGenAncientRuins wgAncientRuinsDolerite = new WorldGenAncientRuins(new IBlockState[]{BlocksRegister.DOLERITE_BRICKS.getDefaultState()}, BlocksRegister.DOLERITE_COLUMN.getDefaultState(), BlocksRegister.DOLERITE_COLUMN.getDefaultState(), BlocksRegister.DOLERITE_PILASTER.getDefaultState(), BlocksRegister.DOLERITE.getDefaultState(), 10, 45, 2, 6, 2, 6, 4, 16);
    ...
    public DungeonChunkGenerator(World worldIn, long seed) {
        ...
        this.adamantiumOreGen = new CustomOreGenerator(BlocksRegister.ADAMANTIUM_ORE.getDefaultState(), 102, BlockMatcher.forBlock(Blocks.STONE), 3, 8, 1, 6, 250);
        this.mithrilOreGen = new CustomOreGenerator(BlocksRegister.MITHRIL_ORE.getDefaultState(), 102, BlockMatcher.forBlock(Blocks.STONE), 2, 9, 1, 6, 250);
    ...
    public void populate(int x, int z) {
        ...
        if (biome != Biomes.DESERT && biome != Biomes.DESERT_HILLS && this.settings.useWaterLakes && this.rand.nextInt(this.settings.waterLakeChance) == 0 && TerrainGen.populate(this, this.world, this.rand, x, z, false, EventType.LAKE)) {
        }

        if (this.rand.nextInt(this.settings.lavaLakeChance / 10) == 0 && this.settings.useLavaLakes && TerrainGen.populate(this, this.world, this.rand, x, z, false, EventType.LAVA)) {
        }
        ...
        if (this.rand.nextFloat() < 0.2F) {
            ...
            if (value > 2.0) {
                ...
                for (int rr = 10; rr < height; rr++) {
                    ...
                    if (!this.world.isAirBlock(currentpos.down()) && this.world.isAirBlock(currentpos) && this.world.isBlockFullCube(currentpos.down())) {
                ...
                for (int j3 = 0; j3 < 16; j3++) {
                    ...
                    if (this.world.getBiome(blockpos2) == BiomesRegister.MAGIC_CRYSTAL_CAVES) {
                        ...
                        for (int rrxx = 1; rrxx < 255; rrxx++) {
                            if ((this.noisegenerator3dbiomes.getValue(xx / 25.1, rrxx / 25.1, zz / 25.1) + 1.0) * 2.0 > (this.rand.nextFloat() + this.rand.nextFloat()) * 8.0F) {
                                ...
                                if (this.world.isAirBlock(finalpos) && BlocksRegister.CAVE_CRYSTAL.canPlaceBlockAt(this.world, finalpos)) {
                                    this.world.setBlockState(finalpos, BlocksRegister.CAVE_CRYSTAL.getActualState(BlocksRegister.CAVE_CRYSTAL.getDefaultState().withProperty(CaveCrystal.TYPE, this.rand.nextInt(4)), this.world, finalpos));
                                }
                            }
                        }
                    }
                    ...
                    if (this.world.getBiome(blockpos2) == BiomesRegister.GLOWING_TUNNELS) {
                        ...
                        for (int rrxxx = 1; rrxxx < 255; rrxxx++) {
                            ...
                            if (this.world.getBlockState(finalpos).getMaterial() == Material.ROCK && GetMOP.collidesWithBlock(this.world, finalpos, Blocks.AIR)) {
                            ...
                            if ((this.noisegenerator3dbiomes.getValue(xx / 25.1, rrxxx / 25.1, zz / 25.1) + 1.0) * 2.0 > (this.rand.nextFloat() + this.rand.nextFloat()) * 9.0F && this.world.isAirBlock(finalpos) && BlocksRegister.GLOWING_CAVE_CRYSTAL.canPlaceBlockAt(this.world, finalpos)) {
                                this.world.setBlockState(finalpos, BlocksRegister.GLOWING_CAVE_CRYSTAL.getActualState(BlocksRegister.GLOWING_CAVE_CRYSTAL.getDefaultState().withProperty(GlowingCaveCrystal.TYPE, this.rand.nextInt(4)), this.world, finalpos));
                            }

                            if ((this.noisegenerator3d.getValue(xx / 20.1, rrxxx / 20.1, zz / 20.1) + 0.8) * 3.0 > (this.rand.nextFloat() + this.rand.nextFloat()) * 15.0F && this.world.isAirBlock(finalpos) && BlocksRegister.BLUE_GLOWING_MUSHROOM.canPlaceBlockAt(this.world, finalpos)) {
                    ...
                    if (this.world.getBiome(blockpos2) == BiomesRegister.CRYSTAL_CAVES) {
                        ...
                        for (int rrxxx = 1; rrxxx < 255; rrxxx++) {
                            if ((this.noisegenerator3dbiomes.getValue(xx / 25.1, rrxxx / 25.1, zz / 25.1) + 1.0) * 3.0 > (this.rand.nextFloat() + this.rand.nextFloat()) * 11.0F) {
                                ...
                                if (this.world.isAirBlock(finalposx) && BlocksRegister.SELENITE_CRYSTAL.canPlaceBlockAt(this.world, finalposx)) {
                                    this.world.setBlockState(finalposx, BlocksRegister.SELENITE_CRYSTAL.getActualState(BlocksRegister.SELENITE_CRYSTAL.getDefaultState().withProperty(SeleniteCrystal.TYPE, this.rand.nextInt(4)), this.world, finalposx));
                                }
                            }
                        }
                    }
                    ...
                    for (int rrxxxxx = 1; rrxxxxx < 255; rrxxxxx++) {
                        ...
                        if (this.world.getBlockState(finalposx).getBlock() == Blocks.ENDER_CHEST) {
                            GenerationHelper.setChestWithLoot(this.world, finalposx, EnumChest.ROTTEN, ListLootTable.CHESTS_DUNGEON_MINESHAFT, this.world.getBlockState(finalposx).getValue(BlockEnderChest.FACING));
                        }
                    }
                }
            }
    ...
    public void generateDeepRoadsCaves(World worldIn, Random random, BlockPos pos, int x, int z, int displace, int displaceheight, ChunkPrimer chunkprimer) {
        for (int ii = 0; ii < 16; ii++) {
            for (int ss = 0; ss < 16; ss++) {
                ...
                double value2 = MathHelper.clamp((this.perlin2.getValue((pos.getX() + ii + 8 + displaceheight) / 600.1, (pos.getZ() + ss + 8 + displaceheight) / 600.1) + 5.0) * 23.0, 15.0, 230.0);
    ...
    public int getWaterLvlInCaveRegion(int x, int z) {
        return MathHelper.clamp((int) Math.round((this.perlin4.getValue(DimensionDungeon.getCaveRegionXZCoord(x), DimensionDungeon.getCaveRegionXZCoord(z)) + 5.0) * 25.0), 2, 254);
    }

    public void generateDeepRoadsWaterCaves(World worldIn, Random random, BlockPos pos, int x, int z, int displace, int displaceheight, ChunkPrimer chunkprimer, Biome biome) {
        for (int ii = 0; ii < 16; ii++) {
            for (int ss = 0; ss < 16; ss++) {
                int fx = pos.getX() + ii + 8 + displace;
                int fz = pos.getZ() + ss + 8 + displace;
                ...
                double value2 = MathHelper.clamp((this.perlin.getValue((pos.getX() + ii + 8 + displaceheight) / 600.1, (pos.getZ() + ss + 8 + displaceheight) / 600.1) - 1.0) * 3.5 + waterlvl, 15.0, 230.0);
    ...
    public static void setStalact(World worldIn, Random random, int x, int y, int z, int flatSamples, double size, int height, IBlockState stone, float doublePlaceChance) {
        BlockPos startpos = null;
        List<BlockPos> poses = new ArrayList<>();
        Chunk chunk1 = worldIn.getChunk(x >> 4, z >> 4);

        while (y > 1) {
            if (chunk1.getBlockState(x, y, z).getBlock() == Blocks.AIR && chunk1.getBlockState(x, y + 1, z).getMaterial() == Material.ROCK) {
    ...
    public void worldDecorate(World worldIn, Random random, BlockPos pos) {
        for (int ii = 0; ii < 16; ii++) {
            for (int ss = 0; ss < 16; ss++) {
                for (int rr = 1; rr < 255; rr++) {
                    BlockPos uppos = new BlockPos(pos.getX() + ii + 8, rr, pos.getZ() + ss + 8);
                    if (this.noisegenerator3dbiomes.getValue(uppos.getX() / 60.1, uppos.getY() / 60.1, uppos.getZ() / 60.1) > this.rand.nextFloat() && this.world.isAirBlock(uppos) && BlocksRegister.CAVE_CRYSTAL.canPlaceBlockAt(this.world, uppos)) {
                        this.world.setBlockState(uppos, BlocksRegister.CAVE_CRYSTAL.getActualState(BlocksRegister.CAVE_CRYSTAL.getDefaultState().withProperty(CaveCrystal.TYPE, this.rand.nextInt(4)), this.world, uppos));
                    }
                }
            }
        }
    ...
    public static void genUpLadderCave(World world, BlockPos position, Random rand) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            caveDirection = caveDirection.add(rand.nextInt(4) - rand.nextInt(4), rand.nextInt(i > 10 ? 2 : 3) - rand.nextInt(4), rand.nextInt(4) - rand.nextInt(4)).normalize().scale(scaleFactor);
    ...
    public static void genDownLadderCave(World world, BlockPos position, Random rand) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            double scaleFactor = radius / 2.0;
            caveDirection = caveDirection.add(rand.nextInt(4) - rand.nextInt(4), rand.nextInt(4) - rand.nextInt(i > 6 ? 2 : 3), rand.nextInt(4) - rand.nextInt(4)).normalize().scale(scaleFactor);
            pos = pos.add(caveDirection.x, caveDirection.y, caveDirection.z);
        }
    }
    ...
    public static void generateChestAndSpawner(World world, BlockPos pos, int size, Random rand) {
        ...
        GenerationHelper.setChestWithLoot(world, pos.up(), EnumChest.CRYSTAL, ListLootTable.CHESTS_DUNGEON_DOLERITE_TROVE, EnumFacing.HORIZONTALS[rand.nextInt(4)], ChestLock.DOLERITE);
