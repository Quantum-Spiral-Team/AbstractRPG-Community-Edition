...
class CoralsDecorator extends BiomeDecorator {
    ...
    public WorldGenMiniCoral[] normalCorals = new WorldGenMiniCoral[]{new WorldGenMiniCoral(BlocksRegister.GORGONARIA_BROWN, 33, 4, 3), new WorldGenMiniCoral(BlocksRegister.ACROPORA_PURPLE, 33, 4, 3), new WorldGenMiniCoral(BlocksRegister.GORGONARIA_RED, 33, 4, 3), new WorldGenMiniCoral(BlocksRegister.ACROPORA_WHITE, 33, 4, 3), new WorldGenMiniCoral(BlocksRegister.GORGONARIA_WHITE, 33, 4, 3)};
    public WorldGenMiniCoral[] faviaCorals = new WorldGenMiniCoral[]{new WorldGenMiniCoral(BlocksRegister.FAVIA_BLUE, 24, 3, 3), new WorldGenMiniCoral(BlocksRegister.FAVIA_GREEN, 24, 3, 3), new WorldGenMiniCoral(BlocksRegister.FAVIA_RED, 24, 3, 3), new WorldGenMiniCoral(BlocksRegister.FAVIA_YELLOW, 24, 3, 3)};
    public WorldGenMiniCoral[] bigCorals = new WorldGenMiniCoral[]{new WorldGenMiniCoral(BlocksRegister.GORGONARIA_BROWN_BIG, 30, 5, 1), new WorldGenMiniCoral(BlocksRegister.ACROPORA_PURPLE_BIG, 30, 5, 1), new WorldGenMiniCoral(BlocksRegister.GORGONARIA_RED_BIG, 30, 5, 1), new WorldGenMiniCoral(BlocksRegister.GORGONARIA_WHITE_BIG, 30, 5, 1), new WorldGenMiniCoral(BlocksRegister.ACROPORA_WHITE_BIG, 30, 5, 1)};
    public WorldGenMiniCoral[] corallimorphaCorals = new WorldGenMiniCoral[]{new WorldGenMiniCoral(BlocksRegister.CORALLIMORPHA_BLUE, 18, 4, 2).setcorallimorpha(), new WorldGenMiniCoral(BlocksRegister.CORALLIMORPHA_BROWN, 18, 4, 2).setcorallimorpha(), new WorldGenMiniCoral(BlocksRegister.CORALLIMORPHA_GREEN, 18, 4, 2).setcorallimorpha(), new WorldGenMiniCoral(BlocksRegister.CORALLIMORPHA_LILAC, 18, 4, 2).setcorallimorpha(), new WorldGenMiniCoral(BlocksRegister.CORALLIMORPHA_PINK, 18, 4, 2).setcorallimorpha(), new WorldGenMiniCoral(BlocksRegister.CORALLIMORPHA_RED, 18, 4, 2).setcorallimorpha(), new WorldGenMiniCoral(BlocksRegister.CORALLIMORPHA_YELLOW, 18, 4, 2).setcorallimorpha()};
    public WorldGenMiniCoral[] glowingCorals = new WorldGenMiniCoral[]{new WorldGenMiniCoral(BlocksRegister.ACTINIFORA_RAMIFORM, 21, 5, 5), new WorldGenMiniCoral(BlocksRegister.ACTINIFORA_ARENACEOUS, 21, 5, 5), new WorldGenMiniCoral(BlocksRegister.ACTINIFORA_BRIGHT, 21, 5, 5), new WorldGenMiniCoral(BlocksRegister.ACTINIFORA_SEGREGATE, 21, 4, 3), new WorldGenMiniCoral(BlocksRegister.ACTINIFORA_GIANT, 20, 3, 2)};
    public WorldGenMiniCoral[] brainCorals = new WorldGenMiniCoral[]{new WorldGenMiniCoral(BlocksRegister.FAVIA_BRAIN, 16, 5, 2)};
    ...
    public void decorate(World world, Random random, Biome biome, BlockPos decpos) {
        if (this.decorating) {
            ...
            Block seastoneBlock = BlocksRegister.SEA_STONE;
            int iters = 27;
            int addition = 4;
            ...
            if (random.nextFloat() < 0.75) {
                BlockPos position = GetMOP.getTrueHeight(world, new BlockPos(decpos.getX() + 8 + random.nextInt(16), 130, decpos.getZ() + 8 + random.nextInt(16)));
            ...
            for (int isw = 0; isw < 12; isw++) {
                ...
                GetMOP.BlockTraceResult res = GetMOP.blockTrace(world, new BlockPos(decpos.getX() + 16 + offsetX, 85 + isw * 2, decpos.getZ() + 16 + offsetZ), facing, dist, null);
                if (res != null) {
            ...
            if (random.nextFloat() < 0.16) {
                ...
                BlockPos position = GetMOP.getTrueHeight(world, new BlockPos(decpos.getX() + 8 + random.nextInt(16), 130, decpos.getZ() + 8 + random.nextInt(16)));
                AquaticaChunkGenerator.genCellularCoral(world, position.getX(), position.getY(), position.getZ(), random, height * 2, height, AquaticaChunkGenerator.corals[random.nextInt(5)].getDefaultState());
            }
            ...
            GetMOP.BlockTraceResult res = GetMOP.blockTrace(world, new BlockPos(decpos.getX() + 16 + offsetXx, 85 + random.nextInt(25), decpos.getZ() + 16 + offsetZx), facingx, distx, null);
            if (res != null) {
                if ((res.impactState.getBlock() == Blocks.WATER || res.impactState.getBlock() == Blocks.FLOWING_WATER) && res.prevState.getBlock() == coralBlock) {
                    this.coralOreGenerator.size = 8 + random.nextInt(20);
                    this.coralOreGenerator.generate(world, random, res.pos);
                } else if ((res.prevState.getBlock() == Blocks.WATER || res.prevState.getBlock() == Blocks.FLOWING_WATER) && res.impactState.getBlock() == coralBlock) {
                    this.coralOreGenerator.size = 8 + random.nextInt(20);
            ...
            if (random.nextFloat() < 0.25) {
                BlockPos position = GetMOP.getTrueHeight(world, new BlockPos(decpos.getX() + 8 + random.nextInt(16), 140, decpos.getZ() + 8 + random.nextInt(16)));
                AquaticaChunkGenerator.genSeaweed(world, position.getX(), position.getY() + 1, position.getZ(), 4 + random.nextInt(8), BlocksRegister.SEAWEEDBLOCK.getDefaultState());
            }

            if (random.nextFloat() < 0.55) {
                BlockPos position = GetMOP.getTrueHeight(world, new BlockPos(decpos.getX() + 8 + random.nextInt(16), 90, decpos.getZ() + 8 + random.nextInt(16)));
                AquaticaChunkGenerator.genSeaweed(world, position.getX(), position.getY() + 1, position.getZ(), 5 + random.nextInt(8), BlocksRegister.SEAWEEDBLOCK.getDefaultState());
            }
            ...
            if (random.nextFloat() < 0.4) {
                BlockPos position = GetMOP.getTrueHeight(world, new BlockPos(decpos.getX() + 8 + random.nextInt(16), 130, decpos.getZ() + 8 + random.nextInt(16))).up();
                if (position.getY() != AquaticaChunkGenerator.sealvl) {
                    boolean w = world.getBlockState(position).getMaterial() == Material.WATER;
                    world.setBlockState(position, BlocksRegister.GIANT_SHELL.getDefaultState().withProperty(GiantShell.TYPE, random.nextInt(8)).withProperty(GiantShell.WET, w), 2);
                }
            }
            ...
            for (int isw = 0; isw < 15; isw++) {
                ...
                GetMOP.BlockTraceResult resx = GetMOP.blockTrace(world, new BlockPos(decpos.getX() + 16 + offsetZx, 83 + isw * 2, decpos.getZ() + 16 + offsetZxx), facingxx, distxx, null);
                if (resx != null) {
            ...
            for (int isw = 0; isw < 6; isw++) {
                ...
                GetMOP.BlockTraceResult resx = GetMOP.blockTrace(world, new BlockPos(decpos.getX() + 16 + offsetZx, 85 + isw * 4, decpos.getZ() + 16 + offsetZxxx), facingxxx, distxxx, null);
                if (resx != null) {
                    if (resx.impactState.getBlock() == Blocks.WATER || resx.impactState.getBlock() == Blocks.FLOWING_WATER) {
