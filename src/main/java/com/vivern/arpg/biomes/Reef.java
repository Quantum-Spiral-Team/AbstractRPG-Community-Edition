...
public class Reef extends Biome {
    ...
    public Reef() {
        super(new BiomeProperties("Reef").setBaseHeight(0.05F).setHeightVariation(0.45F).setTemperature(0.95F).setWaterColor(11921407).setRainfall(0.0F).setRainDisabled());
