        ...
        public void decorate(World worldIn, Random random, Biome biome, BlockPos pos) {
            if (this.decorating) {
                ...
                if (random.nextInt(3) == 0) {
                    ...
                    WorldGenWateredMountains rocks = new WorldGenWateredMountains(BlocksRegister.RADIOACTIVE_STONE.getDefaultState(), BlocksRegister.TOXIC_DIRT.getDefaultState(), BlocksRegister.TOXIC_GRASS.getDefaultState(), noise);
                    BlockPos position = worldIn.getTopSolidOrLiquidBlock(new BlockPos(pos.getX() + 12 + random.nextInt(8), 0, pos.getZ() + 12 + random.nextInt(8))).down(8);
                ...
                if (random.nextInt(2) == 0) {
                    BlockPos position = worldIn.getHeight(new BlockPos(pos.getX() + 8 + random.nextInt(16), 0, pos.getZ() + 8 + random.nextInt(16)));
                    Block blockd = worldIn.getBlockState(position.down()).getBlock();
                    if (blockd == BlocksRegister.TOXIC_GRASS || blockd == BlocksRegister.TOXIC_DIRT || blockd == BlocksRegister.SLUDGE) {
