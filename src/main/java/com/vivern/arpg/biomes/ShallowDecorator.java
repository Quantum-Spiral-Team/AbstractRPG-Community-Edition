...
class ShallowDecorator extends BiomeDecorator {
    ...
    public WorldGenMiniCoral[] faviaCorals = new WorldGenMiniCoral[]{new WorldGenMiniCoral(BlocksRegister.FAVIA_BLUE, 8, 6, 2), new WorldGenMiniCoral(BlocksRegister.FAVIA_GREEN, 8, 6, 2), new WorldGenMiniCoral(BlocksRegister.FAVIA_RED, 8, 6, 2), new WorldGenMiniCoral(BlocksRegister.FAVIA_YELLOW, 8, 6, 2)};
    public WorldGenMiniCoral[] corallimorphaCorals = new WorldGenMiniCoral[]{new WorldGenMiniCoral(BlocksRegister.CORALLIMORPHA_BLUE, 8, 7, 1).setcorallimorpha(), new WorldGenMiniCoral(BlocksRegister.CORALLIMORPHA_BROWN, 9, 7, 1).setcorallimorpha(), new WorldGenMiniCoral(BlocksRegister.CORALLIMORPHA_GREEN, 8, 7, 1).setcorallimorpha(), new WorldGenMiniCoral(BlocksRegister.CORALLIMORPHA_LILAC, 8, 7, 1).setcorallimorpha(), new WorldGenMiniCoral(BlocksRegister.CORALLIMORPHA_PINK, 9, 7, 1).setcorallimorpha(), new WorldGenMiniCoral(BlocksRegister.CORALLIMORPHA_RED, 11, 7, 1).setcorallimorpha(), new WorldGenMiniCoral(BlocksRegister.CORALLIMORPHA_YELLOW, 9, 7, 1).setcorallimorpha()};
        ...
        if (this.decorating) {
            ...
            if (random.nextFloat() < 0.027) {
                ...
                for (int i = 0; i < count; i++) {
                    BlockPos position = GetMOP.getTrueHeight(world, new BlockPos(decpos.getX() + 8 + random.nextInt(16), 183, decpos.getZ() + 8 + random.nextInt(16)));
            ...
            if (random.nextFloat() < 0.025) {
                ...
                for (int i = 0; i < count; i++) {
                    BlockPos position = GetMOP.getTrueHeight(world, new BlockPos(decpos.getX() + 8 + random.nextInt(16), 180, decpos.getZ() + 8 + random.nextInt(16)));
                    int radius = 1 + random.nextInt(3);
                    AquaticaChunkGenerator.generateBigSponge(world, position.up(radius / 2 + 1), random, radius, BlocksRegister.LIVING_SPONGE.getDefaultState());
                }
            }

            if (random.nextFloat() < 0.085) {
                BlockPos position = GetMOP.getTrueHeight(world, new BlockPos(decpos.getX() + 8 + random.nextInt(16), 185, decpos.getZ() + 8 + random.nextInt(16))).up();
                ...
                AquaticaChunkGenerator.genRecursiveCoral(world, position.getX(), position.getY(), position.getZ(), random, count, brl, BlocksRegister.LIVING_SPONGE.getDefaultState(), BlocksRegister.LIVING_SPONGE.getStateFromMeta(1), 193);
            }
            ...
            if (random.nextFloat() < 0.6) {
                BlockPos position = GetMOP.getTrueHeight(world, new BlockPos(decpos.getX() + 8 + random.nextInt(16), 182, decpos.getZ() + 8 + random.nextInt(16)));
            ...
            if (random.nextFloat() < 0.4) {
                BlockPos position = GetMOP.getTrueHeight(world, new BlockPos(decpos.getX() + 8 + random.nextInt(16), 195, decpos.getZ() + 8 + random.nextInt(16))).up();
