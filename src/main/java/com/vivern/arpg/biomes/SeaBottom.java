...
public class SeaBottom extends Biome {
    ...
    public SeaBottom() {
        super(new BiomeProperties("Sea bottom").setBaseHeight(-3.6F).setHeightVariation(0.2F).setTemperature(0.9F).setWaterColor(11921407).setRainfall(0.0F).setRainDisabled());
