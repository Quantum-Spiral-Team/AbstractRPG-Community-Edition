...
public class SeaweedBay extends Biome {
    ...
    public SeaweedBay() {
        super(new BiomeProperties("SeaweedBay").setBaseHeight(-0.9F).setHeightVariation(0.15F).setTemperature(0.9F).setWaterColor(11921407).setRainfall(0.0F).setRainDisabled());
