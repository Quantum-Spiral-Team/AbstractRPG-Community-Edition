    ...
    public void decorate(World worldIn, Random random, Biome biome, BlockPos pos) {
        if (this.decorating) {
            ...
            if (random.nextFloat() < 0.9) {
                ...
                if (blockd == Blocks.GRASS || blockd == Blocks.DIRT) {
                    if (random.nextFloat() < 0.1) {
                        ...
                        templatexxxx.addBlocksToWorld(worldIn, position.add(sxxxxx * disppxxxx, 0, szxxxx * disppxxxx), ReplaceOnlySofter.instance, settingsxxxx, 2);
                        ...
                        templatexxxxx.addBlocksToWorld(worldIn, position.add(sxxxxxx * disppxxxxx, 0, szxxxxx * disppxxxxx), ReplaceOnlySofter.instance, settingsxxxxx, 2);
                    } else {
                        ...
                        templatexxxxxx.addBlocksToWorld(worldIn, position.add(sxxxxxxx * disppxxxxxx, 0, szxxxxxx * disppxxxxxx), ReplaceOnlySofter.instance, settingsxxxxxx, 2);
                    }
                }
            }
            ...
            if ((blockd == Blocks.GRASS || blockd == Blocks.DIRT) && position.getY() < 213 && position.getY() > 198) {
                ...
                templatexxxxxxx.addBlocksToWorld(worldIn, position.add(sxxxxxxxx * disppxxxxxxx, 0, szxxxxxxx * disppxxxxxxx), ReplaceOnlySofter.instance, settingsxxxxxxx, 2);
            }
