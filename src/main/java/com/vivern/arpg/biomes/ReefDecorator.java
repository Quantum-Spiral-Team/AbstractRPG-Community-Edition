    ...
    public void decorate(World world, Random random, Biome biome, BlockPos pos) {
        if (this.decorating) {
            ...
            for (int isw = 0; isw < 3; isw++) {
                BlockPos position = GetMOP.getTrueHeight(world, new BlockPos(pos.getX() + 8 + random.nextInt(16), 186, pos.getZ() + 8 + random.nextInt(16)));
            ...
            if (random.nextFloat() < 0.18) {
                ...
                BlockPos position = GetMOP.getTrueHeight(world, new BlockPos(pos.getX() + 8 + random.nextInt(16), 150, pos.getZ() + 8 + random.nextInt(16)));
            ...
            if (random.nextFloat() < 0.9) {
                ...
                if (blockd == Blocks.GRASS || blockd == Blocks.DIRT) {
                    if (random.nextFloat() < 0.1) {
                        ...
                        templatexxxx.addBlocksToWorld(world, position.add(sxxxxx * disppxxxx, 0, szxxxx * disppxxxx), ReplaceOnlySofter.instance, settingsxxxx, 2);
                        ...
                        templatexxxxx.addBlocksToWorld(world, position.add(sxxxxxx * disppxxxxx, 0, szxxxxx * disppxxxxx), ReplaceOnlySofter.instance, settingsxxxxx, 2);
                    } else {
                        ...
                        templatexxxxxx.addBlocksToWorld(world, position.add(sxxxxxxx * disppxxxxxx, 0, szxxxxxx * disppxxxxxx), ReplaceOnlySofter.instance, settingsxxxxxx, 2);
                    }
                }
            }
            ...
            if ((blockd == Blocks.GRASS || blockd == Blocks.DIRT) && position.getY() < 213 && position.getY() > 198) {
                ...
                templatexxxxxxx.addBlocksToWorld(world, position.add(sxxxxxxxx * disppxxxxxxx, 0, szxxxxxxx * disppxxxxxxx), ReplaceOnlySofter.instance, settingsxxxxxxx, 2);
            }
