...
public class IslandRiver extends Biome {
    ...
    public IslandRiver() {
        super(new BiomeProperties("Island river").setBaseHeight(5.25F).setHeightVariation(0.01F).setTemperature(0.95F).setWaterColor(11921407).setRainfall(0.0F).setRainDisabled());
