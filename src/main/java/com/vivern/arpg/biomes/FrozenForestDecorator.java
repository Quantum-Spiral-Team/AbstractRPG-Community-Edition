...
class FrozenForestDecorator extends BiomeDecorator {
    ...
    public WorldGenGroundFoliage willow = new WorldGenGroundFoliage(BlocksRegister.WINTER_WILLOW, 23, 6, 2);
    public WorldGenGroundFoliage tallgrass = new WorldGenGroundFoliage(BlocksRegister.FROSTED_WEED, 32, 6, 2);
    public WorldGenGroundFoliage magicflower = new WorldGenGroundFoliage(BlocksRegister.ICE_FLOWER, 20, 5, 2);
