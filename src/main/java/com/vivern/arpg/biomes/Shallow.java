...
public class Shallow extends BiomeControlled {
    ...
    public Shallow() {
        super(new BiomeProperties("Shallow").setBaseHeight(4.0F).setHeightVariation(0.032F).setTemperature(0.9F).setWaterColor(11921407).setRainfall(0.0F).setRainDisabled());
