...
public class Corals extends Biome {
    ...
    public Corals() {
        super(new BiomeProperties("Corals").setBaseHeight(-1.0F).setHeightVariation(0.15F).setTemperature(0.95F).setWaterColor(11921407).setRainfall(0.0F).setRainDisabled());
