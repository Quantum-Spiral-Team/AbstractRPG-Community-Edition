...
public class EntityLaserParticle extends Entity {
    ...
    public EntityLaserParticle(World worldIn, EntityPlayer player, ResourceLocation texture, float scale, int livetime, int light, float Red, float Green, float Blue, float alphatime) {
        super(worldIn);
        this.player = player;
    ...
    public EntityLaserParticle(World worldIn, ResourceLocation texture, float scale, int light, float Red, float Green, float Blue, float alphatime, double distance, int livetime, float lengh, float rotatPitch, float rotatYaw) {
        super(worldIn);
