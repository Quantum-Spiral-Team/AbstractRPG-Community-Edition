...
public abstract class AbstractGlyphid extends AbstractMob implements EntityFlying {
    ...
    public boolean checkPosition(World world, BlockPos pos) {
        if (this.isPassable(world, pos)) {
            if (this.hasCollision(world, pos.add(0, 1, 0)) || this.hasCollision(world, pos.add(0, -1, 0)) || this.hasCollision(world, pos.add(-1, 0, 0)) || this.hasCollision(world, pos.add(1, 0, 0)) || this.hasCollision(world, pos.add(0, 0, -1)) || this.hasCollision(world, pos.add(0, 0, 1))) {
                return true;
            }

            if (this.hasCollision(world, pos.add(1, 0, 1)) || this.hasCollision(world, pos.add(-1, 0, -1)) || this.hasCollision(world, pos.add(1, 0, -1)) || this.hasCollision(world, pos.add(-1, 0, 1)) || this.hasCollision(world, pos.add(-1, 1, 0)) || this.hasCollision(world, pos.add(1, 1, 0)) || this.hasCollision(world, pos.add(-1, -1, 0)) || this.hasCollision(world, pos.add(1, -1, 0)) || this.hasCollision(world, pos.add(0, 1, -1)) || this.hasCollision(world, pos.add(0, 1, 1)) || this.hasCollision(world, pos.add(0, -1, -1)) || this.hasCollision(world, pos.add(0, -1, 1))) {
                return true;
            }
        }
    ...
    public EnumClimbingState getClimbingState() {
        ...
        if (this.hasCollision(this.world, pos.add(0, 1, 0))) {
            ...
            return this.hasCollision(this.world, pos.add(0, -1, 1)) ? EnumClimbingState.DOWN_ZPLUS : EnumClimbingState.NONE;
        }
    }
