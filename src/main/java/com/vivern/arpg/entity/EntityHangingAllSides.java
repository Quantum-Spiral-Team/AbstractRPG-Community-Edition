...
public class EntityHangingAllSides extends EntityHanging implements ISynchronizedEntity {
    ...
    public void onUpdate() {
        ...
        if (!this.world.isRemote && (this.ticksExisted < 2 || this.ticksExisted % 50 == 0)) {
            ISynchronizedEntity.sendSynchronize(this, 24.0, this.hangingPosition.getX(), this.hangingPosition.getY(), this.hangingPosition.getZ(), this.facingDirection.getIndex());
        }
    }
