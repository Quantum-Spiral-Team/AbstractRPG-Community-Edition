...
public class EntityShard extends Entity {
    ...
    public void handleStatusUpdate(byte id) {
        if (id == -25) {
            this.world.playSound(this.posX, this.posY, this.posZ, Sounds.shard_drop, SoundCategory.PLAYERS, 0.9F, 0.9F + this.rand.nextFloat() / 5.0F, false);
        ...
        if (id == 0) {
            this.world.playSound(this.posX, this.posY, this.posZ, Sounds.shard_pickup, SoundCategory.PLAYERS, 0.6F, 0.9F + this.rand.nextFloat() / 5.0F, false);
        }
    ...
    public void onUpdate() {
        ...
        if (!this.world.isRemote) {
            ...
            if (this.ticksExisted == 30) {
                GetMOP.BlockTraceResult result = GetMOP.blockTrace(this.world, this.getPosition(), EnumFacing.DOWN, (int) (this.posY + 2.0), GetMOP.SOLID_BLOCKS);
                if (result == null) {
