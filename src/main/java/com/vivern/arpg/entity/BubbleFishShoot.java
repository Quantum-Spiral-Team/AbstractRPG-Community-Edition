...
public class BubbleFishShoot extends EntityThrowable {
    ...
    public void handleStatusUpdate(byte id) {
        if (id == 8) {
            GUNParticle bigsmoke1 = new GUNParticle(tex, 0.05F, 0.0F, 5, -1, this.world, this.lastTickPosX, this.lastTickPosY, this.lastTickPosZ, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, true, this.rand.nextInt(360));
    ...
    protected void onImpact(RayTraceResult result) {
        if (result.entityHit != null) {
            if (Team.checkIsOpponent(this.thrower, result.entityHit) && !this.world.isRemote) {
                ...
                Weapons.dealDamage(new WeaponDamage(this.weaponstack, this.getThrower(), this, false, true, this, WeaponDamage.water), parameters.getEnchantedF("damage", might) * this.magicPower, this.getThrower(), result.entityHit, true, parameters.getEnchantedF("knockback", impulse), this.posX, this.posY, this.posZ);
                result.entityHit.hurtResistantTime = 0;
                Weapons.setPotionIfEntityLB(result.entityHit, parameters.getPotion("slime", PotionEffects.SLIME, witchery));
                this.world.playSound(null, this.posX, this.posY, this.posZ, Sounds.pop, SoundCategory.AMBIENT, 0.7F, 0.9F + this.rand.nextFloat() / 5.0F);
