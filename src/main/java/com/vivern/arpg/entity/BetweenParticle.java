...
public class BetweenParticle extends Entity {
    ...
    public BetweenParticle(World worldIn, ResourceLocation texture, float scale, int light, float Red, float Green, float Blue, float alphatime, double distance, int livetime, float animation, float texlengh, Vec3d from, Vec3d to) {
        super(worldIn);
        this.scale = scale;
        this.light = light;
