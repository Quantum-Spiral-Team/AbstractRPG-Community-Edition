...
public class EntityCubicParticle extends EntityThrowable {
    ...
    public EntityCubicParticle(ResourceLocation texture, float scale, float gravity, int livetime, int light, World world, double x, double y, double z, float speedx, float speedy, float speedz, float Red, float Green, float Blue, boolean opa, float rotateX, float rotateY, float rotateZ, float rotateSpeed, boolean rotateRand, float scaleTickAdding) {
        super(world, x, y, z);
        this.scale = scale;
