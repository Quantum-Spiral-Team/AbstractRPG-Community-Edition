        ...
        if (entity != null) {
            if (!this.repulse(entity) && Team.checkIsOpponent(this.shootingEntity, entity) && !this.world.isRemote) {
                ...
                if (!this.damageDealed) {
                    ...
                    Weapons.dealDamage(new WeaponDamage(this.weaponstack, this.shootingEntity, this, false, true, this, WeaponDamage.pierce), parameters.getEnchantedF("damage", might) * this.magicPower, this.shootingEntity, entity, true, parameters.getEnchantedF("knockback", impulse), this.posX, this.posY, this.posZ);
            ...
            if (this.prickedEntity != null) {
                this.world.playSound(null, this.posX, this.posY, this.posZ, Sounds.crystal_star_impact, SoundCategory.AMBIENT, 2.2F, 0.85F + this.rand.nextFloat() * 0.3F);
            }
