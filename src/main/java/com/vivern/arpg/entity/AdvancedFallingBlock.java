    ...
    public void onUpdate() {
        if (this.fallTile != null) {
            if (!this.world.isRemote && (this.ticksExisted <= 3 || this.ticksExisted % 20 == 0)) {
                ...
                packet.write(this.fallTile.getBlock().getRegistryName().toString(), this.getEntityId(), this.fallTile.getBlock().getMetaFromState(this.fallTile));
            ...
            if (this.fallTile.getMaterial() == Material.AIR) {
                ...
                if (!this.world.isRemote) {
                    ...
                    if (!this.onGround && !flag1) {
                        if (this.fallTime > 40 && !this.world.isRemote && (blockpos1.getY() < 1 || blockpos1.getY() > 256) || this.fallTime > 80) {
                        ...
                        if (this.world.isAirBlock(new BlockPos(this.posX, this.posY - 0.01F, this.posZ)) && !flag1 && BlockFalling.canFallThrough(this.world.getBlockState(new BlockPos(this.posX, this.posY - 0.01F, this.posZ)))) {
                            this.onGround = false;
                            return;
                        }
                        ...
                        if (iblockstate.getBlock() != Blocks.PISTON_EXTENSION) {
                            ...
                            } else if (this.world.mayPlace(block, blockpos1, true, EnumFacing.UP, this) && (flag1 || !BlockFalling.canFallThrough(this.world.getBlockState(blockpos1.down()))) && this.world.setBlockState(blockpos1, this.fallTile, 3)) {
                                if (block instanceof BlockFalling) {
