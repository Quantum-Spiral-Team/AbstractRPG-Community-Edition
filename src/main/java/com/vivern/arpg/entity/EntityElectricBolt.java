...
public class EntityElectricBolt extends EntityThrowable implements ISynchronizedEntity {
    ...
    public static ParticleTracker.TrackerSmoothShowHide trackerssh = new ParticleTracker.TrackerSmoothShowHide(null, new Vec3d[]{new Vec3d(0.0, 3.0, 0.3), new Vec3d(2.0, 5.0, -0.3)});
    ...
    protected void onImpact(RayTraceResult result) {
        if (result.entityHit != null) {
            if (Team.checkIsOpponent(this.thrower, result.entityHit) && !this.world.isRemote) {
                ...
                Weapons.dealDamage(new WeaponDamage(this.weaponstack, this.getThrower(), this, false, true, this, WeaponDamage.electric), parameters.getEnchantedF("damage", might) * this.magicPower, this.getThrower(), result.entityHit, true, parameters.getEnchantedF("knockback", impulse), this.posX, this.posY, this.posZ);
                ...
                this.world.playSound(this.posX, this.posY, this.posZ, Sounds.electricstaffimpact, SoundCategory.AMBIENT, 0.6F, 0.95F + this.rand.nextFloat() / 10.0F, false);
                this.setDead();
            }
    ...
    public void onEntityUpdate() {
        ...
        if (this.ticksExisted > 2 && this.world.isRemote && this.pos1.lengthSquared() > 1.0E-6 && this.pos2.lengthSquared() > 1.0E-6) {
            BetweenParticle laser = new BetweenParticle(this.world, this.texture, 0.2F, 240, 1.0F, 1.0F, 1.0F, 0.17F, this.pos1.distanceTo(this.pos2), Math.min(4, this.ticksExisted - 2), 0.3F, 2.0F, this.pos1, this.pos2);
