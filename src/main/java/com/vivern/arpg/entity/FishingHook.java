...
public class FishingHook extends EntityThrowable {
    ...
    public boolean shouldStopFishing() {
        ...
        if (!this.thrower.isDead && this.thrower.isEntityAlive() && flag && this.getDistance(this.thrower) <= this.fishingRod.length + 1.0F) {
            return false;
        } else {
            this.returnHook();
            return true;
            ...
            if (!this.returning) {
                if (this.fishingRod != null && this.rodstack != null && !this.shouldStopFishing()) {
                    ...
                    if (this.getDistance(this.thrower) > this.fishingRod.length) {
                        ...
                        this.motionY /= 1.2;
                        this.motionZ /= 1.2;
                        SuperKnockback.applyMove(this, -0.7F, this.thrower.posX, this.thrower.posY + this.thrower.height / 2.0F, this.thrower.posZ);
                    }
                    ...
                    if (block != null) {
                        if (this.allliquids.contains(block)) {
                            ...
                            if (!this.captureFish) {
                                if (this.rand.nextFloat() < this.fishingRod.getFishingLuck(this.thrower, this.rodstack, this.world) / 200.0F && Math.abs(this.motionZ * this.motionX) < 0.1 && this.peckTime < 1 && this.bait != null) {
                                    this.world.playSound(null, this.thrower.posX, this.thrower.posY, this.thrower.posZ, Sounds.fishing_splash, SoundCategory.AMBIENT, 0.8F, 1.0F);
                                ...
                                if (this.ticksExisted % 12 == 0) {
                                    this.world.playSound(null, this.thrower.posX, this.thrower.posY, this.thrower.posZ, Sounds.fishing_reel, SoundCategory.AMBIENT, 0.6F, 1.0F);
                                }
                                ...
                                if (rdist > 46.0) {
                                    ...
                                    this.peckTime = 0;
                                    NBTHelper.SetNBTboolean(this.rodstack, false, "pecked");
                                    this.world.playSound(null, this.thrower.posX, this.thrower.posY, this.thrower.posZ, Sounds.fishing_break, SoundCategory.AMBIENT, 0.8F, 1.0F);
                                    ...
                                    this.returning = true;
                                    this.world.setEntityState(this, (byte) 9);
                                    this.world.playSound(null, this.thrower.posX, this.thrower.posY, this.thrower.posZ, Sounds.fishing_success, SoundCategory.AMBIENT, 0.8F, 1.0F);
                                    this.tryLooseBait();
                                }
                            } else {
                                this.captureFish = false;
                        ...
                        if (!this.dropped) {
                            this.world.playSound(null, this.posX, this.posY, this.posZ, Sounds.fishing_drop, SoundCategory.AMBIENT, 0.7F, 1.0F);
                            this.dropped = true;
                        }
                    }
                ...
                this.motionY /= 1.2;
                this.motionZ /= 1.2;
                SuperKnockback.applyMove(this, -1.0F, this.thrower.posX, this.thrower.posY + this.thrower.height / 2.0F, this.thrower.posZ);
                this.returnTime++;
    ...
    public void returnHook() {
        this.world.setEntityState(this, (byte) 9);
        this.world.playSound(null, this.thrower.posX, this.thrower.posY, this.thrower.posZ, Sounds.fishing_reset, SoundCategory.AMBIENT, 0.6F, 1.0F);
