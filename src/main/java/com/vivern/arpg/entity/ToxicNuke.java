...
public class ToxicNuke extends EntityThrowable {
    ...
    public void handleStatusUpdate(byte id) {
        if (id == 5) {
            ...
            this.world.playSound(this.posX, this.posY, this.posZ, Sounds.explode2, SoundCategory.AMBIENT, 4.0F, 0.95F + this.rand.nextFloat() / 10.0F, false);
            this.world.playSound(this.posX, this.posY, this.posZ, Sounds.toxic_nuke, SoundCategory.AMBIENT, 2.0F, 0.9F + this.rand.nextFloat() / 5.0F, false);

            for (int ss = 0; ss < 10; ss++) {
                GUNParticle bigsmoke = new GUNParticle(this.largesmoke, 1.0F + (float) this.rand.nextGaussian() / 2.0F, -0.001F, 34, 60, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 10.0F, (float) this.rand.nextGaussian() / 10.0F, (float) this.rand.nextGaussian() / 10.0F, 1.0F, 1.0F, 1.0F, true, 0);
                bigsmoke.alphaTickAdding = -0.028F;
                this.world.spawnEntity(bigsmoke);
            }

            for (int ss = 0; ss < 20; ss++) {
                GUNParticle fire = new GUNParticle(this.flame, 1.0F + (float) this.rand.nextGaussian() / 5.0F, -0.005F, 33 + this.rand.nextInt(20), 240, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 4.0F, (float) this.rand.nextGaussian() / 27.0F, (float) this.rand.nextGaussian() / 4.0F, 0.0F, 1.0F, 1.0F, true, this.rand.nextInt(100) - 50);
            ...
            for (int ss = 0; ss < 20; ss++) {
                GUNParticle fire = new GUNParticle(this.flame, 1.5F + (float) this.rand.nextGaussian() / 5.0F, 0.02F, 53 + this.rand.nextInt(20), 240, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 27.0F, this.rand.nextFloat(), (float) this.rand.nextGaussian() / 27.0F, 0.0F, 1.0F, 1.0F, true, this.rand.nextInt(100) - 50);
                fire.alphaTickAdding = -0.04F;
                fire.alphaGlowing = true;
                this.world.spawnEntity(fire);
            }
            ...
            for (int ss = 0; ss < 30; ss++) {
                GUNParticle bigsmoke = new GUNParticle(this.largecloud, 0.5F + (float) this.rand.nextGaussian() / 5.0F, 0.005F, 140 + this.rand.nextInt(20), 240, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 10.0F, (float) this.rand.nextGaussian() / 19.0F, (float) this.rand.nextGaussian() / 10.0F, 0.3F, 1.0F, 0.7F + (float) this.rand.nextGaussian() / 5.0F, true, this.rand.nextInt(360), true, 1.6F);
    ...
    public void expl() {
        ...
        if (!this.world.isRemote) {
            ...
            if (!list.isEmpty()) {
                for (Entity entity : list) {
                    ...
                    Weapons.dealDamage(new WeaponDamage(this.weaponstack, this.getThrower(), this, true, false, this, WeaponDamage.explode), wdamage, this.thrower, entity, true, wknockback, this.posX, this.posY - 0.3, this.posZ);
        ...
        if (!this.world.isRemote) {
            Explosion explosion = new Explosion(this.world, null, this.posX, this.posY, this.posZ, parameters.getFloat("explosion_power"), false, true);
            ...
            for (int ss = 0; ss < count; ss++) {
                ToxicNukeShard projectile = new ToxicNukeShard(this.world, this.getThrower(), this.rand.nextGaussian() / 5.0, this.rand.nextGaussian() / 5.0, this.rand.nextGaussian() / 5.0, this.weaponstack);
