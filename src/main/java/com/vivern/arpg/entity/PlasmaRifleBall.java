...
public class PlasmaRifleBall extends EntityThrowable implements RenderModule.IRenderModuleMulticolored {
    ...
    public void handleStatusUpdate(byte id) {
        if (id == 8) {
            GUNParticle bigsmoke1 = new GUNParticle(explode, 0.1F, 0.0F, 11, 240, this.world, this.lastTickPosX, this.lastTickPosY, this.lastTickPosZ, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, true, this.rand.nextInt(360));
    ...
    protected void onImpact(RayTraceResult result) {
        if (result.entityHit != null) {
            if (Team.checkIsOpponent(this.thrower, result.entityHit) && !this.world.isRemote) {
                ...
                Weapons.dealDamage(new WeaponDamage(this.weaponstack, this.getThrower(), this, false, true, this, WeaponDamage.plasma), this.getPowered() ? parameters.getEnchantedF("damage_powered", might) : parameters.getEnchantedF("damage", might), this.getThrower(), result.entityHit, true, parameters.getEnchantedF("knockback", impulse));
                ...
                this.world.playSound(null, this.posX, this.posY, this.posZ, Sounds.plasma_rifle_impact, SoundCategory.AMBIENT, 0.8F, 0.9F + this.rand.nextFloat() / 5.0F);
