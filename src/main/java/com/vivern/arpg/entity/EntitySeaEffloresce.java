        ...
        if (!this.world.isRemote) {
            ...
            if (this.thrower != null && this.ticksExisted % 3 == 0) {
                ...
                if (this.ticksExisted < 60 && distsq < 49.0) {
                    SuperKnockback.applyMove(this, 0.02F * attraction, this.thrower.posX, this.thrower.posY + this.thrower.height / 2.0F, this.thrower.posZ);
                ...
                if (this.ticksExisted > 60) {
                    SuperKnockback.applyMove(this, -0.05F * attraction, this.thrower.posX, this.thrower.posY + this.thrower.height / 2.0F, this.thrower.posZ);
                ...
                if (distsq > 81.0) {
                    SuperKnockback.applyMove(this, -0.2F * attraction, this.thrower.posX, this.thrower.posY + this.thrower.height / 2.0F, this.thrower.posZ);
                }
                ...
                if (EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.SPECIAL, this.weaponstack) == 0 && this.thrower.getHeldItemMainhand().getItem() != ItemsRegister.SEA_EFFLORESCE) {
                    SuperKnockback.applyMove(this, -0.2F * attraction, this.thrower.posX, this.thrower.posY + this.thrower.height / 2.0F, this.thrower.posZ);
                    this.destroyTick += 3;
            ...
            if (this.ticksExisted % 10 == 0) {
                ...
                if (!list.isEmpty()) {
                    for (Entity entity : list) {
                        if (Team.checkIsOpponent(this.thrower, entity) && Weapons.canDealDamageTo(entity) && !(entity instanceof EntitySeaEffloresce) && GetMOP.thereIsNoBlockCollidesBetween(this.world, new Vec3d(this.posX, this.posY + this.height / 2.0F, this.posZ), new Vec3d(entity.posX, entity.posY + entity.height / 2.0F, entity.posZ), null, false)) {
                            int might = EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.MIGHT, this.weaponstack);
                            int impulse = EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.IMPULSE, this.weaponstack);
                            Weapons.dealDamage(new WeaponDamage(this.weaponstack, this.getThrower(), this, false, true, this, WeaponDamage.vines), parametersx.getEnchantedF("damage", might) * this.magicPower, this.getThrower(), entity, true, parametersx.getEnchantedF("knockback", impulse), this.posX, this.posY, this.posZ);
                ...
                if (hasattack) {
                    this.world.playSound(null, this.posX, this.posY, this.posZ, Sounds.sea_effloresce_impact, SoundCategory.AMBIENT, 0.8F, 0.9F + this.rand.nextFloat() / 5.0F);
                }
            }
        }
    }
    ...
    public void onEntityUpdate() {
        ...
        if (this.world.isRemote) {
            ...
            for (Entity entitylivingbase : this.world.getEntitiesWithinAABBExcludingEntity(this, aabb)) {
                if (entitylivingbase != this.thrower && Weapons.canDealDamageTo(entitylivingbase) && !(entitylivingbase instanceof EntitySeaEffloresce) && !(entitylivingbase instanceof GUNParticle) && !(entitylivingbase instanceof BetweenParticle)) {
                    Vec3d vec1 = new Vec3d(this.posX, this.posY + this.height / 2.0F, this.posZ);
                    Vec3d vec2 = new Vec3d(entitylivingbase.posX, entitylivingbase.posY + entitylivingbase.height / 2.0F, entitylivingbase.posZ);
                    BetweenParticle laser = new BetweenParticle(this.world, tex, 0.1F, -1, 0.6F, 0.8F, 1.0F, 0.0F, vec1.distanceTo(vec2), 1, 0.3F, 8.0F, vec1, vec2);
