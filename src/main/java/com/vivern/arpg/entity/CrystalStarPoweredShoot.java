...
public class CrystalStarPoweredShoot extends StandardBullet implements INailer {
        ...
        if (result.entityHit != null) {
            if (Team.checkIsOpponent(this.thrower, result.entityHit) && !this.world.isRemote) {
                ...
                if (!this.damageDealed) {
                    ...
                    Weapons.dealDamage(new WeaponDamage(this.weaponstack, this.getThrower(), this, false, true, this, WeaponDamage.pierce), parameters.getEnchantedF("damage_powered", might) * this.magicPower, this.getThrower(), result.entityHit, true, parameters.getEnchantedF("knockback", impulse), this.prevPosX, this.prevPosY, this.prevPosZ);
            ...
            this.world.playSound(null, this.posX, this.posY, this.posZ, Sounds.crystal_star_impact, SoundCategory.AMBIENT, 2.4F, 0.85F + this.rand.nextFloat() * 0.3F);
    ...
    public void expl(Vec3d pos) {
        ...
        if (this.getThrower() != null) {
            ...
            for (int i = 0; i < nn; i++) {
                ...
                if (this.rand.nextFloat() < randchance) {
                    ...
                    SuperKnockback.setMove(projectile, -parameters.getFloat("velocity"), target.posX + (this.rand.nextFloat() - 0.5F) * 0.18F, target.posY + target.height / 2.0F + (this.rand.nextFloat() - 0.5F) * 0.18F, target.posZ + (this.rand.nextFloat() - 0.5F) * 0.18F);
                }
        ...
        if (this.prickedEntity != null) {
            ...
            int might = EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.MIGHT, this.weaponstack);
            Weapons.dealDamage(new WeaponDamage(this.weaponstack, this.getThrower(), this, false, true, this, WeaponDamage.dismember), parameters.getEnchantedF("damage_powered", might) * this.magicPower, this.getThrower(), this.prickedEntity, true);
    ...
    public void onEntityUpdate() {
        ...
        if (this.world.isRemote && pos1.lengthSquared() > 1.0E-6 && pos2.lengthSquared() > 1.0E-6) {
            BetweenParticle laser = new BetweenParticle(this.world, texture, 0.14F, 190, 0.83F, 0.91F, 0.78F, 0.1F, pos1.distanceTo(pos2), 8, -0.15F, 9999.0F, pos1, pos2);
