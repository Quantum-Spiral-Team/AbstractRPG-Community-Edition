...
public class CoralPolyp extends Entity {
    ...
    public Vec3d followToVec3d(Vec3d base, Vec3d followTo, double distance) {
        return new Vec3d(GetMOP.followNumber(base.x, followTo.x, distance), GetMOP.followNumber(base.y, followTo.y, distance), GetMOP.followNumber(base.z, followTo.z, distance));
    }
    ...
    public void handleStatusUpdate(byte id) {
        ...
        if (id == 8 && this.segmentPoses != null) {
            ...
            for (int i = 0; i < this.segmentPoses.length - 1; i++) {
                ...
                GUNParticle particle = new GUNParticle(tex, scalePrev, this.isInWater() ? 0.001F : 0.01F, lt, 180, this.world, pos.x, pos.y, pos.z, (float) this.rand.nextGaussian() / 36.0F, (float) this.rand.nextGaussian() / 36.0F, (float) this.rand.nextGaussian() / 36.0F, 1.0F, 1.0F, 1.0F, true, this.rand.nextInt(360), true, 3.0F);
    ...
    public void onUpdate() {
        ...
        if (this.world.isRemote) {
            ...
            if (this.ticksExisted % 30 == 0) {
                this.enemy = this.thrower == null ? (EntityLivingBase) GetMOP.findNearestEntityWithinAABB(this.world, EntityLiving.class, GetMOP.newAABB(this, 5.0), this.getPositionVector()) : GetMOP.findNearestEnemy(this.world, this.thrower, this.posX, this.posY, this.posZ, 6.0, false);
            ...
            if (this.enemy != null) {
                SuperKnockback.applyMove(this, this.jump > 0 ? -0.1F : -0.08F, this.enemy.posX, this.enemy.posY + this.rand.nextFloat() * this.enemy.height, this.enemy.posZ);
