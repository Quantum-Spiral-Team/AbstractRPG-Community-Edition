...
public class ParticleGore extends Entity {
    ...
    public ParticleGore(World world, ResourceLocation texture, float scale, float gravity, int livetime, ModelRenderer box, double x, double y, double z, double speedx, double speedy, double speedz) {
        super(world);
