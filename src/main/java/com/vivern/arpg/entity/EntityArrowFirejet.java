...
public class EntityArrowFirejet extends AbstractArrow {
    ...
    public void handleStatusUpdate(byte id) {
        if (id == 8) {
            GUNParticle bigsmoke1 = new GUNParticle(circle, 0.04F, 0.0F, 10, 220, this.world, this.posX, this.posY, this.posZ, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, true, this.rand.nextInt(360));
    ...
    public void onEntityUpdate() {
        ...
        if (this.world.isRemote && this.ticksExisted > 1 && !this.inGround && this.pos1.lengthSquared() > 1.0E-6 && this.pos2.lengthSquared() > 1.0E-6) {
            BetweenParticle laser = new BetweenParticle(this.world, texture, 0.11F, 220, 0.98F, 0.95F, 1.0F, 0.1F, this.pos1.distanceTo(this.pos2), 8, 0.3F, 2.0F, this.pos1, this.pos2);
