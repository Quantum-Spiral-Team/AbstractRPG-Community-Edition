...
public class WandColdShoot extends StandardBullet {
    ...
    public void onUpdate() {
        ...
        if (this.world.isRemote) {
            ...
            GUNParticle fire2 = new GUNParticle(snowflake6, scl, 0.0F, lt, 200, this.world, this.lastTickPosX + this.rand.nextGaussian() / 15.0, this.lastTickPosY + this.height / 2.0F + this.rand.nextGaussian() / 15.0, this.lastTickPosZ + this.rand.nextGaussian() / 15.0, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, true, this.rand.nextInt(360));
    ...
    public void handleStatusUpdate(byte id) {
        if (id == 8) {
            for (int ss = 0; ss < this.rand.nextInt(6) + 7; ss++) {
                ...
                int lt = this.rand.nextInt(5) + 10;
                GUNParticle fire2 = new GUNParticle(snowflake6, scl, 0.0F, lt, 200, this.world, this.lastTickPosX, this.lastTickPosY + this.height / 2.0F, this.lastTickPosZ, (float) this.rand.nextGaussian() / 14.0F, (float) this.rand.nextGaussian() / 14.0F, (float) this.rand.nextGaussian() / 14.0F, 1.0F, 1.0F, 1.0F, true, this.rand.nextInt(360));
    ...
    public void onImpact(RayTraceResult result) {
        if (result.entityHit != null) {
            if (Team.checkIsOpponent(this.thrower, result.entityHit) && !this.world.isRemote && Weapons.canDealDamageTo(result.entityHit)) {
                ...
                if (Weapons.dealDamage(new WeaponDamage(this.weaponstack, this.getThrower(), this, false, true, this, WeaponDamage.frost), parameters.getEnchantedF("damage", might) * this.magicPower, this.getThrower(), result.entityHit, true, parameters.getEnchantedF("knockback", impulse))) {
            ...
            WeaponParameters parameters = WeaponParameters.getWeaponParameters(this.weaponstack.getItem());
            if (!this.world.isRemote && this.impacts > WeaponParameters.getWeaponParameters(this.weaponstack.getItem()).getEnchantedI("max_bounces", EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.SPECIAL, this.weaponstack))) {
                this.world.setEntityState(this, (byte) 8);
                this.setDead();
            }
        }
