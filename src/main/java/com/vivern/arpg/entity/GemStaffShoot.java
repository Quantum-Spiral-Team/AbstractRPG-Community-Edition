...
public class GemStaffShoot extends EntityThrowable implements IRenderOptions {
    ...
    public void onUpdate() {
        ...
        if (!this.world.isRemote) {
            ...
            GUNParticle fire2 = new GUNParticle(cloud, 0.21F, 0.0F, 14, 240, this.world, this.posX, this.posY, this.posZ, 0.0F, 0.0F, 0.0F, this.red, this.green, this.blue, true, this.rand.nextInt(360));
    ...
    public void spawnpart(float red, float green, float blue) {
        for (int ss = 0; ss < this.rand.nextInt(8) + 6; ss++) {
            GUNParticle part = new GUNParticle(tex, 0.06F + this.rand.nextFloat() / 30.0F, 0.002F, 30 + this.rand.nextInt(20), 240, this.world, this.lastTickPosX, this.lastTickPosY, this.lastTickPosZ, (float) this.rand.nextGaussian() / 17.0F, (float) this.rand.nextGaussian() / 17.0F, (float) this.rand.nextGaussian() / 17.0F, red, green, blue, false, 0, true, 1.2F);
    ...
    protected void onImpact(RayTraceResult result) {
        if (!this.world.isRemote) {
            if (result.entityHit != null) {
                if ((this.damagedList == null || !this.damagedList.contains(result.entityHit)) && Team.checkIsOpponent(this.thrower, result.entityHit) && Weapons.canDealDamageTo(result.entityHit)) {
                    Weapons.dealDamage(new WeaponDamage(this.weaponstack, this.getThrower(), this, false, true, this, WeaponDamage.magic), this.damage * this.magicPower, this.getThrower(), result.entityHit, true, this.knockback);
