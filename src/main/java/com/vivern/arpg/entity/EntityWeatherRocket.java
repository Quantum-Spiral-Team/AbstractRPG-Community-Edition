...
public class EntityWeatherRocket extends StandardBullet implements RenderModule.IRenderModuleOverride {
    ...
    public void onUpdate() {
        ...
        if (!this.world.isRemote) {
            ...
            float scl = 0.16F;
            GUNParticle part = new GUNParticle(star2, scl, 0.002F, lt, 240, this.world, this.posX, this.posY, this.posZ, 0.0F, -0.01F, 0.0F, this.getRED(), this.getGREEN(), this.getBLUE(), true, this.rand.nextInt(360));
    ...
    public void handleStatusUpdate(byte id) {
        if (id == 11) {
            this.world.playSound(this.posX, this.posY, this.posZ, Sounds.weather_firework_explode, SoundCategory.AMBIENT, 10.0F, 0.9F + this.rand.nextFloat() / 5.0F, false);
            ParticleFastSummon.round2(this.world, ParticleFastSummon.circle2, this.getPositionVector(), 0.1F, 30.0F, 40, 240, this.getRED(), this.getGREEN(), this.getBLUE(), 2);
            float r = this.getRED();
            ...
            for (int i = 0; i < 25; i++) {
                ...
                float scl = 0.25F;
                GunPEmitter part = new GunPEmitter(star3, scl * 6.0F, 0.002F, lt, 240, this.world, this.posX + this.motionX * this.rand.nextFloat(), this.posY + this.motionY * this.rand.nextFloat(), this.posZ + this.motionZ * this.rand.nextFloat(), (float) this.rand.nextGaussian(), (float) this.rand.nextGaussian() * 0.5F + 0.5F, (float) this.rand.nextGaussian(), r, g, b, true, 3, false, star2, scl * 1.5F, 0.003F, EElt, 240, 250.0F, 250.0F, 250.0F, r, g, b, true);
                part.alpha = 3.0F;
