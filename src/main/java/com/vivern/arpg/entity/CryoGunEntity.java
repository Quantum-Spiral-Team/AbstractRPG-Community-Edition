...
public class CryoGunEntity extends EntityThrowable {
    ...
    public void handleStatusUpdate(byte id) {
        if (id == 5) {
            this.world.playSound(this.posX, this.posY, this.posZ, Sounds.cryo_gun_impact, SoundCategory.AMBIENT, 0.7F, 0.9F + this.rand.nextFloat() / 5.0F, false);

            for (int ss = 0; ss < 8; ss++) {
                GUNParticle bigsmoke = new GUNParticle(this.largecloud, 0.8F + (float) this.rand.nextGaussian() / 8.0F, -0.003F, 20 + this.rand.nextInt(10), 240, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 16.0F, (float) this.rand.nextGaussian() / 16.0F, (float) this.rand.nextGaussian() / 16.0F, 0.75F + this.rand.nextFloat() / 10.0F, 1.0F, 1.0F, true, this.rand.nextInt(360));
            ...
            for (int ss = 0; ss < this.rand.nextInt(4) + 1; ss++) {
                GUNParticle bigsmoke = new GUNParticle(this.snow, 0.3F + (float) this.rand.nextGaussian() / 15.0F, 0.02F, 50, 150, this.world, this.prevPosX, this.prevPosY, this.prevPosZ, (float) this.rand.nextGaussian() / 10.0F, (float) this.rand.nextGaussian() / 10.0F, (float) this.rand.nextGaussian() / 10.0F, 0.9F + this.rand.nextFloat() / 10.0F, 1.0F, 1.0F, true, this.rand.nextInt(360), true, 1.6F);
        ...
        if (id == 8) {
            GUNParticle snow2 = new GUNParticle(this.snow, 0.15F + (float) this.rand.nextGaussian() / 25.0F, -0.005F, 10 + this.rand.nextInt(5), 150, this.world, this.posX, this.posY, this.posZ, 0.0F, 0.0F, 0.0F, 0.9F + this.rand.nextFloat() / 10.0F, 1.0F, 1.0F, true, this.rand.nextInt(100) - 50);
