    ...
    public void handleStatusUpdate(byte id) {
        if (id == 15) {
            for (int ss = 0; ss < 10; ss++) {
                GUNParticle bigsmoke = new GUNParticle(largesmoke, 0.1F + (float) this.rand.nextGaussian() / 20.0F, 0.0F, 8, 240, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 20.0F, (float) this.rand.nextGaussian() / 20.0F, (float) this.rand.nextGaussian() / 20.0F, 0.7F, 0.6F + (float) this.rand.nextGaussian() / 5.0F, 1.0F, true, this.rand.nextInt(360));
        ...
        if (id == 8) {
            ...
            for (int i = 0; i < countOfParticles; i++) {
                ...
                GUNParticle particle = new GUNParticle(stick, 0.07F + (float) this.rand.nextGaussian() / 30.0F, 0.0F, 20, 200, this.world, this.posX + X * 15.0F, this.posY + Y * 15.0F, this.posZ + Z * 15.0F, -X, -Y, -Z, red - (float) this.rand.nextGaussian() / 10.0F, green - (float) this.rand.nextGaussian() / 10.0F, blue - (float) this.rand.nextGaussian() / 10.0F, false, this.rand.nextInt(360));
        ...
        if (id == 9) {
            this.world.playSound(this.posX, this.posY, this.posZ, Sounds.vacuum_gun_impact, SoundCategory.AMBIENT, 1.8F, 1.0F, false);
            GUNParticle bigsmoke1 = new GUNParticle(explode, 2.0F, 0.0F, 20, 240, this.world, this.lastTickPosX, this.lastTickPosY, this.lastTickPosZ, 0.0F, 0.0F, 0.0F, 0.9F + this.rand.nextFloat() / 10.0F, 0.9F + this.rand.nextFloat() / 10.0F, 1.0F, true, this.rand.nextInt(360));
        ...
        if (id == 5) {
            GUNParticle fire2 = new GUNParticle(cloud, 0.17F, 0.0F, 10, 240, this.world, this.posX, this.posY, this.posZ, 0.0F, 0.0F, 0.0F, 0.7F + (float) this.rand.nextGaussian() / 7.0F, 0.5F + (float) this.rand.nextGaussian() / 7.0F, 1.0F, true, this.rand.nextInt(360));
        ...
        if (spec) {
            for (Entity entity : GetMOP.getEntitiesInAABBof(this.world, this, damageRadius, this)) {
                if (Team.checkIsOpponent(this.getThrower(), entity)) {
                    ...
                    SuperKnockback.applyKnockback(entity, parameters.getEnchantedF("attract_knockback", impulse), this.posX, this.posY, this.posZ);
                }
            }
        } else {
            ...
            if (!list.isEmpty()) {
                ...
                for (EntityLivingBase entitylivingbase : list) {
                    SuperKnockback.applyKnockback(entitylivingbase, parameters.getEnchantedF("attract_knockback", impulse), this.posX, this.posY, this.posZ);
                }
            }
        }
        ...
        if (!list.isEmpty()) {
            for (Entity entity : list) {
                if (Team.checkIsOpponent(this.thrower, entity)) {
                    ...
                    int impulse = EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.IMPULSE, this.weaponstack);
                    Weapons.dealDamage(new WeaponDamage(this.weaponstack, this.getThrower(), this, false, false, this, WeaponDamage.portal), parameters.getEnchantedF("damage", might), this.getThrower(), entity, true, parameters.getEnchantedF("knockback", impulse), this.posX, this.posY, this.posZ);
