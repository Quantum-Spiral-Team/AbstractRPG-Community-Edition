...
public class EntityArrowTwin extends AbstractArrow implements ISynchronizedEntity {
    ...
    public void onHit(RayTraceResult raytraceResultIn) {
        ...
        if (this.entityStucked == null || entityhit == null) {
            if (!this.world.isRemote && (this.shootingEntity == null || entityhit != this.shootingEntity || this.ticksExisted >= 10) && entityhit != null && entityhit.isEntityAlive() && (entityhit.width > 0.25 || entityhit.height > 0.25) && Weapons.canDealDamageTo(entityhit) && !(entityhit instanceof EntityArrow)) {
                ...
                ISynchronizedEntity.sendSynchronize(this, 64.0, this.rotationPitch, this.rotationYaw, entityhit.getEntityId(), this.stuckedX, this.stuckedY, this.stuckedZ);
                this.stucked = true;
                this.livetimeAir = 450;
            }
    ...
    public void onUpdate() {
        ...
        if (this.entityStucked != null) {
            if (this.entityStucked.isEntityAlive()) {
                this.setPosition(this.entityStucked.posX + this.stuckedX, this.entityStucked.posY + this.stuckedY, this.entityStucked.posZ + this.stuckedZ);
                this.ticksStucked++;
            } else {
                this.stucked = false;
                    ...
                    if (this.ticksExisted % 5 == 0) {
                        ...
                        if (dist > 0.8 && dist < 8.0) {
                            if (!this.active && (this.timeInGround > 14 || this.ticksStucked > 14)) {
                                ...
                                Vec3d point2 = this.twin.getPositionVector().subtract(GetMOP.pitchYawToVec3D(-this.twin.rotationPitch, -this.twin.rotationYaw).scale(0.6));
                                if (this.pickupStatus == PickupStatus.ALLOWED && GetMOP.thereIsNoBlockCollidesBetween(this.world, point1, point2, null, false)) {
                                    this.active = true;
                                ...
                                if (GetMOP.thereIsNoBlockCollidesBetween(this.world, point1, point2, null, false)) {
                                    ...
                                    for (Entity entity : list) {
                                        if (Team.checkIsOpponent(this.shootingEntity, entity)) {
                                            ...
                                            Weapons.dealDamage(new WeaponDamage(null, this.shootingEntity, this, false, false, point1, WeaponDamage.electric), damageDealen, this.shootingEntity, entity, true);
    ...
    public void doArcParticle(Vec3d pos1, Vec3d pos2) {
        ...
        BetweenParticle laser = new BetweenParticle(this.world, texture, 0.19F + this.rand.nextFloat() * 0.1F - (float) (dist * 0.02), 240, 0.9F, 1.0F, 1.0F, 0.0F, dist, 1, (this.rand.nextFloat() - 0.5F) * 0.1F, this.rand.nextFloat() - 0.5F + 0.8F, pos1, pos2);
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn) {
        if (!this.world.isRemote && this.inGround && this.arrowShake <= 0) {
            ...
            if (flag && this.twin != null && this.twin.isEntityAlive() && this.getDistanceSq(this.twin) <= 3.0 && entityIn.inventory.addItemStackToInventory(this.getArrowStack())) {
