    ...
    public void handleStatusUpdate(byte id) {
        if (id == 1) {
            for (int ss = 0; ss < 9; ss++) {
                Entity air = new GUNParticle(this.puff, 0.2F, 0.0F, 9, Math.round(180.0F + (float) this.rand.nextGaussian() * 50.0F), this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 16.0F, (float) this.rand.nextGaussian() / 16.0F, (float) this.rand.nextGaussian() / 16.0F, 1.0F, 1.0F, 1.0F, true, 0);
        ...
        if (id == 2) {
            for (int ss = 0; ss < 6; ss++) {
                Entity earth = new EntityCubicParticle(this.boulder, 0.013F, 0.015F, 12 + this.rand.nextInt(4), 89, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 14.0F, (float) this.rand.nextGaussian() / 14.0F, (float) this.rand.nextGaussian() / 14.0F, 1.0F, 1.0F, 1.0F, false, this.rand.nextFloat(), this.rand.nextFloat(), this.rand.nextFloat(), 0.14F, true, 0.0F);
        ...
        if (id == 3) {
            for (int ss = 0; ss < 10; ss++) {
                Entity fire = new GUNParticle(this.sparkle, 0.07F + (float) this.rand.nextGaussian() / 30.0F, -0.01F, 7, 240, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 12.0F, (float) this.rand.nextGaussian() / 12.0F, (float) this.rand.nextGaussian() / 12.0F, 1.0F, 0.8F + (float) this.rand.nextGaussian() / 5.0F, 1.0F, true, 0);
        ...
        if (id == 4) {
            for (int ss = 0; ss < 8; ss++) {
                Entity water = new GUNParticle(this.bubble, 0.08F + (float) this.rand.nextGaussian() / 30.0F, 0.017F, 10, 160, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 10.0F, (float) this.rand.nextGaussian() / 10.0F, (float) this.rand.nextGaussian() / 10.0F, 0.8F + (float) this.rand.nextGaussian() / 5.0F, 1.0F, 1.0F, true, 0);
                this.world.spawnEntity(water);
            }
        }

        if (id == 11) {
            Entity air = new GUNParticle(this.puff, 0.13F, 0.0F, 9, Math.round(190.0F + (float) this.rand.nextGaussian() * 40.0F), this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 30.0F, (float) this.rand.nextGaussian() / 30.0F, (float) this.rand.nextGaussian() / 30.0F, 1.0F, 1.0F, 1.0F, true, 0);
            this.world.spawnEntity(air);
        }

        if (id == 12) {
            Entity earth = new EntityCubicParticle(this.boulder, 0.005F, 0.01F, 12 + this.rand.nextInt(4), 89, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 44.0F, (float) this.rand.nextGaussian() / 44.0F, (float) this.rand.nextGaussian() / 44.0F, 1.0F, 1.0F, 1.0F, false, 1.0F, 1.0F, 1.0F, 0.06F, true, 0.0F);
            this.world.spawnEntity(earth);
        }

        if (id == 13) {
            Entity fire = new GUNParticle(this.sparkle, 0.07F, -0.004F, 7, 240, this.world, this.posX, this.posY, this.posZ, 0.0F, 0.0F, 0.0F, 1.0F, 0.8F + (float) this.rand.nextGaussian() / 5.0F, 1.0F, true, 0);
            this.world.spawnEntity(fire);
        }

        if (id == 14) {
            Entity water = new GUNParticle(this.bubble, 0.08F, 0.01F, 10, 160, this.world, this.posX, this.posY, this.posZ, (float) this.rand.nextGaussian() / 20.0F, (float) this.rand.nextGaussian() / 20.0F, (float) this.rand.nextGaussian() / 20.0F, 0.8F + (float) this.rand.nextGaussian() / 5.0F, 1.0F, 1.0F, true, 0);
            this.world.spawnEntity(water);
        }
    ...
    protected void onImpact(RayTraceResult result) {
        ...
        if (this.type == 1) {
            if (result.entityHit != null && result.entityHit != this.thrower && result.entityHit instanceof EntityLivingBase) {
                ...
                SuperKnockback.applyKnockback(base, 1.3F + impulse / 2.0F, this.thrower.posX, this.thrower.posY, this.thrower.posZ);
        ...
        if (this.type == 2) {
            if (result.entityHit != null && result.entityHit != this.thrower && result.entityHit instanceof EntityLivingBase) {
                ...
                base.hurtResistantTime = 0;
                SuperKnockback.applyKnockback(base, 3.0F + impulse / 1.7F, this.thrower.posX, this.thrower.posY, this.thrower.posZ);
                entityAttribute.setBaseValue(baseValue);
            }
            ...
            if (!list.isEmpty()) {
                for (EntityLivingBase base : list) {
                    if (base != this.getThrower()) {
                        ...
                        base.hurtResistantTime = 0;
                        SuperKnockback.applyKnockback(base, 0.5F + impulse / 6.0F, this.thrower.posX, this.thrower.posY, this.thrower.posZ);
                        entityAttribute.setBaseValue(baseValue);
                        base.setFire(2);
                    }
                }
        ...
        if (this.type == 4) {
            if (result.entityHit != null && result.entityHit != this.thrower && result.entityHit instanceof EntityLivingBase) {
                ...
                SuperKnockback.applyKnockback(basex, 1.7F + impulse / 3.5F, this.thrower.posX, this.thrower.posY, this.thrower.posZ);
                entityAttribute.setBaseValue(baseValue);
                basex.extinguish();
