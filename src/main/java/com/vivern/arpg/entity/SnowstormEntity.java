...
public class SnowstormEntity extends EntityThrowable {
    ...
    public void handleStatusUpdate(byte id) {
        if (id == 5) {
            this.world.playSound(this.posX, this.posY, this.posZ, SoundEvents.BLOCK_GLASS_HIT, SoundCategory.AMBIENT, 0.3F, 1.15F + this.rand.nextFloat() / 10.0F, false);
            EntityCubicParticle spel = new EntityCubicParticle(this.icecube, 0.006F, 0.0F, 32 + this.rand.nextInt(14), 99, this.world, this.posX, this.posY, this.posZ, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, true, 1.0F, 1.0F, 1.0F, 0.0F, true, 0.0022F);
            spel.maxsize = 0.04F;
    ...
    protected void onImpact(RayTraceResult result) {
        ...
        if (result.entityHit != null && result.entityHit instanceof EntityLivingBase) {
            ...
            if (entitylivingbase != this.getThrower() && !this.impacted) {
                ...
                entitylivingbase.attackEntityFrom(DamageSource.causePlayerDamage((EntityPlayer) this.getThrower()), 2.0F + EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.MIGHT, this.weaponstack) / 2.0F);
