...
public class Render2D<T extends Entity> extends Render<T> {
    ...
    public Render2D(RenderManager renderManagerIn, ResourceLocation texture, float scaleX, float scaleY, float scaleZ, float rotationx, float rotationy, float rotationz, boolean opaq, int light, DestFactor dstFactor, boolean checkAdvanced, float r, float g, float b) {
