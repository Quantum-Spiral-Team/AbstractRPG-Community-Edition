...
public class Sounds {
    ...
    public static SoundEvent STONE_CHEST_CLOSE;
    public static SoundEvent STONE_CHEST_OPEN;
    public static SoundEvent METAL_CHEST_CLOSE;
    public static SoundEvent METAL_CHEST_OPEN;
    public static SoundEvent chest_close_bones;
    public static SoundEvent chest_open_bones;
    public static SoundEvent PLASMA_CHEST_CLOSE;
    public static SoundEvent PLASMA_CHEST_OPEN;
