...
public class BlockBreaking {
    ...
    public int damageMultiblock(IMultiblockBreakHandler handler, @Nullable EntityPlayer player, BlockPos pos, float hardnessAmount, String tool, int toolLevel, int fortune, boolean withSilkTouch) {
    ...
    public class BreakingProgress {
        ...
        public boolean damageBlock(@Nullable EntityPlayer player, WorldServer world, float hardnessAmount, String tool, int toolLevel, int fortune, boolean withSilkTouch) {
        ...
        public int damageMultiblock(IMultiblockBreakHandler handler, @Nullable EntityPlayer player, WorldServer world, float hardnessAmount, String tool, int toolLevel, int fortune, boolean withSilkTouch) {
            IBlockState blockState = world.getBlockState(this.pos);
