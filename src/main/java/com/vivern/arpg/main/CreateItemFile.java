...
public class CreateItemFile {
    ...
    public static void customPlantResLocationCreate(Block block, int type) {
        if (enable) {
            if (type != 3) {
                ...
                resLocationCreate(mainPatch + "blockstates/" + itemname + ".json", "{\r\n  \"forge_marker\": 1,\r\n  \"defaults\": {\r\n\t\r\n  },\r\n  \"variants\": {\r\n    \r\n    \"growed=false\": { \"model\": \"arpg:" + itemname + "0\"},\r\n\t\"growed=true\": { \"model\": \"arpg:" + itemname + "1\"}\r\n\t\r\n  }\r\n}\r\n");
                if (type == 1) {
                    resLocationCreate(mainPatch + "models/block/" + itemname + "0.json", "{\r\n    \"parent\": \"block/tinted_cross\",\r\n    \"textures\": {\r\n        \"cross\": \"arpg:customplants/" + itemname + "0\"\r\n    }\r\n}\r\n");
                    resLocationCreate(mainPatch + "models/block/" + itemname + "1.json", "{\r\n    \"parent\": \"block/tinted_cross\",\r\n    \"textures\": {\r\n        \"cross\": \"arpg:customplants/" + itemname + "1\"\r\n    }\r\n}\r\n");
                }
                ...
                resLocationCreate(mainPatch + "models/item/" + itemname + "_seed.json", "{\r\n  \"parent\": \"item/generated\",\r\n  \"textures\": {\r\n    \"layer0\": \"arpg:customplants/" + itemname + "_seed\"\r\n  }\r\n}");
            }
        }
    }
    ...
    public static void resLocationCreate(Block block) {
        if (enable) {
            ...
            resLocationCreate(mainPatch + "models/block/" + itemname + ".json", "{\r\n    \"parent\": \"block/cube_all\",\r\n    \"textures\": {\r\n        \"all\": \"arpg:" + itemname + "\"\r\n    }\r\n}\r\n");
    ...
    public static void resLocationCreateColumn(Block block, String top, String side) {
        if (enable) {
            String itemname = block.getTranslationKey().replaceFirst("tile.", "");
            resLocationCreate(mainPatch + "blockstates/" + itemname + ".json", "{\r\n    \"forge_marker\": 1,\r\n    \"defaults\":\r\n    {\r\n        \"transform\": \"forge:default-block\",\r\n        \"model\": \"cube_column\",\r\n        \"textures\": {\"end\": \"arpg:" + top + "\",\"side\": \"arpg:" + side + "\"}\r\n    },\r\n    \"variants\": {    \r\n        \"normal\": [{}], \"inventory\": [{}],\r\n        \"axis\": { \"x\":{\"x\": 90, \"y\": 90}, \"y\":{}, \"z\":{\"x\": 90} }\r\n    }\r\n}");
        }
    }
    ...
    public static void rotatedBlockResLocationCreate(Block block) {
        if (enable) {
            String itemname = block.getTranslationKey().replaceFirst("tile.", "");
            resLocationCreate(mainPatch + "blockstates/" + itemname + ".json", "{\r\n  \"forge_marker\": 1,\r\n  \"defaults\": {\r\n    \"textures\": {\r\n      \"0\": \"arpg:" + itemname + "\",\r\n\t  \"particle\": \"arpg:" + itemname + "\",\r\n\t  \"model\": \"arpg:" + itemname + "\"\r\n    }\r\n  },\r\n  \"variants\": {\r\n    \"facing=east\": { \"model\": \"arpg:" + itemname + "\" },\r\n    \"facing=south\": { \"model\": \"arpg:" + itemname + "\", \"y\": 90 },\r\n    \"facing=west\": { \"model\": \"arpg:" + itemname + "\", \"y\": 180 },\r\n    \"facing=north\": { \"model\": \"arpg:" + itemname + "\", \"y\": 270 }\r\n  }\r\n}\r\n");
            resLocationCreate(mainPatch + "models/item/" + itemname + ".json", "{\r\n    \"parent\": \"arpg:block/" + itemname + "\"\r\n}");
        }
    }
    ...
    public static void resLocationCreateStalact(String blockname, String secname) {
        if (enable) {
            resLocationCreate(mainPatch + "blockstates/" + blockname + ".json", "{\r\n    \"variants\": {\r\n        \"variant=s1\": { \"model\": \"arpg:stalacts/" + secname + "1\" },\r\n\t\t\"variant=s2\": { \"model\": \"arpg:stalacts/" + secname + "2\" },\r\n\t\t\"variant=s3\": { \"model\": \"arpg:stalacts/" + secname + "3\" },\r\n\t\t\"variant=s4\": { \"model\": \"arpg:stalacts/" + secname + "4\" },\r\n\t\t\"variant=s5\": { \"model\": \"arpg:stalacts/" + secname + "5\" }\r\n    }\r\n}");

            for (int ii = 1; ii < 6; ii++) {
                resLocationCreate(mainPatch + "models/block/stalacts/" + secname + ii + ".json", "{\r\n    \"parent\": \"block/tinted_cross\",\r\n    \"textures\": {\r\n        \"cross\": \"arpg:stalacts/" + secname + ii + "\"\r\n    }\r\n}\r\n");
            }
    ...
    public static void resLocationCreateSpeleothem(String name) {
        if (enable) {
            for (int x = 0; x < 5; x++) {
                for (int y = 0; y < 5; y++) {
                    ...
                    try (FileWriter writer = new FileWriter(file, false)) {
                        ...
                        String text = "{\r\n    \"ambientocclusion\": false,\r\n    \"textures\": {\r\n        \"0\": \"arpg:stalacts/" + name + "\"\r\n    },\r\n    \"elements\": [\r\n        {\r\n            \"from\": [ -2, 0, 8 ], \r\n            \"to\": [ 18, 16, 8 ], \r\n            \"rotation\": { \"origin\": [ 8, 8, 8 ], \"axis\": \"y\", \"angle\": 45.0 },\r\n            \"faces\": {\r\n                \"north\": { \"texture\": \"#0\", \"uv\": " + arrayText + " },\r\n                \"south\": { \"texture\": \"#0\", \"uv\": " + arrayText + " }\r\n            }\r\n        },\r\n        {\r\n            \"from\": [ -2, 0, 8 ], \r\n            \"to\": [ 18, 16, 8 ], \r\n            \"rotation\": { \"origin\": [ 8, 8, 8 ], \"axis\": \"y\", \"angle\": -45.0 },\r\n            \"faces\": {\r\n                \"north\": { \"texture\": \"#0\", \"uv\": " + arrayText + " },\r\n                \"south\": { \"texture\": \"#0\", \"uv\": " + arrayText + " }\r\n            }\r\n        }\r\n    ]\r\n}";
                        writer.write(text);
                        writer.flush();
            ...
            try (FileWriter writer = new FileWriter(file, false)) {
                String text = "{\r\n    \"forge_marker\": 1,\r\n    \"defaults\":\r\n    {\r\n        \"transform\": \"forge:default-block\",\r\n        \"textures\": {\r\n\t\t\"particle\": \"arpg:stalacts/" + name + "\"\r\n        }\r\n    },\r\n    \"variants\": {\r\n\t\t\"normal\": [{}], \r\n\t\t\"type=0\": [\r\n            { \"model\": \"arpg:stalacts/" + name + "00\" },\r\n            { \"model\": \"arpg:stalacts/" + name + "10\" },\r\n\t\t\t{ \"model\": \"arpg:stalacts/" + name + "20\" }\r\n        ],\r\n\t\t\"type=1\": [\r\n            { \"model\": \"arpg:stalacts/" + name + "01\" },\r\n            { \"model\": \"arpg:stalacts/" + name + "11\" },\r\n\t\t\t{ \"model\": \"arpg:stalacts/" + name + "21\" }\r\n        ],\r\n\t\t\"type=2\": [\r\n            { \"model\": \"arpg:stalacts/" + name + "02\" },\r\n            { \"model\": \"arpg:stalacts/" + name + "12\" },\r\n\t\t\t{ \"model\": \"arpg:stalacts/" + name + "22\" }\r\n        ],\r\n\t\t\"type=3\": [\r\n            { \"model\": \"arpg:stalacts/" + name + "03\" },\r\n            { \"model\": \"arpg:stalacts/" + name + "13\" },\r\n\t\t\t{ \"model\": \"arpg:stalacts/" + name + "23\" }\r\n        ],\r\n\t\t\"type=4\": [\r\n            { \"model\": \"arpg:stalacts/" + name + "04\" },\r\n            { \"model\": \"arpg:stalacts/" + name + "14\" },\r\n\t\t\t{ \"model\": \"arpg:stalacts/" + name + "24\" }\r\n        ],\r\n\t\t\"type=5\": [\r\n            { \"model\": \"arpg:stalacts/" + name + "30\" },\r\n            { \"model\": \"arpg:stalacts/" + name + "40\" },\r\n\t\t\t{ \"model\": \"arpg:stalacts/" + name + "32\" }\r\n        ],\r\n\t\t\"type=6\": [\r\n            { \"model\": \"arpg:stalacts/" + name + "34\" },\r\n            { \"model\": \"arpg:stalacts/" + name + "44\" },\r\n\t\t\t{ \"model\": \"arpg:stalacts/" + name + "42\" }\r\n        ],\r\n\t\t\"type=7\": [\r\n            { \"model\": \"arpg:stalacts/" + name + "31\" },\r\n            { \"model\": \"arpg:stalacts/" + name + "41\" }\r\n        ],\r\n\t\t\"type=8\": [\r\n            { \"model\": \"arpg:stalacts/" + name + "33\" },\r\n            { \"model\": \"arpg:stalacts/" + name + "43\" }\r\n        ]\r\n\t\t\r\n  }\r\n}";
                writer.write(text);
                writer.flush();
    ...
    public static void generateTexture(ModelBase model, String name, boolean doubleSize, BufferedImage decorSample, int seedCol, int seedTex, java.awt.Color... colors) {
    ...
    public static void drawModelBox(ModelRenderer renderer, int sizeM, BufferedImage image, java.awt.Color colorInside, java.awt.Color colorBound, BufferedImage sample, Random rand) {
        ...
        drawBoundedQuad(textureOffsetX * sizeM, sizez * sizeM + textureOffsetY * sizeM, sizez * sizeM, sizey * sizeM, image, colorInside, colorBound, 1, seed, sample);
        drawBoundedQuad(textureOffsetX * sizeM + sizez * sizeM, sizez * sizeM + textureOffsetY * sizeM, sizex * sizeM, sizey * sizeM, image, colorInside, colorBound, 2, seed, sample);
        drawBoundedQuad(textureOffsetX * sizeM + sizez * sizeM + sizex * sizeM, sizez * sizeM + textureOffsetY * sizeM, sizez * sizeM, sizey * sizeM, image, colorInside, colorBound, 3, seed, sample);
        drawBoundedQuad(textureOffsetX * sizeM + sizez * 2 * sizeM + sizex * sizeM, sizez * sizeM + textureOffsetY * sizeM, sizex * sizeM, sizey * sizeM, image, colorInside, colorBound, 4, seed, sample);
        drawBoundedQuad(textureOffsetX * sizeM + sizez * sizeM, textureOffsetY * sizeM, sizex * sizeM, sizez * sizeM, image, colorInside, colorBound, 5, seed, sample);
        drawBoundedQuad(textureOffsetX * sizeM + sizez * sizeM + sizex * sizeM, textureOffsetY * sizeM, sizex * sizeM, sizez * sizeM, image, colorInside, colorBound, 6, seed, sample);
    }

    public static void drawBoundedQuad(int x, int y, int width, int height, BufferedImage image, java.awt.Color colorInside, java.awt.Color colorBound, int number, int seed, BufferedImage sample) {
        if (width < 3 && height >= 3) {
    ...
    public static java.awt.Color mix(java.awt.Color color, java.awt.Color color2) {
        return new java.awt.Color((int) ((float) color.getRed() * color2.getRed() / 255.0F), (int) ((float) color.getGreen() * color2.getGreen() / 255.0F), (int) ((float) color.getBlue() * color2.getBlue() / 255.0F));
    }
    ...
    public static int mixIntColors(int color1, int color2, float ratio) {
        ...
        return ColorConverters.RGBAtoDecimal(col1[0] * ratio + col2[0] * unratio, col1[1] * ratio + col2[1] * unratio, col1[2] * ratio + col2[2] * unratio, col1[3] * ratio + col2[3] * unratio);
    }
    ...
    public static int addIntColors(int color1, int color2) {
        ...
        java.awt.Color colres = new java.awt.Color(Math.min(coll1.getRed() + coll2.getRed(), 255), Math.min(coll1.getGreen() + coll2.getGreen(), 255), Math.min(coll1.getBlue() + coll2.getBlue(), 255), Math.min(coll1.getAlpha(), coll2.getAlpha()));
    ...
    public static java.awt.Color hex2Rgb(String colorStr) {
        ...
        return new java.awt.Color(Integer.valueOf(colorStr.substring(0, 2), 16), Integer.valueOf(colorStr.substring(2, 4), 16), Integer.valueOf(colorStr.substring(4, 6), 16));
    }
    ...
    public static void printLang() {
        if (enable) {
            ...
            for (Item item : Item.REGISTRY) {
                if (!(item instanceof ItemBlock) && item.getRegistryName().getNamespace().equals("arpg") && !Ln.canTranslate("item." + item.getRegistryName().getPath() + ".name")) {
                    System.out.print("item." + item.getRegistryName().getPath() + ".name=" + toUpperCaseFirst(item.getRegistryName().getPath().replace('_', ' ')));
                    System.out.print("\n");
                }
            }
            ...
            for (Item itemx : Item.REGISTRY) {
                if (itemx instanceof ItemBlock && itemx.getRegistryName().getNamespace().equals("arpg") && !Ln.canTranslate("tile." + itemx.getRegistryName().getPath() + ".name")) {
                    System.out.print("tile." + itemx.getRegistryName().getPath() + ".name=" + toUpperCaseFirst(itemx.getRegistryName().getPath().replace('_', ' ')));
                    System.out.print("\n");
                }
            }
    ...
    public static BufferedImage blackToColor(BufferedImage image, java.awt.Color color) {
        ...
        for (int xx = 0; xx < image.getWidth(); xx++) {
            for (int yy = 0; yy < image.getHeight(); yy++) {
                ...
                java.awt.Color newcolor = new java.awt.Color((int) MathHelper.clamp(255.0F * unblackness + color.getRed() * blackness, 0.0F, 255.0F), (int) MathHelper.clamp(255.0F * unblackness + color.getGreen() * blackness, 0.0F, 255.0F), (int) MathHelper.clamp(255.0F * unblackness + color.getBlue() * blackness, 0.0F, 255.0F), lastcolor.getAlpha());
    ...
    public static BufferedImage blackToTranslucent(BufferedImage image) {
        ...
        for (int xx = 0; xx < image.getWidth(); xx++) {
            for (int yy = 0; yy < image.getHeight(); yy++) {
                ...
                float blackness = (765 - lastcolor.getRed() - lastcolor.getGreen() - lastcolor.getBlue()) / 765.0F;
                float unblackness = 1.0F - blackness;
                java.awt.Color newcolor = new java.awt.Color(lastcolor.getRed(), lastcolor.getGreen(), lastcolor.getBlue(), (int) MathHelper.clamp(unblackness * 255.0F, 0.0F, 255.0F));
                imagenew.setRGB(xx, yy, newcolor.getRGB());
            }
        }
    ...
    public static BufferedImage blackToTranslucent2(BufferedImage image) {
        ...
        for (int xx = 0; xx < image.getWidth(); xx++) {
            for (int yy = 0; yy < image.getHeight(); yy++) {
                ...
                java.awt.Color newcolor = new java.awt.Color((int) (lastcolor.getRed() * allColorsmultiplier), (int) (lastcolor.getGreen() * allColorsmultiplier), (int) (lastcolor.getBlue() * allColorsmultiplier), MathHelper.clamp(unblackness, 0, 255));
                imagenew.setRGB(xx, yy, newcolor.getRGB());
            }
        }
    ...
    public static BufferedImage powColor(BufferedImage image, float pow) {
        ...
        for (int xx = 0; xx < image.getWidth(); xx++) {
            for (int yy = 0; yy < image.getHeight(); yy++) {
                java.awt.Color lastcolor = new java.awt.Color(image.getRGB(xx, yy));
                java.awt.Color newcolor = new java.awt.Color((int) MathHelper.clamp(Math.pow(lastcolor.getRed() / 255.0, pow) * 255.0, 0.0, 255.0), (int) MathHelper.clamp(Math.pow(lastcolor.getGreen() / 255.0, pow) * 255.0, 0.0, 255.0), (int) MathHelper.clamp(Math.pow(lastcolor.getBlue() / 255.0, pow) * 255.0, 0.0, 255.0), lastcolor.getAlpha());
                imagenew.setRGB(xx, yy, newcolor.getRGB());
            }
        }
    ...
    public static void resampleImageBilinear(BufferedImage oldPixels, BufferedImage newPixels) {
        ...
        for (int j = 0; j < newh; j++) {
            ...
            for (int i = 0; i < neww; i++) {
                ...
                int color = ColorConverters.RGBAtoDecimal((float) (col1.x + col2.x + col3.x + col4.x), (float) (col1.y + col2.y + col3.y + col4.y), (float) (col1.z + col2.z + col3.z + col4.z), 1.0F);
    ...
    public static void networkTest() {
        ...
        float[][] data = new float[][]{{1.0F, 1.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F}, {1.0F, 1.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F}, {1.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F}, {0.0F, 1.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 1.0F, 0.0F}, {0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 1.0F}, {1.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F}, {0.0F, 1.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 1.0F, 0.0F}, {0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 1.0F}, {1.0F, 1.0F, 1.0F, 1.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F}, {1.0F, 1.0F, 1.0F, 0.0F, 1.0F, 0.0F, 0.0F, 1.0F, 0.0F}, {1.0F, 1.0F, 1.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 1.0F}, {1.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, 1.0F, 0.0F, 0.0F}, {0.0F, 1.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, 1.0F, 0.0F}, {0.0F, 0.0F, 1.0F, 1.0F, 1.0F, 1.0F, 0.0F, 0.0F, 1.0F}, {1.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F}, {0.0F, 1.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 1.0F, 1.0F}, {0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, 1.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F}};
        float[][] answers = new float[][]{{1.0F, 0.0F}, {1.0F, 0.0F}, {1.0F, 0.0F}, {1.0F, 0.0F}, {1.0F, 0.0F}, {1.0F, 0.0F}, {0.0F, 1.0F}, {0.0F, 1.0F}, {0.0F, 1.0F}, {0.0F, 1.0F}, {0.0F, 1.0F}, {0.0F, 1.0F}, {1.0F, 1.0F}, {1.0F, 1.0F}, {1.0F, 1.0F}, {1.0F, 1.0F}, {1.0F, 1.0F}, {1.0F, 1.0F}, {1.0F, 1.0F}, {1.0F, 1.0F}, {1.0F, 1.0F}, {0.0F, 0.0F}, {0.0F, 0.0F}, {0.0F, 0.0F}, {0.0F, 0.0F}, {0.0F, 0.0F}, {0.0F, 0.0F}};
    ...
    public static ItemCameraTransforms readJsonItemCameraTransforms(String itemname) {
        try {
            ...
            if (obj instanceof Gson) {
                Gson gsonn = (Gson) obj;
                ItemCameraTransforms cameraTransforms = JsonUtils.gsonDeserialize(gsonn, jsonString, ItemCameraTransforms.class);
