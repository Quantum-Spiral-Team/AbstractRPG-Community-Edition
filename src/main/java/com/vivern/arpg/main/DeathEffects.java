...
public class DeathEffects {
    ...
    public static DeathEffect DE_ICING = new DeathEffect() {
        ...
        public void onRenderLivingPre(RenderLivingEvent.Pre<? extends EntityLivingBase> event, EntityLivingBase entity) {
            ...
            GL11.glEnable(3042);
            Color.doRender(entity, event.getX(), event.getY(), event.getZ(), entity.rotationYaw, event.getPartialRenderTick(), model, DeathEffects.freezing, 0.0F, false);
            GL11.glDisable(3042);
        ...
        public void onLivingUpdate(World world, LivingEvent.LivingUpdateEvent event, EntityLivingBase living, double x, double y, double z) {
            ...
            if (living.deathTime == 19) {
                for (int i = 0; i < Math.min(living.getMaxHealth() / 5.0F, 10.0F); i++) {
                    GunPEmitter emi = new GunPEmitter(DeathEffects.snowflake2, 0.3F, 0.06F, 30, 240, world, x, y, z, (float) RANDOM.nextGaussian() / 4.0F, (float) RANDOM.nextGaussian() / 4.0F + 0.3F, (float) RANDOM.nextGaussian() / 4.0F, 1.0F, 1.0F, 1.0F, true, 1, false, DeathEffects.snowflake2, 0.35F, 0.0F, 10, 100, 100.0F, 100.0F, 100.0F, 1.0F, 1.0F, 1.0F, true);
                    world.spawnEntity(emi);
                }

                for (int i = 0; i < Math.min(living.getMaxHealth() / 2.0F, 15.0F); i++) {
                    Entity spel = new EntityCubicParticle(DeathEffects.ice_cube, 0.02F, 0.02F, 20 + RANDOM.nextInt(10), 90 + RANDOM.nextInt(9), world, x, y + 0.5, z, (float) RANDOM.nextGaussian() / 9.0F, (float) RANDOM.nextGaussian() / 9.0F + 0.3F, (float) RANDOM.nextGaussian() / 9.0F, 1.0F, 1.0F, 1.0F, true, RANDOM.nextFloat(), RANDOM.nextFloat(), RANDOM.nextFloat(), 0.05F, true, -3.0E-4F);
                    world.spawnEntity(spel);
                    Entity spelll = new GUNParticle(DeathEffects.snowflake3, 0.57F, 0.005F, 20 + RANDOM.nextInt(10), 240, world, x, y + 0.8, z, (float) RANDOM.nextGaussian() / 20.0F, (float) RANDOM.nextGaussian() / 20.0F + 0.1F, (float) RANDOM.nextGaussian() / 20.0F, 1.0F, 1.0F, 0.9F + (float) RANDOM.nextGaussian() / 10.0F, false, RANDOM.nextInt(360));
    ...
    public static DeathEffect DE_SAND = new DeathEffect() {
        ...
        public void onRenderLivingPre(RenderLivingEvent.Pre<? extends EntityLivingBase> event, EntityLivingBase living) {
            ModelBase model = event.getRenderer().getMainModel();
            GlStateManager.pushMatrix();
            Color.doRender(living, event.getX(), event.getY(), event.getZ(), living.rotationYaw, event.getPartialRenderTick(), model, ClientProxy.sand.get(living.deathTime - 1), 0.0F, false);
            event.setCanceled(true);
            GlStateManager.popMatrix();
        }
        ...
        public void onLivingUpdate(World world, LivingEvent.LivingUpdateEvent event, EntityLivingBase base, double x, double y, double z) {
            if (base.deathTime == 1) {
                world.playSound(null, x, y, z, Sounds.de_sand, SoundCategory.AMBIENT, 0.8F + RANDOM.nextFloat() / 5.0F, 0.9F + RANDOM.nextFloat() / 5.0F);
            }
            ...
            Entity sandp = new GUNParticle(sandptex, scale, 0.01F, 30 + RANDOM.nextInt(15), -1, world, rX, rY, rZ, (float) RANDOM.nextGaussian() / 30.0F, (float) RANDOM.nextGaussian() / 30.0F, (float) RANDOM.nextGaussian() / 30.0F, 1.0F, 1.0F, 0.9F + (float) RANDOM.nextGaussian() / 10.0F, false, RANDOM.nextInt(360), true, 1.1F);
    ...
    public static DeathEffect DE_COLOREDACID = new DeathEffect() {
        ...
        public void onRenderLivingPre(RenderLivingEvent.Pre<? extends EntityLivingBase> event, EntityLivingBase entity) {
            ...
            Color.doRender(entity, event.getX(), event.getY(), event.getZ(), entity.rotationYaw, event.getPartialRenderTick(), model, ClientProxy.coloredAcidTex.get(mobdeathtime - 1), 0.0F, false);
            GlStateManager.popMatrix();
            GL11.glDisable(3042);
            GL11.glEnable(2896);
            event.setCanceled(true);
        ...
        public void onLivingUpdate(World world, LivingEvent.LivingUpdateEvent event, EntityLivingBase base, double x, double y, double z) {
            if (base.deathTime == 1) {
                world.playSound(null, x, y, z, Sounds.de_acid, SoundCategory.AMBIENT, 0.8F + RANDOM.nextFloat() / 5.0F, 0.9F + RANDOM.nextFloat() / 5.0F);
            }
            ...
            Entity acidp = new GUNParticle(DeathEffects.de_acid_bubble, 0.04F + RANDOM.nextFloat() / 20.0F, -0.01F, 30 + RANDOM.nextInt(25), -1, world, x, y, z, (float) RANDOM.nextGaussian() / 30.0F, (float) RANDOM.nextGaussian() / 30.0F, (float) RANDOM.nextGaussian() / 30.0F, re + (float) RANDOM.nextGaussian() / 10.0F, gr + (float) RANDOM.nextGaussian() / 10.0F, bl + (float) RANDOM.nextGaussian() / 10.0F, true, RANDOM.nextInt(360), false, 1.1F);
    ...
    public static DeathEffect DE_DISMEMBER = new DeathEffect() {
        ...
        public void onLivingUpdate(World world, LivingEvent.LivingUpdateEvent event, EntityLivingBase base, double x, double y, double z) {
            if (base.deathTime == 1) {
                ...
                world.playSound(null, x, y, z, bloodtype.dismemberSound, SoundCategory.NEUTRAL, 0.8F + RANDOM.nextFloat() / 5.0F, 0.9F + RANDOM.nextFloat() / 5.0F);
                ...
                for (int i = 0; i < Math.min(base.getMaxHealth() / 8.0F, 8.0F); i++) {
                    EntityCubicParticle spell = new EntityCubicParticle(DeathEffects.gore, 0.01F + base.height / 100.0F, 0.02F, 20 + RANDOM.nextInt(10), bloodtype.isGlowing ? 240 : 40 + RANDOM.nextInt(9), world, x, y + 0.5, z, (float) RANDOM.nextGaussian() / 13.0F + motionX, (float) RANDOM.nextGaussian() / 25.0F + 0.2F + motionY, (float) RANDOM.nextGaussian() / 13.0F + motionZ, bloodtype.red, bloodtype.green, bloodtype.blue, bloodtype.isAdditiveBlend, RANDOM.nextFloat(), RANDOM.nextFloat(), RANDOM.nextFloat(), 0.05F, true, -3.0E-4F);
                    spell.alphaGlowing = bloodtype.isAdditiveBlend;
                    world.spawnEntity(spell);
                }

                for (int i = 0; i < Math.min(base.getMaxHealth() / 2.0F, 15.0F); i++) {
                    GUNParticle sp = new GUNParticle(DeathEffects.drop, 0.07F + RANDOM.nextFloat() / 20.0F, 0.02F, 50, bloodtype.isGlowing ? 240 : -1, world, x, y + 0.5, z, (float) RANDOM.nextGaussian() / 11.0F, (float) RANDOM.nextGaussian() / 14.0F + 0.3F, (float) RANDOM.nextGaussian() / 11.0F, bloodtype.red, bloodtype.green, bloodtype.blue, false, RANDOM.nextInt(360), true, 5.0F);
                    sp.dropMode = true;
                    ...
                    GUNParticle spelll = new GUNParticle(DeathEffects.blood, 0.15F, 0.015F, livt, bloodtype.isGlowing ? 240 : -1, world, x, y + 0.8, z, (float) RANDOM.nextGaussian() / 20.0F + motionX / 2.0F, (float) RANDOM.nextGaussian() / 22.0F + 0.1F + motionY / 2.0F, (float) RANDOM.nextGaussian() / 20.0F + motionZ / 2.0F, bloodtype.red, bloodtype.green, bloodtype.blue, true, RANDOM.nextInt(360), true, 5.0F);
    ...
    public static DeathEffect DE_ELECTRIC = new DeathEffect() {
        ...
        public void onLivingUpdate(World world, LivingEvent.LivingUpdateEvent event, EntityLivingBase base, double x, double y, double z) {
            if (base.deathTime == 1) {
                world.playSound(null, x, y, z, Sounds.de_electric, SoundCategory.NEUTRAL, 0.8F + RANDOM.nextFloat() / 5.0F, 1.1F);
            }

            if (base.deathTime < 18 && base.deathTime > 1) {
                GUNParticle bigboom = new GUNParticle(DeathEffects.blueexplode4, base.height, 0.0F, 1, 240, world, x, y + base.height / 2.0F, z, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, true, RANDOM.nextInt(360));
            ...
            if (base.deathTime == 19) {
                ...
                for (int i = 0; i < Math.min(base.getMaxHealth() / 5.0F, 10.0F); i++) {
                    Entity spel = new EntityCubicParticle(DeathEffects.gore, 0.01F + base.height / 100.0F, 0.02F, 20 + RANDOM.nextInt(10), 40 + RANDOM.nextInt(9), world, x, y + 0.5, z, (float) RANDOM.nextGaussian() / 13.0F, (float) RANDOM.nextGaussian() / 25.0F + 0.2F, (float) RANDOM.nextGaussian() / 13.0F, (float) color.x, (float) color.y, (float) color.z, false, RANDOM.nextFloat(), RANDOM.nextFloat(), RANDOM.nextFloat(), 0.05F, true, -3.0E-4F);
                    world.spawnEntity(spel);
                }

                for (int i = 0; i < Math.min(base.getMaxHealth() / 2.0F, 15.0F); i++) {
                    GUNParticle sp = new GUNParticle(DeathEffects.drop, 0.07F + RANDOM.nextFloat() / 20.0F, 0.02F, 50, -1, world, x, y + 0.5, z, (float) RANDOM.nextGaussian() / 14.0F, (float) RANDOM.nextGaussian() / 14.0F + 0.3F, (float) RANDOM.nextGaussian() / 14.0F, (float) color.x, (float) color.y, (float) color.z, false, (int) Math.round(RANDOM.nextGaussian() * 20.0), true, 5.0F);
                    sp.dropMode = true;
                    base.world.spawnEntity(sp);
                    Entity spelll = new GUNParticle(DeathEffects.snowflake3, 0.57F, 0.005F, 20 + RANDOM.nextInt(10), -1, world, x, y + 0.8, z, (float) RANDOM.nextGaussian() / 20.0F, (float) RANDOM.nextGaussian() / 22.0F + 0.1F, (float) RANDOM.nextGaussian() / 20.0F, (float) color.x, (float) color.y, (float) color.z, false, RANDOM.nextInt(360));
                    world.spawnEntity(spelll);
                }
            }
        }
    ...
    public static DeathEffect DE_FIRE = new DeathEffect() {
        ...
        public void onRenderLivingPre(RenderLivingEvent.Pre<? extends EntityLivingBase> event, EntityLivingBase entity) {
            ...
            Color.doRender(entity, event.getX(), event.getY(), event.getZ(), entity.rotationYaw, event.getPartialRenderTick(), model, ClientProxy.fireDetex.get(MathHelper.clamp(entity.deathTime - 1, 0, 18)), 0.0F, false);
        ...
        public void onLivingUpdate(World world, LivingEvent.LivingUpdateEvent event, EntityLivingBase base, double x, double y, double z) {
            if (base.deathTime == 1) {
                world.playSound(null, x, y, z, Sounds.de_fire, SoundCategory.AMBIENT, 0.8F + RANDOM.nextFloat() / 5.0F, 0.9F + RANDOM.nextFloat() / 5.0F);
            }
            ...
            if (base.deathTime > 0 && base.deathTime < 15) {
                ...
                for (int i = 0; i < Math.min(base.width + base.height, 10.0F); i++) {
                    ...
                    if (RANDOM.nextFloat() < 0.7) {
                        SparkleSubparticle part = new SparkleSubparticle(rX, rY, rZ, 0.02F + RANDOM.nextFloat() * 0.01F, 90 + RANDOM.nextInt(40) + (RANDOM.nextFloat() < 0.15 ? RANDOM.nextInt(70) + 40 : 0), (float) (0.01 * RANDOM.nextGaussian()), (float) (0.01 * RANDOM.nextGaussian() + 0.01), (float) (0.01 * RANDOM.nextGaussian()), 0.0F);
                        SparkleSubparticle.particles.add(part);
                    } else {
                        SparkleSubparticle part = new SparkleSubparticle(rX, rY, rZ, 0.02F + RANDOM.nextFloat() * 0.01F, 80 + RANDOM.nextInt(20), 0.0F, -0.02F, 0.0F, 0.1F);
                        SparkleSubparticle.particles.add(part);
                    }
                }
            }
    ...
    public static DeathEffect DE_CUT = new DeathEffect() {
        ...
        public void onLivingUpdate(World world, LivingEvent.LivingUpdateEvent event, EntityLivingBase base, double x, double y, double z) {
            if (base.deathTime == 1) {
                ...
                BloodType bloodtype = DeathEffects.getBloodType(base);
                world.playSound(null, x, y, z, bloodtype.cutSound, SoundCategory.NEUTRAL, 0.9F + RANDOM.nextFloat() / 5.0F, 0.9F + RANDOM.nextFloat() / 5.0F);
                ...
                for (int i = 0; i < Math.min(base.getMaxHealth() / 3.0F, 15.0F); i++) {
                    ...
                    int livt = 50 + RANDOM.nextInt(50);
                    float scalmax = 0.35F + RANDOM.nextFloat() / 4.0F;
                    GUNParticle spelll = new GUNParticle(DeathEffects.blood, 0.15F, 0.015F, livt, bloodtype.isGlowing ? 240 : -1, world, x, y + 0.8, z, motionX, motionY, motionZ, bloodtype.red, bloodtype.green, bloodtype.blue, true, RANDOM.nextInt(360), true, 5.0F);
                    spelll.dropMode = true;
                    if (bloodtype.isAdditiveBlend) {
                        spelll.alphaGlowing = true;
                    } else {
    ...
    public static void spawnGore(World world, EntityLivingBase entity) {
        ...
        List<Entity> listNailers = world.getEntitiesWithinAABB(Entity.class, new AxisAlignedBB(entity.posX + range, entity.posY + range, entity.posZ + range, entity.posX - range, entity.posY - range, entity.posZ - range), e -> e instanceof INailer);
        ...
        if (model != null && res != null) {
            ...
            if (list != null) {
                for (ModelRenderer box : list) {
                    ...
                    ParticleGore particle = new ParticleGore(world, res, 0.0F, 0.04F, 150, box, x, y, z, RANDOM.nextGaussian() / 13.0 + entity.motionX * 1.3, RANDOM.nextGaussian() / 13.0 + 0.2F + (entity.onGround ? 0.0 : entity.motionY), RANDOM.nextGaussian() / 13.0 + entity.motionZ * 1.3);
                    boolean rotate = true;
    ...
    public static boolean spawnCutParts(EntityLivingBase entity, boolean type) {
        ...
        if (world.isRemote) {
            ...
            ResourceLocation res = pl ? new NetworkPlayerInfo(((EntityPlayer) entity).getGameProfile()).getLocationSkin() : mainTextures.get(entity.getClass());
            double range = entity.height + 0.7;
            List<Entity> listnails = world.getEntitiesWithinAABB(Entity.class, new AxisAlignedBB(entity.posX + range, entity.posY + range, entity.posZ + range, entity.posX - range, entity.posY - range, entity.posZ - range), e -> e instanceof INailer);
            if (res == null || model == null) {
                Render rend = Minecraft.getMinecraft().getRenderManager().entityRenderMap.get(entity.getClass());
                boolean nullmodel = (model == null || model.boxList == null || model.boxList.isEmpty()) && rend instanceof RenderLivingBase;
                if (rend != null) {
                ...
                if (!list.isEmpty()) {
                    if (type) {
                        for (ModelRenderer box : list) {
                            ...
                            ParticleGore particle = new ParticleGore(world, res, 0.0F, 0.04F, 150, box, x, y, z, RANDOM.nextGaussian() / 13.0 + entity.motionX * 0.5, RANDOM.nextGaussian() / 13.0 + 0.4F + (entity.onGround ? 0.0 : entity.motionY), RANDOM.nextGaussian() / 13.0 + entity.motionZ * 0.5);
                            boolean rotate = true;
                            particle.rotateX = (float) RANDOM.nextGaussian() * 45.0F;
                            particle.rotateY = (float) RANDOM.nextGaussian() * 45.0F;
                            particle.rotateZ = (float) RANDOM.nextGaussian() * 45.0F;
                        ...
                        ParticleGore particlex = new ParticleGore(world, res, 0.0F, 0.04F, 150, null, xx, yx, zx, RANDOM.nextGaussian() / 13.0 + entity.motionX * 0.4, RANDOM.nextGaussian() / 13.0 + 0.5 + (entity.onGround ? 0.0 : entity.motionY), RANDOM.nextGaussian() / 13.0 + entity.motionZ * 0.4);
