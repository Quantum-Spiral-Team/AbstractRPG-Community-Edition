...
public class WeaponDamage extends EntityDamageSource {
    ...
    public WeaponDamage(@Nullable ItemStack weapon, @Nullable Entity entityDamager, @Nullable Entity entityProjectile, boolean explosion, boolean projectile, @Nullable Object damagePosition, String type) {
    ...
    public ITextComponent getDeathMessage(EntityLivingBase entityLivingBaseIn) {
        ...
        String s1 = s + ".player";
        return entitydamager != null && I18n.canTranslate(s1) ? new TextComponentTranslation(s1, new Object[]{entityLivingBaseIn.getDisplayName(), entitydamager.getDisplayName()}) : new TextComponentTranslation(s, new Object[]{entityLivingBaseIn.getDisplayName()});
    }
