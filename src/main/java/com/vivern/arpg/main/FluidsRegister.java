...
public class FluidsRegister {
    ...
    public static Fluid POISON = new Fluid("poison", new ResourceLocation("arpg", "poison_still"), new ResourceLocation("arpg", "poison_flow"), new ResourceLocation("arpg", "poison_overlay")).setColor(-8663990);
    public static Fluid SLIME = new Fluid("slime", new ResourceLocation("arpg", "slime_still"), new ResourceLocation("arpg", "slime_flow"), new ResourceLocation("arpg", "slime_overlay")).setColor(-8275600).setViscosity(1600).setDensity(1300);
    public static Fluid DARKNESS = new Fluid("darkness", new ResourceLocation("arpg", "liquid_darkness"), new ResourceLocation("arpg", "liquid_darkness"), new ResourceLocation("arpg", "liquid_darkness")).setColor(-16777216).setViscosity(2000).setDensity(5000).setTemperature(155);
    public static Fluid LARVAWATER = new Fluid("larva_water", new ResourceLocation("arpg", "larva_water_still"), new ResourceLocation("arpg", "larva_water_flow")).setColor(-7744837);
    public static Fluid HYDROTHERMAL = new Fluid("hydrothermal_solution", new ResourceLocation("arpg", "hydrothermal_solution_still"), new ResourceLocation("arpg", "hydrothermal_solution_flow"), (ResourceLocation) null).setColor(-2769179).setViscosity(1100).setTemperature(450);
    public static Fluid BIOGENICACID = new Fluid("biogenic_acid", new ResourceLocation("arpg", "biogenic_acid_still"), new ResourceLocation("arpg", "biogenic_acid_flow"), new ResourceLocation("arpg", "poison_overlay")).setColor(-8663990).setDensity(1664);
    public static Fluid SULFURICACID = new FluidFluid("sulfuric_acid", "sulfuric_acid_still", "sulfuric_acid_flow", 10655026).setViscosity(2792).setDensity(1835);
    public static Fluid LUMINESCENT = new FluidFluid("luminescent_liquid", "luminescent_liquid_still", "luminescent_liquid_flow", 12189679).setViscosity(1200).setDensity(1100).setTemperature(290);
    ...
    public static Fluid DISSOLVEDTOXINIUM = new FluidFluid("dissolved_toxinium", "dissolved_toxinium_still", "dissolved_toxinium_flow", 48703).setDensity(1795).setViscosity(1080);
