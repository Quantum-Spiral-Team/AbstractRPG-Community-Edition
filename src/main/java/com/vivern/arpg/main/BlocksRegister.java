...
//   public static Block FROZENCHEST = new Chest(Material.WOOD, "frozen_chest", 1.5F, 2.25F, SoundType.WOOD, "axe", 0, EnumChest.FROZEN);
   public static Block FROZENCHEST = getFrozenChest();
   private static Block getFrozenChest() {
      if (FMLCommonHandler.instance().getSide().isClient()) {
         EnumChest.initAllModels();
      }
      return new Chest(Material.WOOD, "frozen_chest", 1.5F, 2.25F, SoundType.WOOD, "axe", 0, EnumChest.FROZEN);
   }
