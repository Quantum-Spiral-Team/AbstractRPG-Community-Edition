...
public abstract class ShardType {
    ...
    public float colorG;
    public float colorB;
    public static float[][] additionalColors = new float[][]{{0.0F, 0.0F, 0.0F}, ColorConverters.hexToRgb("ffdf41"), ColorConverters.hexToRgb("675d53"), ColorConverters.hexToRgb("4793d4"), ColorConverters.hexToRgb("acaad5"), ColorConverters.hexToRgb("00ff00"), ColorConverters.hexToRgb("80ceff"), ColorConverters.hexToRgb("4936ff"), ColorConverters.hexToRgb("000000"), ColorConverters.hexToRgb("ffb8c2"), ColorConverters.hexToRgb("ff0000"), ColorConverters.hexToRgb("00f071"), ColorConverters.hexToRgb("b5ea34")};
    ...
    public void renderShardEntity(EntityShard entity, double x, double y, double z, float entityYaw, float partialTicks, RenderManager renderManager) {
        ...
        model.setRotateAngle(model.shape1, 0.017453F * GetMOP.partial(entity.rotationX, entity.prevrotationX, partialTicks), 0.017453F * GetMOP.partial(entity.rotationY, entity.prevrotationY, partialTicks), 0.017453F * GetMOP.partial(entity.rotationZ, entity.prevrotationZ, partialTicks));
    ...
    public void spawnNativeParticle(World world, float scaleMultiplier, double x, double y, double z, double motionX, double motionY, double motionZ, boolean sparkle) {
    }
    ...
    public static void spawnShards(ShardType shardType, Entity entitySpawnOn, float energyAmount) {
        spawnShards(entitySpawnOn.world, shardType, entitySpawnOn.posX, entitySpawnOn.posY + 0.0625, entitySpawnOn.posZ, energyAmount);
    }
    ...
    public static void dealShardDamage(Object dealer, @Nullable Entity projectile, Entity entity, Object damagePosition, float damageAmount, float knockback, String damageType) {
        ...
        if (damageSource.damagePosition != null) {
            Weapons.dealDamage(damageSource, damage, damager, entity, true, knockback, damageSource.damagePosition.x, damageSource.damagePosition.y, damageSource.damagePosition.z);
        } else {
    ...
    public static class ShardTypeAir extends ShardType {
        ...
        public void spawnNativeParticle(World world, float scaleMultiplier, double x, double y, double z, double motionX, double motionY, double motionZ, boolean sparkle) {
            if (sparkle) {
                if (rand.nextFloat() < 0.4) {
                    ...
                    GUNParticle part = new GUNParticle(pixel, scl, -0.002F * particlesGravityMult, lt, -1, world, x, y, z, (float) motionX, (float) motionY, (float) motionZ, 1.0F - col * 0.35F, 1.0F - col * 0.28F, 1.0F - col * 0.35F, false, rand.nextInt(360));
                    ...
                    AnimatedGParticle part = new AnimatedGParticle(airdust, scl, 0.0F * particlesGravityMult, lt, -1, world, x, y, z, (float) motionX / 2.0F, (float) motionY / 2.0F, (float) motionZ / 2.0F, 1.0F, 1.0F, 1.0F, true, rand.nextInt(360));
                    part.disableLightning = false;
        ...
        public void onAffectEntity(Object dealer, @Nullable Entity projectile, Entity entity, Object damagePosition, float elementAmount) {
            ...
            if (damageSource.damagePosition != null) {
                SuperKnockback.applyKnockback(entity, (float) Math.sqrt(elementAmount * 8.0F), damageSource.damagePosition.x, damageSource.damagePosition.y, damageSource.damagePosition.z);
            }
        }
    ...
    public static class ShardTypeCold extends ShardType {
        ...
        public void spawnNativeParticle(World world, float scaleMultiplier, double x, double y, double z, double motionX, double motionY, double motionZ, boolean sparkle) {
            if (sparkle) {
                if (rand.nextFloat() < 0.6F) {
                    ...
                    GUNParticle part = new GUNParticle(star, scl, 0.0F * particlesGravityMult, lt, 240, world, x + motionX * rand.nextFloat(), y + motionY * rand.nextFloat(), z + motionZ * rand.nextFloat(), (float) motionX * 0.3F, (float) motionY * 0.3F, (float) motionZ * 0.3F, 0.8F + rand.nextFloat() * 0.2F, 1.0F, 1.0F, false, rand.nextInt(360));
                ...
                if (rand.nextFloat() < 0.3F) {
                    ...
                    GUNParticle bigsmoke = new GUNParticle(largecloud, scl, 0.002F * particlesGravityMult, lt, 240, world, x, y, z, (float) motionX * 0.8F, (float) motionY * 0.8F, (float) motionZ * 0.8F, 0.5F + rand.nextFloat() * 0.2F, 0.7F + rand.nextFloat() * 0.2F, 1.0F, true, rand.nextInt(360));
                    ...
                    GUNParticle hailp = new GUNParticle(snowflake5, scl, (0.01F + (rand.nextFloat() - 0.5F) * 0.016F) * particlesGravityMult, lt, -1, world, x, y, z, (float) motionX, (float) motionY, (float) motionZ, 1.0F, 1.0F, 1.0F, false, rand.nextInt(360), true, 5.0F);
                    hailp.scaleTickDropAdding = -0.002F;
                    float value = 0.2F;
                    hailp.tracker = new ParticleTracker.TrackerMotionVector(Weather.getWindX(x, z), Weather.getWindY(x, z), Weather.getWindZ(x, z), value / 3.0F, value / 10.0F, 60);
        ...
        public void onAffectEntity(Object dealer, @Nullable Entity projectile, Entity entity, Object damagePosition, float elementAmount) {
            ...
            PotionEffect lastdebaff = Weapons.mixPotion(entity, PotionEffects.FREEZING, 30.0F * elementAmount + ManaBuffer.TICKRATE, 1.0F, Weapons.EnumPotionMix.WITH_MAXIMUM, Weapons.EnumPotionMix.WITH_MAXIMUM, Weapons.EnumMathOperation.PLUS, Weapons.EnumMathOperation.PLUS, 180, 40);
        ...
        public void spawnNativeParticle(World world, float scaleMultiplier, double x, double y, double z, double motionX, double motionY, double motionZ, boolean sparkle) {
            if (sparkle) {
                if (rand.nextFloat() < 0.4) {
                    ...
                    TrailParticle part = new TrailParticle(blueexplode, scl, -0.002F * particlesGravityMult, lt, 240, world, x, y, z, (float) motionX, (float) motionY, (float) motionZ, colR, colG, colB, true, rand.nextInt(360), false, 1.0F, ghostly_shoot, (0.12F + sclF * 0.02F) * scaleMultiplier, 240, colR, colG, colB, 0.1F, 5, -0.15F, 9999.0F);
                    part.alphaGlowing = true;
                    part.TalphaGlowing = true;
                    part.Ttexstart = 0.1F;
                    part.Toffset = -0.1F;
                    ParticleTracker pt = new ParticleTracker.TrackerTrailParticleGradient(new Vec3d(colR, colG, colB), new Vec3d(EcolR, EcolG, EcolB), (int) (lt * 0.2F), lt - 4);
                    ...
                    GUNParticle part = new GUNParticle(ghostly_shoot, scl, 0.003F * particlesGravityMult, lt, 240, world, x, y, z, (float) motionX, (float) motionY, (float) motionZ, colR, colG, colB, true, (int) (-pitchYaw.x) - 90);
                    part.alphaGlowing = true;
    ...
    public static class ShardTypeEarth extends ShardType {
        ...
        public static ResourceLocation[] stone_shards = new ResourceLocation[]{new ResourceLocation("arpg:textures/stone_shard_1.png"), new ResourceLocation("arpg:textures/stone_shard_2.png"), new ResourceLocation("arpg:textures/stone_shard_3.png")};
        ...
        public static ParticleTracker.TrackerRotate[] ptrs = new ParticleTracker.TrackerRotate[]{new ParticleTracker.TrackerRotate(7), new ParticleTracker.TrackerRotate(-7), new ParticleTracker.TrackerRotate(14), new ParticleTracker.TrackerRotate(-14)};
        ...
        public void spawnNativeParticle(World world, float scaleMultiplier, double x, double y, double z, double motionX, double motionY, double motionZ, boolean sparkle) {
            if (sparkle) {
                ...
                GUNParticle part = new GUNParticle(stone_shards[rand.nextInt(3)], scl, 0.02F * particlesGravityMult, lt, 240, world, x, y, z, (float) motionX * 2.0F, (float) motionY * 2.0F, (float) motionZ * 2.0F, 1.0F, 1.0F - colGB, 1.0F - colGB * 3.0F, false, rand.nextInt(360));
                part.scaleTickAdding = -scl / lt;
                ...
                if (rand.nextFloat() < 0.84F) {
                    ...
                    scl = 0.001953125F;
                    EntityCubicParticle partx = new EntityCubicParticle(pixel_cubic, scl, 0.024F * particlesGravityMult, lt, -1, world, x, y, z, (float) motionX, (float) motionY, (float) motionZ, r, g, b, false, rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), 0.2F, true, 0.0F);
                    partx.collide = true;
                    ...
                    lt = 20 + rand.nextInt(40);
                    scl = 0.00390625F;
                    EntityCubicParticle partx = new EntityCubicParticle(boulder2, scl, 0.024F * particlesGravityMult, lt, -1, world, x, y, z, (float) motionX, (float) motionY, (float) motionZ, r, g, b, false, rand.nextFloat(), rand.nextFloat(), rand.nextFloat(), 0.2F, true, 0.0F);
                    partx.collide = true;
                    partx.frictionMultipl = 3.0F;
                    world.spawnEntity(partx);
                }
    ...
    public static class ShardTypeElectric extends ShardType {
        ...
        public void spawnNativeParticle(World world, float scaleMultiplier, double x, double y, double z, double motionX, double motionY, double motionZ, boolean sparkle) {
            if (sparkle) {
                ...
                float scl = (0.02F + rand.nextFloat() * 0.02F) * scaleMultiplier;
                AnimatedGParticle part = new AnimatedGParticle(sparkle7, scl, 0.02F * particlesGravityMult, lt, 240, world, x, y, z, (float) motionX, (float) motionY, (float) motionZ, 0.8F + rand.nextFloat() * 0.2F, 1.0F, 1.0F, true, rand.nextInt(360), true, 1.3F);
                part.alphaGlowing = true;
                part.scaleTickAdding = -scl / lt;
                part.framecount = 4;
                ...
                if (rand.nextFloat() < 0.8F) {
                    part.tracker = scaleMultiplier == 1.0F ? ptlb : new ParticleTracker.TrackerLinkBeams(13, lightning3, 0.8F, 1.0F, 1.0F, 0.05F * scaleMultiplier, 3, 5, 0.07F, 2.0F);
                }
    ...
    public static class ShardTypeFire extends ShardType {
        ...
        public void spawnNativeParticle(World world, float scaleMultiplier, double x, double y, double z, double motionX, double motionY, double motionZ, boolean sparkle) {
            if (sparkle) {
                SparkleSubparticle sparklepart = new SparkleSubparticle(x, y, z, (0.02F + rand.nextFloat() * 0.01F) * scaleMultiplier, 80 + rand.nextInt(30) + (rand.nextFloat() < 0.15 ? rand.nextInt(50) + 40 : 0), (float) motionX / 2.0F, (float) motionY / 2.0F, (float) motionZ / 2.0F, 0.0F);
                SparkleSubparticle.particles.add(sparklepart);
                if (rand.nextFloat() < 0.5) {
                    int lt = 20 + rand.nextInt(40);
                    float scl = (0.02F + rand.nextFloat() * 0.01F) * scaleMultiplier;
                    GUNParticle part = new GUNParticle(pixel, scl, 0.025F * particlesGravityMult, lt, 240, world, x, y, z, (float) motionX, (float) motionY, (float) motionZ, 1.0F, 0.5F + rand.nextFloat() * 0.5F, rand.nextFloat() * rand.nextFloat(), false, 0, true, 2.5F);
                    ...
                    AnimatedGParticle part = new AnimatedGParticle(sparkle6, scl, 0.025F * particlesGravityMult, lt, 240, world, x, y, z, (float) motionX, (float) motionY, (float) motionZ, 1.0F, 0.5F + rand.nextFloat() * 0.5F, rand.nextFloat() * rand.nextFloat(), true, 0, true, 2.5F);
                    part.alphaGlowing = true;
                    part.scaleTickAdding = -scl / lt;
                    part.framecount = 5;
                    ...
                    GunPEmitter emi = new GunPEmitter(pixel, scl, 0.02F * particlesGravityMult, lt, 240, world, x, y, z, (float) motionX, (float) motionY, (float) motionZ, 1.0F, 0.5F + rand.nextFloat() * 0.5F, rand.nextFloat() * rand.nextFloat(), false, 2, true, EnumParticleTypes.SMOKE_NORMAL, 0.0F, 0.0F, 0.0F);
    ...
    public static class ShardTypeLive extends ShardType {
        ...
        public static ResourceLocation[] live_fractals = new ResourceLocation[]{new ResourceLocation("arpg:textures/live_fractal_1.png"), new ResourceLocation("arpg:textures/live_fractal_2.png"), new ResourceLocation("arpg:textures/live_fractal_3.png")};
        ...
        public void spawnNativeParticle(World world, float scaleMultiplier, double x, double y, double z, double motionX, double motionY, double motionZ, boolean sparkle) {
            if (sparkle) {
                if (rand.nextFloat() < 0.6F) {
                    ...
                    GunPEmitter part = new GunPEmitter(mana_flow, scl * 3.0F, 0.002F * particlesGravityMult, lt, 240, world, x + motionX * rand.nextFloat(), y + motionY * rand.nextFloat(), z + motionZ * rand.nextFloat(), (float) motionX, (float) motionY, (float) motionZ, r, g, b, true, 3, false, mana_flow, scl * 2.0F, 0.003F, EElt, 240, 250.0F, 250.0F, 250.0F, r, g, b, true);
                    part.alpha = 3.0F;
                    ...
                    GUNParticle part = new GUNParticle(live_fractals[rand.nextInt(3)], scl, 0.0F * particlesGravityMult, lt, 240, world, x, y, z, 0.0F, 0.0F, 0.0F, 1.0F - rand.nextFloat() * 0.4F, 1.0F - rand.nextFloat() * 0.4F, 1.0F - rand.nextFloat() * 0.9F, true, 1);
                    part.alphaGlowing = true;
                    ...
                    part.tracker = new ParticleTracker.TrackerFractalRender(amountFractal, 0.87F + rand.nextFloat() * 0.1F, 3 + rand.nextInt(13), 1.0F + rand.nextFloat() * 0.18F, 0.3F, showTime, showedTime, hideTime);
                    world.spawnEntity(part);
                }
            }
        }
        ...
        public void spawnNativeParticle(World world, float scaleMultiplier, double x, double y, double z, double motionX, double motionY, double motionZ, boolean sparkle) {
            if (sparkle) {
                if (rand.nextFloat() < 0.25) {
                    ...
                    GUNParticle part = new GUNParticle(star2, scl, 0.01F * particlesGravityMult, lt, 240, world, x, y, z, (float) motionX, (float) motionY, (float) motionZ, 1.0F, 0.98F, 0.98F, true, rand.nextInt(360));
                    part.scaleTickAdding = -scl / lt;
                    part.tracker = this.tctm;
                    part.alphaGlowing = true;
                    world.spawnEntity(part);
                ...
                if (rand.nextFloat() < 0.5) {
                    ...
                    float scl = (0.06F + rand.nextFloat() * 0.03F) * scaleMultiplier;
                    GUNParticle part = new GUNParticle(star2, scl, 0.04F * particlesGravityMult, lt, 240, world, x, y, z, (float) motionX, (float) motionY, (float) motionZ, 1.0F, 0.98F, 0.98F, true, rand.nextInt(360), true, 2.0F);
                    part.scaleTickAdding = -scl / lt;
                    part.tracker = this.tctm;
                    part.alphaGlowing = true;
                    world.spawnEntity(part);
                    ...
                    AnimatedGParticle part = new AnimatedGParticle(rand.nextFloat() < 0.5F ? pain_particle1 : pain_particle2, scl, 0.0F * particlesGravityMult, lt, 240, world, x + posAdd.x, y + posAdd.y, z + posAdd.z, (float) motionX / 1.5F, (float) motionY / 1.5F, (float) motionZ / 1.5F, 1.0F, 1.0F, 1.0F, true, (int) (-pitchYaw.x + 135.0));
                    part.alphaGlowing = true;
                    part.rotationPitchYaw = new Vec2f(0.0F, (float) pitchYaw.y + 90.0F);
                    part.framecount = 11;
                    part.disableOnEnd = true;
    ...
    public static class ShardTypePleasure extends ShardType {
        ...
        public void spawnNativeParticle(World world, float scaleMultiplier, double x, double y, double z, double motionX, double motionY, double motionZ, boolean sparkle) {
            if (sparkle) {
                Vec3d rgb = rand.nextFloat() < 0.65 ? new Vec3d(1.0, 0.3F + rand.nextFloat() * 0.3F, 0.8F + rand.nextFloat() * 0.2F) : ColorConverters.getRainbow(rand.nextFloat());
                int lt = 20 + rand.nextInt(20);
                float scl = (0.03F + rand.nextFloat() * 0.02F) * scaleMultiplier;
                GUNParticle part = new GUNParticle(firework_sparkle, scl, 0.015F * particlesGravityMult, lt, 240, world, x, y, z, (float) motionX, (float) motionY, (float) motionZ, (float) rgb.x, (float) rgb.y, (float) rgb.z, true, rand.nextInt(360));
                part.alphaGlowing = true;
                part.scaleTickAdding = -scl / lt;
                world.spawnEntity(part);
                if (rand.nextFloat() < 0.4) {
                    ...
                    AnimatedGParticle part0 = new AnimatedGParticle(pleasure_sparks, scl, 0.0F * particlesGravityMult, lt, 240, world, x, y, z, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, true, rand.nextInt(41) - 20);
                    if (rand.nextFloat() < 0.8) {
                    ...
                    TrailParticle partx = new TrailParticle(present_random_5, scl2, 0.025F * particlesGravityMult, lt2, 240, world, x, y, z, (float) motionX * 1.1F, (float) motionY * 1.1F, (float) motionZ * 1.1F, (float) rgb.x, (float) rgb.y, (float) rgb.z, true, rand.nextInt(360), true, 5.0F, shard_trace, scl2 / 2.0F, 240, (float) rgb.x, (float) rgb.y, (float) rgb.z, 0.1F, 3, -0.15F, 9999.0F);
    ...
    public static class ShardTypePoison extends ShardType {
        ...
        public static ParticleTracker.TrackerRotate[] ptrs = new ParticleTracker.TrackerRotate[]{new ParticleTracker.TrackerRotate(5), new ParticleTracker.TrackerRotate(-5), new ParticleTracker.TrackerRotate(8), new ParticleTracker.TrackerRotate(-8)};
        ...
        public void spawnNativeParticle(World world, float scaleMultiplier, double x, double y, double z, double motionX, double motionY, double motionZ, boolean sparkle) {
            if (sparkle) {
                ...
                AnimatedGParticle part = new AnimatedGParticle(acid_splash7, scl, 0.023F * particlesGravityMult, lt, 180, world, x, y, z, (float) motionX, (float) motionY, (float) motionZ, 1.0F, 1.0F, 1.0F, true, rand.nextInt(360), true, 3.0F);
                part.alphaGlowing = true;
                part.scaleTickAdding = -scl / lt;
                part.framecount = 5;
            ...
            if (entity instanceof EntityItem) {
                ...
                if (entityItem.getItem().getItem() == ItemsRegister.PHOTORESISTED_PLATE && damagePosition instanceof Vec3d) {
                    ...
                    if (angle < 60.0) {
                        ...
                        EntityItem newitem = new EntityItem(entityItem.world, entityItem.posX, entityItem.posY, entityItem.posZ, new ItemStack(ItemsRegister.PROCESSOR_PATTERN));
        ...
        public void spawnNativeParticle(World world, float scaleMultiplier, double x, double y, double z, double motionX, double motionY, double motionZ, boolean sparkle) {
            if (sparkle) {
                if (rand.nextFloat() < 0.6F) {
                    int lt = 20 + rand.nextInt(40);
                    float scl = (0.06F + rand.nextFloat() * 0.03F) * scaleMultiplier;
                    GUNParticle part = new GUNParticle(lava_drop, scl, 0.0F * particlesGravityMult, lt, 0, world, x, y, z, (float) motionX, (float) motionY, (float) motionZ, 0.0F, 0.0F, 0.0F, true, 0);
                    ...
                    Vec3d posAdd = motionvec.normalize().scale(scl / 1.45);
                    AnimatedGParticle part = new AnimatedGParticle(rand.nextFloat() < 0.5F ? void_parts_1 : void_parts_2, scl, 0.0F * particlesGravityMult, lt, 0, world, x + posAdd.x, y + posAdd.y, z + posAdd.z, (float) motionX / 1.2F, (float) motionY / 1.2F, (float) motionZ / 1.2F, 0.0F, 0.0F, 0.0F, false, (int) (-pitchYaw.x + 135.0));
                    part.scaleTickAdding = -scl / lt;
                    part.rotationPitchYaw = new Vec2f(0.0F, (float) pitchYaw.y + 90.0F);
                    part.framecount = 32;
                    part.disableOnEnd = false;
    ...
    public static class ShardTypeWater extends ShardType {
        ...
        public static ResourceLocation[] waters = new ResourceLocation[]{new ResourceLocation("arpg:textures/water1.png"), new ResourceLocation("arpg:textures/water2.png"), new ResourceLocation("arpg:textures/water3.png")};
        ...
        public void spawnNativeParticle(World world, float scaleMultiplier, double x, double y, double z, double motionX, double motionY, double motionZ, boolean sparkle) {
            if (sparkle) {
                if (rand.nextFloat() < 0.7F) {
                    ...
                    GUNParticle part = new GUNParticle(rand.nextFloat() < 0.5 ? BlowholeShoot.bubbleglow1 : BlowholeShoot.bubbleglow2, scl, 0.013F * particlesGravityMult, lt, 240, world, x, y, z, (float) motionX * 1.8F, (float) motionY * 1.8F, (float) motionZ * 1.8F, 1.0F, 1.0F, 1.0F, true, rand.nextInt(360));
                    part.alphaGlowing = true;
                    part.scaleTickAdding = -scl / lt;
                    world.spawnEntity(part);
                }
                ...
                AnimatedGParticle part = new AnimatedGParticle(waters[tex], scl, 0.018F * particlesGravityMult, lt, -1, world, x, y, z, (float) motionX, (float) motionY, (float) motionZ, 1.0F, 1.0F, 1.0F, true, rand.nextInt(21) - 10, true, 3.0F);
        ...
        public void onAffectEntity(Object dealer, @Nullable Entity projectile, Entity entity, Object damagePosition, float elementAmount) {
            if (rand.nextFloat() < 0.25) {
                ...
                if (damageSource.damagePosition != null) {
                    SuperKnockback.applyKnockback(entity, (float) Math.sqrt(elementAmount * 5.0F), damageSource.damagePosition.x, damageSource.damagePosition.y, damageSource.damagePosition.z);
                }
            }
