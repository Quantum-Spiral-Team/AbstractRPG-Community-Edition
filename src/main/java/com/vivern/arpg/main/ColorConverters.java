...
public class ColorConverters {
    ...
    public static Vec3d mix(Vec3d color1, Vec3d color2) {
        return new Vec3d((color1.x + color2.x) * 0.5, (color1.y + color2.y) * 0.5, (color1.z + color2.z) * 0.5);
    }

    public static Vec3d mix(Vec3d color1, Vec3d color2, Vec3d color3) {
        return new Vec3d((color1.x + color2.x + color3.x) / 3.0, (color1.y + color2.y + color3.y) / 3.0, (color1.z + color2.z + color3.z) / 3.0);
    }

    public static Vec3d mix(Vec3d color1, Vec3d color2, Vec3d color3, Vec3d color4) {
        return new Vec3d((color1.x + color2.x + color3.x + color4.x) * 0.25, (color1.y + color2.y + color3.y + color4.y) * 0.25, (color1.z + color2.z + color3.z + color4.z) * 0.25);
    }
    ...
    public static float[] hexToRgb(String colorStr) {
        ...
        return new float[]{Integer.valueOf(colorStr.substring(0, 2), 16).intValue() / 255.0F, Integer.valueOf(colorStr.substring(2, 4), 16).intValue() / 255.0F, Integer.valueOf(colorStr.substring(4, 6), 16).intValue() / 255.0F};
    }
