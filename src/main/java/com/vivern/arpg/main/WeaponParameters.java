...
public class WeaponParameters {
    ...
    public static void registerAll() {
        ...
        for (int type = 0; type < 8; type++) {
            ...
            newparam("gem_staff_" + type).lvl("damage", sdamage, -8.792019E7F).add("knockback", knockback, 0.25F).add("cooldown", cooldown - 5, -5.0F).add("manacost", manacost * 0.7F, -0.3125F).add("red", red).add("green", green).add("blue", blue).add("livetime", livetime, 10.0F).add("velocity", velocity * 1.4F).add("inaccuracy", inaccuracy, -inaccuracy / 3.5F);
        }

        levelRate += 0.2F * raise;
        newparam(ItemsRegister.MAGIC_BOOMERANG).lvl("damage", 10.08F, -8.792019E7F).add("knockback", 0.0F, 0.4F).add("damage_radius", 1.2F, 0.35F).add("cooldown", 10.0F, -3.0F).add("manacost", 2.5F, -0.37F).add("velocity", 0.9F, 0.45F).add("inaccuracy", 2.5F, -0.8F).add("ticks_flying", 15.0F, 2.0F).add("return_speed", 1.0F, 0.5F);
        ...
        newparam(ItemsRegister.NETHER_GRINDER).lvl("damage", 3.36F, -8.792019E7F).add("knockback", 0.7F, 0.2F).lvl("fire_bonus", 2.0F).add("bullet_damage", 1.0F).add("bullet_knockback", 1.0F).add("cooldown", 4.0F, -1.0F).add("reload", 60.0F, -15.0F).add("velocity", 3.1F).add("inaccuracy", 2.0F, -0.6F).add("livetime", 20.0F, 4.0F);
        newparam(ItemsRegister.CINDER_BOW).lvl("damage", 1.64F, -8.792019E7F).add("knockback", 0.0F, 0.5F).lvl("fullcharged_damage", 3.28F, -8.792019E7F).add("fullcharged_knockback", 2.0F, 0.5F).add("manacost", 0.4F, -0.0625F).add("velocity", 3.2F).add("inaccuracy", 1.4F, -0.4F).add("max_pull_time", 55.0F).add("min_pull_time", 3.0F);
        newparam(ItemsRegister.STAFF_OF_WITHERDRY).lvl("damage", 0.88F, -8.792019E7F).add("knockback", 0.25F, 0.1F).add("tick_damage_reduction", 0.02173F).add("fire", 4.0F, 2.0F).add("incinerate_chance", 0.85F).add("manacost", 0.2F, -0.035F).add("maxfire_time", 45.0F, -5.0F).add("charge_consume_chance", 1.0F, -0.22F).add("max_charge", 6.0F, 1.0F).add("mob_health_for_charge", 20.0F).add("cooldown", 20.0F, -4.0F).add("velocity", 1.0F).add("inaccuracy", 4.0F, -1.0F).add("livetime", 20.0F, 3.0F);
        newparam(ItemsRegister.VIOLENCE).lvl("damage", 2.34F, -8.792019E7F).add("knockback", 0.2F, 0.1F).add("damage_radius", 2.2F, 0.2F).add("manacost", 3.0F, -0.4F).add("mana_add", 1.5F, 0.25F).add("hit_radius", 9.0F, 1.6F).lvl("hit_damage", 1.56F, 0.78F).add("hit_knockback", 2.0F, 0.5F).add("hit_potion_power_mult", 2.0F).add("hit_potion_time_add", 40.0F, 10.0F).add("hit_potion_time_max", 200.0F, 20.0F).add("hit_potion_power_max", 2.0F, 0.5F).add("potion_time", 160.0F, 10.0F).add("potion_power", 0.0F).add("cooldown", 16.0F, -2.0F).add("hit_cooldown", 100.0F).add("shots", 4.0F).add("shots_random_bonus", 3.0F, 1.0F).add("velocity", 1.0F).add("range", 16.0F, 1.5F).add("area", 2.0F, -0.35F);
        newparam(ItemsRegister.LAVA_DROPPER).lvl("damage", 12.150001F, -8.792019E7F).add("knockback", 1.5F, 0.5F).add("fire", 9.0F, 2.0F).add("manacost", 2.0F, -0.4F).add("cooldown", 35.0F, -8.0F).add("velocity", 1.1F).add("inaccuracy", 3.5F, -1.0F);
        newparam(ItemsRegister.FIREBALL_STAFF).lvl("damage", 19.0F, -8.792019E7F).add("knockback", 1.5F, 0.43F).add("friendlyfire", 0.5F).add("damage_radius", 5.0F, 0.75F).add("fire", 4.0F, 2.0F).add("special_explosion_size", 2.0F).add("manacost", 20.0F, -2.5F).add("cooldown", 220.0F, -20.0F).add("velocity", 1.0F).add("inaccuracy", 2.8F, -0.8F);
        ...
        newparam(ItemsRegister.VACUUM_GUN).lvl("damage", 8.8F, -8.792019E7F).add("knockback", 0.5F, 0.33F).add("damage_radius", 1.0F, 0.3F).add("attract_knockback", -0.3F, -0.136F).add("attract_damage_radius", 4.3F, 0.5F).add("cooldown", 23.0F, -6.0F).add("reload", 50.0F, -11.0F).add("velocity", 1.4F).add("inaccuracy", 3.3F, -1.0F).add("livetime", 35.0F);
        ...
        levelRate += 0.55F * raise;
        newparam(ItemsRegister.MAGIC_ROCKET).lvl("damage", 6.2999997F, -8.792019E7F).add("knockback", 1.5F, 0.5F).add("find_radius", 4.0F).add("manacost", 1.6F, -0.27F).add("friction", 0.93F, -0.025F).add("acceleration", 0.17F, 0.06F).add("cooldown", 7.0F, -1.0F).add("distance", 35.0F, 5.0F).add("livetime", 50.0F, 10.0F).add("velocity", 0.95F).add("inaccuracy", 2.0F, -0.6F);
        newparam(ItemsRegister.CRYSTAL_STAR).lvl("damage", 2.075F, -8.792019E7F).add("knockback", 0.4F, 0.2F).lvl("damage_powered", 8.3F, -8.792019E7F).add("manacost", 2.0F, -0.33F).add("xp_decrease", 1.0F).add("cooldown", 21.0F, -2.0F).add("cooldown_powered", 7.0F, -1.0F).add("shots", 8.0F).add("find_radius", 6.5F, 0.5F).add("explode_find_radius", 8.0F).add("homing_power", 0.35F).add("homing_power_random", 0.1F).add("homing_power_max", 0.55F).add("velocity", 2.5F).add("inaccuracy", 2.0F, -0.666F).add("health_to_prick", 20.0F).add("health_to_prick_powered", 26.0F);
        newparam(ItemsRegister.ICHOR_SHOWER).lvl("damage", 1.84F, -8.792019E7F).add("knockback", 0.5F, 0.2F).add("manacost", 0.7F, -0.105F).add("cooldown", 3.0F, -0.5F).potion("ichor", 100, 0, 40, 0.0F, false).add("velocity", 3.5F).add("inaccuracy", 0.1F, -0.03F);
        ...
        newparam(ItemsRegister.WHISPERS_BLADE).lvl("damage", 6.16F, -8.792019E7F).add("knockback", 1.5F, 0.4F).lvl("damage_edge", 4.62F, -8.792019E7F).add("knockback_edge", 1.4F, 0.33F).lvl("damage_powered", 23.76F, 0.88F).add("knockback_powered", 1.4F, 0.33F).add("cutter_size", 2.6F, 0.35F).add("cutter_size_powered", 4.6F, 0.28F).add("bounces", 5.0F, 5.0F).add("manacost", 1.3F, -0.18F).add("xp_decrease", 1.0F).add("cooldown", 17.0F, -2.0F).add("cooldown_powered", 22.0F, -3.0F).add("velocity", 1.3F).add("inaccuracy", 3.0F, -1.0F).add("velocity_powered", 1.5F);
        newparam(ItemsRegister.SCEPTER_OF_SANDS).lvl("damage", 0.984F, -8.792019E7F).add("knockback", 0.25F, 0.12F).add("knockback_trace", 0.15F, 0.05F).add("knockback_to_blocks", 1.2F, 0.08F).add("manacost", 0.22F, -0.033F).add("hardness_breaks", 10.0F).add("cooldown", 0.0F).add("rapid_multiplier", 0.2F).add("velocity", 1.6F).add("inaccuracy", 9.4F, -1.0F).add("inaccuracy_trace", 15.0F, -1.5F).add("distance", 10.5F, 1.5F).add("trace_count", 4.0F).add("livetime", 13.0F, 2.0F).add("max_crystal_charge", 80.0F).add("fallingblock_chance", 0.2F, 0.125F);
        ...
        newparam(ItemsRegister.CRYSTAL_CUTTER).lvl("damage", 3.2400002F, -8.792019E7F).add("knockback", 0.0F, 0.2F).add("cutter_size", 2.5F, 0.6F).add("livetime", 100.0F, 15.0F).add("cutter_thickness", 0.2F).add("cutter_thickness_triple", 0.6F).add("cooldown", 15.0F, -2.0F).add("reload", 70.0F, -10.0F).add("velocity", 0.4F).add("inaccuracy", 2.0F, -0.6F);
        ...
        levelRate += 0.55F * raise;
        newparam(ItemsRegister.BUBBLEFISH).lvl("damage", 1.1F, -8.792019E7F).add("knockback", 0.3F, 0.12F).add("manacost", 0.1F, -0.02F).add("cooldown", 0.0F, 0.0F).add("reload", 45.0F, -10.0F).add("velocity", 0.56F).add("inaccuracy", 5.8F, -1.2F).add("livetime", 50.0F, 10.0F).add("livetime_random_add", 40.0F).add("shots", 2.0F, 0.4F).potion("slime", 80, 1, 20, 0.25F, false);
        newparam(ItemsRegister.PISTOL_FISH).lvl("damage", 6.0F, -8.792019E7F).add("knockback", 1.0F, 0.4F).add("cooldown", 20.0F, -4.0F).add("reload", 50.0F, -8.0F).add("livetime", 60.0F, 7.0F).add("velocity", 2.0F).add("inaccuracy", 3.5F, -1.0F).potion("toxin", 40, 0, 10, 0.25F, true).add("ammo_consume_chance", 1.0F, -0.15F).add("feed_drop_chance", 0.0F, 0.1F).add("special_shoot_chance", 0.0F, 0.15F);
        ...
        newparam(ItemsRegister.CERATARGET).lvl("damage", 4.0F, -8.792019E7F).add("knockback", 1.2F, 0.33F).lvl("damage_explode", 4.8F, -8.792019E7F).add("knockback_explode", 1.0F, 0.4F).add("damage_radius", 1.3F, 0.23F).add("manacost", 10.0F, -1.5F).add("ammo_consume_chance", 1.0F, -0.18F).add("cooldown", 2.0F, 0.0F).add("reload", 120.0F, -20.0F).add("velocity", 1.34F).add("inaccuracy", 4.0F, -1.0F).add("displace_angle", 3.0F, -0.7F).add("friction", 0.8F).add("follow_power_entity", 0.4F).add("follow_power_point", 0.3F);
        ...
        newparam(ItemsRegister.CORAL_RIFLE).lvl("damage", 2.22F, -8.792019E7F).add("knockback", 1.1F, 0.4F).add("bullet_damage", 1.0F).add("bullet_knockback", 1.0F).add("cooldown", 2.0F, -0.3F).add("reload", 45.0F, -9.0F).add("livetime", 20.0F, 3.0F).add("polyps", 4.0F).lvl("polyps_damage", 3.7F, -8.792019E7F).add("velocity", 3.5F).add("inaccuracy", 3.2F, -1.0F);
        newparam(ItemsRegister.SEA_EFFLORESCE).lvl("damage", 1.72F, -8.792019E7F).add("knockback", -0.6F, -0.25F).add("damage_radius", 2.5F, 0.33F).add("manacost", 8.0F, -1.2F).add("cooldown", 35.0F, -5.0F).add("velocity", 0.45F).add("inaccuracy", 4.0F, -1.2F).add("attraction", 1.0F).add("livetime", 400.0F);
        newparam(ItemsRegister.STINGING_CELL).lvl("damage", 7.0699997F, -8.792019E7F).lvl("damage_growed", 14.139999F, -8.792019E7F).add("knockback", 2.0F, 0.5F).add("damage_radius", 2.5F, 0.33F).add("manacost", 2.0F, -0.3125F).add("cooldown", 10.0F, -2.0F).add("velocity", 0.35F).add("inaccuracy", 7.0F, -2.0F).add("shots", 3.0F).add("livetime", 400.0F).add("special_grow_time", 60.0F).add("move_speed", 0.01F);
        ...
        levelRate += 0.2F * raise;
        newparam(ItemsRegister.AZURE_ORE_STAFF).lvl("damage", 1.84F, -8.792019E7F).add("knockback", 0.35F, 0.25F).add("manacost", 1.0F, -0.18F).add("xp_decrease", 1.0F).add("cooldown", 6.0F, -1.0F).add("cooldown_powered", 4.0F, 0.0F).add("velocity", 1.2F).add("inaccuracy", 4.5F, -0.8F).add("random_motion", 0.0666F, -0.015F).add("random_motion_powered", 0.03F, -0.01F).add("find_radius", 5.5F, 0.3F).add("homing_power", 0.32F).add("homing_power_random", 0.1F).add("homing_power_max", 0.55F).add("shots", 2.0F).add("shots_powered", 5.0F);
        ...
        newparam(ItemsRegister.PLASMA_RAILGUN).lvl("damage", 13.75F, -8.792019E7F).add("knockback", 2.0F, 0.83F).lvl("damage_per_pierces", -1.6500001F, 0.11000001F).add("cooldown", 19.0F, -3.0F).add("reload", 45.0F, -10.0F).add("livetime", 14.0F, 2.0F).add("velocity", 3.9F).add("inaccuracy", 0.0F, 0.0F).add("rf_to_shoot", 5000.0F, -250.0F).add("max_pierces", 1.0F, 2.0F).potion("shock", 50, 1, 15, 0.2F, true);
        newparam(ItemsRegister.ELECTROSTATIC).lvl("damage", 6.18F, -8.792019E7F).add("knockback", 0.3F, 0.25F).add("manacost", 2.8F, -0.45F).add("cooldown", 10.0F, -2.0F).add("velocity", 1.4F).add("inaccuracy", 3.8F, -1.1F).add("livetime", 100.0F, 10.0F).potion("shock", 125, 0, 10, 0.43F, true);
        newparam(ItemsRegister.CHARGER).lvl("damage", 0.35999998F, -8.792019E7F).add("knockback", 0.0F, 0.125F).add("damage_radius", 5.0F, 0.8F).add("manacost", 0.11F, -0.02F).add("cooldown", 0.0F, 0.0F).add("rapid_multiplier", 0.2F).add("distance", 10.0F, 2.0F).add("targets", 3.0F, 2.0F);
        ...
        newparam(ItemsRegister.VOLTRIDENT).lvl("damage", 1.54F, -8.792019E7F).add("knockback", 0.0F, 0.33F).add("damage_radius", 15.0F, 1.0F).lvl("damage_overkill", 7.7F, -8.792019E7F).add("manacost", 0.4F, -0.077F).add("manacost_powered", 0.2F, -0.038F).add("cooldown", 4.0F, -1.0F).add("xp_decrease", 1.0F).add("distance", 22.0F, 5.0F).add("targets", 8.0F, 2.0F).add("voltage_to_overkill", 3.0F);
        ...
        newparam(ItemsRegister.PLASMA_ACCELERATOR).lvl("damage", 7.8F, -8.792019E7F).add("knockback", 1.8F, 0.666F).add("damage_radius", 2.0F, 0.3F).add("radius_blocks", 3.0F, 0.5F).lvl("friendlyfire_damage", 6.0F, -8.792019E7F).add("friendlyfire", 0.5F).add("damage_multiplier", 3.0F).add("knockback_to_blocks", 2.0F, 0.2F).add("hardness_breaks", 2.0F, 0.5F).add("cooldown", 37.0F, -7.0F).add("livetime", 40.0F, 5.0F).add("velocity", 1.5F).add("inaccuracy", 2.0F, -0.65F).add("rf_to_shoot", 15000.0F, -1000.0F).add("shots", 2.0F, 1.0F);
        ...
        newparam(ItemsRegister.GRAVITY_GRENADE).add("cooldown", 400.0F).add("first_explode_delay", 40.0F).add("damage_radius", 7.0F).add("livetime", 200.0F).add("gravity", 0.65F).add("friendlyfire_gravity", 0.3F);
