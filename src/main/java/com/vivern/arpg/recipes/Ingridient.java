...
public abstract class Ingridient {
        ...
        if (itemStack != null && !itemStack.isEmpty()) {
            ...
            if (item == ItemsRegister.SLIME_PLASTIC) {
                ...
                if (!orenames.isEmpty()) {
                    ...
                    return itemStack.getHasSubtypes() ? new IngridientItem(item, count, itemStack.getMetadata(), true) : new IngridientItem(item, count, 0, false);
                }
            }
        } else {
            return EMPTY;
    ...
    public static class IngridientFluidBucket extends Ingridient {
        ...
        @Override
        public String toString() {
            return this.mbAmount == 1000 ? "new IngridientFluidBucket(\"" + this.fluidName + "\")" : "new IngridientFluidBucket(\"" + this.fluidName + "\", " + this.mbAmount + ")";
        }
    ...
    public static class IngridientItem extends Ingridient {
        ...
        public boolean isStackAllowed(ItemStack itemStack) {
            if (this.missingItemName != null) {
                ...
                return this.useMeta ? itemStack.getCount() >= this.amount && itemStack.getItem() == this.item && itemStack.getMetadata() == this.meta : itemStack.getCount() >= this.amount && itemStack.getItem() == this.item;
            }
        }
        ...
        public ItemStack createStack() {
            if (this.oreDictionaryName != null) {
                ...
                ItemStack stack = new ItemStack(this.item, this.amount, this.useMeta ? this.meta : 0, this.stackTagCompound != null ? this.stackTagCompound.copy() : null);
