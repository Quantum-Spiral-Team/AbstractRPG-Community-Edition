...
public class TerraformingResearchPuzzle {
    ...
    public boolean tryGenerateCross(int posx, int posy, int direction, int maxNext, boolean simulate) {
        ...
        if (this.checkBounds(offX, offY) && !this.board[offX][offY].hasWays()) {
            ...
            if (!this.tryGenerateBranch(offX, offY, directionRotate(direction, false), simulate, true) || !this.tryGenerateBranch(offX, offY, directionRotate(direction, true), simulate, true)) {
                return false;
            } else {
                return maxNext > 0 ? this.tryGenerateCross(offX, offY, direction, maxNext - 1, simulate) : this.tryGenerateBranch(offX, offY, direction, simulate, true);
            }
        } else {
            if (!simulate) {
                this.board[posx][posy].isPoint = true;
            ...
            if (!this.checkForPlayer()) {
                ...
                if (this.skipAll) {
                    ...
                    if (this.delayAfterStep > 0) {
                        if (playerCommand != null && (playerCommand.commandType == TerraformingPlayerCommand.TRPlayerCommandType.SKIP || playerCommand.commandType == TerraformingPlayerCommand.TRPlayerCommandType.SKIP_ALL)) {
                        ...
                        if (!this.surfacesStepped) {
                            ...
                            if (!this.isGENERATING) {
                                ...
                                if (!this.isOnClient && this.currentBalance.isWin(this.finalBalance) && this.researchingPlayer != null) {
                                    ...
                                    this.researchingPlayer.world.playSound(null, this.researchingPlayer.getPosition(), SoundEvents.ENTITY_PLAYER_LEVELUP, SoundCategory.BLOCKS, 0.9F, 1.0F);
                                    this.ISWINNED = true;
                        ...
                        if (playerCommand != null) {
                            ...
                            if (playerCommand.commandType == TerraformingPlayerCommand.TRPlayerCommandType.MOVE_SELECTED && this.selected != null && this.selected.phenomenon != null) {
                            ...
                            if (playerCommand.commandType == TerraformingPlayerCommand.TRPlayerCommandType.GET_ORB && this.checkBounds(playerCommand.boardSelectX, playerCommand.boardSelectY)) {
                                TerraformingResearchCell cell = this.board[playerCommand.boardSelectX][playerCommand.boardSelectY];
                            ...
                            if (playerCommand.commandType == TerraformingPlayerCommand.TRPlayerCommandType.SPLIT && this.splitOrbs > 0 && this.checkBounds(playerCommand.boardSelectX, playerCommand.boardSelectY)) {
                                TerraformingResearchCell cell = this.board[playerCommand.boardSelectX][playerCommand.boardSelectY];
                                if (this.selected != null && this.selected.phenomenon != null) {
