...
public class IndustrialMixerRecipe {
    ...
    public boolean isAllowForCraft(TileIndustrialMixer lab) {
        ...
        if (fluidcost1 == null || lab.tank1.getFluid() != null && lab.tank1.getFluid().containsFluid(fluidcost1) || lab.tank2.getFluid() != null && lab.tank2.getFluid().containsFluid(fluidcost1)) {
            ...
            if (fluidcost2 == null || lab.tank1.getFluid() != null && lab.tank1.getFluid().containsFluid(fluidcost2) || lab.tank2.getFluid() != null && lab.tank2.getFluid().containsFluid(fluidcost2)) {
