...
public class PyrocrystallineRecipe {
    ...
    public PyrocrystallineRecipe(String output, Block source, int fluidcost, float geoEnergyCost, float manaToMelt, int progressPerOne, int damageToFocus, OreCost[] input1, OreCost[] input2, OreCost[] input3) {
    ...
    public static void init() {
        registerRecipe(new PyrocrystallineRecipe("oreCopper", Blocks.STONE, 1000, 2.0F, 10.0F, 20, 20, new OreCost[]{new OreCost("dirt", 2), new OreCost("sand", 2), new OreCost("sandstone", 1), new OreCost(Blocks.SOUL_SAND, 1), new OreCost(BlocksRegister.TOXIC_DIRT, 1), new OreCost(BlocksRegister.SCRAP, 1)}, new OreCost[]{new OreCost("slimeball", 8), new OreCost(Items.PRISMARINE_CRYSTALS, 3), new OreCost(Items.PRISMARINE_SHARD, 3)}, new OreCost[]{new OreCost("blockPrismarine", 2), new OreCost("blockPrismarineBrick", 2), new OreCost("blockPrismarineDark", 2), new OreCost(Blocks.SEA_LANTERN, 1), new OreCost(BlocksRegister.SLUDGE, 4), new OreCost(BlocksRegister.JUNK, 4)}));
    }
