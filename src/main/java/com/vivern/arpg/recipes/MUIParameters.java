...
public interface MUIParameters {
    ...
    default void modifyEvil(EntityMagicUI muiExecutor, EntityMagicUI muiModificator, float power, float range, Vec3d flow, float chaos, boolean might, Entity activatingEntity, ManaProvider mana, float manaSpended) {
    }
