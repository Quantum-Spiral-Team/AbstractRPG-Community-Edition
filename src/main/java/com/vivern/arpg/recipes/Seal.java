...
public abstract class Seal {
    ...
    public static ResourceLocation[] splashes = new ResourceLocation[]{new ResourceLocation("arpg:textures/splash1.png"), new ResourceLocation("arpg:textures/splash2.png"), new ResourceLocation("arpg:textures/splash3.png")};
    ...
    public void renderInTileWithRotation(double x, double y, double z, float partialTicks, float rotationPitch, float rotationYaw, float serverPitch, float serverYaw, TileRunicMirror mirror) {
    }
    ...
    public static class SealOfFire extends Seal {
        ...
        public boolean evil(World world, double x, double y, double z, float power, float range, float chaos, Vec3d flowVector, boolean mighty) {
            ...
            if (power >= 1.0F && Blocks.FIRE.canPlaceBlockAt(world, randpos) && world.isAirBlock(randpos)) {
                ...
                if (power >= 4.0F) {
                    Explosion explosion = new Explosion(world, null, randpos.getX(), randpos.getY(), randpos.getZ(), power - 3.0F, true, true);
