...
public class BlockTurnCollection {
    ...
    public boolean recursiveAffectBlock(BlockShardTypeTurn turn, Object dealer, World world, BlockPos blockPos, float elementAmount, int lastRecursions, @Nullable EnumFacing lastFacing) {
        if (lastRecursions > 0) {
