...
public class RenderBlockEntity<T extends Entity> extends Render<T> {
    ...
    public RenderBlockEntity(RenderManager renderManagerIn, ResourceLocation texture, float scaleX, float scaleY, float scaleZ, int light, float Red, float Green, float Blue, boolean opa, float rotateX, float rotateY, float rotateZ, float rotateSpeed, boolean rotateRand) {
