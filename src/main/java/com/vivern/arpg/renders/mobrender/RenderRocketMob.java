...
public class RenderRocketMob extends RenderLiving<EntityLiving> {
    ...
    public RenderRocketMob(RenderManager manager, ModelBase model, ResourceLocation mobTexture, float shadowSize, boolean layerHeldItem, boolean layerArmor, boolean vertical, AbstractMob.RenderAbstractMobEntry entry) {
    ...
    public static RocketMobFactory getFACTORY(ModelBase model, ResourceLocation mobTexture, float shadowSize, boolean vertical, AbstractMob.RenderAbstractMobEntry entry) {
