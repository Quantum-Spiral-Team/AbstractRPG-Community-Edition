...
public class RenderUniversal extends RenderLiving<EntityLiving> {
    ...
    public RenderUniversal(RenderManager manager, ModelBase model, ResourceLocation mobTexture, float shadowSize, boolean layerHeldItem, boolean layerArmor, LayerRandomItem layerrandItem, boolean useIRender, AbstractMob.RenderAbstractMobEntry entry) {
    ...
    public static UniversalFactory getFACTORY(ModelBase model, ResourceLocation mobTexture, float shadowSize, boolean useIRender, AbstractMob.RenderAbstractMobEntry entry) {
    ...
    public static class UniversalFactory implements IRenderFactory<EntityLiving> {
        ...
        public Render<? super EntityLiving> createRenderFor(RenderManager manager) {
            return new RenderUniversal(manager, this.model, this.mobTexture, this.shadowSize, this.layerHeldItem, this.layerArmor, this.layerrandItem, this.useIRender, this.entry);
        }
