...
import com.vivern.arpg.items.models.PresentBoxModel;
...
public class PresentBoxTESR extends TileEntitySpecialRenderer<TilePresentBox> {
    ...
    public static ResourceLocation[] tex = new ResourceLocation[]{new ResourceLocation("arpg:textures/present_box_1.png"), new ResourceLocation("arpg:textures/present_box_2.png"), new ResourceLocation("arpg:textures/present_box_3.png"), new ResourceLocation("arpg:textures/present_box_4.png"), new ResourceLocation("arpg:textures/present_box_5.png"), new ResourceLocation("arpg:textures/present_box_6.png")};
