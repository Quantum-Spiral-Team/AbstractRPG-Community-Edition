...
public class RenderLiveHeart<T extends EntityLiveHeart> extends Render<T> {
    ...
    protected void renderItemModel(ItemStack stack, IBakedModel bakedmodel, TransformType transform, boolean leftHanded, float r, float g, float b, float translate) {
        if (!stack.isEmpty()) {
