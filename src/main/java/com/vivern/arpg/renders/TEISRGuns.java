        ...
        if (IWeapon.canShoot(Itemstack)) {
            ...
            if (item == ItemsRegister.FIREWORK_LAUNCHER) {
                ...
                if (Itemstack.isItemEnchanted()) {
                    ...
                    GlStateManager.enableBlend();
                    float f3 = 0.5F;
                    GlStateManager.color(0.6F + AnimationTimer.rainbow1 / 34.0F, 0.4F + AnimationTimer.rainbow2 / 34.0F, 0.4F + AnimationTimer.rainbow3 / 34.0F, 1.0F);
                    GlStateManager.blendFunc(SourceFactor.ONE, DestFactor.ONE);
                    Minecraft.getMinecraft().entityRenderer.setupFogColor(true);
                    this.fireworklaun.render(null, 1.0F, dragonf, 1.0F, 1.0F, 1.0F, 1.0F);
                    Minecraft.getMinecraft().entityRenderer.setupFogColor(false);
            ...
            if (item == ItemsRegister.PLASMA_ACCELERATOR) {
                ...
                this.plasmaaccelerator.render(null, ff1, !(chargexx > 0.0F) ? 30.0F : 240.0F, !(chargexx > cooldown) ? 30.0F : 240.0F, !(chargexx > cooldown * 2) ? 30.0F : 240.0F, special > 0 && chargexx > cooldown * 3 ? 1.0F : 0.0F, 1.0F);
                GlStateManager.popMatrix();
                GlStateManager.pushMatrix();
                GlStateManager.scale(0.1F, 0.1F, 0.1F);
                GlStateManager.rotate(90.0F, 0.0F, 1.0F, 0.0F);
                ...
                if (Itemstack.isItemEnchanted()) {
                    ...
                    GlStateManager.blendFunc(SourceFactor.ONE, DestFactor.ONE);
                    Minecraft.getMinecraft().entityRenderer.setupFogColor(true);
                    this.plasmaaccelerator.render(null, ff1, !(chargexx > 0.0F) ? 30.0F : 240.0F, !(chargexx > cooldown) ? 30.0F : 240.0F, !(chargexx > cooldown * 2) ? 30.0F : 240.0F, 0.0F, 1.0F);
                    this.plasmaacceleratorOv.render(null, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
                    Minecraft.getMinecraft().entityRenderer.setupFogColor(false);
                    GlStateManager.matrixMode(5890);
                    GlStateManager.loadIdentity();
            ...
            if (item == ItemsRegister.SPELL_HAMMER) {
                ...
                if (Itemstack.isItemEnchanted()) {
                    ...
                    GlStateManager.enableBlend();
                    float f3 = 0.5F;
                    GlStateManager.color(0.4F + AnimationTimer.rainbow2 / 34.0F, (float) (0.48F + Math.sin((double) timer / 100) / 4.0), 0.6F + AnimationTimer.rainbow1 / 34.0F, 1.0F);
                    GlStateManager.blendFunc(SourceFactor.ONE, DestFactor.ONE);
                    Minecraft.getMinecraft().entityRenderer.setupFogColor(true);
            ...
            if (item == ItemsRegister.ROCKET_LAUNCHER) {
                ...
                float modev = GetMOP.partial((float) Math.abs(NBTHelper.GetNBTint(Itemstack, "firemode")), (float) Math.abs(NBTHelper.GetNBTint(Itemstack, "prevfiremode")));
                ...
                this.rocketLauncherModel.render(null, GetMOP.partial(NBTHelper.GetNBTfloat(Itemstack, "angle"), NBTHelper.GetNBTfloat(Itemstack, "prevangle")), reloadValue, modeF, ammo, color, 1.0F);
                GlStateManager.popMatrix();
                if (Itemstack.isItemEnchanted()) {
                    GlStateManager.pushMatrix();
                    GlStateManager.scale(0.1F, 0.1F, 0.1F);
            ...
            if (item == ItemsRegister.CARAPACE) {
                ...
                float ft2 = 1.0F - ft1;
                float ft3 = GetMOP.getFromTo((float) ticksusing, (float) (begintime - 10), (float) begintime) - GetMOP.getFromTo((float) ticksusing, (float) begintime, (float) (begintime + 10));
                if (ft3 > 0.0F) {
                    ft2 = ft3;
                    ft1 = 0.1F;
                }
            ...
            if (item == ItemsRegister.CRYSTAL_CUTTER) {
                float anim = GetMOP.partial((float) NBTHelper.GetNBTint(Itemstack, "animation"), (float) NBTHelper.GetNBTint(Itemstack, "prevanimation"), partialTicks);
            ...
            if (item == ItemsRegister.PLASMA_MINIGUN) {
                float animDeploy = GetMOP.partial(NBTHelper.GetNBTfloat(Itemstack, "deploy"), NBTHelper.GetNBTfloat(Itemstack, "prevdeploy"), Minecraft.getMinecraft().getRenderPartialTicks());
                float animRotate = GetMOP.partial(NBTHelper.GetNBTfloat(Itemstack, "rotate"), NBTHelper.GetNBTfloat(Itemstack, "prevrotate"), Minecraft.getMinecraft().getRenderPartialTicks());
            ...
            if (item == ItemsRegister.INSTANCER) {
                float animReady = GetMOP.partial((float) NBTHelper.GetNBTint(Itemstack, "ready"), (float) NBTHelper.GetNBTint(Itemstack, "prevready"), Minecraft.getMinecraft().getRenderPartialTicks()) / 15.0F;
                GlStateManager.pushMatrix();
                GlStateManager.scale(0.09F, 0.09F, 0.09F);
                GlStateManager.rotate(90.0F, 0.0F, 1.0F, 0.0F);
            ...
            if (item == ItemsRegister.CINDER_BOW) {
                ...
                progress = GetMOP.getFromTo(progress, 0.0F, 0.45F) * 0.7F + GetMOP.getFromTo(progress, 0.45F, 0.95F) * 0.1F + GetMOP.getFromTo(progress, 0.95F, 1.0F) * 0.2F;
                progress = MathHelper.clamp(progress * progress, 0.0F, 1.0F);
                GlStateManager.pushMatrix();
                GlStateManager.scale(0.09F, 0.09F, 0.09F);
                GlStateManager.rotate(90.0F, 0.0F, 1.0F, 0.0F);
            ...
            if (item == ItemsRegister.XMASS_LAUNCHER) {
                ...
                if (Itemstack.isItemEnchanted()) {
                    ...
                    GlStateManager.color(0.05F * col1 + 0.8F * col2 + 0.4F * col3, 0.5F * col1 + 0.2F * col2 + 0.8F * col3, 0.25F * col1 + 0.2F * col2 + 1.0F * col3, 1.0F);
                    GlStateManager.blendFunc(SourceFactor.ONE, DestFactor.ONE);
                    Minecraft.getMinecraft().entityRenderer.setupFogColor(true);
            ...
            if (item == ItemsRegister.ICE_COMPASS) {
                ...
                this.iceCompassModel.render(null, GetMOP.partial(IceCompass.arrowRotation, IceCompass.prevArrowRotation, partialTicks), 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
                GlStateManager.popMatrix();
            }
        }
    }
