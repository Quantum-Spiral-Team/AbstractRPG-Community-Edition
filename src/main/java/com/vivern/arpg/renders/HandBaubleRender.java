...
public class HandBaubleRender {
    ...
    public static void renderHeldItem(EntityLivingBase p_188358_1_, ItemStack p_188358_2_, TransformType p_188358_3_, EnumHandSide handSide, RenderLivingBase renderlb) {
