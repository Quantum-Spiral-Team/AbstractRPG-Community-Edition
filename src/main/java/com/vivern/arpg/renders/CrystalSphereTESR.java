    ...
    public static class RenderShardsEffect {
        ...
        public void renderIn(ShardType shard, @Nullable TileCrystalSphere te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
            ...
            if (shard == ShardType.FIRE) {
                ...
                for (int i = 0; i < 4; i++) {
                    ...
                    GlStateManager.rotate(90 * i, 0.0F, 1.0F, 0.0F);
                    int anplus = i * 20;
                    bufferbuilder.pos(-width, height + downAll, downfromCenter).tex(0.0, 1.0F / framecount + time / framecount + anplus).endVertex();
                    ...
                    bufferbuilder.pos(width, height + downAll, downfromCenter).tex(1.0, 1.0F / framecount + time / framecount + anplus).endVertex();
                    tessellator.draw();
                    GlStateManager.popMatrix();
                }
                ...
                for (int i = 0; i < 1; i++) {
                    ...
                    int anplus = i * 22;
                    bufferbuilderx.pos(-width, height + downAll, downfromCenter).tex(0.0, 0.0076923077F + time2 / 130.0F + anplus).endVertex();
                    ...
                    bufferbuilderx.pos(width, height + downAll, downfromCenter).tex(1.0, 0.0076923077F + time2 / 130.0F + anplus).endVertex();
                    tessellatorx.draw();
                    GlStateManager.popMatrix();
                }
                ...
                for (int st = 0; st < 2; st++) {
                    ...
                    for (int i = 0; i < 3; i++) {
                        if (i != 2 || st != 0) {
                            ...
                            int anplus = i * 25;
                            bufferbuilderx.pos(-width, height + downAll, downfromCenter).tex(0.0, 0.016666668F + (time + anplus) / 60.0F).endVertex();
                            ...
                            bufferbuilderx.pos(width, height + downAll, downfromCenter).tex(1.0, 0.016666668F + (time + anplus) / 60.0F).endVertex();
                            tessellatorx.draw();
                            GlStateManager.popMatrix();
                        }
                    }
        ...
        public void renderOut(ShardType shard, @Nullable TileCrystalSphere te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
            ...
            if (shard == ShardType.FIRE) {
                ...
                GlStateManager.color((float) rainbow.x * ratio + shard.colorR * unratio, (float) rainbow.y * ratio + shard.colorG * unratio, (float) rainbow.z * ratio + shard.colorB * unratio, 1.0F);
                GlStateManager.blendFunc(SourceFactor.ONE, DestFactor.ONE);
                Minecraft.getMinecraft().entityRenderer.setupFogColor(true);
                CrystalSphereTESR.model.render(null, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
                Minecraft.getMinecraft().entityRenderer.setupFogColor(false);
                ...
                GlStateManager.color(ratio * 0.7F + shard.colorR * unratio, ratio * 0.7F + shard.colorG * unratio, ratio * 0.7F + shard.colorB * unratio, 1.0F);
                GlStateManager.blendFunc(SourceFactor.ONE, DestFactor.ONE);
                Minecraft.getMinecraft().entityRenderer.setupFogColor(true);
                CrystalSphereTESR.model.render(null, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
                Minecraft.getMinecraft().entityRenderer.setupFogColor(false);
