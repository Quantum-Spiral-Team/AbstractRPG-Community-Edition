...
public class SweepParticle extends Entity {
    ...
    public SweepParticle(ResourceLocation texture, float scale, int livetime, int ticksPerFrame, int frameCount, int schedule, int light, World world, double x, double y, double z, float pitch, float yaw, float Red, float Green, float Blue, boolean opa, int rotation) {
        super(world);
