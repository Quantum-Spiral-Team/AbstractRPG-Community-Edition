...
public class InvasionInfo {
    ...
    public static void render(FontRenderer fontRenderer, EntityPlayer player, int i, int f) {
        if (wave != 0 && currentInfo != null) {
            ...
            fontRenderer.drawStringWithShadow(currentInfo.unlocalizedInvasionName, (float) i / 2 - (float) fontRenderer.getStringWidth(currentInfo.unlocalizedInvasionName) / 2, 1.0F, currentInfo.colorFont);
            fontRenderer.drawStringWithShadow(currentInfo.unlocalizedNexusName + ":", (float) i / 2 - 55 - fontRenderer.getStringWidth(currentInfo.unlocalizedNexusName + ":"), 16.0F, currentInfo.colorFont);
            ...
            if (finalwaveAnim > 0) {
                ...
                Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(unlocalizedFinal, ((float) i / 2 - (float) fontRenderer.getStringWidth(unlocalizedFinal) / 2 * scale) / scale, 30.0F / scale, ColorConverters.RGBAtoDecimal255(227, 30, 30, (int) (GetMOP.getFromTo((float) finalwaveAnim, 0.0F, 40.0F) * 255.0F - fromto * 255.0F)));
                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            ...
            if (nextwaveAnim > 0) {
                ...
                Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(ubw, ((float) i / 2 - (float) fontRenderer.getStringWidth(ubw) / 2 * scale) / scale, 30.0F / scale, ColorConverters.RGBAtoDecimal255(90, 55, 227, (int) (GetMOP.getFromTo((float) nextwaveAnim, 0.0F, 40.0F) * 255.0F - fromto * 255.0F)));
                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                GlStateManager.popMatrix();
                nextwaveAnim--;
            }
            ...
            if (winAnim > 0) {
                ...
                Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(ubw, ((float) i / 2 - (float) fontRenderer.getStringWidth(ubw) / 2 * scale) / scale, 40.0F / scale, ColorConverters.RGBAtoDecimal255(245, 223, 77, (int) (GetMOP.getFromTo((float) winAnim, 0.0F, 40.0F) * 255.0F - fromto * 255.0F)));
                GlStateManager.popMatrix();
                if (winAnim < 161 && winAnim > 10) {
                    ...
                    Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(ubw2, ((float) i / 2 - (float) fontRenderer.getStringWidth(ubw2) / 2 * scale2) / scale2, 65.0F / scale2, ColorConverters.RGBAtoDecimal255(245, 223, 77, (int) (GetMOP.getFromTo((float) winAnim, 10.0F, 50.0F) * 255.0F - fromto2 * 255.0F)));
                    GlStateManager.popMatrix();
                }

                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                if (winAnim == 160) {
                    player.world.playSound(player, player.posX, player.posY, player.posZ, Sounds.next_wave, SoundCategory.AMBIENT, 2.0F, 1.1F);
                }
            ...
            if (loseAnim > 0) {
                ...
                Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(ubwx, ((float) i / 2 - (float) fontRenderer.getStringWidth(ubwx) / 2 * scalex) / scalex, 30.0F / scalex, ColorConverters.RGBAtoDecimal255(190, 30, 36, (int) (GetMOP.getFromTo((float) loseAnim, 0.0F, 60.0F) * 255.0F - fromtox * 255.0F)));
                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                GlStateManager.popMatrix();
                loseAnim--;
            }
