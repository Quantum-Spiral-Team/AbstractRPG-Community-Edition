...
public class RenderTerraformingResearch {
    ...
    public TRRenderer pointRenderer = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 0, 0, 100, 50, 18, 18, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer selectionRenderer1 = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 0, 0, 164, 3, 44, 44, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer selectionRenderer2 = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 0, 0, 211, 3, 44, 44, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer moveRendererUp = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 0, -41, 137, 0, 12, 37, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer moveRendererRight = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 41, 0, 100, 0, 37, 12, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer moveRendererDown = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 0, 41, 149, 0, 12, 37, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer moveRendererLeft = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, -41, 0, 100, 12, 37, 12, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer[] waysRenderers = new TRRenderer[]{new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 0, 0, 0, 50, 50, 50, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 0, 10, 50, 80, 50, 30, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, -10, 0, 0, 100, 30, 50, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 0, -10, 50, 50, 50, 30, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 10, 0, 30, 100, 30, 50, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 0, 0, 103, 68, 8, 50, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 0, 0, 118, 53, 50, 8, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 10, -10, 120, 100, 30, 30, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 10, 10, 120, 70, 30, 30, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, -10, 10, 150, 70, 30, 30, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, -10, -10, 150, 100, 30, 30, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 0, -10, 111, 120, 8, 30, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 10, 0, 120, 134, 30, 8, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 0, 10, 103, 120, 8, 30, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, -10, 0, 120, 142, 30, 8, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 10, -10, 20, 50, 30, 30, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 10, 10, 20, 70, 30, 30, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, -10, 10, 0, 70, 30, 30, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY), new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, -10, -10, 0, 50, 30, 30, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY)};
    public TRRenderer woodFrameRendererLeft = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, -29, 0, 242, 100, 8, 50, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer woodFrameRendererRight = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 29, 0, 242, 100, 8, 50, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer woodFrameRendererUp = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 0, -29, 192, 142, 50, 8, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer woodFrameRendererDown = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 0, 29, 192, 142, 50, 8, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer woodFrameRendererLeftUpOut = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, -27, -27, 210, 100, 16, 16, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer woodFrameRendererRightUpOut = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 27, -27, 226, 100, 16, 16, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer woodFrameRendererLeftDownOut = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, -27, 27, 210, 116, 16, 16, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer woodFrameRendererRightDownOut = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 27, 27, 226, 116, 16, 16, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer woodFrameRendererLeftUpIn = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, -29, -21, 210, 132, 8, 8, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY).setLayer(0.1F);
    public TRRenderer woodFrameRendererRightUpIn = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 21, -29, 218, 132, 8, 8, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY).setLayer(0.1F);
    public TRRenderer woodFrameRendererLeftDownIn = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, -21, 29, 226, 132, 8, 8, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY).setLayer(0.1F);
    public TRRenderer woodFrameRendererRightDownIn = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 29, 21, 234, 132, 8, 8, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY).setLayer(0.1F);
    public TRRenderer orbRendererMoving = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 0, 0, 340, 0, 20, 20, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer orbRendererInterflow = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 0, 0, 360, 0, 20, 20, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer orbRendererSplit = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 0, 0, 380, 0, 20, 20, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY);
    public TRRenderer electricFieldRenderer = new TRRenderer.TRRendererSprite(Phenomenons.tfr_sprites, 1050, 0, 50, 50, Phenomenons.tfr_sprites_sizeX, Phenomenons.tfr_sprites_sizeY).setAnimation(3, 20).setStyle(TRRenderer.RenderStyle.ADDITIVE);
        ...
        for (int layer = 0; layer < maxLayers; layer++) {
            for (int y = 0; y < researchPuzzle.height; y++) {
                for (int x = 0; x < researchPuzzle.width; x++) {
                    this.terrainAnimations[x][y].render(this, resultX + x * this.cellWidth, resultY + y * this.cellHeight, x, y, x * 231896917442L + y * 542813726771L, partialTicks, layer);
                }
            }
        }
        ...
        for (int y = 0; y < researchPuzzle.height; y++) {
            for (int x = 0; x < researchPuzzle.width; x++) {
                if (researchPuzzle.fields[x][y][0]) {
                    this.electricFieldRenderer.render(this, resultX + x * this.cellWidth, resultY + y * this.cellHeight, x, y, x * 231896917442L + y * 542813726771L, 1.0F);
                }
            }
        }
        ...
        for (int layer = 0; layer < maxLayers; layer++) {
            for (int y = 0; y < researchPuzzle.height; y++) {
                for (int xx = 0; xx < researchPuzzle.width; xx++) {
                    this.atmosphereAnimations[xx][y].render(this, resultX + xx * this.cellWidth, resultY + y * this.cellHeight, xx, y, xx * 231896917442L + y * 542813726771L, partialTicks, layer);
                }
            }
        }
