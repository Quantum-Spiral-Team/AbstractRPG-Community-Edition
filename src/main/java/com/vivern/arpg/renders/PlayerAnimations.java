...
public class PlayerAnimations {
    ...
    public void renderOverlays(float partialTicks) {
        ...
        if (this.mc.player.isEntityInsideOpaqueBlock()) {
            ...
            if (iblockstate.getRenderType() != EnumBlockRenderType.INVISIBLE && !ForgeEventFactory.renderBlockOverlay(this.mc.player, partialTicks, OverlayType.BLOCK, iblockstate, overlayPos)) {
    ...
    public void updateEquippedItem() {
        ...
        if (entityplayersp.isRowingBoat()) {
            ...
            this.equippedProgressMainHand = this.equippedProgressMainHand + MathHelper.clamp((!requipM ? f * f * f : 0.0F) - this.equippedProgressMainHand, -0.4F, 0.4F);
    ...
    public static class CASCHardSwingRepeat extends PlayerAnimation {
        ...
        public void render(AbstractClientPlayer player, EnumHand hand, float progress, ItemStack stack, float p_187457_7_) {
            ...
            if (stack.isEmpty()) {
                ...
                GlStateManager.translate(Debugger.floats[0] - translateX - 0.9F * decr, Debugger.floats[1] + translateY - 0.9F * decr, Debugger.floats[2] + translateZ);
        ...
        @Override
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            ...
            if (model != null) {
                ...
                float decr = 1.0F - ft5;
                handrenderer.rotateAngleX = handrenderer.rotateAngleX + ((-50.0F + Debugger.floats[6] - 0.0F * ft2 - 5.0F * ft3 + 50.0F * ft4 + 30.0F * ft6) * (float) (Math.PI / 180.0) * decr + model.bipedHead.rotateAngleX * ft0_2);
                handrenderer.rotateAngleY = handrenderer.rotateAngleY + ((20.0F + Debugger.floats[7] - 10.0F * ft1 + 10.0F * ft3 - 30.0F * ft4 + 20.0F * ft6) * (float) (Math.PI / 180.0) * decr + model.bipedHead.rotateAngleY * ft0_2);
                handrenderer.rotateAngleZ = handrenderer.rotateAngleZ + (-80.0F + Debugger.floats[8] - 10.0F * ft1 + 35.0F * ft3 + 110.0F * ft4 - 20.0F * ft6) * (float) (Math.PI / 180.0) * decr;
    ...
    public static class CASCStaffShootMiddle extends PlayerAnimation {
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            ...
            if (model != null) {
                ...
                handrenderer.rotateAngleX = handrenderer.rotateAngleX + ((Debugger.floats[6] - 68.0F * ft2) * (float) (Math.PI / 180.0) + model.bipedHead.rotateAngleX * ft0);
                handrenderer.rotateAngleY = handrenderer.rotateAngleY + ((Debugger.floats[7] - 11.0F * ft1) * (float) (Math.PI / 180.0) + model.bipedHead.rotateAngleY * ft0);
                handrenderer.rotateAngleZ = handrenderer.rotateAngleZ + Debugger.floats[8] * (float) (Math.PI / 180.0);
                handrenderer2.rotateAngleX = handrenderer2.rotateAngleX + ((Debugger.floats[6] - 45.0F * ft2) * (float) (Math.PI / 180.0) + model.bipedHead.rotateAngleX * 0.9F * ft0);
                handrenderer2.rotateAngleY = handrenderer2.rotateAngleY + ((Debugger.floats[7] + 25.0F * ft1) * (float) (Math.PI / 180.0) + model.bipedHead.rotateAngleY * 0.9F * ft0);
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            if (model != null) {
                ...
                if (hand == EnumHandSide.RIGHT) {
                    ...
                    model.bipedRightArm.rotateAngleX = ((float) (-Math.PI / 2) + model.bipedHead.rotateAngleX) * ft1 + model.bipedRightArm.rotateAngleX * ft2;
                    model.bipedLeftArm.rotateAngleX = ((float) (-Math.PI / 2) + model.bipedHead.rotateAngleX) * ft1 + model.bipedLeftArm.rotateAngleX * ft2;
                } else {
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            ...
            if (progress < 1.0F) {
                if (model != null) {
                    ...
                    handrenderer.rotateAngleX = handrenderer.rotateAngleX + (-120.0F + MathHelper.sin(mult * progress * 6.5F) * 4.0F) * (float) (Math.PI / 180.0);
                    handrenderer.rotateAngleZ = handrenderer.rotateAngleZ + (-6.0F * handmult + MathHelper.cos(mult * progress * 6.5F) * 4.0F) * (float) (Math.PI / 180.0);
                } else {
                    float rotateX = 0.0F;
                    float rotateY = 0.0F;
                    float rotateZ = 0.0F;
    ...
    public static class PAClassicSwing extends PlayerAnimation {
        ...
        @Override
        public void transform(float progress, ModelBiped biped, ModelRenderer handrenderer, EnumHandSide enumhandside, ItemStack stack, EntityPlayer player, float partialTicks) {
            if (biped != null) {
    ...
    public static class PADaggerAttack extends PlayerAnimation {
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            if (model != null) {
                ...
                handrenderer.rotateAngleX = handrenderer.rotateAngleX - (50.0F * ft1 * (float) (Math.PI / 180.0) - model.bipedHead.rotateAngleX * 0.5F * ft6);
    ...
    public static class PAFlatBlow extends PlayerAnimation {
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            if (model != null) {
                ...
                handrenderer.rotateAngleX = handrenderer.rotateAngleX - ((Debugger.floats[6] + 80.0F * ft1 - 60.0F * ft2 - 20.0F * ft4 + 5.0F * ft5) * (float) (Math.PI / 180.0) - model.bipedHead.rotateAngleX * 0.6F * ft6);
    ...
    public static class PAForging extends PlayerAnimation {
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            if (model != null) {
                ...
                handrenderer.rotateAngleX = handrenderer.rotateAngleX + ((Debugger.floats[6] - rotateX) * (float) (Math.PI / 180.0) + model.bipedHead.rotateAngleX * ft6);
                handrenderer.rotateAngleY = handrenderer.rotateAngleY + ((Debugger.floats[7] - rotateY) * (float) (Math.PI / 180.0) + model.bipedHead.rotateAngleY * ft6);
    ...
    public static class PAGrenadeslaunReloading extends PlayerAnimation {
        ...
        public void render(AbstractClientPlayer player, EnumHand hand, float progress, ItemStack stack, float p_187457_7_) {
            ...
            if (stack.isEmpty()) {
                ...
                float rotateX = 10.0F * GetMOP.getFromTo(progress, 0.0F, 0.085F) - 33.0F * GetMOP.getFromTo(progress, 0.085F, 0.185F) - 13.0F * GetMOP.getFromTo(progress, 0.65F, 0.75F) + 46.0F * GetMOP.getFromTo(progress, 0.75F, 0.9F) - 10.0F * GetMOP.getFromTo(progress, 0.9F, 1.0F);
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            if (model != null) {
                ...
                handrenderer.rotateAngleX = handrenderer.rotateAngleX + ((-46.0F * GetMOP.getFromTo(progress, 0.0F, 0.085F) + ft1 + 14.0F * GetMOP.getFromTo(progress, 0.085F, 0.185F) + 10.0F * GetMOP.getFromTo(progress, 0.65F, 0.75F) - 26.0F * GetMOP.getFromTo(progress, 0.75F, 0.9F) + 6.0F * GetMOP.getFromTo(progress, 0.9F, 1.0F)) * (float) (Math.PI / 180.0) + model.bipedHead.rotateAngleX * 0.4F);
                ...
                handrenderer2.rotateAngleX = handrenderer2.rotateAngleX + (Debugger.floats[6] + 10.0F * ft3 - 80.0F * ft4 + 40.0F * ft5 + 40.0F * ft6) * (float) (Math.PI / 180.0);
                handrenderer2.rotateAngleY = handrenderer2.rotateAngleY + (Debugger.floats[7] + 25.0F * ft5 - 25.0F * ft6) * (float) (Math.PI / 180.0);
                handrenderer2.rotateAngleZ = handrenderer2.rotateAngleZ + (Debugger.floats[8] + 15.0F * ft3 + 25.0F * ft4 + 10.0F * ft5 - 35.0F * ft6) * (float) (Math.PI / 180.0);
            } else {
    ...
    public static class PAGunAimShootNormal extends PlayerAnimation {
        ...
        public void render(AbstractClientPlayer player, EnumHand hand, float progress, ItemStack stack, float p_187457_7_) {
            ...
            if (stack.isEmpty()) {
                ...
                boolean flag1 = enumhandside == EnumHandSide.RIGHT;
                float rotateX = GetMOP.getFromTo(progress, 0.05F, 0.15F) * 8.0F - GetMOP.getFromTo(progress, 0.15F, 0.3F) * 11.0F + GetMOP.getFromTo(progress, 0.3F, 0.5F) * 1.5F + GetMOP.getFromTo(progress, 0.5F, 1.0F) * 1.5F;
    ...
    public static class PAHammerAxeAttack extends PlayerAnimation {
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            if (model != null) {
                ...
                handrenderer.rotateAngleX *= ft7;
                handrenderer2.rotateAngleX *= ft7;
                handrenderer.rotateAngleX = handrenderer.rotateAngleX - ((Debugger.floats[6] + 110.0F * ft1 - 80.0F * ft2 - 20.0F * ft4 + 5.0F * ft5) * (float) (Math.PI / 180.0) - model.bipedHead.rotateAngleX * 0.6F * ft6);
    ...
    public static class PAHardSwing extends PlayerAnimation {
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            ...
            if (model != null) {
                ...
                float ft0_2 = ft0 * 0.5F;
                handrenderer.rotateAngleX *= ft0_1;
                handrenderer.rotateAngleX = handrenderer.rotateAngleX + ((-80.0F * ft2 + 20.0F * ft3 + 10.0F * ft4 + 50.0F * ft4_5) * (float) (Math.PI / 180.0) + model.bipedHead.rotateAngleX * ft0_2);
                handrenderer.rotateAngleY = handrenderer.rotateAngleY + ((50.0F * ft1 - 10.0F * ft3 - 30.0F * ft4 - 20.0F * ft5) * (float) (Math.PI / 180.0) + model.bipedHead.rotateAngleY * ft0_2);
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            if (model != null) {
                ...
                if (hand == EnumHandSide.RIGHT) {
                    ...
                    model.bipedRightArm.rotateAngleX = ((float) (-Math.PI / 2) + model.bipedHead.rotateAngleX) * ft6 + model.bipedRightArm.rotateAngleX * ft7;
                    model.bipedLeftArm.rotateAngleX = ((float) (-Math.PI / 2) + model.bipedHead.rotateAngleX) * ft6 + model.bipedLeftArm.rotateAngleX * ft7;
                } else {
    ...
    public static class PAPistolAimShoot extends PAGunAimShootNormal {
        ...
        @Override
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks, EnumHand handWithItem) {
            float progressOtherhand = 1.0F - Weapons.getPlayerAnimationValue(player, handWithItem == EnumHand.MAIN_HAND ? EnumHand.OFF_HAND : EnumHand.MAIN_HAND, partialTicks);
    ...
    public static class PAPistolReloadingSpin extends PlayerAnimation {
        ...
        public void render(AbstractClientPlayer player, EnumHand hand, float progress, ItemStack stack, float p_187457_7_) {
            ...
            if (stack.isEmpty()) {
                ...
                boolean flag1 = enumhandside == EnumHandSide.RIGHT;
                float rotateX = GetMOP.getFromTo(progress, 0.0F, 0.2F) * -45.0F + GetMOP.getFromTo(progress, 0.5F, 0.75F) * 160.0F + GetMOP.getFromTo(progress, 0.75F, 1.0F) * 245.0F;
                float rotateY = (GetMOP.getFromTo(progress, 0.0F, 0.15F) - GetMOP.getFromTo(progress, 0.3F, 0.4F)) * 8.0F;
                float translateY = -0.2F * GetMOP.getFromTo(progress, 0.4F, 0.75F) + GetMOP.getFromTo(progress, 0.75F, 0.9F) * 0.3F + GetMOP.getFromTo(progress, 0.9F, 1.0F) * -0.1F;
                float translateZ = GetMOP.getFromTo(progress, 0.55F, 0.7F) * 0.4F + GetMOP.getFromTo(progress, 0.7F, 0.9F) * -0.8F + GetMOP.getFromTo(progress, 0.9F, 1.0F) * 0.4F;
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            if (model != null) {
                ...
                float ft3 = -20.0F * GetMOP.getFromTo(progress, 0.4F, 0.75F) + GetMOP.getFromTo(progress, 0.75F, 0.9F) * 30.0F + GetMOP.getFromTo(progress, 0.9F, 1.0F) * -10.0F;
                handrenderer.rotateAngleX -= ft3 * (float) (Math.PI / 180.0);
            } else {
                float rotateX = GetMOP.getFromTo(progress, 0.0F, 0.2F) * -25.0F + GetMOP.getFromTo(progress, 0.5F, 0.75F) * 160.0F + GetMOP.getFromTo(progress, 0.75F, 1.0F) * 225.0F;
                float translateZ = GetMOP.getFromTo(progress, 0.55F, 0.7F) * 0.1F + GetMOP.getFromTo(progress, 0.7F, 0.9F) * -0.2F + GetMOP.getFromTo(progress, 0.9F, 1.0F) * 0.1F;
                GlStateManager.rotate(rotateX, 1.0F, 0.0F, 0.0F);
                GlStateManager.translate(0.0F, 0.0F, translateZ);
            }
        }
    ...
    public static class PAReloadingGunNormal extends PlayerAnimation {
        ...
        public void render(AbstractClientPlayer player, EnumHand hand, float progress, ItemStack stack, float p_187457_7_) {
            ...
            if (stack.isEmpty()) {
                ...
                float translateY = (GetMOP.getFromTo(progress, 0.4F + this.fallupTimeOffset, 0.45F + this.fallupTimeOffset) - GetMOP.getFromTo(progress, 0.45F + this.fallupTimeOffset, 0.5F + this.fallupTimeOffset)) * 0.05F - 0.1F * ft2;
                float translateZ = -0.2F * ft1;
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            if (model != null) {
                ...
                handrenderer.rotateAngleX = handrenderer.rotateAngleX + ((-30.0F * ft1 - 20.0F * ft2 + GetMOP.getFromTo(progress, 0.8F, 1.0F) * -30.0F) * (float) (Math.PI / 180.0) + model.bipedHead.rotateAngleX * 0.7F);
                handrenderer.rotateAngleY += 5.0F * ft1 * (float) (Math.PI / 180.0);
                handrenderer.rotateAngleZ += (-10.0F * ft1 + ft4 * 15.0F) * (float) (Math.PI / 180.0);
                if (hand == EnumHandSide.RIGHT) {
                    model.bipedLeftArm.rotateAngleX = model.bipedLeftArm.rotateAngleX + ((-40.0F * ft3 + ft2 * 25.0F + (GetMOP.getFromTo(progress, 0.5F, 0.55F) - GetMOP.getFromTo(progress, 0.75F, 0.85F)) * -20.0F) * (float) (Math.PI / 180.0) + model.bipedHead.rotateAngleX * 0.7F);
                    ...
                    model.bipedRightArm.rotateAngleX = model.bipedRightArm.rotateAngleX + ((-40.0F * ft3 + ft2 * 25.0F + (GetMOP.getFromTo(progress, 0.5F, 0.55F) - GetMOP.getFromTo(progress, 0.75F, 0.85F)) * -20.0F) * (float) (Math.PI / 180.0) + model.bipedHead.rotateAngleX * 0.7F);
    ...
    public static class PAReloadingMinigun extends PlayerAnimation {
        ...
        public void render(AbstractClientPlayer player, EnumHand hand, float progress, ItemStack stack, float p_187457_7_) {
            ...
            if (stack.isEmpty()) {
                ...
                float ft2 = GetMOP.getFromTo(progress, 0.1F, 0.5F) - GetMOP.getFromTo(progress, 0.5F, 0.7F);
                float translateX = 0.0F;
                float translateY = 0.5F * ft1 + (GetMOP.getFromTo(progress, 0.45F + this.fallupTimeOffset, 0.475F + this.fallupTimeOffset) - GetMOP.getFromTo(progress, 0.475F + this.fallupTimeOffset, 0.5F + this.fallupTimeOffset)) * 0.1F - 0.1F * ft2;
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            ...
            if (model != null) {
                ...
                if (hand == EnumHandSide.RIGHT) {
                    ...
                    model.bipedRightArm.rotateAngleX = ((float) (-Math.PI / 2) + model.bipedHead.rotateAngleX) * ft5 + model.bipedRightArm.rotateAngleX * ft6 + 0.18F * ft2 + ft8;
                    model.bipedLeftArm.rotateAngleX = ((float) (-Math.PI / 2) + model.bipedHead.rotateAngleX) * ft5 + model.bipedLeftArm.rotateAngleX * ft6 + ft8 * 1.8F;
                    model.bipedLeftArm.rotateAngleX = model.bipedLeftArm.rotateAngleX + (Debugger.floats[6] - 20.0F * ft7 + 5.0F * ft2 + 20.0F * ft3) * (float) (Math.PI / 180.0);
                    ...
                    model.bipedRightArm.rotateAngleX = ((float) (-Math.PI / 2) + model.bipedHead.rotateAngleX) * ft5 + model.bipedRightArm.rotateAngleX * ft6 + ft8 * 1.8F;
                    model.bipedLeftArm.rotateAngleX = ((float) (-Math.PI / 2) + model.bipedHead.rotateAngleX) * ft5 + model.bipedLeftArm.rotateAngleX * ft6 + 0.18F * ft2 + ft8;
                    model.bipedRightArm.rotateAngleX = model.bipedRightArm.rotateAngleX + (Debugger.floats[6] - 20.0F * ft7 + 5.0F * ft2 + 20.0F * ft3) * (float) (Math.PI / 180.0);
    ...
    public static class PARollOpen extends PlayerAnimation {
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            if (model != null) {
                ...
                handrenderer.rotateAngleY = handrenderer.rotateAngleY + (Debugger.floats[7] + 40.0F * ft2 - 50.0F * ft3 + 5.0F * ft4 + 5.0F * ft5) * (float) (Math.PI / 180.0);
                handrenderer.rotateAngleZ = handrenderer.rotateAngleZ + Debugger.floats[8] * (float) (Math.PI / 180.0);
    ...
    public static class PASpearAttack extends PlayerAnimation {
        ...
        public void render(AbstractClientPlayer player, EnumHand hand, float progress, ItemStack stack, float p_187457_7_) {
            ...
            if (stack.isEmpty()) {
                ...
                boolean flag1 = enumhandside == EnumHandSide.RIGHT;
                float rotateX = GetMOP.getFromTo(progress, 0.0F, 0.2F) * -70.0F + GetMOP.getFromTo(progress, 0.2F, 0.4F) * -10.0F + GetMOP.getFromTo(progress, 0.6F, 1.0F) * 80.0F;
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            if (model != null) {
                ...
                handrenderer.rotateAngleX = handrenderer.rotateAngleX + (GetMOP.getFromTo(progress, 0.0F, 0.3F) * 15.0F + GetMOP.getFromTo(progress, 0.3F, 0.5F) * -98.0F + GetMOP.getFromTo(progress, 0.5F, 0.8F) * 83.0F) * (float) (Math.PI / 180.0);
                handrenderer.rotateAngleY = handrenderer.rotateAngleY + (ft1 * -9.0F * (float) (Math.PI / 180.0) * handMult + model.bipedHead.rotateAngleY * ft2 * 0.7F);
                ...
                model.bipedBody.rotateAngleY = model.bipedBody.rotateAngleY + (GetMOP.getFromTo(progress, 0.0F, 0.3F) * 10.0F + GetMOP.getFromTo(progress, 0.3F, 0.5F) * -15.0F + GetMOP.getFromTo(progress, 0.5F, 0.8F) * 5.0F) * (float) (Math.PI / 180.0) * handMult;
            } else {
                float rotateX = GetMOP.getFromTo(progress, 0.0F, 0.3F) * -20.0F + GetMOP.getFromTo(progress, 0.3F, 0.5F) * -60.0F + GetMOP.getFromTo(progress, 0.5F, 0.8F) * 80.0F;
                float translateX = -0.05F * (GetMOP.getFromTo(progress, 0.0F, 0.15F) - GetMOP.getFromTo(progress, 0.8F, 1.0F));
                float translateY = GetMOP.getFromTo(progress, 0.0F, 0.3F) * -0.5F + GetMOP.getFromTo(progress, 0.3F, 0.5F) * 1.0F - GetMOP.getFromTo(progress, 0.5F, 0.8F) * 0.5F;
    ...
    public static class PAStaffCastGroundhit extends PlayerAnimation {
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            if (model != null) {
                ...
                float ft1 = GetMOP.getFromTo(progress, 0.0F, 0.37F) * -140.0F + GetMOP.getFromTo(progress, 0.43F, 0.5F) * 60.0F + GetMOP.getFromTo(progress, 0.5F, 0.54F) * -5.0F + GetMOP.getFromTo(progress, 0.54F, 0.58F) * 5.0F;
                ...
                float ft4 = GetMOP.getFromTo(progress, 0.08F, 0.37F) * -120.0F + GetMOP.getFromTo(progress, 0.43F, 0.5F) * 45.0F + GetMOP.getFromTo(progress, 0.5F, 0.54F) * -5.0F + GetMOP.getFromTo(progress, 0.54F, 0.58F) * 5.0F;
    ...
    public static class PAStaffShootMiddlePunch extends PlayerAnimation {
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            ...
            if (model != null) {
                ...
                handrenderer2.rotateAngleX *= 1.0F - 0.85F * ft0;
                handrenderer.rotateAngleX *= 1.0F - 0.95F * ft0;
                handrenderer.rotateAngleX = handrenderer.rotateAngleX + ((Debugger.floats[6] - 68.0F * ft2 + 14.0F * ft3) * (float) (Math.PI / 180.0) + model.bipedHead.rotateAngleX * ft0);
                handrenderer.rotateAngleY = handrenderer.rotateAngleY + ((Debugger.floats[7] - 11.0F * ft1) * (float) (Math.PI / 180.0) + model.bipedHead.rotateAngleY * ft0);
                handrenderer2.rotateAngleX = handrenderer2.rotateAngleX + ((Debugger.floats[6] - 45.0F * ft2 + 9.0F * ft3) * (float) (Math.PI / 180.0) + model.bipedHead.rotateAngleX * 0.9F * ft0);
                handrenderer2.rotateAngleY = handrenderer2.rotateAngleY + ((Debugger.floats[7] + 25.0F * ft1) * (float) (Math.PI / 180.0) + model.bipedHead.rotateAngleY * 0.9F * ft0);
    ...
    public static class PAStaffShootNormal extends PlayerAnimation {
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            if (model != null) {
                ...
                handrenderer.rotateAngleX = handrenderer.rotateAngleX + model.bipedHead.rotateAngleX * ft2 * 0.85F;
                model.bipedBody.rotateAngleY = model.bipedBody.rotateAngleY + (GetMOP.getFromTo(progress, 0.0F, 0.1F) * -10.0F + GetMOP.getFromTo(progress, 0.15F, 0.4F) * 10.0F) * (float) (Math.PI / 180.0) * handMult;
    ...
    public static class PAWhipAttack extends PlayerAnimation {
        ...
        public void transform(float progress, @Nullable ModelBiped model, @Nullable ModelRenderer handrenderer, EnumHandSide hand, @Nullable ItemStack stack, EntityPlayer player, float partialTicks) {
            if (model != null) {
                ...
                float ft3 = GetMOP.getFromTo(progress, 0.42F, 0.48F);
                float ft4 = GetMOP.softFromTo(progress, 0.62F, 1.0F);
                handrenderer.rotateAngleX = handrenderer.rotateAngleX + ((Debugger.floats[6] + 10.0F * ft1 - 150.0F * ft2 + 125.0F * ft3 - 65.0F * ft4) * (float) (Math.PI / 180.0) + model.bipedHead.rotateAngleX);
                handrenderer.rotateAngleY = handrenderer.rotateAngleY + ((Debugger.floats[7] + 10.0F * ft1 - 15.0F * ft2 + 5.0F * ft4) * (float) (Math.PI / 180.0) * handMult + model.bipedHead.rotateAngleY);
                handrenderer.rotateAngleZ = handrenderer.rotateAngleZ + (Debugger.floats[8] + 10.0F * ft1 - 20.0F * ft2 + 10.0F * ft4) * (float) (Math.PI / 180.0) * handMult;
            } else {
                float ft2 = GetMOP.softFromTo(progress, 0.12F, 0.35F);
                float ft3 = GetMOP.getFromTo(progress, 0.42F, 0.48F);
                float ft3_4 = GetMOP.softFromTo(progress, 0.52F, 0.85F);
