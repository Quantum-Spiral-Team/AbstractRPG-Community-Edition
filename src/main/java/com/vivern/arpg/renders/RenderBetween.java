...
public class RenderBetween<T extends BetweenParticle> extends Render<BetweenParticle> {
    ...
    public void doRender(BetweenParticle entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        bufferbuilder.pos(-entity.scale, 0.0, 0.0).tex(0.0, entity.texstart + dist / entity.texlengh + timee * entity.animation + entity.offset).endVertex();
        ...
        bufferbuilder.pos(entity.scale, 0.0, 0.0).tex(1.0, entity.texstart + dist / entity.texlengh + timee * entity.animation + entity.offset).endVertex();
        tessellator.draw();
        ...
        if (entity.horizontal) {
            ...
            bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
            bufferbuilder2.pos(0.0, -entity.scale, 0.0).tex(0.0, entity.texstart + dist / entity.texlengh + timee * entity.animation + entity.offset).endVertex();
            ...
            bufferbuilder2.pos(0.0, entity.scale, 0.0).tex(1.0, entity.texstart + dist / entity.texlengh + timee * entity.animation + entity.offset).endVertex();
            tessellator2.draw();
            GlStateManager.disableRescaleNormal();
            GL11.glDisable(3042);
            GL11.glEnable(2896);
