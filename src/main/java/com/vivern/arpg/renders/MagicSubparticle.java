...
public class MagicSubparticle {
    ...
    public MagicSubparticle(double posX, double posY, double posZ, int livetime, float moveX, float moveY, float moveZ, float colorR, float colorG, float colorB, float targetcolorR, float targetcolorG, float targetcolorB) {
        this.posX = posX;
        this.posY = posY;
        this.posZ = posZ;
