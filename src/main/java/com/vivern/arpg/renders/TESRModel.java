    ...
    public void render(TileEntity te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (te != null) {
            if (this.dataToFloats != null) {
                ...
                if (floats != null) {
                    this.model.render(null, floats[0], floats.length > 1 ? floats[1] : 0.0F, floats.length > 2 ? floats[2] : 0.0F, floats.length > 3 ? floats[3] : 0.0F, floats.length > 4 ? floats[4] : 0.0F, 0.0625F);
                } else {
                    this.model.render(null, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
                }
            } else {
                this.model.render(null, te.getPos().getX(), te.getPos().getY(), te.getPos().getZ(), 0.0F, 0.0F, 0.0625F);
            }
        } else {
            this.model.render(null, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
        }
