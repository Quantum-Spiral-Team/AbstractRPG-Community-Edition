...
public class PotionBurningEffects {
    ...
    public static void onLivingUpdate(LivingUpdateEvent event) {
        ...
        if (fieryoil.contains(entityliving)) {
            ...
            BetweenParticle laser = new BetweenParticle(entityliving.world, fiertrtex, 0.35F, -1, 1.0F, 1.0F, 1.0F, 0.0F, vecpos.distanceTo(vec), 1, 0.0F, 3.0F, vecpos, vec);
            ...
            BetweenParticle laser2 = new BetweenParticle(entityliving.world, fiertrtex, 0.35F, -1, 1.0F, 1.0F, 1.0F, 0.0F, vecpos.distanceTo(vec2), 1, 0.0F, 3.0F, vecpos, vec2);
    ...
    public static void onRenderHand(RenderWorldLastEvent event) {
        if (fireaura.contains(Minecraft.getMinecraft().player) && Minecraft.getMinecraft().getRenderManager().options != null && Minecraft.getMinecraft().getRenderManager().options.thirdPersonView == 0) {
    ...
    public static void onRenderHand(RenderHandEvent event) {
        if (Minecraft.getMinecraft().getRenderViewEntity() != null && Minecraft.getMinecraft().getRenderViewEntity() instanceof EntityPlayer && Minecraft.getMinecraft().getRenderManager() != null && Minecraft.getMinecraft().getRenderManager().options != null && Minecraft.getMinecraft().getRenderManager().options.thirdPersonView == 0) {
