...
public class ParticleTentacle extends GUNParticle {
    ...
    public ParticleTentacle(ResourceLocation texture, float scaleStart, float scaleEnd, float gravity, int livetime, int light, World world, Vec3d start, Vec3d end, Vec3d rotationStart, Vec3d rotationEnd, float speedx, float speedy, float speedz, float Red, float Green, float Blue, boolean opa, int segments, float rotationVecLength) {
        super(texture, scaleStart, gravity, livetime, light, world, (start.x + end.x) / 2.0, (start.y + end.y) / 2.0, (start.z + end.z) / 2.0, speedx, speedy, speedz, Red, Green, Blue, opa, 0);
    ...
    public ParticleTentacle(ResourceLocation texture, float scaleStart, float scaleEnd, float gravity, int livetime, int light, World world, ParticleTentaclePOINT start, ParticleTentaclePOINT end, float speedx, float speedy, float speedz, float Red, float Green, float Blue, boolean opa, int segments, float rotationVecLength) {
