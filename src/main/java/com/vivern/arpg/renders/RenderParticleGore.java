        ...
        if (boxnonull || listnonull) {
            ...
            if (boxnonull) {
                ...
                for (ModelRenderer boxx : entity.renderCutList) {
                    ...
                    GlStateManager.translate(-boxx.rotationPointX * Debugger.floats[0], -boxx.rotationPointY * Debugger.floats[0], -boxx.rotationPointZ * Debugger.floats[0]);
                    GlStateManager.translate(boxx.offsetX * Debugger.floats[1], boxx.offsetY * Debugger.floats[1], boxx.offsetZ * Debugger.floats[1]);
