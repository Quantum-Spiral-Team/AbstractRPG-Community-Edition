...
public class CloudSubparticle {
    ...
    public CloudSubparticle(ResourceLocation texture, int model, double posX, double posY, double posZ, float sizeX, float sizeY, float sizeZ, int livetime, int alphaChangeTime) {
