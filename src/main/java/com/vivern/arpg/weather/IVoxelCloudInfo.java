...
public interface IVoxelCloudInfo {
    ...
    void writeColorInPoint(VoxelCloudField var1, VoxelCloud var2, float[] var3, double var4, double var6, double var8, int var10, int var11, int var12, VoxelCloud.EnumCubeVertex var13);
