...
public class VoxelCloudField {
    ...
    public void writeColorInPoint(VoxelCloud voxelCloud, float[] colorRGBA, double x, double y, double z, int arrayX, int arrayY, int arrayZ, VoxelCloud.EnumCubeVertex vertex) {
        if (this.voxelCloudInfo != null) {
    ...
    public class VoxelCloudArray {
        ...
        public VoxelCloud get(int x, int y, int z) {
            return this.voxels[GetMOP.cycle(this.startPointX + x, this.arraySizeX)][GetMOP.cycle(this.startPointY + y, this.arraySizeY)][GetMOP.cycle(this.startPointZ + z, this.arraySizeZ)];
        }

        public void set(int x, int y, int z, VoxelCloud voxel) {
            this.voxels[GetMOP.cycle(this.startPointX + x, this.arraySizeX)][GetMOP.cycle(this.startPointY + y, this.arraySizeY)][GetMOP.cycle(this.startPointZ + z, this.arraySizeZ)] = voxel;
        }
