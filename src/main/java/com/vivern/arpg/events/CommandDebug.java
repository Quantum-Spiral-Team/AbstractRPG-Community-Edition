    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException, NumberFormatException {
        if (args.length > 2) {
            ...
            if (args.length == 2) {
                ...
                Minecraft.getMinecraft().player.sendChatMessage(Debugger.floats[0] + " " + Debugger.floats[1] + " " + Debugger.floats[2] + " " + Debugger.floats[3] + " " + Debugger.floats[4] + " " + Debugger.floats[5] + " " + Debugger.floats[6] + " " + Debugger.floats[7] + " " + Debugger.floats[8] + " " + Debugger.floats[9] + " " + Debugger.floats[10]);
