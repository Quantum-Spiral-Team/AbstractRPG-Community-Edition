        ...
        if (this.isLockedWithWinterCurse()) {
            ...
            if (!player.world.isRemote) {
                if (rand.nextFloat() < 0.6) {
                    PotionEffect lastdebaff = Weapons.mixPotion(player, PotionEffects.FREEZING, 80.0F, 3.0F, Weapons.EnumPotionMix.GREATEST, Weapons.EnumPotionMix.GREATEST, Weapons.EnumMathOperation.NONE, Weapons.EnumMathOperation.NONE, 160, 3);
    ...
    public void update() {
        ...
        if (this.numPlayersUsing == 0 && this.lidAngle > 0.0F || this.numPlayersUsing > 0 && this.lidAngle < 1.0F) {
            ...
            if (this.lidAngle < 0.5F && f2 >= 0.5F && this.adjacentChestZNeg == null && this.adjacentChestXNeg == null) {
                ...
                this.world.playSound(null, d3, j + 0.5, d0, SoundEvents.BLOCK_CHEST_CLOSE, SoundCategory.BLOCKS, 0.5F, this.world.rand.nextFloat() * 0.1F + 0.9F);
            }
