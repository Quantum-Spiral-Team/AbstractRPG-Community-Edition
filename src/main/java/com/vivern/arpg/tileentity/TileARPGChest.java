...
public class TileARPGChest extends TileEntityLockableLoot implements ITickable {
    ...
    public IInventory getOpenedInventory() {
        ...
        if (otherChest != null) {
            ...
            return standing == EnumChestStanding.LEFT ? new InventoryLargeChest("container.chestDouble", this, otherChest) : new InventoryLargeChest("container.chestDouble", otherChest, this);
        } else {
            return this;
        }
    }
    ...
    public boolean canOpen() {
        if (this.world.getBlockState(this.pos.up()).doesSideBlockChestOpening(this.world, this.pos.up(), EnumFacing.DOWN)) {
            return false;
            ...
            if (other != null) {
                if (this.world.getBlockState(other.getPos().up()).doesSideBlockChestOpening(this.world, other.getPos().up(), EnumFacing.DOWN)) {
                    return false;
                }
    ...
    public AxisAlignedBB getRenderBoundingBox() {
        return this.getChestStanding() == EnumChestStanding.LEFT ? super.getRenderBoundingBox().expand(this.otherChestSide.getXOffset(), 0.0, this.otherChestSide.getZOffset()) : super.getRenderBoundingBox();
    }
