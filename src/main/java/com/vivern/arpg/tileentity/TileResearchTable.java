...
public class TileResearchTable extends TileEntityLockableLoot implements TileEntityClicked, ITileEntitySynchronized, ITickable {
    ...
    public static Phenomenon RAINBOW = new Phenomenon("rainbow", ShardType.FIRE, ShardType.VOID, ShardType.WATER, ShardType.AIR);
    ...
    public static Phenomenon THUNDERSTORM = new Phenomenon("thunderstorm", ShardType.WATER, ShardType.ELECTRIC, ShardType.AIR);
    public static Phenomenon RELIGION = new Phenomenon("religion", ShardType.DEATH, ShardType.LIVE, ShardType.PAIN, ShardType.PLEASURE);
    ...
    public static Phenomenon OCEANIC_PLANET = new Phenomenon("oceanic_planet", ShardType.EARTH, ShardType.VOID, ShardType.WATER);
    ...
    public static Phenomenon INHABITED_PLANET = new Phenomenon("inhabited_planet", ShardType.EARTH, ShardType.VOID, ShardType.LIVE);
    ...
    public static Phenomenon QUAZAR = new Phenomenon("quazar", ShardType.EARTH, ShardType.VOID, ShardType.DEATH, ShardType.FIRE);
    public static Phenomenon WHITE_DWARF = new Phenomenon("white_dwarf", ShardType.EARTH, ShardType.VOID, ShardType.FIRE, ShardType.COLD);
    public static Phenomenon CONSTELLATION = new Phenomenon("constellation", ShardType.EARTH, ShardType.VOID, ShardType.FIRE, ShardType.PLEASURE);
    ...
    public static boolean checkInventoryForRollResources(IInventory inventory) {
        return inventory.getStackInSlot(2).isEmpty() && OreDicHelper.itemStringOredigMatches(inventory.getStackInSlot(0), "stickWood") && OreDicHelper.itemStringOredigMatches(inventory.getStackInSlot(1), "paper") && checkInkInSlot(inventory);
    }
    ...
    public static MoveLayout getPhenomenonMoveLayout(HypothesisBoard board, HypothesisCell cellFrom, Phenomenon phenomenonMoves, boolean reverseTime) {
    ...
    public static MoveLayout getElementMoveLayout(ShardType element, HypothesisBoard board, HypothesisCell cellFrom, Phenomenon phenomenonMoves) {
                    ...
                    if (cell != null && board.canStand(cell.pos, phenomenonMoves)) {
                        ...
                        for (int ixxxxx = 0; ixxxxx < 8; ixxxxx++) {
                            ...
                            if (way != null) {
                                ...
                                if (cellTo != null && cellTo.phenomenon != null && cellTo.phenomenon.hasElementsExcept(ShardType.VOID) && !cellTo.pos.equals(cellFrom.pos)) {
                                    addToList = false;
                                    break;
                                }
                            }
    ...
    public static class HypothesisBoard {
        ...
        public void recursiveGenerateBoard(Random rand, CellPos pos, float wayChance, @Nullable HypothesisCell cellFrom, int generatorDirection) {
            if (this.lastCells > 0) {
        ...
        public HypothesisCell getCell(CellPos position) {
            return position.posHoriz >= 0 && position.posVert >= 0 && position.posHoriz < this.sizeHoriz && position.posVert < this.sizeVert ? this.cells[position.posHoriz][position.posVert] : null;
        }
        ...
        public boolean movePhenomenon(MoveLayout layout, HypothesisCell cellFrom, CellPos posTo, boolean reverseTime) {
        ...
        public boolean setMovedPhenomenon(Phenomenon phenomenon, HypothesisCell cellFrom, CellPos posTo, boolean reverseTime) {
