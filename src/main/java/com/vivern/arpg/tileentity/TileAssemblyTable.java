...
public class TileAssemblyTable extends TileEntityLockableLoot implements ITickable, TileEntityClicked, ITileEntitySynchronized, ISidedInventory {
    ...
    public AssemblyTableModel.AssemblyManipulatorAnimation[] animations = new AssemblyTableModel.AssemblyManipulatorAnimation[]{new AssemblyTableModel.AssemblyManipulatorAnimation(1), new AssemblyTableModel.AssemblyManipulatorAnimation(2), new AssemblyTableModel.AssemblyManipulatorAnimation(3)};
    ...
    public void setAugmentsTilesToWork(AugmentInfo augmentInfo, int allTimeToWork) {
        if (allTimeToWork <= 0 || augmentInfo.cutters != 0 || augmentInfo.presses != 0 || augmentInfo.welds != 0 || augmentInfo.plasmaSprays != 0 || augmentInfo.molecularPrinters != 0) {
        ...
        if (!this.world.isRemote) {
            ...
            if (this.started) {
                ...
                if (rand.nextFloat() < 0.4F) {
                    this.world.spawnParticle(EnumParticleTypes.CLOUD, this.getPos().getX() + 0.5, this.getPos().getY() + 1.05, this.getPos().getZ() + 0.5, (rand.nextFloat() - 0.5) * 0.2, (rand.nextFloat() - 0.5) * 0.1, (rand.nextFloat() - 0.5) * 0.2, new int[0]);
                    this.world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, this.getPos().getX() + 0.5, this.getPos().getY() + 1.05, this.getPos().getZ() + 0.5, (rand.nextFloat() - 0.5) * 0.2, (rand.nextFloat() - 0.5) * 0.1, (rand.nextFloat() - 0.5) * 0.2, new int[0]);
                }
            }
        }
