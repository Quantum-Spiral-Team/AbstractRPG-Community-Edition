    ...
    public void update() {
        ...
        if (!this.world.isRemote) {
            ...
            if (this.ticks % 3 == 0 && this.type > 0 && this.tank1 != null && this.tank2 != null && this.tank1.getFluid() != null) {
                ...
                if (cinfo != null && this.heat >= cinfo.coolingMinimum && this.heat >= cinfo.coolingAmount && cinfo.inputExponent <= this.tank1.getFluidAmount() && (cinfo.existedFluid == null || cinfo.existedExponent == 0 || this.tank2.getFluid().getFluid() == cinfo.existedFluid) && this.tank2.getFluidAmount() + cinfo.existedExponent <= this.tank2.getCapacity()) {
