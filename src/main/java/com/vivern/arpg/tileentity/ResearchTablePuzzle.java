...
public class ResearchTablePuzzle {
    ...
    public void generate() {
        ...
        for (int i = 0; i < 6; i++) {
            RTPElementRunePiece runePiece = new RTPElementRunePiece(this.rand.nextInt(this.sizeX), this.rand.nextInt(this.sizeY), i);
    ...
    public RTPElement createRandomFunctionalElement(float difficulty) {
        if (this.rand.nextFloat() < 0.33F) {
            ...
            return this.rand.nextFloat() < 0.5F ? new RTPElementQuad(this.chipX, this.chipY) : new RTPElementLine(this.chipX, this.chipY);
        }
    }
    ...
    public static class RTPElementCross extends RTPElement {
        ...
        @Override
        public boolean onGenerate(ResearchTablePuzzle puzzle) {
            if (puzzle.canPlaceBlock(this.posX + 1, this.posY + 1) && puzzle.canPlaceBlock(this.posX - 1, this.posY + 1) && puzzle.canPlaceBlock(this.posX + 1, this.posY - 1) && puzzle.canPlaceBlock(this.posX - 1, this.posY - 1)) {
    ...
    public static class RTPElementQuad extends RTPElement {
        ...
        @Override
        public boolean onGenerate(ResearchTablePuzzle puzzle) {
            if (puzzle.canPlaceBlock(this.posX + 1, this.posY + 1) && puzzle.canPlaceBlock(this.posX - 1, this.posY + 1) && puzzle.canPlaceBlock(this.posX + 1, this.posY - 1) && puzzle.canPlaceBlock(this.posX - 1, this.posY - 1) && puzzle.canPlaceBlock(this.posX + 1, this.posY) && puzzle.canPlaceBlock(this.posX - 1, this.posY) && puzzle.canPlaceBlock(this.posX, this.posY + 1) && puzzle.canPlaceBlock(this.posX, this.posY - 1)) {
                puzzle.setToBoard(new RTPElementBlock(this.posX + 1, this.posY + 1));
                puzzle.setToBoard(new RTPElementBlock(this.posX - 1, this.posY + 1));
                puzzle.setToBoard(new RTPElementBlock(this.posX + 1, this.posY - 1));
                puzzle.setToBoard(new RTPElementBlock(this.posX - 1, this.posY - 1));
