...
public class ChestItemHandler extends WeakReference<TileChest> implements IItemHandlerModifiable {
    ...
    public ChestItemHandler(@Nullable TileChest mainChest, @Nullable TileChest other, boolean mainChestIsUpper) {
        ...
        this.hashCode = Objects.hashCode(new Object[]{mainChestIsUpper ? mainChest : other}) * 31 + Objects.hashCode(new Object[]{!mainChestIsUpper ? mainChest : other});
    }
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            if (this.hashCode != that.hashCode) {
                ...
                return this.mainChestIsUpper == that.mainChestIsUpper ? Objects.equal(this.mainChest, that.mainChest) && Objects.equal(otherChest, that.getOtherChest()) : Objects.equal(this.mainChest, that.getOtherChest()) && Objects.equal(otherChest, that.mainChest);
            }
        } else {
            return false;
        }
