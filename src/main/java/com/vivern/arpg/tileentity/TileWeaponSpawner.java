...
public class TileWeaponSpawner extends TileEntityLockableLoot implements ITickable, TileEntityClicked {
    ...
    public ItemStack[] spawn = new ItemStack[]{ItemStack.EMPTY, ItemStack.EMPTY, ItemStack.EMPTY, ItemStack.EMPTY, ItemStack.EMPTY};
    ...
    public boolean spawnempty() {
        return this.spawn[0].isEmpty() && this.spawn[1].isEmpty() && this.spawn[2].isEmpty() && this.spawn[3].isEmpty() && this.spawn[4].isEmpty();
    }
    ...
    public void update() {
        if (!this.world.isRemote && !this.playerRelativeCooldown) {
            if (this.cooldown <= 0) {
                ...
                if (!this.spawnempty()) {
                    AxisAlignedBB aabb = new AxisAlignedBB(this.getPos().getX(), this.getPos().getY(), this.getPos().getZ(), this.getPos().getX() + 1, this.getPos().getY() + 3, this.getPos().getZ() + 1);
