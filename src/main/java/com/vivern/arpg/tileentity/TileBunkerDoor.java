...
public class TileBunkerDoor extends TileEntity implements ITickable {
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        if (compound.hasKey("relativeposX") && compound.hasKey("relativeposY") && compound.hasKey("relativeposZ")) {
            this.relativeCurrentPos = new BlockPos(compound.getInteger("relativeposX"), compound.getInteger("relativeposY"), compound.getInteger("relativeposZ"));
        }
    ...
    public boolean isAccessBlock(IBlockState block, BlockPos pos) {
        return block.getBlock() == BlocksRegister.RUST_METAL || block.getBlock() == BlocksRegister.RUSTED_PIPE || block.getBlock() == BlocksRegister.RUST_ARMATURE || block.getBlock() == BlocksRegister.RUST_LAMP || block.getBlock() == BlocksRegister.DARK_RUST_METALL || block.getBlock() == BlocksRegister.LAB_PLATING || block.getBlock() == BlocksRegister.SCRAP_ELECTRONICS || block.getBlock() == Blocks.IRON_BLOCK || block.getBlock() == Blocks.IRON_BARS || Weapons.easyBreakBlockFor(this.world, 12.0F, pos, block);
    }
