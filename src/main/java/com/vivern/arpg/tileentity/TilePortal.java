...
public class TilePortal extends TileEntity {
    ...
    public void readFromNBT(NBTTagCompound compound) {
        if (compound.hasKey("mainBlockposX") && compound.hasKey("mainBlockposY") && compound.hasKey("mainBlockposZ")) {
            this.mainBlockPosition = new BlockPos(compound.getInteger("mainBlockposX"), compound.getInteger("mainBlockposY"), compound.getInteger("mainBlockposZ"));
        }

        if (compound.hasKey("linkedPortalX") && compound.hasKey("linkedPortalY") && compound.hasKey("linkedPortalZ")) {
            this.linkedPortal = new BlockPos(compound.getInteger("linkedPortalX"), compound.getInteger("linkedPortalY"), compound.getInteger("linkedPortalZ"));
        }
