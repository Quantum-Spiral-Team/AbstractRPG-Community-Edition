    ...
    public void update() {
        if (this.world.isRemote && this.energyType == ShardType.AIR) {
            if (rand.nextFloat() < 0.15F) {
                ...
                float vdecr = 110.0F;
                GUNParticle fog = new GUNParticle(clouds11, 0.125F, 0.0F, lt, 170, this.world, xx, yy, zz, (rand.nextFloat() - 0.5F) / vdecr, (rand.nextFloat() - 0.5F) / vdecr, (rand.nextFloat() - 0.5F) / vdecr, this.energyType.colorR, this.energyType.colorG, this.energyType.colorB, true, rand.nextInt(360));
            ...
            if (rand.nextFloat() < 0.215F) {
                ...
                GUNParticle part = new GUNParticle(pixel, scl, 0.0F, lt, 150 + rand.nextInt(90), this.world, poss.x, poss.y, poss.z, (float) direction.x, (float) direction.y, (float) direction.z, this.energyType.colorR, this.energyType.colorG, this.energyType.colorB, false, 0);
