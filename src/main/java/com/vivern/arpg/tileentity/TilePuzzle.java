        ...
        if (!this.world.isRemote) {
            if (mouseX >= 0 && mouseY >= 0 && mouseX < this.puzzleWidth && mouseY < this.puzzleHeight) {
                if (!this.puzzlePlate[mouseX][mouseY].filled && this.canFit(mouseX, mouseY)) {
                    ...
                    this.world.playSound(null, this.pos, Sounds.puzzle_place, SoundCategory.BLOCKS, 0.3F, 0.85F + rand.nextFloat() / 4.0F);
                } else if (this.puzzlePlate[mouseX][mouseY].center) {
                    this.removeFromPuzzleSlot(mouseX, mouseY);
                    this.world.playSound(null, this.pos, Sounds.puzzle_remove, SoundCategory.BLOCKS, 0.3F, 0.85F + rand.nextFloat() / 4.0F);
                }
            ...
            if (mouseY == 9 || mouseY == 10) {
                ...
                if ((mouseX == 6 || mouseX == 7) && this.checkForFill()) {
                    ...
                    this.world.playSound(null, this.pos, Sounds.puzzle_unlock, SoundCategory.BLOCKS, 0.9F, 0.9F + rand.nextFloat() / 5.0F);
