...
public class TileNexusBeacon extends TileNexus {
    ...
    public void update() {
        ...
        if (this.world.isRemote) {
            ...
            GUNParticle water = new GUNParticle(Seal.splashes[this.rand.nextInt(3)], scl, 0.023F, lt, 150, this.world, this.pos.getX() + 0.5, this.pos.getY() + 0.51, this.pos.getZ() + 0.5, (float) this.rand.nextGaussian() / 25.0F, (float) this.rand.nextGaussian() / 25.0F + (this.invasionStarted ? 0.2F : 0.1F), (float) this.rand.nextGaussian() / 25.0F, 0.65F - this.rand.nextFloat() * 0.2F, 1.0F - this.rand.nextFloat() * 0.22F, 1.0F - this.rand.nextFloat() * 0.2F, false, this.rand.nextInt(360), true, 1.15F);
    ...
    public void onInvasionEnd(boolean success) {
        if (success) {
            ...
            if (activ != null) {
                this.world.spawnEntity(new EntityItem(this.world, this.getPos().getX() + 0.5, this.getPos().getY() + 0.6, this.getPos().getZ() + 0.5, new ItemStack(activ)));
                if (this.ACTIVATOR == 3 && this.rand.nextFloat() < 0.5F) {
                    this.world.spawnEntity(new EntityItem(this.world, this.getPos().getX() + 0.5, this.getPos().getY() + 0.6, this.getPos().getZ() + 0.5, new ItemStack(ItemsRegister.TIDAL_HEART)));
                }
            ...
            if (activx != null) {
                this.world.spawnEntity(new EntityItem(this.world, this.getPos().getX() + 0.5, this.getPos().getY() + 0.6, this.getPos().getZ() + 0.5, new ItemStack(activx)));
            }
        }
