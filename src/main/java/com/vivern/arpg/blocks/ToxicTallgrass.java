...
public class ToxicTallgrass extends Block implements IShearable {
    ...
    public static boolean canStayAtPos(World worldIn, BlockPos pos) {
        ...
        return blockd == BlocksRegister.TOXIC_DIRT || blockd == BlocksRegister.TOXIC_GRASS || blockd == BlocksRegister.SLUDGE || blockd == BlocksRegister.JUNK || blockd == BlocksRegister.NUCLEAR_WASTE;
    }
