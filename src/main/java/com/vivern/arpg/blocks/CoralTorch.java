    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        if (rand.nextFloat() < 0.19F) {
            ...
            if (enumfacing.getAxis().isHorizontal()) {
                EnumFacing enumfacing1 = enumfacing.getOpposite();
                GUNParticle spell = new GUNParticle(res, 0.15F, 0.0F, livetime, 210, worldIn, d0 + d4 * enumfacing1.getXOffset(), d1 + d3, d2 + d4 * enumfacing1.getZOffset(), 0.0F, 0.0F, 0.0F, 0.5F + rand.nextFloat() * 0.1F, 1.0F, 0.85F + rand.nextFloat() * 0.15F, true, 0);
                spell.alpha = 1.0F;
                ...
                GUNParticle spell = new GUNParticle(res, 0.15F, 0.0F, livetime, 210, worldIn, d0, d1, d2, 0.0F, 0.0F, 0.0F, 0.5F + rand.nextFloat() * 0.1F, 1.0F, 0.85F + rand.nextFloat() * 0.15F, true, 0);
                spell.alpha = 1.0F;
                spell.alphaTickAdding = -0.0125F;
                spell.scaleTickAdding = scaleTickAdding;
                spell.alphaGlowing = true;
