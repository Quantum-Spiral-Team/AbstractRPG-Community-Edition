...
public class RedPepperVine extends Block implements IGrowable {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        if (!worldIn.isRemote) {
            ...
            } else if (OreDicHelper.itemStringOredigMatches(player.getHeldItem(hand), OreDicHelper.DUSTCHARCOAL) || OreDicHelper.itemStringOredigMatches(player.getHeldItem(hand), OreDicHelper.DUSTCOAL)) {
