...
public class BlockRotated extends Block {
    ...
    public IBlockState getStateForPlacement(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        return this.fullFacing ? this.getDefaultState().withProperty(FACING, facing) : this.getDefaultState().withProperty(this.getProperty(), placer.getHorizontalFacing());
    }
    ...
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
        if (this.useBBOne) {
            ...
            return this.AABB == null ? FULL_BLOCK_AABB : this.AABB[state.getValue(this.getProperty()).getIndex() - (this.fullFacing ? 0 : 2)];
        }
    }
    ...
    public AxisAlignedBB getCollisionBoundingBox(IBlockState blockState, IBlockAccess worldIn, BlockPos pos) {
        if (this.useBBOne) {
            ...
            return this.AABB == null ? FULL_BLOCK_AABB : this.AABB[blockState.getValue(this.getProperty()).getIndex() - (this.fullFacing ? 0 : 2)];
        }
    }
    ...
    public static class HardBlockRotated extends BlockRotated implements IBlockHardBreak {
        ...
        public HardBlockRotated(Material mater, String name, float hard, float resi, boolean fullFacing, float slowSpeed, float fastSpeed, int harvestlvl, String tool, boolean canDropWhithoutTool) {
        ...
        public HardBlockRotated(Material mater, String name, BlocksRegister.HardRes hardres, String tool, boolean canDropWhithoutTool, boolean fullFacing, AxisAlignedBB aabb) {
