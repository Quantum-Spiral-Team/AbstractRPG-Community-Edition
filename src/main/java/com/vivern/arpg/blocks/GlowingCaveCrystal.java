...
public class GlowingCaveCrystal extends Block {
    ...
    public IBlockState getStateForPlacement(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        ...
        return this.getDefaultState().withProperty(TYPE, worldIn.rand.nextInt(4)).withProperty(WEST, west).withProperty(EAST, east).withProperty(NORTH, north).withProperty(SOUTH, south).withProperty(UPPER, up).withProperty(DOWN, down);
    }
