...
public class Corallimorpha extends Block implements IBlockHardBreak {
    ...
    public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer player, boolean willHarvest) {
        ...
        return this.isAroundWater(world, pos) ? world.setBlockState(pos, Blocks.WATER.getDefaultState(), flag) : world.setBlockState(pos, Blocks.AIR.getDefaultState(), flag);
    }
    ...
    public Vec3d getOffset(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        ...
        return new Vec3d(dx * (axis == Axis.X ? 0.1 : 0.5), dy * (axis == Axis.Y ? 0.1 : 0.5), dz * (axis == Axis.Z ? 0.1 : 0.5));
    }
    ...
    public IBlockState getStateFromMeta(int meta) {
        ...
        return this.getDefaultState().withProperty(FACING, EnumFacing.byIndex(facingIndex)).withProperty(WET, isWet);
    }
