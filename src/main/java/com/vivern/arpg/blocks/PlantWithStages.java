...
public class PlantWithStages extends Block implements IGrowable {
    ...
    public PlantWithStages(Material material, String name, Block[] groundBlocks, float hardness, float resistance, SoundType soundType, int maxStage, AxisAlignedBB[] COLLISION_BOXES, int minLightForGrow, int maxLightForGrow, float growChance, String drops) {
        this(material);
    ...
    public Vec3d getOffset(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        ...
        if (block$enumoffsettype == EnumOffsetType.NONE) {
            ...
            return new Vec3d(((float) (i >> 16 & 15L) / 15.0F - 0.5) * this.randOffsetAmountXZ, ((float) (i >> 20 & 15L) / 15.0F - 0.4) * this.randOffsetAmountY, ((float) (i >> 24 & 15L) / 15.0F - 0.5) * this.randOffsetAmountXZ);
        }
    }
