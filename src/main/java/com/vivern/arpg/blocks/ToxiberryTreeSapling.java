...
public class ToxiberryTreeSapling extends Block implements IGrowable {
    ...
    public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
        ...
        return block == BlocksRegister.TOXIC_GRASS || block == BlocksRegister.TOXIC_DIRT || block == BlocksRegister.SLUDGE || block == BlocksRegister.JUNK || block == BlocksRegister.NUCLEAR_WASTE;
    }
    ...
    public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
        ...
        Block block = worldIn.getBlockState(pos.down()).getBlock();
        if (block != BlocksRegister.TOXIC_GRASS && block != BlocksRegister.TOXIC_DIRT && block != BlocksRegister.SLUDGE && block != BlocksRegister.JUNK && block != BlocksRegister.NUCLEAR_WASTE) {
