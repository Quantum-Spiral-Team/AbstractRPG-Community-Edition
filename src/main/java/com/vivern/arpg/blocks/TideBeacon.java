...
public class TideBeacon extends Block implements IBlockHardBreak {
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        if (rand.nextFloat() < 0.19F) {
            ...
            GUNParticle spell = new GUNParticle(res, 0.15F, 0.0F, liveTime, 210, worldIn, d0, d1, d2, 0.0F, 0.0F, 0.0F, 0.45F + rand.nextFloat() * 0.1F, 0.9F + rand.nextFloat() * 0.1F, 0.9F + rand.nextFloat() * 0.1F, true, 0);
            spell.alpha = 1.0F;
