...
public class DungeonFloorLadder extends Block {
    ...
    public boolean teleport(Entity entity, BlockPos pos) {
        if (entity != null && !entity.world.isRemote) {
            ...
            Vec3d relativePos = DimensionDungeon.getRelativePosInRegion(pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5, coordsCR.getX(), coordsCR.getZ());
            ...
            entity.setPositionAndUpdate(nextFloorCenterPos.getX() + relativePos.x, 254.8 - entity.height, nextFloorCenterPos.getZ() + relativePos.z);
            entity.world.playSound(null, pos, Sounds.dungeon_ladder, SoundCategory.BLOCKS, 0.7F, 0.85F + RANDOM.nextFloat() * 0.3F);
            entity.world.playSound(null, entity.posX, entity.posY, entity.posZ, Sounds.dungeon_ladder, SoundCategory.BLOCKS, 0.7F, 0.85F + RANDOM.nextFloat() * 0.3F);
            return true;
        } else {
            return false;
        }
