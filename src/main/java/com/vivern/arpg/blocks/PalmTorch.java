    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        if (rand.nextFloat() < 0.9F) {
            ...
            if (enumfacing.getAxis().isHorizontal()) {
                EnumFacing enumfacing1 = enumfacing.getOpposite();
                GUNParticle spelll = new GUNParticle(res, scale, -4.0E-4F, livetime, 240, worldIn, d0 + d4 * enumfacing1.getXOffset(), d1 + 0.22, d2 + d4 * enumfacing1.getZOffset(), randsp1, 0.0F, randsp3, 1.0F, 0.9F + rand.nextFloat() / 10.0F, 0.9F + rand.nextFloat() / 10.0F, false, 0);
                spelll.scaleTickAdding = scaleTickAdding;
                worldIn.spawnEntity(spelll);
                worldIn.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, d0 + d4 * enumfacing1.getXOffset(), d1 + 0.22, d2 + d4 * enumfacing1.getZOffset(), 0.0, 0.0, 0.0, new int[0]);
            } else {
                GUNParticle spelll = new GUNParticle(res, scale, -4.0E-4F, livetime, 240, worldIn, d0, d1, d2, randsp1, 0.0F, randsp3, 1.0F, 0.9F + rand.nextFloat() / 10.0F, 0.9F + rand.nextFloat() / 10.0F, false, 0);
                spelll.scaleTickAdding = scaleTickAdding;
                worldIn.spawnEntity(spelll);
