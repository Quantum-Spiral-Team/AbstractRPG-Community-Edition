...
public class BlockColumn extends BlockBlock {
    ...
    public static class HardBlockColumn extends BlockColumn implements IBlockHardBreak {
        ...
        public HardBlockColumn(Material mater, String name, float hard, float resi, float slowSpeed, float fastSpeed, int harvestlvl, String tool, boolean canDropWhithoutTool) {
            super(mater, name, hard, resi);
