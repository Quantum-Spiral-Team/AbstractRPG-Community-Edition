...
public class FrozenChandelier extends Block {
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        EnumAxis enumaxis = stateIn.getValue(ROTATE);
        double xx = pos.getX() + 0.5;
        double yy = pos.getY() + 1.6;
        double zz = pos.getZ() + 0.5;
        double d3 = 0.26;
        GUNParticle spelll = new GUNParticle(res, 0.1F + rand.nextFloat() / 20.0F, -0.001F, 20 + rand.nextInt(10), 240, worldIn, xx, yy + 0.07, zz, 0.0F, 0.0F, 0.0F, 0.9F + rand.nextFloat() / 10.0F, 1.0F, 1.0F, false, 0);
        spelll.scaleTickAdding = -0.0037F;
        worldIn.spawnEntity(spelll);
        if (enumaxis == EnumAxis.X) {
            GUNParticle spellx = new GUNParticle(res, 0.1F + rand.nextFloat() / 20.0F, -0.001F, 20 + rand.nextInt(10), 240, worldIn, xx + d3, yy, zz, 0.0F, 0.0F, 0.0F, 0.9F + rand.nextFloat() / 10.0F, 1.0F, 1.0F, false, 0);
            spellx.scaleTickAdding = -0.0037F;
            worldIn.spawnEntity(spellx);
            GUNParticle spelx = new GUNParticle(res, 0.1F + rand.nextFloat() / 20.0F, -0.001F, 20 + rand.nextInt(10), 240, worldIn, xx - d3, yy, zz, 0.0F, 0.0F, 0.0F, 0.9F + rand.nextFloat() / 10.0F, 1.0F, 1.0F, false, 0);
            spelx.scaleTickAdding = -0.0037F;
            worldIn.spawnEntity(spelx);
        } else {
            GUNParticle spellz = new GUNParticle(res, 0.1F + rand.nextFloat() / 20.0F, -0.001F, 20 + rand.nextInt(10), 240, worldIn, xx, yy, zz + d3, 0.0F, 0.0F, 0.0F, 0.9F + rand.nextFloat() / 10.0F, 1.0F, 1.0F, false, 0);
            spellz.scaleTickAdding = -0.0037F;
            worldIn.spawnEntity(spellz);
            GUNParticle spelz = new GUNParticle(res, 0.1F + rand.nextFloat() / 20.0F, -0.001F, 20 + rand.nextInt(10), 240, worldIn, xx, yy, zz - d3, 0.0F, 0.0F, 0.0F, 0.9F + rand.nextFloat() / 10.0F, 1.0F, 1.0F, false, 0);
