...
public class ManaFlowerLeaves extends Block implements IPlantable {
    ...
    public static class ManaFlower extends PlantWithStages {
        ...
        public ManaFlower() {
            super(Material.PLANTS, "mana_flower", new Block[]{BlocksRegister.MANA_FLOWER_LEAVES}, 0.1F, 0.1F, SoundType.PLANT, 2, new AxisAlignedBB[]{GetMOP.newAABB(10, 7, 0), GetMOP.newAABB(12, 10, 0), GetMOP.newAABB(14, 12, 0)}, 13, 15, 0.6F, "arpg:mana_berry,1,1,0");
                        ...
                        for (EnumFacing facing : EnumFacing.HORIZONTALS) {
                            if (rand.nextFloat() < 0.6) {
                                for (int i = 0; i >= -2; i--) {
                                    ...
                                    if (worldIn.isAirBlock(poss) && BlocksRegister.MANA_FLOWER_LEAVES.canPlaceBlockAt(worldIn, poss) && worldIn.getBlockState(poss.down()).getBlock().isFertile(worldIn, poss.down())) {
