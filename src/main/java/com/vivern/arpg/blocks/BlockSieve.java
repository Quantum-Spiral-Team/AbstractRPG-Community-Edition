...
public class BlockSieve extends Block {
    ...
    protected static final AxisAlignedBB AABB_WALL_NORTH = new AxisAlignedBB(boundOffset, 0.5, boundOffset, 1.0 - boundOffset, 0.875, boundOffset + wallThickness);
    protected static final AxisAlignedBB AABB_WALL_SOUTH = new AxisAlignedBB(boundOffset, 0.5, 1.0 - boundOffset - wallThickness, 1.0 - boundOffset, 0.875, 1.0 - boundOffset);
    protected static final AxisAlignedBB AABB_WALL_EAST = new AxisAlignedBB(1.0 - boundOffset - wallThickness, 0.5, boundOffset, 1.0 - boundOffset, 0.875, 1.0 - boundOffset);
