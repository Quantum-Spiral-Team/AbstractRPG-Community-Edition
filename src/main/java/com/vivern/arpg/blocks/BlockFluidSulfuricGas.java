...
public class BlockFluidSulfuricGas extends BlockFluidClassic {
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        ...
        if (rand.nextInt(50) == 0) {
            ...
            GUNParticle spelll = new GUNParticle(res, 0.3F + rand.nextFloat() / 4.0F, -4.0E-4F, lt, 80, worldIn, xx, yy, zz, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 0.9F + rand.nextFloat() / 10.0F, true, rand.nextInt(360));
            spelll.alpha = 0.0F;
