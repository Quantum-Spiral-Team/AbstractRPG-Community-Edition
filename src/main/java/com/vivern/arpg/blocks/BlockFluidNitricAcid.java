...
public class BlockFluidNitricAcid extends BlockFluidClassic {
    ...
    public PathNodeType getAiPathNodeType(IBlockState state, IBlockAccess world, BlockPos pos, @Nullable EntityLiving entity) {
        return entity != null && entity.isEntityInvulnerable(DamageSource.WITHER) && entity.isEntityInvulnerable(DamageSource.MAGIC) ? PathNodeType.WATER : PathNodeType.LAVA;
    }
