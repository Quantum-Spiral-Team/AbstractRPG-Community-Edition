...
public class BlockFluidNaturalGas extends BlockFluidClassic {
    ...
    public static ParticleTracker.TrackerSmoothShowHide ssh = new ParticleTracker.TrackerSmoothShowHide(new Vec3d[]{new Vec3d(0.0, 40.0, 0.025), new Vec3d(40.0, 80.0, -0.025)}, null);
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        ...
        if (rand.nextInt(50) == 0) {
            ...
            GUNParticle spell = new GUNParticle(res, 0.3F + rand.nextFloat() / 4.0F, -4.0E-4F, lt, 100, worldIn, xx, yy, zz, 0.0F, 0.0F, 0.0F, 0.8F + rand.nextFloat() / 10.0F, 1.0F, 1.0F, true, rand.nextInt(360));
            spell.alpha = 0.0F;
