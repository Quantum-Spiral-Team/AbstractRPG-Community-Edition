    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        if (rand.nextFloat() < 0.23F) {
            ...
            if (enumfacing.getAxis().isHorizontal()) {
                EnumFacing enumfacing1 = enumfacing.getOpposite();
                GUNParticle spelll = new GUNParticle(res, scale, 0.001F, livetime, 240, worldIn, d0 + 0.27 * enumfacing1.getXOffset() + randispl1, d1 + 0.22 + randispl2, d2 + 0.27 * enumfacing1.getZOffset() + randispl3, randsp1, randsp2, randsp3, 1.0F, 0.8F + rand.nextFloat() * 0.15F, 0.9F + rand.nextFloat() * 0.1F, false, 0);
                spelll.alpha = 0.1F;
                ...
                GUNParticle spelll = new GUNParticle(res, scale, 0.001F, livetime, 240, worldIn, d0 + randispl1, d1 + randispl2, d2 + randispl3, randsp1, randsp2, randsp3, 1.0F, 0.8F + rand.nextFloat() * 0.15F, 0.9F + rand.nextFloat() * 0.1F, false, 0);
                spelll.alpha = 0.1F;
                spelll.alphaTickAdding = 0.1F;
                spelll.scaleTickAdding = scaleTickAdding;
                spelll.alphaGlowing = true;
