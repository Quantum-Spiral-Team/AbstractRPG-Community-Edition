...
public class MagmaBloom extends Block implements IGrowable {
    ...
    public static final AxisAlignedBB[] AABB = new AxisAlignedBB[]{new AxisAlignedBB(0.175, 0.0, 0.175, 0.825, 0.565, 0.825), new AxisAlignedBB(0.145, 0.0, 0.145, 0.855, 0.7875, 0.855), new AxisAlignedBB(0.125, 0.0, 0.125, 0.875, 0.9375, 0.875)};
    ...
    public Vec3d getOffset(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        ...
        if (block$enumoffsettype == EnumOffsetType.NONE) {
            ...
            return new Vec3d(((float) (i >> 16 & 15L) / 15.0F - 0.5) * 0.5, ((float) (i >> 20 & 15L) / 15.0F - 0.4) * 0.4, ((float) (i >> 24 & 15L) / 15.0F - 0.5) * 0.5);
        }
    }
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        ...
        if (rand.nextInt(10 - age * 2) == 0) {
            ...
            GUNParticle spelll = new GUNParticle(res, 0.1F + rand.nextFloat() / 20.0F + age * 0.05F, -8.0E-4F, 20 + rand.nextInt(10), 200, worldIn, xx, yy, zz, 0.0F, 0.0F, 0.0F, 1.0F, 0.9F + rand.nextFloat() / 10.0F, 1.0F, true, rand.nextInt(41) - 20);
