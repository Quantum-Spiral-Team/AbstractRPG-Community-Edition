...
public class Pilaster extends Block {
    ...
    public static class HardPilaster extends Pilaster implements IBlockHardBreak {
        ...
        public HardPilaster(Material mater, String name, float hard, float resi, float slowSpeed, float fastSpeed, SoundType stype, String tool, int harvestlvl, boolean canDropWhithoutTool) {
