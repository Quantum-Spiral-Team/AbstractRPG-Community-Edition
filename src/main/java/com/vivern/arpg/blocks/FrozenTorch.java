...
public class FrozenTorch extends Block {
    ...
    private boolean canPlaceAt(World worldIn, BlockPos pos, EnumFacing facing) {
        ...
        if (facing.equals(EnumFacing.UP) && this.canPlaceOn(worldIn, blockpos)) {
            ...
            return block == Blocks.ICE || block == Blocks.PACKED_ICE || !isExceptBlockForAttachWithPiston(block) && blockfaceshape == BlockFaceShape.SOLID;
        }
    }
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        ...
        if (enumfacing.getAxis().isHorizontal()) {
            EnumFacing enumfacing1 = enumfacing.getOpposite();
            GUNParticle spelll = new GUNParticle(res, 0.14F + rand.nextFloat() / 20.0F, -0.001F, 20 + rand.nextInt(10), 240, worldIn, d0 + 0.27 * enumfacing1.getXOffset(), d1 + 0.22, d2 + 0.27 * enumfacing1.getZOffset(), 0.0F, 0.0F, 0.0F, 0.9F + rand.nextFloat() / 10.0F, 1.0F, 1.0F, false, 0);
            spelll.scaleTickAdding = -0.0037F;
            worldIn.spawnEntity(spelll);
        } else {
            GUNParticle spelll = new GUNParticle(res, 0.14F + rand.nextFloat() / 20.0F, -0.001F, 20 + rand.nextInt(10), 240, worldIn, d0, d1, d2, 0.0F, 0.0F, 0.0F, 0.9F + rand.nextFloat() / 10.0F, 1.0F, 1.0F, false, 0);
            spelll.scaleTickAdding = -0.0037F;
            worldIn.spawnEntity(spelll);
        }
    }
