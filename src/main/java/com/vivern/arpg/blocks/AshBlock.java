...
public class AshBlock extends BlockFalling {
    ...
    private void checkFallable(World worldIn, BlockPos pos) {
        if (worldIn.getBlockState(pos.down()).getBlock() == this && worldIn.getBlockState(pos.down()).getValue(LAYERS) < 8 || (worldIn.isAirBlock(pos.down()) || canFallThrough(worldIn.getBlockState(pos.down()))) && pos.getY() >= 0) {
            int i = 32;
