...
public class DecorativePipe extends Block implements IBlockHardBreak {
    ...
    public DecorativePipe(Material material, String name, BlocksRegister.HardRes hardres, String tool, CreativeTabs tab, SoundType soundType, float aabbPipeRadius, float aabbCenterRadius, IPipeConnectorFunction isConnected) {
        super(material);
