...
public class RustLamp extends Block {
    ...
    public IBlockState getStateFromMeta(int meta) {
        return meta >= 6 ? this.getDefaultState().withProperty(FACING, EnumFacing.byIndex(meta)).withProperty(ON, true) : this.getDefaultState().withProperty(FACING, EnumFacing.byIndex(meta)).withProperty(ON, false);
    }
