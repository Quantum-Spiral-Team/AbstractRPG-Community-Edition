    ...
    public boolean teleport(Entity entity, BlockPos pos) {
        ...
        if (entity != null) {
            ...
            if (!entity.world.isRemote) {
                ...
                this.getTileEntity(entity.world, pos).positionToTeleport = new Vec3d(nextFloorCenterPos.getX() + relativePos.x, 1.125, nextFloorCenterPos.getZ() + relativePos.z);
                this.getTileEntity(entity.world, pos).teleportTick = 10;
                BlockPos ftilePos = new BlockPos(nextFloorCenterPos.getX() + relativePos.x, 1.0, nextFloorCenterPos.getZ() + relativePos.z);
