...
public class VoidCrystal extends BlockSpawner {
    ...
    public void randomDisplayTick(IBlockState stateIn, World world, BlockPos pos, Random rand) {
        for (int i = 0; i < 2; i++) {
            world.spawnParticle(EnumParticleTypes.PORTAL, pos.getX() + rand.nextDouble(), pos.getY() + rand.nextDouble(), pos.getZ() + rand.nextDouble(), (rand.nextDouble() - 0.5) * 2.0, -rand.nextDouble(), (rand.nextDouble() - 0.5) * 2.0, new int[0]);
        }
    }
