        ...
        if (entity instanceof EntityPlayer) {
            ...
            if (type != null) {
                for (int j = 0; j < 1 + itemRand.nextInt(3); j++) {
                    TileSplitter.spawnTentacleParticle(world, new Vec3d(x, y, z), new Vec3d(itemRand.nextGaussian(), 0.5 + itemRand.nextGaussian() / 4.0, itemRand.nextGaussian()).normalize(), trueplayer, null, 0.2, -0.3, type, 2.0F, b == 0.0);
                }
            }
        }
    }
            ...
            if (IWeapon.canShoot(itemstack)) {
                ...
                if (player.getHeldItemMainhand() == itemstack && (click || click2) && !player.getCooldownTracker().hasCooldown(this)) {
                    if (player.isSneaking() && click) {
                        ...
                        world.playSound(null, player.posX, player.posY, player.posZ, Sounds.item_misc_a, SoundCategory.PLAYERS, 0.5F, 0.9F + itemRand.nextFloat() / 5.0F);
                                ...
                                if (click) {
                                    ...
                                    if (i != 0) {
                                        ...
                                        if (accepted != 0.0F && result.hitVec != null) {
                                            IWeapon.fireEffect(this, player, world, 64.0, result.hitVec.x, result.hitVec.y, result.hitVec.z, shardType.id, 0.0, player.getEntityId(), 0.0, 0.0, 0.0);
                                        }
                                    }
                                } else if (click2) {
                                    if (i == 0) {
                                    ...
                                    if (i != 0) {
                                        ...
                                        if (accepted != 0.0F && result.hitVec != null) {
                                            IWeapon.fireEffect(this, player, world, 64.0, result.hitVec.x, result.hitVec.y, result.hitVec.z, shardType.id, 1.0, player.getEntityId(), 0.0, 0.0, 0.0);
                                        }
                                    }
                                }
