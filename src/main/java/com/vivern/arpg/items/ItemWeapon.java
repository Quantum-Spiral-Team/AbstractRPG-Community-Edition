...
public abstract class ItemWeapon extends Item implements IWeapon {
    ...
    @SideOnly(Side.CLIENT)
    public void playOrContinueLoopSound(EntityLivingBase entity, SoundEvent soundEvent, SoundCategory category, float volume, float pitch, int playtime, int startTime, int endTime, float startPitch, float endPitch) {
