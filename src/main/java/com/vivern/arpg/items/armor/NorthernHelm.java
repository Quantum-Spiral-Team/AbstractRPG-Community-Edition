...
public class NorthernHelm extends AbstractArmor {
    ...
    public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
        ...
        if (equipmentSlot == this.armorType) {
            ...
            multimap.put(SharedMonsterAttributes.MOVEMENT_SPEED.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor speed", -0.05, 1));
    ...
    public static class NorthernBoots extends AbstractArmor {
        ...
        public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
            ...
            if (equipmentSlot == this.armorType) {
                ...
                multimap.put(SharedMonsterAttributes.MOVEMENT_SPEED.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor speed", -0.03, 1));
                multimap.put(PropertiesRegistry.ARMOR_PROTECTION.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor protection", 1.0, 0));
    ...
    public static class NorthernChestplate extends AbstractArmor {
        ...
        public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
            ...
            if (equipmentSlot == this.armorType) {
                ...
                multimap.put(SharedMonsterAttributes.MOVEMENT_SPEED.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor speed", -0.08, 1));
                ...
                multimap.put(SharedMonsterAttributes.ATTACK_DAMAGE.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor damage", 0.1, 2));
