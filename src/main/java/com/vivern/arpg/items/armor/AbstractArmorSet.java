...
public abstract class AbstractArmorSet {
    ...
    public boolean isFullset(EntityLivingBase entityLivingBase) {
        return entityLivingBase.getItemStackFromSlot(EntityEquipmentSlot.HEAD).getItem() == this.HELMET && entityLivingBase.getItemStackFromSlot(EntityEquipmentSlot.CHEST).getItem() == this.CHESTPLATE && entityLivingBase.getItemStackFromSlot(EntityEquipmentSlot.LEGS).getItem() == this.LEGGINS && entityLivingBase.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() == this.BOOTS;
    }

    public boolean isChargedFullset(EntityLivingBase entityLivingBase) {
        return entityLivingBase.getItemStackFromSlot(EntityEquipmentSlot.HEAD).getItem() == this.HELMET && isCharged(entityLivingBase.getItemStackFromSlot(EntityEquipmentSlot.HEAD)) && entityLivingBase.getItemStackFromSlot(EntityEquipmentSlot.CHEST).getItem() == this.CHESTPLATE && isCharged(entityLivingBase.getItemStackFromSlot(EntityEquipmentSlot.CHEST)) && entityLivingBase.getItemStackFromSlot(EntityEquipmentSlot.LEGS).getItem() == this.LEGGINS && isCharged(entityLivingBase.getItemStackFromSlot(EntityEquipmentSlot.LEGS)) && entityLivingBase.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() == this.BOOTS && isCharged(entityLivingBase.getItemStackFromSlot(EntityEquipmentSlot.FEET));
    }
    ...
    public static class ARPGArmor extends AbstractArmor implements IItemHurted {
        ...
        public void onUpdate(ItemStack stack, World world, Entity entity, int itemSlot, boolean isSelected) {
            if (entity instanceof EntityLivingBase) {
                ...
                if (this.armorType == EntityEquipmentSlot.HEAD && entityLivingBase.getItemStackFromSlot(EntityEquipmentSlot.HEAD) == stack && this.armorSet.isFullset(entityLivingBase)) {
        ...
        public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot equipmentSlot, ItemStack itemStack) {
            ...
            if (equipmentSlot == this.armorType) {
                for (NamedAttributeModifier modifier : this.armorSet.modifiers) {
                    multimap.put(modifier.name, new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], modifier.name + " modifier", this.armorSet.getAttributeValueForSlot(modifier.value, this.armorType, itemStack), modifier.operation));
                }
            }
    ...
    public static class ARPGElectricArmor extends ARPGArmor implements IEnergyItem {
        ...
        public void onUpdate(ItemStack stack, World world, Entity entity, int itemSlot, boolean isSelected) {
            if (entity instanceof EntityLivingBase) {
                EntityLivingBase entityLivingBase = (EntityLivingBase) entity;
                if (this.armorType == EntityEquipmentSlot.HEAD && entityLivingBase.getItemStackFromSlot(EntityEquipmentSlot.HEAD) == stack && this.armorSet.isChargedFullset(entityLivingBase)) {
                    this.armorSet.onUpdateFullset(this, stack, world, entityLivingBase, itemSlot, isSelected);
                }
