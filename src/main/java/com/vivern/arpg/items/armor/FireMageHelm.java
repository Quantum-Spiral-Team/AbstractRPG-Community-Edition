...
public class FireMageHelm extends ItemArmor {
    ...
    public static ArmorMaterial firemage_mt = EnumHelper.addArmorMaterial("arpg:firemage_mt", "arpg:firemage_tx", 9, new int[]{2, 3, 4, 3}, 7, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 1.0F);
    ...
    public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
        ...
        if (equipmentSlot == this.armorType) {
            ...
            multimap.put(SharedMonsterAttributes.ARMOR_TOUGHNESS.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor toughness", this.toughness, 0));
