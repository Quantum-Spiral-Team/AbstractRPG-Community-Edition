...
public class WizardHelm extends ItemArmor {
    ...
    public static ArmorMaterial wizard_mt = EnumHelper.addArmorMaterial("arpg:wizard_mt", "arpg:wizaed_tx", 9, new int[]{3, 3, 4, 3}, 7, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 1.0F);
