...
public class SlimeHelm extends ItemArmor {
    ...
    public static ArmorMaterial slime_mt = EnumHelper.addArmorMaterial("arpg:slime_mt", "arpg:slime_tx", 9, new int[]{3, 4, 5, 3}, 5, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 1.0F);
    ...
    public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
        ...
        if (equipmentSlot == this.armorType) {
            ...
            multimap.put(PropertiesRegistry.JUMP_HEIGHT.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor jumping", 0.02, 0));
