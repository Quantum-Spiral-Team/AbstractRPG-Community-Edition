...
public class SnowcoatHelm extends AbstractArmor {
    ...
    public static String[] armortextures = new String[]{"arpg:textures/snowcoat_armor_model_tex.png", "arpg:textures/snowcoat_armor_model_tex_blue.png", "arpg:textures/snowcoat_armor_model_tex_white.png"};
    ...
    public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
        ...
        if (equipmentSlot == this.armorType) {
            multimap.put(SharedMonsterAttributes.ARMOR.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor modifier", 1.0, 0));
            ...
            multimap.put(PropertiesRegistry.MANA_MAX.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor mana", 10.0, 0));
            multimap.put(PropertiesRegistry.MANA_SPEED_MAX.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor manaregen", 0.05, 0));
    ...
    public static class SnowcoatBoots extends AbstractArmor {
        ...
        public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
            ...
            if (equipmentSlot == this.armorType) {
                multimap.put(SharedMonsterAttributes.ARMOR.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor modifier", 1.0, 0));
                multimap.put(PropertiesRegistry.LEADERSHIP.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor leadership", 4.0, 0));
                multimap.put(PropertiesRegistry.MANA_MAX.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor mana", 3.0, 0));
                multimap.put(PropertiesRegistry.ARMOR_PROTECTION.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor protection", 0.5, 0));
            }
    ...
    public static class SnowcoatDye extends Impl<IRecipe> implements IRecipe {
        ...
        public boolean matches(InventoryCrafting inv, World worldIn) {
            ...
            for (int i = 0; i < inv.getSizeInventory(); i++) {
                ...
                if (iitem == ItemsRegister.SNOW_COAT_BOOTS || iitem == ItemsRegister.SNOW_COAT_LEGS || iitem == ItemsRegister.SNOW_COAT_CHEST || iitem == ItemsRegister.SNOW_COAT_HELM) {
                    if (coat != null) {
                        return false;
                    }
                ...
                if (OreDicHelper.itemStringOredigMatches(inv.getStackInSlot(i), "dyeBlue") || OreDicHelper.itemStringOredigMatches(inv.getStackInSlot(i), "dyeLightBlue") || OreDicHelper.itemStringOredigMatches(inv.getStackInSlot(i), "dyeRed")) {
                    if (dye != null) {
                        return false;
                    }
    ...
    public static class SnowcoatLeggins extends AbstractArmor {
        ...
        public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
            ...
            if (equipmentSlot == this.armorType) {
                multimap.put(SharedMonsterAttributes.ARMOR.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor modifier", 2.0, 0));
                multimap.put(PropertiesRegistry.LEADERSHIP.getName(), new AttributeModifier(ARMOR_MODIFIERSG[equipmentSlot.getIndex()], "Armor leadership", 5.0, 0));
