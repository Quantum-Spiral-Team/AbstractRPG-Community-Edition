...
public class ChainMace extends ItemWeapon {
                    ...
                    if (click) {
                        if (!hascooldown) {
                            if (!throwed) {
                                ...
                                double attackspeed = player.getEntityAttribute(SharedMonsterAttributes.ATTACK_SPEED).getAttributeValue();
                                player.getCooldownTracker().setCooldown(this, this.getModifiedMeleeCooldown(attackspeed, this.getCooldownTime(itemstack)));
                                entity.world.playSound(null, entity.posX, entity.posY, entity.posZ, Sounds.chain_mace_throw, SoundCategory.AMBIENT, 0.9F, 0.9F + itemRand.nextFloat() / 5.0F);
                                Weapons.setPlayerAnimationOnServer(player, 8, EnumHand.MAIN_HAND);
                            }
                        }
    ...
    public void returnMace(EntityChainMace entity, ItemStack stack, EntityPlayer player) {
        ...
        entity.world.playSound(null, entity.posX, entity.posY, entity.posZ, Sounds.chain_mace_pick, SoundCategory.AMBIENT, 0.8F, 0.9F + itemRand.nextFloat() / 5.0F);
        double attackspeed = player.getEntityAttribute(SharedMonsterAttributes.ATTACK_SPEED).getAttributeValue();
    ...
    public void onImpactMace(EntityChainMace entity, RayTraceResult result) {
        if (result.entityHit != null) {
            if (Team.checkIsOpponent(entity.thrower, result.entityHit) && !entity.world.isRemote) {
                ...
                if (this.doMeleeMaceAttack(entity, result.entityHit, entity.weaponstack, entity.thrower, maceDamage, maceKnockback, EnumHand.MAIN_HAND, false) && entity.soundCooldown <= 0) {
                    entity.world.playSound(null, entity.posX, entity.posY, entity.posZ, this.getImpactSound(), SoundCategory.AMBIENT, 0.9F, 0.9F + itemRand.nextFloat() / 5.0F);
        ...
        } else if (entity.soundCooldown <= 0 && entity.world.getBlockState(result.getBlockPos()).getBlock().getCollisionBoundingBox(entity.world.getBlockState(result.getBlockPos()), entity.world, result.getBlockPos()) != null) {
            entity.world.playSound(null, entity.posX, entity.posY, entity.posZ, this.getImpactSound(), SoundCategory.AMBIENT, 0.9F, 0.9F + itemRand.nextFloat() / 5.0F);
            entity.soundCooldown = 15 + itemRand.nextInt(10);
        }
    }
    ...
    public void onTickMace(EntityChainMace entity) {
        if (!entity.world.isRemote) {
            ...
            if (entity.returnTime <= 0) {
                ...
                if (spin) {
                    Vec3d relativeEntityPos = new Vec3d(entity.posX - entity.thrower.posX, entity.posY - throwerPosY, entity.posZ - entity.thrower.posZ);
                    ...
                    Vec3d relativeInplanePos = relativeEntityPos.add(-headVector.x * distFromEntityToPlane, -headVector.y * distFromEntityToPlane, -headVector.z * distFromEntityToPlane);
                    Vec3d relativeNextPos = GetMOP.rotateVecAroundAxis(relativeInplanePos, headVector, (float) Math.toRadians(NBTHelper.GetNBTboolean(entity.weaponstack, "spindirection") ? this.angleSpin : -this.angleSpin));
                    ...
                    if (entity.ticksExisted % (this.soundFrequency + (int) Debugger.floats[9]) == 0) {
                        entity.world.playSound(null, entity.posX, entity.posY, entity.posZ, Sounds.chain_mace_spin, SoundCategory.AMBIENT, 0.9F, 0.9F + itemRand.nextFloat() / 5.0F);
                    }
                    ...
                    if (distSq > this.maxDistanceSq) {
                        ...
                        entity.motionY *= 0.85;
                        entity.motionZ *= 0.85;
                        SuperKnockback.applyMove(entity, (float) (this.maxDistanceSq - distSq) / 14.0F, entity.thrower.posX, throwerPosY, entity.thrower.posZ);
                    }
                }
            } else {
                entity.returnTime++;
                ...
                if (entity.returnTime > 50 || edistSq > this.maxDistanceSq) {
                    if (!entity.noClip) {
                        entity.weaponstack.damageItem(Math.min(this.noclipDamage, entity.weaponstack.getMaxDamage() - entity.weaponstack.getItemDamage()), entity.thrower);
                    }
    ...
    public boolean doMeleeMaceAttack(EntityChainMace maceEntity, Entity entity, ItemStack stack, EntityPlayer player, float damage, float knockback, EnumHand hand, boolean isCritical) {
    ...
    public void applyMaceMeleeEffects(EntityChainMace maceEntity, Entity entity, ItemStack stack, EntityPlayer player, float damage, float knockback, EnumHand hand, boolean isCritical) {
        WeaponParameters parameters = WeaponParameters.getWeaponParameters(this);
    ...
    public void renderEntity(EntityChainMace entity, double x, double y, double z, float entityYaw, float partialTicks, Render render) {
        ...
        if (entity.thrower != null) {
            ...
            GlStateManager.enableRescaleNormal();
            Vec3d pwd = entity.getRotatPitchYawAndDist(partialTicks, entity.thrower != Minecraft.getMinecraft().player || Minecraft.getMinecraft().gameSettings.thirdPersonView != 0);
    ...
    public static class Echinus extends ChainMace {
        ...
        public float getAdditionalDurabilityBar(ItemStack stack) {
            return MathHelper.clamp((float) NBTHelper.GetNBTint(stack, "kills") / WeaponParameters.getWeaponParameters(this).getEnchantedI("charges_max", EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.SPECIAL, stack)), 0.0F, 1.0F);
        }
        ...
        public void onImpactMace(EntityChainMace entity, RayTraceResult result) {
            ...
            if (!entity.world.isRemote && entity.var1 == 0) {
                ...
                if (active) {
                    ...
                    } else if (entity.world.getBlockState(result.getBlockPos()).getBlock().getCollisionBoundingBox(entity.world.getBlockState(result.getBlockPos()), entity.world, result.getBlockPos()) != null) {
        ...
        public void spawnBombs(int count, EntityChainMace entity) {
            ...
            entity.world.playSound(null, entity.posX, entity.posY, entity.posZ, Sounds.sea_bomb, SoundCategory.AMBIENT, 0.9F, 1.1F + itemRand.nextFloat() / 5.0F);
            entity.var1 = 1;
        ...
        public void onTickMace(EntityChainMace entity) {
            ...
            if (entity.world.isRemote) {
                if (itemRand.nextFloat() < 0.15F) {
                    ...
                    GUNParticle part = new GUNParticle(this.blob, scl, -0.01F, lt, -1, entity.world, entity.posX, entity.posY + entity.height / 2.0F, entity.posZ, (float) itemRand.nextGaussian() / 8.0F, (float) itemRand.nextGaussian() / 8.0F, (float) itemRand.nextGaussian() / 8.0F, 0.8F + itemRand.nextFloat() / 5.0F, 0.8F + itemRand.nextFloat() / 5.0F, 0.8F + itemRand.nextFloat() / 5.0F, true, itemRand.nextInt(40) - 20);
                ...
                if (NBTHelper.GetNBTboolean(entity.weaponstack, "spinned") && (entity.ticksExisted > 80 || active)) {
                    ...
                    if (active) {
                        if (kills <= 0) {
                            ...
                            entity.world.playSound(null, entity.posX, entity.posY, entity.posZ, Sounds.slimeshoot_a, SoundCategory.AMBIENT, 0.9F, 1.1F + itemRand.nextFloat() / 5.0F);
                        }
                    }
                }
            }
        ...
        public boolean attackEntityMelee(Entity entity, ItemStack stack, EntityPlayer player, EnumHand hand, boolean isCritical) {
            ...
            if (kills < parameters.getEnchantedI("charges_max", EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.SPECIAL, stack)) && !NBTHelper.GetNBTboolean(stack, "active") && entity instanceof EntityLivingBase && ((EntityLivingBase) entity).getHealth() > 0.0F) {
                checkdead = true;
            }
            ...
            if (dead) {
                ...
                if (kills < 16 && kills + addkills >= 16) {
                    entity.world.playSound(null, entity.posX, entity.posY, entity.posZ, Sounds.item_misc_b, SoundCategory.AMBIENT, 0.9F, 0.9F + itemRand.nextFloat() / 5.0F);
                }
            }
    ...
    public static class Icebreaker extends ChainMace {
        ...
        public static ParticleTracker.TrackerSmoothShowHide tssh = new ParticleTracker.TrackerSmoothShowHide(new Vec3d[]{new Vec3d(0.0, 5.0, 0.2F), new Vec3d(5.0, 15.0, -0.1F)}, null);
        ...
        public boolean attackEntityMelee(Entity entity, ItemStack stack, EntityPlayer player, EnumHand hand, boolean isCritical) {
            ...
            if (entity instanceof EntityLivingBase) {
                ...
                if (Freezing.canImmobilizeEntity((EntityLivingBase) entity, ((EntityLivingBase) entity).getActivePotionEffect(PotionEffects.FREEZING))) {
                    freezebreak += WeaponParameters.getWeaponParameters(this).getEnchantedF("icebreak_damage", EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.MIGHT, stack));
                }
            }

            boolean ret = entity.attackEntityFrom(DamageSource.causePlayerDamage(player), (float) player.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).getAttributeValue() * artropods * holy + freezebreak);
            entity.hurtResistantTime = 0;
            return ret;
        }
        ...
        public void onTickMace(EntityChainMace entity) {
            ...
            if (entity.world.isRemote) {
                if (Math.abs(entity.motionX) + Math.abs(entity.motionY) + Math.abs(entity.motionZ) > 0.1) {
                    ...
                    GUNParticle fire2 = new GUNParticle(this.largecloud, scl, 0.009F, lt, 240, entity.world, entity.posX, entity.posY + entity.height / 2.0F, entity.posZ, 0.0F, 0.0F, 0.0F, 0.75F + itemRand.nextFloat() / 10.0F, 1.0F, 1.0F, true, itemRand.nextInt(100) - 50);
                    fire2.tracker = tssh;
                    ...
                    GUNParticle snoww = new GUNParticle(this.snow, scl2, 0.03F, lt2, 200, entity.world, entity.posX, entity.posY + entity.height / 2.0F, entity.posZ, (float) itemRand.nextGaussian() / 15.0F, (float) itemRand.nextGaussian() / 15.0F, (float) itemRand.nextGaussian() / 15.0F, 0.9F, 0.9F, 1.0F, false, itemRand.nextInt(360), true, 2.3F);
        ...
        public void onTickMace(EntityChainMace entity) {
            ...
            if (entity.world.isRemote) {
                if (entity.spinned) {
                    ...
                    float scl = 0.1F + itemRand.nextFloat() / 3.0F;
                    GUNParticle fire2 = new GUNParticle(this.flame, scl, -0.009F, lt, 240, entity.world, entity.posX, entity.posY + entity.height / 2.0F, entity.posZ, 0.0F, 0.0F, 0.0F, 1.0F, 0.8F + (float) itemRand.nextGaussian() / 5.0F, 1.0F, true, itemRand.nextInt(100) - 50);
                    fire2.alphaTickAdding = -1.0F / lt;
                    fire2.scaleTickAdding = -scl / lt / 1.6F;
                    fire2.alphaGlowing = true;
                    entity.world.spawnEntity(fire2);
                    if (itemRand.nextFloat() < 0.2F) {
                        entity.world.spawnParticle(EnumParticleTypes.LAVA, entity.posX, entity.posY, entity.posZ, 0.0, 0.2F, 0.0, new int[0]);
                    }
                } else {
