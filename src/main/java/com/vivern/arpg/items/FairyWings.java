                        ...
                        if (clickforw && flying) {
                            if (!cool) {
                                ...
                                if (!player.world.isRemote) {
                                    player.world.playSound(null, player.posX, player.posY, player.posZ, SoundEvents.ENTITY_ENDERDRAGON_FLAP, SoundCategory.PLAYERS, 0.5F, 0.9F + itemRand.nextFloat() / 5.0F);
                                }
