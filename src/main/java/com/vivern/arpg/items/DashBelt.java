        ...
        if (!entityIn.world.isRemote && entityIn instanceof EntityPlayer) {
            ...
            if (this.checkAndUpdateBeltCooldown(itemstack) && charges > 0 && player.isSprinting() && !player.isElytraFlying()) {
                ...
                if (dashVec != null) {
                    ...
                    player.world.playSound(null, player.posX, player.posY, player.posZ, Sounds.dash_a, SoundCategory.PLAYERS, 0.7F, 0.9F + itemRand.nextFloat() / 5.0F);
        ...
        public void onWornTick(ItemStack itemstack, EntityLivingBase entityIn) {
            ...
            if (!entityIn.world.isRemote && entityIn instanceof EntityPlayer) {
                ...
                if (recharge > 0) {
                    ...
                    NBTHelper.SetNBTint(itemstack, -1, "recharge");
                    NBTHelper.SetNBTint(itemstack, maxCharges, "charges");
                    player.world.playSound(null, player.posX, player.posY, player.posZ, Sounds.dash_ready_shadow, SoundCategory.PLAYERS, 0.5F, 0.9F + itemRand.nextFloat() / 5.0F);
                }
        ...
        public void onWornTick(ItemStack itemstack, EntityLivingBase entityIn) {
            ...
            if (!entityIn.world.isRemote && entityIn instanceof EntityPlayer) {
                ...
                if (recharge > 0) {
                    ...
                    NBTHelper.SetNBTint(itemstack, -1, "recharge");
                    NBTHelper.SetNBTint(itemstack, maxCharges, "charges");
                    player.world.playSound(null, player.posX, player.posY, player.posZ, Sounds.dash_ready, SoundCategory.PLAYERS, 0.5F, 0.9F + itemRand.nextFloat() / 5.0F);
                }
                ...
                if (this.checkAndUpdateBeltCooldown(itemstack) && charges > 0 && player.isSprinting() && !player.isElytraFlying()) {
                    ...
                    if (dashVec != null) {
                        ...
                        this.setBeltCooldown(itemstack, player, this.dashVelocity);
                        player.addExhaustion(this.exhaustion);
                        player.world.playSound(null, player.posX, player.posY, player.posZ, Sounds.dash_b, SoundCategory.PLAYERS, 0.7F, 0.9F + itemRand.nextFloat() / 5.0F);
                        NBTHelper.AddNBTint(itemstack, -1, "charges");
                        NBTHelper.AddNBTint(itemstack, oneCharge, "recharge");
                    }
                }
            ...
            if (!entityIn.world.isRemote && entityIn instanceof EntityPlayer) {
                ...
                if (this.checkAndUpdateBeltCooldown(itemstack) && charges > 0 && player.isSprinting() && !player.isElytraFlying()) {
                    ...
                    if (dashVec != null) {
                        ...
                        this.setBeltCooldown(itemstack, player, this.dashVelocity);
                        player.addExhaustion(this.exhaustion);
                        player.world.playSound(null, player.posX, player.posY, player.posZ, Sounds.dash_c, SoundCategory.PLAYERS, 0.7F, 0.9F + itemRand.nextFloat() / 5.0F);
                        NBTHelper.AddNBTint(itemstack, -1, "charges");
                        NBTHelper.AddNBTint(itemstack, oneCharge, "recharge");
                    }
                }
        ...
        public void onWornTick(ItemStack itemstack, EntityLivingBase entityIn) {
            ...
            if (!entityIn.world.isRemote && entityIn instanceof EntityPlayer) {
                ...
                if (recharge > 0) {
                    ...
                    NBTHelper.SetNBTint(itemstack, -1, "recharge");
                    NBTHelper.SetNBTint(itemstack, maxCharges, "charges");
                    player.world.playSound(null, player.posX, player.posY, player.posZ, Sounds.dash_ready_cold, SoundCategory.PLAYERS, 0.5F, 0.9F + itemRand.nextFloat() / 5.0F);
                }
