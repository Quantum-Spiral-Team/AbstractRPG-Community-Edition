    ...
    public void spawnPartickles(World world, EntityPlayer player, boolean deploy) {
        if (deploy) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                GUNParticle part = new GUNParticle(mana_flow, scl, 0.0F, lt, 210, world, partpos.x + (itemRand.nextFloat() - 0.5F) / 2.0F, partpos.y + (itemRand.nextFloat() - 0.5F) / 2.0F, partpos.z + (itemRand.nextFloat() - 0.5F) / 2.0F, 0.0F, 0.0F, 0.0F, 0.5F + itemRand.nextFloat() * 0.1F, 1.0F, 0.85F + itemRand.nextFloat() * 0.15F, true, itemRand.nextInt(360), true, 1.0F);
            ...
            for (int i = 0; i < 2; i++) {
                ...
                GUNParticle water = new GUNParticle(Seal.splashes[itemRand.nextInt(3)], scl, 0.011F, lt, 180, world, partpos.x + (itemRand.nextFloat() - 0.5F) / 2.0F, partpos.y + (itemRand.nextFloat() - 0.5F) / 2.0F, partpos.z + (itemRand.nextFloat() - 0.5F) / 2.0F, 0.0F, 0.0F, 0.0F, 0.55F - itemRand.nextFloat() * 0.2F, 0.8F - itemRand.nextFloat() * 0.22F, 1.0F - itemRand.nextFloat() * 0.2F, false, itemRand.nextInt(360), true, 1.15F);
                water.dropMode = true;
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (result != null && result.hitVec != null) {
                    ...
                    GUNParticle part = new GUNParticle(mana_flow, scl, 0.0F, lt, 210, world, result.hitVec.x, result.hitVec.y, result.hitVec.z, (float) itemRand.nextGaussian() / 20.0F, (float) itemRand.nextGaussian() / 20.0F, (float) itemRand.nextGaussian() / 20.0F, 0.5F + itemRand.nextFloat() * 0.1F, 1.0F, 0.85F + itemRand.nextFloat() * 0.15F, true, itemRand.nextInt(360));
                    part.alphaGlowing = true;
                    part.scaleTickAdding = -scl / lt;
                ...
                world.spawnParticle(EnumParticleTypes.WATER_BUBBLE, result.hitVec.x, result.hitVec.y, result.hitVec.z, (float) itemRand.nextGaussian() / 20.0F, (float) itemRand.nextGaussian() / 20.0F, (float) itemRand.nextGaussian() / 20.0F, new int[0]);
            }
            ...
            GUNParticle water = new GUNParticle(waterhammer, scl, 0.0F, lt, 150, world, vecpos.x, vecpos.y, vecpos.z, (float) (-look.x) / lt, (float) (-look.y) / lt, (float) (-look.z) / lt, 0.75F - itemRand.nextFloat() * 0.2F, 0.8F - itemRand.nextFloat() * 0.2F, 1.0F, true, itemRand.nextInt(360));
