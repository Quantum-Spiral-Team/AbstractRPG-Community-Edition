    ...
    public static class BehaviorArrowsDispense extends BehaviorDefaultDispenseItem {
        ...
        public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
            if (stack.getItem() instanceof ItemArrow) {
                ...
                projectile.shoot(enumfacing.getXOffset(), enumfacing.getYOffset() + this.upwardMotion, enumfacing.getZOffset(), this.getProjectileVelocity(), this.getProjectileInaccuracy());
