...
public class AnimationChannel {
    ...
    public void animate(float time) {
        ...
        if (key1 != null && key2 != null) {
            float ftKey2 = key1.interpolation != Interpolations.CATMULLROM && key2.interpolation != Interpolations.CATMULLROM ? GetMOP.getFromTo(time, key1.keyTime, key2.keyTime) : GetMOP.softFromTo(time, key1.keyTime, key2.keyTime);
