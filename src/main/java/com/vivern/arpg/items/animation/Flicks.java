...
public class Flicks {
    ...
    public FlickInertia getOrCreateFlickInertia(EntityPlayer player, int slot, EnumFlick name, int valueMin, int valueMax, int tendency, int value, int valueTarget) {
