...
public class ItemBasicTool extends ItemItem {
    ...
    public boolean canApplyAtEnchantingTable(ItemStack stack, Enchantment enchantment) {
        return enchantment.type == EnumEnchantmentType.DIGGER || enchantment.type == EnumEnchantmentType.BREAKABLE || enchantment.type == EnumEnchantmentType.ALL;
    }
    ...
    public static String getToolForMaterial(Material material) {
        if (material == Material.WOOD || material == Material.CACTUS || material == Material.GOURD || material == Material.LEAVES || material == Material.PLANTS || material == Material.VINE) {
            return "axe";
        } else if (material == Material.CARPET || material == Material.CLOTH || material == Material.LEAVES || material == Material.PLANTS || material == Material.VINE || material == Material.SPONGE || material == Material.WEB) {
            return "shears";
        } else {
            return material != Material.CLAY && material != Material.CRAFTED_SNOW && material != Material.GRASS && material != Material.GROUND && material != Material.SAND && material != Material.SNOW ? "pickaxe" : "shovel";
        }
    }
