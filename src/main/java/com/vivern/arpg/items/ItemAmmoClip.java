...
public class ItemAmmoClip extends Item {
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
        ...
        if (this.specialAmmo) {
            ...
            return this.fillWithAmmo(world, player, itemstack) ? new ActionResult(EnumActionResult.SUCCESS, itemstack) : new ActionResult(EnumActionResult.PASS, itemstack);
        } else {
            int i = 0;
            ...
            if (itemstack.getItemDamage() == this.maxAmmoStore || !itemstack.hasTagCompound()) {
                for (ItemBullet key : counts.keySet()) {
                    ...
                    if (count >= this.maxAmmoStore) {
                        ...
                        world.playSound(null, player.posX, player.posY, player.posZ, Sounds.vampireknifes, SoundCategory.PLAYERS, 0.5F, 1.0F);
