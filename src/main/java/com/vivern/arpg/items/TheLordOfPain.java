            ...
            if (IWeapon.canShoot(itemstack)) {
                ...
                if (player.getHeldItemMainhand() == itemstack && Mana.getMana(player) > 5.0F - sor / 1.1F && click && !player.getCooldownTracker().hasCooldown(itemIn)) {
                    ...
                    if (causeCooldown) {
                        ...
                        world.playSound(null, player.posX, player.posY, player.posZ, SoundEvents.EVOCATION_ILLAGER_CAST_SPELL, SoundCategory.AMBIENT, 0.9F, 0.95F + itemRand.nextFloat() / 5.0F);
