                ...
                if (click && player.getHeldItemMainhand() == itemstack) {
                    if (ammo > 0 && this.isReloaded(itemstack)) {
                        if (!player.getCooldownTracker().hasCooldown(this)) {
                            world.playSound(null, player.posX, player.posY, player.posZ, Sounds.stinger, SoundCategory.AMBIENT, 0.9F, 0.95F + itemRand.nextFloat() / 10.0F);
                            ...
                            Weapons.shoot(stinger, EnumHand.MAIN_HAND, player, player.rotationPitch, player.rotationYaw, 0.0F, parameters.getFloat("velocity"), parameters.getEnchantedF("inaccuracy", acc), -0.05F, 0.5F, 0.5F);
                        ...
                        world.playSound(null, player.posX, player.posY, player.posZ, Sounds.stinger_reload, SoundCategory.NEUTRAL, 0.7F, 0.95F + itemRand.nextFloat() / 10.0F);
