...
public class ItemTurret extends Item {
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
        ...
        if (raytraceresult == null) {
            ...
            if (!world.checkBlockCollision(new AxisAlignedBB(posup.getX() + 0.1, posup.getY(), posup.getZ() + 0.1, posup.getX() + 0.9, posup.getY() + 0.9, posup.getZ() + 0.9)) && !world.isRemote) {
                ...
                itemstack.shrink(1);
                player.world.playSound(null, turret.posX, turret.posY, turret.posZ, Sounds.turret_set, SoundCategory.PLAYERS, 0.9F, 0.9F + itemRand.nextFloat() / 5.0F);
