    ...
    public boolean onEntitySwing(EntityLivingBase entityLiving, ItemStack stack) {
        ...
        if (IWeapon.canShoot(stack)) {
            ...
            if (!player.getCooldownTracker().hasCooldown(this)) {
                ...
                if (world.isRemote) {
                    SweepParticle particle = new SweepParticle(sweeptex, 1.9F + itemRand.nextFloat() / 2.0F, 6, 1, 4, 2, 170, world, vec.x, vec.y, vec.z, player.rotationPitch, player.rotationYaw, 0.8F, 0.2F, 0.85F, false, player.getHeldItemMainhand() == stack ? 180 - itemRand.nextInt(65) - 10 : itemRand.nextInt(65) + 10);
                ...
                if (!list.isEmpty()) {
                    ...
                    if (itemRand.nextFloat() < 0.33) {
                        crit = 11.0F;
                        world.playSound(null, player.posX, player.posY, player.posZ, Sounds.cursed_blade_crit, SoundCategory.AMBIENT, 0.9F, 0.9F + itemRand.nextFloat() / 5.0F);
                    }
                    ...
                    AttributeModifier modifier = new AttributeModifier("cursedblade", 9.0 + EnchantmentHelper.getEnchantmentLevel(Enchantments.SHARPNESS, stack) + crit, 0);
