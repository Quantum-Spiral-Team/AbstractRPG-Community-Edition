        ...
        if (IWeapon.canShoot(itemstack)) {
            ...
            if (player.getHeldItemMainhand() == itemstack && mana > 0.1F - sor / 55.0F && click && !player.getCooldownTracker().hasCooldown(itemIn)) {
                ...
                if (player.ticksExisted % 10 == 0) {
                    world.playSound(null, player.posX, player.posY, player.posZ, Sounds.impetus_wind, SoundCategory.AMBIENT, 0.8F, 0.6F + charge / 125.0F);
                }
                ...
                if (charge < 30) {
                    ...
                    world.playSound(null, player.posX, player.posY, player.posZ, Sounds.impetus_1, SoundCategory.AMBIENT, 0.8F, 0.9F + itemRand.nextFloat() / 5.0F);
                    ...
                    if (!list.isEmpty()) {
                        for (Entity entitylivingbase : list) {
                            if (entitylivingbase != player && !worldIn.isRemote) {
                                ...
                                SuperKnockback.applyKnockback(entitylivingbase, 0.5F + charge / (15.0F - impulse), player.posX, player.posY, player.posZ);
                            }
                        }
                    }
                } else if (charge < 60) {
                    ...
                    world.playSound(null, player.posX, player.posY, player.posZ, Sounds.impetus_2, SoundCategory.AMBIENT, 1.5F, 0.9F + itemRand.nextFloat() / 5.0F);
                    player.getCooldownTracker().setCooldown(this, this.getCooldownTime(itemstack));
                    this.boom(2);
                    NBTHelper.SetNBTint(itemstack, 0, "usecharge");
                    if (!list.isEmpty()) {
                        for (Entity entitylivingbasex : list) {
                            if (entitylivingbasex != player && !worldIn.isRemote) {
                                ...
                                SuperKnockback.applyKnockback(entitylivingbasex, 0.5F + charge / (15.0F - impulse), player.posX, player.posY, player.posZ);
                            }
                        }
                    }
                } else {
                    world.playSound(null, player.posX, player.posY, player.posZ, Sounds.impetus_3, SoundCategory.AMBIENT, 3.0F, 0.9F + itemRand.nextFloat() / 5.0F);
                    player.getCooldownTracker().setCooldown(this, this.getCooldownTime(itemstack));
                    this.boom(3);
                    NBTHelper.SetNBTint(itemstack, 0, "usecharge");
                    ...
                    if (!alllist.isEmpty()) {
                        for (Entity entitylivingbasexx : alllist) {
                            if (entitylivingbasexx != player && !worldIn.isRemote) {
                                ...
                                SuperKnockback.applyKnockback(entitylivingbasexx, 0.5F + charge / (15.0F - impulse), player.posX, player.posY, player.posZ);
                            }
                        }
                    }
                }
