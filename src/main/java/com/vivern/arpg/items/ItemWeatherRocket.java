...
public class ItemWeatherRocket extends ItemItem {
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        if (!worldIn.isRemote) {
            ...
            EntityWeatherRocket entityfireworkrocket = new EntityWeatherRocket(worldIn, pos.getX() + hitX, pos.getY() + hitY, pos.getZ() + hitZ);
            ...
            worldIn.playSound(null, entityfireworkrocket.posX, entityfireworkrocket.posY, entityfireworkrocket.posZ, Sounds.weather_firework_launch, SoundCategory.PLAYERS, 1.0F, 0.9F + itemRand.nextFloat() / 5.0F);
