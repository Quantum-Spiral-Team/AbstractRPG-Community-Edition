        ...
        if (!worldIn.isRemote) {
            ...
            if (IWeapon.canShoot(itemstack)) {
                ...
                if (selected && mana > 5.0F && clickb && !player.getCooldownTracker().hasCooldown(itemIn)) {
                    ...
                    world.playSound(null, player.posX, player.posY, player.posZ, Sounds.magic_a, SoundCategory.AMBIENT, 1.0F, 0.7F / (itemRand.nextFloat() * 0.4F + 0.8F));
                ...
                if (selected && click && !player.getCooldownTracker().hasCooldown(itemIn)) {
                    if (mana > 0.5F) {
                        world.playSound(null, player.posX, player.posY, player.posZ, Sounds.swosh_a, SoundCategory.AMBIENT, 0.8F, 0.9F / (itemRand.nextFloat() * 0.4F + 0.5F));
