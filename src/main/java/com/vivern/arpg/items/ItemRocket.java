...
public class ItemRocket extends Item {
    ...
    public static ParticleTracker trackerExplode1 = new ParticleTracker.TrackerSmoothShowHide(null, new Vec3d[]{new Vec3d(-1.0, 4.0, 0.2F), new Vec3d(3.0, 7.0, 0.1F), new Vec3d(7.0, 100.0, -0.025F)});
    public static ParticleTracker trackerRandom1 = new ParticleTracker.TrackerRandomMotion(null, 0.04F, 6);
    public static ParticleTracker trackerExplode2 = new ParticleTracker.TrackerSmoothShowHide(null, new Vec3d[]{new Vec3d(-1.0, 6.0, 0.2F), new Vec3d(5.0, 10.0, 0.07F), new Vec3d(10.0, 20.0, -0.2F)});
    ...
    public boolean explode(World world, EntityLivingBase player, double x, double y, double z, @Nullable RayTraceResult result, @Nullable Entity projectile, ItemStack weaponstack, float weaponDamage, float weaponKnockback) {
        return true;
    }
    ...
    public static void onEffectPacket(World world, double x, double y, double z, double a, double b, double c, int id) {
        if (id == -1) {
            ...
            for (int ss = 0; ss < 7; ss++) {
                GUNParticle bigsmoke = new GUNParticle(largesmoke, 0.6F + itemRand.nextFloat() / 2.0F, -0.001F, 40, 60, world, x, y, z, (float) itemRand.nextGaussian() / 13.0F, (float) itemRand.nextGaussian() / 20.0F, (float) itemRand.nextGaussian() / 13.0F, 1.0F, 1.0F, 1.0F, true, itemRand.nextInt(360));
            ...
            for (int ss = 0; ss < 10; ss++) {
                ...
                GUNParticle fire = new GUNParticle(flame, 0.1F + (float) itemRand.nextGaussian() / 6.0F, -0.003F, lt, 240, world, x, y, z, (float) itemRand.nextGaussian() / 9.0F, (float) itemRand.nextGaussian() / 9.0F, (float) itemRand.nextGaussian() / 9.0F, 1.0F - itemRand.nextFloat() * 0.2F, 1.0F - itemRand.nextFloat() * 0.2F, 0.7F, true, itemRand.nextInt(100) - 50);
        ...
        if (id == -2) {
            ...
            for (int ss = 0; ss < 5; ss++) {
                ...
                GUNParticle bigsmoke = new GUNParticle(largecloud, (float) (1.0 + itemRand.nextGaussian() / 6.0), -0.005F, lt, 240, world, x, y, z, (float) (itemRand.nextGaussian() / 10.0), (float) (itemRand.nextGaussian() / 10.0), (float) (itemRand.nextGaussian() / 10.0), 0.5F + itemRand.nextFloat() / 10.0F, 1.0F, 1.0F, true, itemRand.nextInt(360));
            ...
            for (int i = 0; i < countOfParticles; i++) {
                ...
                GUNParticle particle = new GUNParticle(snow, 0.35F + (float) itemRand.nextGaussian() / 30.0F, 0.01F, 22 + itemRand.nextInt(10), 180, world, x, y, z, X, Y, Z, 0.75F + itemRand.nextFloat() / 10.0F, 0.9F, 1.0F, false, itemRand.nextInt(360), true, 1.0F);
            ...
            for (int ss = 0; ss < 2; ss++) {
                ...
                GUNParticle part = new GUNParticle(frostcircle, 1.0F, 0.0F, lt, 240, world, x, y, z, 0.0F, 0.0F, 0.0F, 0.35F + itemRand.nextFloat() / 5.0F, 0.8F, 1.0F, true, itemRand.nextInt(360));
            ...
            GUNParticle part = new GUNParticle(frostexpl, 1.0F, 0.0F, lt, 240, world, x, y, z, 0.0F, 0.0F, 0.0F, 0.75F + itemRand.nextFloat() / 5.0F, 0.8F, 1.0F, true, itemRand.nextInt(360));
            part.scaleTickAdding = fsize / lt;
            part.alphaGlowing = true;
            part.alphaTickAdding = -0.025F;
            world.spawnEntity(part);
        ...
        if (id == -3) {
            ...
            for (int ss = 0; ss < 7; ss++) {
                GUNParticle bigsmoke = new GUNParticle(largecloud, 0.6F + itemRand.nextFloat() / 2.0F, -0.005F, 40, 170, world, x, y, z, (float) itemRand.nextGaussian() / 33.0F, (float) itemRand.nextGaussian() / 20.0F, (float) itemRand.nextGaussian() / 33.0F, 1.0F, 0.35F + itemRand.nextFloat() * 0.2F, 0.0F, true, itemRand.nextInt(360));
            ...
            for (int ss = 0; ss < 10; ss++) {
                int lt = 19 + itemRand.nextInt(10);
                GUNParticle fire = new GUNParticle(flame, 0.1F + (float) itemRand.nextGaussian() / 6.0F, -0.003F, lt, 240, world, x, y, z, (float) itemRand.nextGaussian() / 9.0F, (float) itemRand.nextGaussian() / 9.0F, (float) itemRand.nextGaussian() / 9.0F, 0.15F + itemRand.nextFloat() * 0.1F, 1.0F, 1.0F - itemRand.nextFloat() * 0.15F, true, itemRand.nextInt(100) - 50);
                fire.alphaTickAdding = -1.0F / lt;
                fire.alphaGlowing = true;
                fire.tracker = trackerExplode1;
                world.spawnEntity(fire);
                ...
                GUNParticle part = new GUNParticle(toxicspell, scl, -0.004F, lt2, 200, world, x, y, z, (float) itemRand.nextGaussian() / 13.0F, (float) itemRand.nextGaussian() / 16.0F, (float) itemRand.nextGaussian() / 13.0F, 1.0F, 0.8F + itemRand.nextFloat() * 0.2F, 1.0F, true, itemRand.nextInt(360));
        ...
        if (id == -4) {
            ...
            for (int ss = 0; ss < itemRand.nextInt(10) + 4; ss++) {
                world.spawnParticle(EnumParticleTypes.LAVA, x, y, z, itemRand.nextGaussian() / 13.0, 0.4 + itemRand.nextGaussian() / 13.0, itemRand.nextGaussian() / 13.0, new int[0]);
            }

            float fsize = (float) (1.8 + itemRand.nextGaussian() / 6.0);
            int lt = 4 + itemRand.nextInt(3);
            GUNParticle part = new GUNParticle(firecircle, 0.4F, 0.0F, lt, 240, world, x, y, z, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, true, itemRand.nextInt(360));
            part.scaleTickAdding = fsize / lt;
            part.alphaGlowing = true;
        ...
        if (id == -6) {
            ...
            for (int ss = 0; ss < 8; ss++) {
                ...
                GUNParticle part = new GUNParticle(sparkle4, 0.4F, 0.0F, lt, 240, world, x + itemRand.nextGaussian() / 2.0, y + itemRand.nextGaussian() / 2.0, z + itemRand.nextGaussian() / 2.0, (float) itemRand.nextGaussian() / 9.0F, (float) itemRand.nextGaussian() / 9.0F, (float) itemRand.nextGaussian() / 9.0F, 1.0F, 1.0F, 0.8F, true, itemRand.nextInt(360));
                part.scaleTickAdding = fsize / lt;
                part.alphaGlowing = true;
            ...
            for (int ss = 0; ss < 3; ss++) {
                world.spawnParticle(EnumParticleTypes.EXPLOSION_LARGE, x + itemRand.nextGaussian() / 4.0, y + itemRand.nextGaussian() / 4.0, z + itemRand.nextGaussian() / 4.0, 0.0, 0.0, 0.0, new int[0]);
            }
        }
        ...
        if (id == -7) {
            ...
            for (int ss = 0; ss < 10; ss++) {
                int lt = 16;
                GUNParticle fire = new GUNParticle(purple_smoke, 0.1F, 0.0F, lt, 240, world, x + itemRand.nextGaussian() / 2.0, y + itemRand.nextGaussian() / 2.0, z + itemRand.nextGaussian() / 2.0, (float) itemRand.nextGaussian() / 9.0F, (float) itemRand.nextGaussian() / 9.0F, (float) itemRand.nextGaussian() / 9.0F, 0.7F + itemRand.nextFloat() * 0.2F, 0.5F, 0.8F + itemRand.nextFloat() * 0.2F, true, itemRand.nextInt(100) - 50);
                fire.alphaTickAdding = -1.0F / lt;
                fire.alphaGlowing = true;
            ...
            for (int i = 0; i < 20; i++) {
                world.spawnParticle(EnumParticleTypes.PORTAL, x + (itemRand.nextDouble() - 0.5), y + itemRand.nextDouble() - 0.25, z + (itemRand.nextDouble() - 0.5), (itemRand.nextDouble() - 0.5) * 2.0, -itemRand.nextDouble(), (itemRand.nextDouble() - 0.5) * 2.0, new int[0]);
            }

            float fsize = (float) (1.0 + itemRand.nextGaussian() / 6.0);
            int lt = 4 + itemRand.nextInt(3);
            GUNParticle part = new GUNParticle(void_explode, 0.4F, 0.0F, lt, 240, world, x, y, z, 0.0F, 0.0F, 0.0F, 0.5F, 0.8F, 1.0F, true, itemRand.nextInt(360));
            part.scaleTickAdding = fsize / lt;
            part.alphaGlowing = true;
            part.alphaTickAdding = -0.8F / lt;
            part.randomDeath = false;
            ...
            GUNParticle partx = new GUNParticle(void_explode, 4.5F, 0.0F, ltx, 240, world, x, y, z, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, true, itemRand.nextInt(360));
        ...
        if (id == -8) {
            world.playSound(x, y, z, a == 0.0 ? Sounds.explode_water_a : Sounds.explode_water_b, SoundCategory.PLAYERS, 1.3F, 0.9F + itemRand.nextFloat() / 5.0F, false);
            if (a == 0.0) {
                for (int ss = 0; ss < 5; ss++) {
                    GUNParticle bubble = new GUNParticle(slimesplash, 0.6F + itemRand.nextFloat() / 2.0F, -0.001F, 7 + itemRand.nextInt(7), -1, world, x + itemRand.nextGaussian() / 2.0, y + itemRand.nextGaussian() / 2.0, z + itemRand.nextGaussian() / 2.0, (float) itemRand.nextGaussian() / 15.0F, (float) itemRand.nextGaussian() / 16.0F + 0.05F, (float) itemRand.nextGaussian() / 15.0F, 0.3F, 0.8F, 1.0F, true, itemRand.nextInt(180));
                ...
                GUNParticle part = new GUNParticle(blob, 0.4F, 0.0F, lt, 240, world, x, y, z, 0.0F, 0.0F, 0.0F, 0.5F, 0.8F, 1.0F, true, itemRand.nextInt(11) - 10);
                part.randomDeath = false;
            ...
            for (int i = 0; i < countOfParticles; i++) {
                ...
                GUNParticle particle = new GUNParticle(blob, 0.1F + itemRand.nextFloat() * 0.05F, a > 0.0 ? -0.001F : 0.01F, 22 + itemRand.nextInt(20), 180, world, x, y, z, X, Y, Z, 0.6F, 0.8F, 1.0F, true, itemRand.nextInt(360), true, 1.5F);
                world.spawnEntity(particle);
            }
        }
        ...
        if (id == -9) {
            ...
            for (int i = 0; i < 10; i++) {
                GUNParticle particle = new GUNParticle(star2, 0.1F, 0.003F, 10, 240, world, x, y, z, (float) itemRand.nextGaussian() / 8.0F, (float) itemRand.nextGaussian() / 8.0F, (float) itemRand.nextGaussian() / 8.0F, 0.15F + itemRand.nextFloat() * 0.1F, 0.3F - itemRand.nextFloat() * 0.2F, 1.0F, true, itemRand.nextInt(360));
            ...
            for (int ss = 0; ss < 6; ss++) {
                EntityCubicParticle part = new EntityCubicParticle(arcane_rocket, 0.007F + itemRand.nextFloat() * 0.005F, 0.017F, 12 + itemRand.nextInt(10), -1, world, x, y, z, (float) itemRand.nextGaussian() / 11.0F, (float) itemRand.nextGaussian() / 11.0F + 0.08F, (float) itemRand.nextGaussian() / 11.0F, 1.0F, 1.0F, 1.0F, false, itemRand.nextFloat(), itemRand.nextFloat(), itemRand.nextFloat(), 0.14F, true, 0.0F);
                world.spawnEntity(part);
            }
        }
        ...
        if (id == -10) {
            ...
            for (int ss = 0; ss < 3; ss++) {
                int lt = 30 + itemRand.nextInt(20);
                GUNParticle bigsmoke = new GUNParticle(largecloud, (float) (0.75 + itemRand.nextGaussian() / 7.0), -0.005F, lt, 240, world, x, y, z, (float) (itemRand.nextGaussian() / 10.0), (float) (itemRand.nextGaussian() / 10.0), (float) (itemRand.nextGaussian() / 10.0), 0.5F + itemRand.nextFloat() / 10.0F, 1.0F, 1.0F, true, itemRand.nextInt(360));
                bigsmoke.alphaGlowing = true;
                bigsmoke.alphaTickAdding = -1.0F / lt;
                world.spawnEntity(bigsmoke);
            }
            ...
            for (int i = 0; i < countOfParticles; i++) {
                ...
                GUNParticle particle = new GUNParticle(snow2, 0.35F + (float) itemRand.nextGaussian() / 30.0F, 0.01F, 26 + itemRand.nextInt(10), 200, world, x, y, z, X, Y, Z, 0.75F + itemRand.nextFloat() / 10.0F, 0.9F, 1.0F, false, itemRand.nextInt(360), true, 1.0F);
                particle.dropMode = true;
                world.spawnEntity(particle);
            }

            for (int ss = 0; ss < itemRand.nextInt(3) + 5; ss++) {
                GUNParticle part = new GUNParticle(snow_cloth, 0.2F + itemRand.nextFloat() * 0.1F, 0.03F, 40 + itemRand.nextInt(15), -1, world, x, y, z, (float) itemRand.nextGaussian() / 8.0F, (float) itemRand.nextGaussian() / 8.0F + 0.1F, (float) itemRand.nextGaussian() / 8.0F, 0.77F, 0.11F, 0.09F, false, itemRand.nextInt(360), true, 3.0F);
                part.dropMode = true;
                part.rotationPitchYaw = new Vec2f(itemRand.nextInt(360), itemRand.nextInt(360));
                part.tracker = new ParticleTracker.TrackerGlassShard((float) itemRand.nextGaussian() * 18.0F, (float) itemRand.nextGaussian() * 18.0F, (int) itemRand.nextGaussian() * 2, false);
                world.spawnEntity(part);
            }
        }
    ...
    public static class ArcaneRocket extends ItemRocket {
        ...
        public void onProjectileUpdate(Entity projectile, ItemStack weaponstack) {
            if (projectile.world.isRemote) {
                GUNParticle fire2 = new GUNParticle(magic_rocket, 0.1F, 0.0F, 11, 240, projectile.world, projectile.posX, projectile.posY, projectile.posZ, 0.0F, 0.0F, 0.0F, 0.15F, 0.2F + itemRand.nextFloat() / 5.0F, 0.8F + itemRand.nextFloat() / 5.0F, true, itemRand.nextInt(360));
        ...
        @Override
        public boolean explode(World world, EntityLivingBase player, double x, double y, double z, RayTraceResult result, Entity projectile, ItemStack weaponstack, float weaponDamage, float weaponKnockback) {
            if (!world.isRemote) {
    ...
    public static class ChemicalRocket extends ItemRocket {
        ...
        public void onProjectileUpdate(Entity projectile, ItemStack weaponstack) {
            if (projectile.world.isRemote) {
                GUNParticle fire2 = new GUNParticle(flame, 0.15F, 0.0F, 14, 240, projectile.world, projectile.posX, projectile.posY, projectile.posZ, 0.0F, 0.0F, 0.0F, 0.1F + itemRand.nextFloat() / 5.0F, 1.0F, 0.3F + itemRand.nextFloat() / 5.0F, true, itemRand.nextInt(360));
        ...
        public boolean explode(World world, EntityLivingBase player, double x, double y, double z, RayTraceResult result, Entity projectile, ItemStack weaponstack, float weaponDamage, float weaponKnockback) {
            ...
            AxisAlignedBB axisalignedbb = projectile.getEntityBoundingBox().expand(damageRadius * 2.0, damageRadius * 2.0, damageRadius * 2.0).offset(-damageRadius, -damageRadius, -damageRadius);
            if (world.isRemote) {
                return false;
            } else {
                ...
                if (!list.isEmpty()) {
                    ...
                    for (Entity entity : list) {
                        ...
                        if (opponent) {
                            Weapons.dealDamage(new WeaponDamage(weaponstack, player, projectile, true, false, projectile, WeaponDamage.toxin), weaponDamage + this.damage(), player, entity, true, weaponKnockback + this.knockback(), x, y - entity.height / 2.0F, z);
                            entity.hurtResistantTime = 0;
                        } else {
                            if (EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.SPECIAL, weaponstack) == 0) {
                                Weapons.dealDamage(new WeaponDamage(weaponstack, player, projectile, true, false, projectile, WeaponDamage.toxin), weaponDamage + this.damage(), player, entity, true);
                            }
                    ...
                    for (BlockPos blockpos : GetMOP.getPosesInsideSphere((int) x, (int) y, (int) z, radiusBlocks)) {
                        if (itemRand.nextFloat() < chance) {
                            ...
                            if (state.getBlock() == Blocks.WATER || state.getBlock() == Blocks.FLOWING_WATER) {
                                world.setBlockState(blockpos, BlocksRegister.FLUID_POISON.getDefaultState().withProperty(BlockFluidPoison.LEVEL, state.getValue(BlockLiquid.LEVEL)));
                            }
                        }
                    }
                }
    ...
    public static class CommonRocket extends ItemRocket {
        ...
        public void onProjectileUpdate(Entity projectile, ItemStack weaponstack) {
            if (projectile.world.isRemote) {
                GUNParticle fire2 = new GUNParticle(flame, 0.15F, 0.0F, 14, 240, projectile.world, projectile.posX, projectile.posY, projectile.posZ, 0.0F, 0.0F, 0.0F, 1.0F, 0.8F + itemRand.nextFloat() / 5.0F, 0.8F + itemRand.nextFloat() / 5.0F, true, itemRand.nextInt(360));
                fire2.alphaTickAdding = -0.06F;
                fire2.alphaGlowing = true;
                fire2.scaleTickAdding = -0.01F;
                projectile.world.spawnEntity(fire2);
                ...
                if (!list.isEmpty()) {
                    for (Entity entity : list) {
                        if (Team.checkIsOpponent(player, entity)) {
                            Weapons.dealDamage(new WeaponDamage(weaponstack, player, projectile, true, false, projectile, WeaponDamage.explode), weaponDamage + this.damage(), player, entity, true, weaponKnockback + this.knockback(), x, y - entity.height / 2.0F, z);
                            entity.hurtResistantTime = 0;
                        } else {
                            if (EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.SPECIAL, weaponstack) == 0) {
                                Weapons.dealDamage(new WeaponDamage(weaponstack, player, projectile, true, false, projectile, WeaponDamage.explode), weaponDamage + this.damage(), player, entity, true);
                            }
    ...
    public static class DemolishingRocket extends ItemRocket {
        ...
        public void onProjectileUpdate(Entity projectile, ItemStack weaponstack) {
            if (projectile.world.isRemote) {
                projectile.world.spawnParticle(EnumParticleTypes.CLOUD, projectile.posX, projectile.posY, projectile.posZ, itemRand.nextGaussian() / 40.0, itemRand.nextGaussian() / 40.0, itemRand.nextGaussian() / 40.0, new int[0]);
            }
        }
        ...
        public boolean explode(World world, EntityLivingBase player, double x, double y, double z, RayTraceResult result, Entity projectile, ItemStack weaponstack, float weaponDamage, float weaponKnockback) {
            if (!world.isRemote) {
                float weapondamageMultiplier = WeaponParameters.getWeaponParameters(this).getFloat("rooted_weapondamage_explode_multiplier");
                world.newExplosion(player, x, y, z, WeaponParameters.getWeaponParameters(this).getEnchantedF("base_explosion_size", EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.MIGHT, weaponstack)) + (float) (Math.sqrt(weaponDamage) * weapondamageMultiplier), EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.SPECIAL, weaponstack) > 0, true);
                return true;
            } else {
                return false;
            }
        ...
        public void onProjectileUpdate(Entity projectile, ItemStack weaponstack) {
            if (projectile.world.isRemote) {
                if (itemRand.nextFloat() < 0.7) {
                    GUNParticle fire2 = new GUNParticle(largecloud, 0.2F, 0.0F, 14, 240, projectile.world, projectile.posX, projectile.posY, projectile.posZ, 0.0F, 0.0F, 0.0F, 0.6F, 0.75F + itemRand.nextFloat() / 9.0F, 1.0F, true, itemRand.nextInt(360));
                    fire2.alphaTickAdding = -0.06F;
                    fire2.alphaGlowing = true;
                    fire2.scaleTickAdding = -0.01F;
                    projectile.world.spawnEntity(fire2);
                } else {
                    GUNParticle fire2 = new GUNParticle(frostlight, 0.13F, -0.01F, 30, 200, projectile.world, projectile.posX, projectile.posY, projectile.posZ, (float) itemRand.nextGaussian() / 40.0F, (float) itemRand.nextGaussian() / 40.0F, (float) itemRand.nextGaussian() / 40.0F, 0.9F + itemRand.nextFloat() / 10.0F, 1.0F, 1.0F, false, 0);
            ...
            if (world.isRemote) {
                ...
                if (!list.isEmpty()) {
                    ...
                    for (Entity entity : list) {
                        ...
                        boolean opponent = Team.checkIsOpponent(player, entity);
                        if (opponent) {
                            Weapons.dealDamage(new WeaponDamage(weaponstack, player, projectile, true, false, projectile, WeaponDamage.frost), weaponDamage + this.damage(), player, entity, true, weaponKnockback + this.knockback(), x, y - entity.height / 2.0F, z);
                            entity.hurtResistantTime = 0;
                        } else {
                            if (EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.SPECIAL, weaponstack) == 0) {
                                Weapons.dealDamage(new WeaponDamage(weaponstack, player, projectile, true, false, projectile, WeaponDamage.frost), weaponDamage + this.damage(), player, entity, true);
                            }
                        ...
                        if (entity instanceof EntityLivingBase) {
                            EntityLivingBase entitylivingbase = (EntityLivingBase) entity;
                            Weapons.mixPotion(entitylivingbase, PotionEffects.FROSTBURN, opponent ? ptime : ftime, (float) ppower, Weapons.EnumPotionMix.GREATEST, Weapons.EnumPotionMix.GREATEST, Weapons.EnumMathOperation.NONE, Weapons.EnumMathOperation.NONE, 0, 0);
                            if (entitylivingbase.getHealth() <= 0.0F && itemRand.nextFloat() < 0.55 && entitylivingbase.deathTime < 1) {
    ...
    public static class MiningRocket extends ItemRocket {
        ...
        public void onProjectileUpdate(Entity projectile, ItemStack weaponstack) {
            if (projectile.world.isRemote && projectile.ticksExisted % 2 == 0) {
                GUNParticle fire2 = new GUNParticle(flame, 0.15F, 0.0F, 14, 240, projectile.world, projectile.posX, projectile.posY, projectile.posZ, 0.0F, 0.0F, 0.0F, 0.7F, 0.8F + itemRand.nextFloat() / 5.0F, 0.7F + itemRand.nextFloat() / 5.0F, true, itemRand.nextInt(360));
                fire2.alphaTickAdding = -0.06F;
                fire2.alphaGlowing = true;
                fire2.scaleTickAdding = -0.01F;
                projectile.world.spawnEntity(fire2);
            ...
            projectile.world.spawnParticle(EnumParticleTypes.CRIT_MAGIC, projectile.posX, projectile.posY, projectile.posZ, 0.0, 0.0, 0.0, new int[0]);
        }
        ...
        public boolean explode(World world, EntityLivingBase player, double x, double y, double z, RayTraceResult result, Entity projectile, ItemStack weaponstack, float weaponDamage, float weaponKnockback) {
            ...
            if (world.isRemote) {
                ...
                if (world.isAreaLoaded(new BlockPos(x - 16.0, y - 16.0, z - 16.0), new BlockPos(x + 16.0, y + 16.0, z + 16.0))) {
                    ...
                    float mult = parameters.getFloat("damage_to_hardness_breaks");
                    ...
                    for (BlockPos blockpos : blocks) {
                        IBlockState state = world.getBlockState(blockpos);
                        if (!Weapons.triggerExplodeBlock(world, blockpos, player, projectile) && Weapons.easyBreakBlockFor(world, (this.damage() + weaponDamage) * mult, blockpos, state)) {
                            Block block = state.getBlock();
                            if (entityplayer != null && EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.SPECIAL, weaponstack) > 0 && block.canSilkHarvest(world, blockpos, state, entityplayer)) {
    ...
    public static class NapalmRocket extends ItemRocket {
        ...
        public void onProjectileUpdate(Entity projectile, ItemStack weaponstack) {
            if (projectile.world.isRemote) {
                ...
                fire2.scaleTickAdding = -0.01F;
                projectile.world.spawnEntity(fire2);
                projectile.world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, projectile.posX, projectile.posY, projectile.posZ, itemRand.nextGaussian() / 40.0, itemRand.nextGaussian() / 40.0, itemRand.nextGaussian() / 40.0, new int[0]);
            }
        }
            ...
            if (world.isRemote) {
                ...
                if (!list.isEmpty()) {
                    ...
                    for (Entity entity : list) {
                        boolean opponent = Team.checkIsOpponent(player, entity);
                        if (opponent) {
                            Weapons.dealDamage(new WeaponDamage(weaponstack, player, projectile, true, false, projectile, WeaponDamage.fire), weaponDamage + this.damage(), player, entity, true, weaponKnockback + this.knockback(), x, y - entity.height / 2.0F, z);
                            entity.hurtResistantTime = 0;
                            entity.setFire(parameters.getEnchantedI("fire", EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.WITCHERY, weaponstack)));
                        } else {
                            if (EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.SPECIAL, weaponstack) == 0) {
                                Weapons.dealDamage(new WeaponDamage(weaponstack, player, projectile, true, false, projectile, WeaponDamage.fire), weaponDamage + this.damage(), player, entity, true);
                            }
                ...
                if (world.isAreaLoaded(new BlockPos(x - 16.0, y - 16.0, z - 16.0), new BlockPos(x + 16.0, y + 16.0, z + 16.0))) {
                    WeaponParameters parameters = WeaponParameters.getWeaponParameters(this);
                    float chanceIgnite = parameters.getFloat("chance_ignite");
    ...
    public static class ShellRocket extends ItemRocket {
        ...
        public void onProjectileUpdate(Entity projectile, ItemStack weaponstack) {
            ...
            if (projectile.world.isRemote) {
                GUNParticle fire2 = new GUNParticle(largecloud, 0.15F, 0.0F, 14, 240, projectile.world, projectile.posX, projectile.posY, projectile.posZ, 0.0F, 0.0F, 0.0F, this.colorR + 0.15F + itemRand.nextFloat() / 10.0F, this.colorG + 0.15F + itemRand.nextFloat() / 20.0F, this.colorB + 0.15F + itemRand.nextFloat() / 5.0F, true, itemRand.nextInt(360));
                fire2.alphaTickAdding = -0.06F;
                fire2.alphaGlowing = true;
                fire2.scaleTickAdding = -0.01F;
                projectile.world.spawnEntity(fire2);
        ...
        public boolean explode(World world, EntityLivingBase player, double x, double y, double z, RayTraceResult result, Entity projectile, ItemStack weaponstack, float weaponDamage, float weaponKnockback) {
            if (world.isRemote) {
                ...
                double damageRadius = this.damageRadius(weaponstack);
                HostileProjectiles.SeaBomb.explodeSeabomb(world, damageRadius, itemRand.nextInt(2) + 1, itemRand, poss, player, this.damage() + weaponDamage, true);
                WeaponParameters parameters = WeaponParameters.getWeaponParameters(this);
                float shellsDamage = parameters.getFloat("shells_damage") + weaponDamage;
                int max = parameters.getInt("shells_min") + itemRand.nextInt(parameters.getInt("shells_max") - parameters.getInt("shells_min") + 1);
                ...
                if (block) {
                    for (int i = 0; i < max; i++) {
                        ShellShard newarrow = new ShellShard(world, result.sideHit == EnumFacing.WEST ? poss.x - blockoffset : poss.x, result.sideHit == EnumFacing.DOWN ? poss.y - blockoffset : poss.y, result.sideHit == EnumFacing.NORTH ? poss.z - blockoffset : poss.z);
                        newarrow.motionX = result.sideHit.getAxis() == Axis.X ? result.sideHit.getXOffset() * 0.5F * power : (itemRand.nextFloat() - 0.5F) * power;
                        newarrow.motionY = result.sideHit.getAxis() == Axis.Y ? result.sideHit.getYOffset() * 0.5F * power : (itemRand.nextFloat() - 0.5F) * power;
                        newarrow.motionZ = result.sideHit.getAxis() == Axis.Z ? result.sideHit.getZOffset() * 0.5F * power : (itemRand.nextFloat() - 0.5F) * power;
    ...
    public static class SurpriseRocket extends ItemRocket {
        ...
        public void onProjectileUpdate(Entity projectile, ItemStack weaponstack) {
            if (projectile.world.isRemote) {
                GUNParticle fire2 = new GUNParticle(magic_rocket, 0.1F, 0.0F, 11, 240, projectile.world, projectile.posX, projectile.posY, projectile.posZ, 0.0F, 0.0F, 0.0F, 1.0F, 0.8F + itemRand.nextFloat() / 5.0F, 0.0F, true, itemRand.nextInt(360));
                fire2.alphaTickAdding = -0.09F;
                fire2.alphaGlowing = true;
                fire2.scaleTickAdding = -0.009F;
                projectile.world.spawnEntity(fire2);
        ...
        public boolean explode(World world, EntityLivingBase player, double x, double y, double z, RayTraceResult result, Entity projectile, ItemStack weaponstack, float weaponDamage, float weaponKnockback) {
            if (world.isRemote) {
                ...
                int amount = WeaponParameters.getWeaponParameters(this).getEnchantedI("surprises", EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.REUSE, weaponstack));
    ...
    public static class VoidRocket extends ItemRocket {
        ...
        public void onProjectileUpdate(Entity projectile, ItemStack weaponstack) {
            if (projectile.world.isRemote) {
                GUNParticle fire2 = new GUNParticle(purple_smoke, 0.15F, 0.0F, 14, 240, projectile.world, projectile.posX, projectile.posY, projectile.posZ, 0.0F, 0.0F, 0.0F, 0.8F, 0.6F, 0.8F + itemRand.nextFloat() * 0.2F, true, itemRand.nextInt(360));
                fire2.alphaTickAdding = -0.06F;
                fire2.alphaGlowing = true;
                fire2.scaleTickAdding = -0.01F;
                projectile.world.spawnEntity(fire2);
            ...
            if (world.isRemote) {
                ...
                if (!list.isEmpty()) {
                    for (Entity entity : list) {
                        boolean opponent = Team.checkIsOpponent(player, entity);
                        if (opponent) {
                            Weapons.dealDamage(new WeaponDamage(weaponstack, player, projectile, true, false, projectile, WeaponDamage.portal), weaponDamage + this.damage(), player, entity, true, -(weaponKnockback + this.knockback()), x, y - entity.height / 2.0F, z);
                            entity.hurtResistantTime = 0;
                        } else {
                            if (EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.SPECIAL, weaponstack) == 0) {
                                Weapons.dealDamage(new WeaponDamage(weaponstack, player, projectile, true, false, projectile, WeaponDamage.portal), weaponDamage + this.damage(), player, entity, true);
                            }
                        ...
                        if (entity instanceof EntityLivingBase) {
                            ...
                            if (entitylivingbase.getHealth() <= 0.0F && itemRand.nextFloat() < 0.25 && entitylivingbase.deathTime < 1 && entitylivingbase.getDistanceSq(x, y, z) < 1.0) {
                                DeathEffects.applyDeathEffect(entitylivingbase, DeathEffects.DE_DISMEMBER);
                            }
                        }
                    }
    ...
    public static class WaterblastRocket extends ItemRocket {
        ...
        public void onProjectileUpdate(Entity projectile, ItemStack weaponstack) {
            ...
            if (projectile.world.isRemote) {
                GUNParticle fire2 = new GUNParticle(blob, 0.12F, 0.0F, 14, 240, projectile.world, projectile.posX, projectile.posY, projectile.posZ, 0.0F, 0.0F, 0.0F, 0.4F, 0.5F + itemRand.nextFloat() / 5.0F, 0.9F + itemRand.nextFloat() / 10.0F, true, itemRand.nextInt(360));
                fire2.alphaTickAdding = -0.06F;
                fire2.alphaGlowing = true;
                fire2.scaleTickAdding = -0.01F;
                projectile.world.spawnEntity(fire2);
            ...
            if (world.isRemote) {
                ...
                if (!list.isEmpty()) {
                    for (Entity entity : list) {
                        ...
                        if (opponent) {
                            Weapons.dealDamage(new WeaponDamage(weaponstack, player, projectile, true, false, projectile, WeaponDamage.water), weaponDamage + this.damage(), player, entity, true, weaponKnockback + this.knockback(), x, y - entity.height / 2.0F, z);
                            entity.hurtResistantTime = 0;
                        } else {
                            if (EnchantmentHelper.getEnchantmentLevel(EnchantmentInit.SPECIAL, weaponstack) == 0) {
                                Weapons.dealDamage(new WeaponDamage(weaponstack, player, projectile, true, false, projectile, WeaponDamage.water), weaponDamage + this.damage(), player, entity, true);
                            }
