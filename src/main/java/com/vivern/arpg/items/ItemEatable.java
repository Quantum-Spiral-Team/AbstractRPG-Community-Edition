...
public class ItemEatable extends ItemFood {
    ...
    public ItemEatable(String name, int maxdamage, int maxstacksize, int hunger, float saturat, boolean wolfFood, int eatTime, @Nullable PotionEffect[] effectsToAdd, @Nullable float[] chances, boolean drink, int radiation) {
