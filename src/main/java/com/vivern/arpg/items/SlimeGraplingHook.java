...
public class SlimeGraplingHook extends GraplingHook {
    ...
    public void onGrap(EntityPlayer player, ItemStack itemstack) {
        ...
        player.world.playSound(null, player.posX, player.posY, player.posZ, SoundEvents.ENTITY_SMALL_SLIME_HURT, SoundCategory.PLAYERS, 0.5F, 0.9F + itemRand.nextFloat() / 5.0F);
    }
    ...
    public void spawnParticle(Vec3d pos1, Vec3d pos2, World world, EntityPlayer player) {
        if (world.isRemote && pos1.lengthSquared() > 1.0E-6 && pos2.lengthSquared() > 1.0E-6) {
            ...
            GraplingHookParticle laser = new GraplingHookParticle(world, this.texture, this.texture2, 0.08F - dis / 500.0F, -1, 1.0F, 1.0F, 1.0F, 0.0F, dis, 1, 0.0F, 1.5F, player.ticksExisted, 0.4F, 0.35F, pos1, pos2);
