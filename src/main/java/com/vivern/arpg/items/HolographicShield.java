...
public class HolographicShield extends ItemWeapon implements IItemHurted {
    ...
    private static final UUID[] SHIELD_MODIFIERS = new UUID[]{UUID.fromString("845FB26B-F624-465F-3C4F-6020A9A49B6B"), UUID.fromString("E8499B04-0E55-2136-BA29-64469C734C0C"), UUID.fromString("9F3E436E-C458-4444-3365-14256304D48D"), UUID.fromString("2AE3C246-FDF3-4E67-B334-69FD380CC150")};
    ...
    public float onHurtWithItem(float hurtdamage, ItemStack stack, EntityPlayer player, DamageSource source) {
        if (source != DamageSource.DROWN && source != DamageSource.ON_FIRE && source != DamageSource.MAGIC && source != DamageSource.OUT_OF_WORLD && source != DamageSource.STARVE && source != DamageSource.WITHER && source != DamageSource.FALL) {
