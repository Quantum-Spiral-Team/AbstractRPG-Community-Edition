                ...
                if (click && player.getHeldItemMainhand() == itemstack) {
                    if (ammo > 0 && this.isReloaded(itemstack)) {
                        if (!player.getCooldownTracker().hasCooldown(this)) {
                            world.playSound(null, player.posX, player.posY, player.posZ, Sounds.lasergun, SoundCategory.AMBIENT, 0.8F, 0.95F + itemRand.nextFloat() / 10.0F);
                            ...
                            IWeapon.fireEffect(this, player, world, 64.0, player.getEntityId(), 0.0, 0.0, vec.x, vec.y, vec.z, 0.0, 0.0, 0.0);
