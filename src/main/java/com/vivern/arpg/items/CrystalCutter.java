                ...
                if (click && player.getHeldItemMainhand() == itemstack) {
                    if (ammo > 0 && this.isReloaded(itemstack)) {
                        if (!player.getCooldownTracker().hasCooldown(this)) {
                            world.playSound(null, player.posX, player.posY, player.posZ, Sounds.crystal_cutter, SoundCategory.AMBIENT, 0.9F, 0.95F + itemRand.nextFloat() / 10.0F);
                            ...
                            Weapons.shoot(shoot, EnumHand.MAIN_HAND, player, player.rotationPitch, player.rotationYaw, 0.0F, parameters.getFloat("velocity"), parameters.getEnchantedF("inaccuracy", acc), -0.4F, 0.4F, 0.2F);
                        ...
                        world.playSound(null, player.posX, player.posY, player.posZ, Sounds.crystal_cutter_rel, SoundCategory.NEUTRAL, 0.7F, 0.95F + itemRand.nextFloat() / 10.0F);
