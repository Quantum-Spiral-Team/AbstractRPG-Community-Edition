...
public class FinWingsModel extends ModelWings {
    ...
    @Override
    public void renderWings(Entity entity, float expanded0, float nofly, float upward, float upwardProgress, float gliding, float limbSwing, float limbSwingAmount, float f5) {
