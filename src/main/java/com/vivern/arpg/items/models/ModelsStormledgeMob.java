...
public class ModelsStormledgeMob {
    ...
    public static class BossOphanimModel extends AbstractMobModel {
        ...
        public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5, int an1, int an2, int an3, int an4, boolean isAbstractMob) {
            ...
            float upForce = GetMOP.softFromTo(wingsTime, 0.1F, 0.35F) - GetMOP.softFromTo(wingsTime, 0.35F, 0.8F) + (GetMOP.softFromTo(wingsTime2, 0.1F, 0.35F) - GetMOP.softFromTo(wingsTime2, 0.35F, 0.8F));
            int ix = 0;
            ...
            if (an3 >= dashAnim) {
                ...
                float ft1 = GetMOP.getFromTo(animx, 0.0F, (float) BossOphanim.dashTimeReady) - GetMOP.getFromTo(animx, (float) (BossOphanim.dashTimeMax - 4), (float) BossOphanim.dashTimeMax);
