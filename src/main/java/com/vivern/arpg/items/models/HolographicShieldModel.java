...
public class HolographicShieldModel extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        GlStateManager.pushMatrix();
        GL11.glDisable(2896);
        OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, Math.min(240.0F, OpenGlHelper.lastBrightnessX + 150.0F), Math.min(240.0F, OpenGlHelper.lastBrightnessY + 150.0F));
        GlStateManager.pushMatrix();
