...
public class ModelsOtherMob {
    ...
    public static class EquestrianModel extends AbstractMobModel {
        ...
        public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5, int an1, int an2, int an3, int an4, boolean isAbstractMob) {
            ...
            this.silverfishBodyParts5.rotateAngleY = MathHelper.cos(partsAnim * 0.9F + (float) (Math.PI * 3.0 / 4.0)) * (float) Math.PI * 0.05F * (1 + Math.abs(3));
            ...
            float ft1 = GetMOP.getFromTo(anim1, 2.0F, OtherMobsPack.Equestrian.shootCooldown * 0.2F) - GetMOP.getFromTo(anim1, OtherMobsPack.Equestrian.shootCooldown * 0.8F, (float) OtherMobsPack.Equestrian.shootCooldown);
    ...
    public static class VarmintModel extends AbstractMobModel {
        ...
        @Override
        public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, int an1, int an2, int an3, int an4, boolean isAbstractMob) {
