...
public class StandartChestModel extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        GlStateManager.translate(this.chestBelowBigRight.rotationPointX * f5, this.chestBelowBigRight.rotationPointY * f5, this.chestBelowBigRight.rotationPointZ * f5);
        ...
        GlStateManager.translate(this.chestBelowBigFront.rotationPointX * f5, this.chestBelowBigFront.rotationPointY * f5, this.chestBelowBigFront.rotationPointZ * f5);
        GlStateManager.scale(1.06, 1.06, 1.06);
        GlStateManager.translate(-this.chestBelowBigFront.offsetX, -this.chestBelowBigFront.offsetY, -this.chestBelowBigFront.offsetZ);
        GlStateManager.translate(-this.chestBelowBigFront.rotationPointX * f5, -this.chestBelowBigFront.rotationPointY * f5, -this.chestBelowBigFront.rotationPointZ * f5);
        ...
        GlStateManager.translate(this.chestBelowBigBottom.rotationPointX * f5, this.chestBelowBigBottom.rotationPointY * f5, this.chestBelowBigBottom.rotationPointZ * f5);
        GlStateManager.scale(1.06, 1.06, 1.06);
        GlStateManager.translate(-this.chestBelowBigBottom.offsetX, -this.chestBelowBigBottom.offsetY, -this.chestBelowBigBottom.offsetZ);
        GlStateManager.translate(-this.chestBelowBigBottom.rotationPointX * f5, -this.chestBelowBigBottom.rotationPointY * f5, -this.chestBelowBigBottom.rotationPointZ * f5);
        ...
        GlStateManager.translate(this.chestBelowBigBack.rotationPointX * f5, this.chestBelowBigBack.rotationPointY * f5, this.chestBelowBigBack.rotationPointZ * f5);
        GlStateManager.scale(1.06, 1.06, 1.06);
        GlStateManager.translate(-this.chestBelowBigBack.offsetX, -this.chestBelowBigBack.offsetY, -this.chestBelowBigBack.offsetZ);
        GlStateManager.translate(-this.chestBelowBigBack.rotationPointX * f5, -this.chestBelowBigBack.rotationPointY * f5, -this.chestBelowBigBack.rotationPointZ * f5);
        ...
        GlStateManager.translate(this.chestBelowBigLeft.rotationPointX * f5, this.chestBelowBigLeft.rotationPointY * f5, this.chestBelowBigLeft.rotationPointZ * f5);
        GlStateManager.scale(1.06, 1.06, 1.06);
        GlStateManager.translate(-this.chestBelowBigLeft.offsetX, -this.chestBelowBigLeft.offsetY, -this.chestBelowBigLeft.offsetZ);
        GlStateManager.translate(-this.chestBelowBigLeft.rotationPointX * f5, -this.chestBelowBigLeft.rotationPointY * f5, -this.chestBelowBigLeft.rotationPointZ * f5);
