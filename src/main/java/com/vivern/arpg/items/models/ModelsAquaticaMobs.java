    ...
    public static class MermaidModel extends AbstractMobModel {
        ...
        public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5, int an1, int an2, int an3, int an4, boolean isAbstractMob) {
            ...
            if (WEAPON == 1) {
                ...
                this.armt1.rotateAngleX = this.armt1.rotateAngleX + ((96.0F * ft1 - 143.0F * ft2 + 47.0F * ft3) * (float) (Math.PI / 180.0) + this.head0.rotateAngleX);
            ...
            if (WEAPON == 2) {
                ...
                this.armr1.rotateAngleX = this.armr1.rotateAngleX + ((-35.0F * ft2 + 60.0F * ft3 - 25.0F * ft5) * (float) (Math.PI / 180.0) + this.head0.rotateAngleX);
