...
public class FrozenWingsModel extends ModelBase {
    ...
    public void renderWings(Entity entity, float expanded, float nofly, float upward, float upwardProgress, float gliding, float limbSwing, float limbSwingAmount, float f5) {
