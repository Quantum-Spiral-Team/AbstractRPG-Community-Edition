...
public class StingingCellModel extends ModelBase {
    ...
    public static Vec3d[] colors = new Vec3d[]{new Vec3d(0.9, 0.1, 0.3), new Vec3d(0.9, 0.5, 0.1), new Vec3d(0.9, 0.9, 0.0), new Vec3d(0.3, 0.9, 0.2), new Vec3d(0.2, 0.7, 1.0), new Vec3d(0.3, 0.3, 1.0), new Vec3d(0.5, 0.0, 0.9), new Vec3d(0.7, 0.1, 0.8), new Vec3d(0.8, 0.1, 0.5), new Vec3d(0.9, 0.1, 0.3), new Vec3d(0.9, 0.5, 0.1)};
