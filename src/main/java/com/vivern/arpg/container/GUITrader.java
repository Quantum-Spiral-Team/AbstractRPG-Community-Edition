    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        if (my > 173 && my < 198) {
            ...
            if (play && Minecraft.getMinecraft().player != null) {
                this.npc.world.playSound(Minecraft.getMinecraft().player, Minecraft.getMinecraft().player.posX, Minecraft.getMinecraft().player.posY, Minecraft.getMinecraft().player.posZ, SoundEvents.UI_BUTTON_CLICK, SoundCategory.AMBIENT, 1.0F, 1.0F);
            }
        }
