...
public class GUIFrozenPuzzle extends GuiScreen {
    ...
    public Vec3d[] colors = new Vec3d[]{new Vec3d(0.5, 0.8, 1.0), new Vec3d(0.3, 0.6, 0.7), new Vec3d(0.2, 0.8, 0.9), new Vec3d(0.4, 0.9, 0.9), new Vec3d(0.3, 0.9, 1.0), new Vec3d(0.4, 0.9, 0.7), new Vec3d(0.5, 0.4, 0.8), new Vec3d(0.3, 0.6, 0.7), new Vec3d(0.3, 0.4, 1.0), new Vec3d(0.1, 0.4, 0.6), new Vec3d(0.1, 0.6, 0.5), new Vec3d(0.5, 0.8, 0.8), new Vec3d(0.1, 0.7, 0.9), new Vec3d(0.1, 0.1, 0.7), new Vec3d(0.2, 0.1, 0.5), new Vec3d(0.2, 0.6, 0.3), new Vec3d(0.3, 0.7, 0.7), new Vec3d(0.2, 0.6, 0.9), new Vec3d(0.3, 0.9, 0.7), new Vec3d(0.6, 0.6, 0.7), new Vec3d(0.5, 0.6, 0.5), new Vec3d(0.4, 0.2, 1.0), new Vec3d(0.8, 0.8, 0.9), new Vec3d(0.2, 0.3, 0.4), new Vec3d(0.3, 0.6, 0.3), new Vec3d(0.1, 1.0, 0.7), new Vec3d(0.1, 0.1, 0.1), new Vec3d(0.3, 0.1, 0.3), new Vec3d(0.2, 0.2, 0.2), new Vec3d(0.3, 0.5, 0.5), new Vec3d(0.1, 0.3, 0.5), new Vec3d(0.4, 0.4, 0.4), new Vec3d(0.5, 0.6, 0.7), new Vec3d(0.4, 0.4, 0.4), new Vec3d(0.3, 0.1, 0.5), new Vec3d(0.3, 0.4, 0.1), new Vec3d(0.7, 0.7, 0.8), new Vec3d(0.5, 0.5, 0.2), new Vec3d(0.6, 0.7, 0.7), new Vec3d(0.9, 0.9, 0.9)};
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        packet.writeInts(this.tile.getPos().getX(), this.tile.getPos().getY(), this.tile.getPos().getZ(), x / 14, y / 14, mouseButton);
