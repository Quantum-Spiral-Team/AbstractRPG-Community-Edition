...
public class GUIElectromagnet extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.fontRenderer.drawString("" + FluidsRegister.biomeToLiquidTemperature(this.tile.getWorld().getBiome(this.tile.getPos()).getTemperature(this.tile.getPos())), i + 33, j + 74, 4210752);
