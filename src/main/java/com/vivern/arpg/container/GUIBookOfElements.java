...
public class GUIBookOfElements extends GuiScreen {
    ...
    public static final ResourceLocation[] GUI_TEXTURES = new ResourceLocation[]{new ResourceLocation("arpg:textures/gui_book_of_elements_1.png"), new ResourceLocation("arpg:textures/gui_book_of_elements_2.png"), new ResourceLocation("arpg:textures/gui_book_of_elements_3.png")};
    ...
    public void playsound(SoundEvent soundEvent) {
        ...
        if (player != null) {
            player.world.playSound(player.posX, player.posY, player.posZ, soundEvent, SoundCategory.PLAYERS, 0.8F, 0.9F + player.getRNG().nextFloat() / 5.0F, false);
        }
    }
